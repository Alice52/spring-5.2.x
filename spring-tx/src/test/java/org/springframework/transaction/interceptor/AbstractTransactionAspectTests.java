...
public abstract class AbstractTransactionAspectTests {
    ...
    public void transactionShouldSucceedWithCallbackPreference() throws Exception {
        ...
        MockCallbackPreferringTransactionManager ptm =
                new MockCallbackPreferringTransactionManager();
    ...
    /**
     * Simulate failure of the underlying transaction infrastructure to commit. Check that the
     * target method was invoked, but that the transaction infrastructure exception was thrown to
     * the client
     */
    @Test
     ...
     *
     * @param target the target if there's a distinct target. If not (AspectJ), return target.
