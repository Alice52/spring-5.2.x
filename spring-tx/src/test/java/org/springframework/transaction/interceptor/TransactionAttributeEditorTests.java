...
public class TransactionAttributeEditorTests {
    ...
    public void testValidPropagationCodeOnly() {
        ...
        TransactionAttribute ta = (TransactionAttribute) pe.getValue();
        assertThat(ta != null).isTrue();
        assertThat(ta.getPropagationBehavior() == TransactionDefinition.PROPAGATION_REQUIRED)
                .isTrue();
    ...
    public void testInvalidPropagationCodeOnly() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> pe.setAsText("XXPROPAGATION_REQUIRED"));
    }
    ...
    public void testValidPropagationCodeAndIsolationCode() {
        ...
        assertThat(ta.getPropagationBehavior() == TransactionDefinition.PROPAGATION_REQUIRED)
                .isTrue();
        assertThat(ta.getIsolationLevel() == TransactionDefinition.ISOLATION_READ_UNCOMMITTED)
                .isTrue();
    }
    ...
    public void testValidPropagationCodeAndIsolationCodeAndRollbackRules1() {
        ...
        assertThat(ta.getPropagationBehavior())
                .isEqualTo(TransactionDefinition.PROPAGATION_MANDATORY);
        assertThat(ta.getIsolationLevel())
