...
public class NameMatchTransactionAttributeSource
    ...
    protected static final Log logger =
            LogFactory.getLog(NameMatchTransactionAttributeSource.class);
    ...
    /**
     * Parses the given properties into a name/attribute map. Expects method names as keys and
     * String attributes definitions as values, parsable into TransactionAttribute instances via
     ...
     *
     * <p>Method names can be exact matches, or of the pattern "xxx*", "*xxx" or "*xxx*" for
        ...
        if (attr == null) {
            ...
            for (String mappedName : this.nameMap.keySet()) {
                if (isMatch(methodName, mappedName)
                        && (bestNameMatch == null
                                || bestNameMatch.length() <= mappedName.length())) {
     ...
     * direct equality. Can be overridden in subclasses.
     *
