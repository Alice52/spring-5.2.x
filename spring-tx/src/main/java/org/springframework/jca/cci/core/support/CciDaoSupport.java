...
public abstract class CciDaoSupport extends DaoSupport {
    ...
    /**
     * Create a CciTemplate for the given ConnectionFactory. Only invoked if populating the DAO with
     * a ConnectionFactory reference!
     *
    ...
    public final void setConnectionFactory(ConnectionFactory connectionFactory) {
        if (this.cciTemplate == null
                || connectionFactory != this.cciTemplate.getConnectionFactory()) {
     ...
     * ConnectionFactory and other settings but overriding the ConnectionSpec used for obtaining
     * Connections.
     *
     * @param connectionSpec the CCI ConnectionSpec that the returned template instance is supposed
    ...
    /**
     * Close the given CCI Connection, created via this bean's ConnectionFactory, if it isn't bound
     * to the thread.
     *
