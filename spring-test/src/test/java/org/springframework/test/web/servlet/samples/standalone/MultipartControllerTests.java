...
public class MultipartControllerTests {
    ...
    public void multipartRequestWithSingleFile() throws Exception {
        ...
        MockMultipartFile jsonPart =
                new MockMultipartFile("json", "json", "application/json", json);
        ...
        standaloneSetup(new MultipartController())
                ...
                .andExpect(
                        model().attribute(
                                        "jsonContent", Collections.singletonMap("name", "yeeeah")));
    }
    ...
    public void multipartRequestWrapped() throws Exception {
        ...
        mockMvc.perform(multipart("/json").file(jsonPart))
