...
public class JsonPathResultMatchersTests {
    ...
    public void valueWithTypeMismatch() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
                .isThrownBy(
                        () ->
                                new JsonPathResultMatchers("$.str")
                                        .value("bogus".getBytes())
                                        .match(stubMvcResult))
                .withMessage(
                        "At JSON path \"$.str\", value <foo> of type <java.lang.String> cannot be converted to type <byte[]>");
    }
    ...
    public void doesNotExistForAnEmptyArray() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
                .isThrownBy(
                        () ->
                                new JsonPathResultMatchers("$.emptyArray")
                                        .doesNotExist()
                                        .match(stubMvcResult));
    }
    ...
    public void doesNotExistForAnEmptyMap() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
                .isThrownBy(
                        () ->
                                new JsonPathResultMatchers("$.emptyMap")
                                        .doesNotExist()
                                        .match(stubMvcResult));
    }
    ...
    public void isNotEmptyForAnEmptyString() throws Exception {
        assertThatExceptionOfType(AssertionError.class)
                .isThrownBy(
                        () ->
                                new JsonPathResultMatchers("$.emptyString")
                                        .isNotEmpty()
                                        .match(stubMvcResult));
    }
    ...
    private StubMvcResult createPrefixedStubMvcResult(String jsonPrefix) throws Exception {
        ...
        response.addHeader("Content-Type", "application/json");
        response.getWriter()
                .print(jsonPrefix + new String(RESPONSE_CONTENT.getBytes("ISO-8859-1")));
