...
@ContextConfiguration(
        classes =
                TransactionalAnnotatedConfigClassesWithoutAtConfigurationTests.AnnotatedFactoryBeans
                        .class)
public class TransactionalAnnotatedConfigClassesWithoutAtConfigurationTests
     ...
     *
     * <p>Consequently, this class contains <i>annotated factory bean methods</i> instead of
     * standard singleton bean methods.
     */
    // @Configuration
    static class AnnotatedFactoryBeans {
         ...
         * singleton bean when retrieved through the application context (e.g., when injected into
         * the test instance). The result is that this method will be called twice:
         *
         * <ol>
         ...
         * different {@code DataSource} instances, which is almost certainly not the desired or
         * intended behavior.
         */
        @Bean
