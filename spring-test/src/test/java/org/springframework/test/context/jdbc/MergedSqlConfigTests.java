...
class MergedSqlConfigTests {
    ...
    void localConfigWithCustomValues() throws Exception {
        ...
        assertSoftly(
                softly -> {
                    ...
                    softly.assertThat(cfg.getCommentPrefixes())
                            .as("commentPrefixes")
                            .isEqualTo(array("`"));
                    softly.assertThat(cfg.getBlockCommentStartDelimiter())
                            .as("blockCommentStartDelimiter")
                            .isEqualTo("<<");
                    softly.assertThat(cfg.getBlockCommentEndDelimiter())
                            .as("blockCommentEndDelimiter")
                            .isEqualTo(">>");
                    softly.assertThat(cfg.getErrorMode())
                            .as("errorMode")
                            .isEqualTo(IGNORE_FAILED_DROPS);
                });
    }
    ...
    void globalConfigWithDuplicatedCommentPrefixes() throws Exception {
        SqlConfig sqlConfig =
                GlobalConfigWithWithDuplicatedCommentPrefixesClass.class.getAnnotation(
                        SqlConfig.class);
    ...
    void globalConfigWithDefaults() throws Exception {
        ...
        SqlConfig localSqlConfig = method.getAnnotation(Sql.class).config();
        MergedSqlConfig cfg =
                new MergedSqlConfig(localSqlConfig, GlobalConfigWithDefaultsClass.class);
        assertDefaults(cfg);
    }
    ...
    private void assertDefaults(MergedSqlConfig cfg) {
        assertSoftly(
                softly -> {
                    ...
                    softly.assertThat(cfg.getSeparator())
                            .as("separator")
