...
public class EventPublishingTestExecutionListenerIntegrationTests {
     ...
     * test method is annotated with {@code @Traceable}, and {@link ExampleTestCase#standardTest()}
     * is not.
     */
    @Test
    ...
    /**
     * An exception thrown from an event listener executed in the current thread should fail the
     * test method.
     */
    @Test
    ...
    /**
     * An exception thrown from an event listener that is executed asynchronously should not fail
     * the test method.
     */
    @Test
    ...
    /**
     * MUST be annotated with {@code @Component} due to a change in Spring 5.1 that does not
     * consider beans in a package starting with "org.springframework" to be event listeners unless
    ...
    static class AsyncTestEventComponent {
        ...
        @BeforeTestMethod(
                "event.testContext.testMethod.name == 'testWithFailingAsyncEventListener'")
        @Async
