...
class ContextCacheTests {
    ...
    private void assertParentContextCount(int expected) {
        assertThat(contextCache.getParentContextCount())
                .as("parent context count")
                .isEqualTo(expected);
    }
    ...
    void removeContextHierarchyCacheLevel2() {
        ...
        // removed.
        contextCache.remove(
                getMergedContextConfiguration(testContext3a).getParent(),
                HierarchyMode.CURRENT_LEVEL);
    ...
    void removeContextHierarchyCacheLevel3Then2() {
        ...
        // Remove Level 3-A
        contextCache.remove(
                getMergedContextConfiguration(testContext3a), HierarchyMode.CURRENT_LEVEL);
        ...
        contextCache.remove(
                getMergedContextConfiguration(testContext3b).getParent(),
                HierarchyMode.CURRENT_LEVEL);
        assertContextCacheStatistics(contextCache, "removed level 2", 1, 1, 4);
        assertParentContextCount(0);
    }
    ...
    @ContextConfiguration(
            ...
            loader = CustomAnnotationConfigContextLoader.class)
    private static class CustomAnnotationConfigContextLoaderTestCase {}

    private static class CustomAnnotationConfigContextLoader
