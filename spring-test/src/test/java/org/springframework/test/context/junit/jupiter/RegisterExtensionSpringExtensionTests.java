...
class RegisterExtensionSpringExtensionTests {
    ...
    void autowiredFields() {
        ...
        assertThat(this.enigma)
                .as("Enigma should have been injected via @Value by Spring")
                .isNotNull();
    ...
    void autowiredParameterOfList(@Autowired List<Person> peopleParam) {
        assertThat(peopleParam)
                .as("list of people should have been @Autowired by Spring")
                .isNotNull();
