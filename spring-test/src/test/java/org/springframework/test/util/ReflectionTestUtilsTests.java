...
class ReflectionTestUtilsTests {
    ...
    private static void assertSetFieldAndGetFieldBehavior(Person person) {
        ...
        assertThat(person.getFavoriteNumber())
                .as("'favorite number' (package field)")
                .isEqualTo(PI);
    }
    ...
    private static void assertSetFieldAndGetFieldBehaviorForProxy(Person proxy, Person target) {
        ...
        assertThat(target.likesPets())
                .as("'likes pets' flag (package private boolean field)")
                .isEqualTo(true);
        assertThat(target.getFavoriteNumber())
                .as("'favorite number' (package field)")
                .isEqualTo(PI);
    }
    ...
    void setFieldWithNullValueForPrimitiveLong() throws Exception {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> setField(person, "id", null, long.class));
    }

    @Test
    void setFieldWithNullValueForPrimitiveInt() throws Exception {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> setField(person, "age", null, int.class));
    }
    ...
    void getStaticFieldViaInstance() throws Exception {
        StaticFields staticFields = new StaticFields();
        assertThat(getField(staticFields, "publicField"))
                .as("public static field")
                .isEqualTo("public");
    ...
    void invokeSetterMethodAndInvokeGetterMethodWithExplicitMethodNames() throws Exception {
        ...
        assertThat(person.getEyeColor())
                .as("eye color (package private method)")
                .isEqualTo("green");
        assertThat(person.likesPets())
