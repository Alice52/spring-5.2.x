...
class MetaAnnotationUtilsTests {
    ...
    void findAnnotationDescriptorWithNoAnnotationPresent() {
        assertThat(findAnnotationDescriptor(NonAnnotatedInterface.class, Transactional.class))
                .isNull();
    ...
    void findAnnotationDescriptorWithInheritedAnnotationOnClass() {
        ...
        assertThat(
                        findAnnotationDescriptor(
                                        InheritedAnnotationClass.class, Transactional.class)
                                .getRootDeclaringClass())
                .isEqualTo(InheritedAnnotationClass.class);
        assertThat(
                        findAnnotationDescriptor(
                                        SubInheritedAnnotationClass.class, Transactional.class)
                                .getRootDeclaringClass())
                .isEqualTo(InheritedAnnotationClass.class);
    }
    ...
    void findAnnotationDescriptorWithInheritedAnnotationOnInterface() {
        ...
        assertThat(descriptor).isNotNull();
        assertThat(descriptor.getRootDeclaringClass())
                .isEqualTo(SubInheritedAnnotationInterface.class);
        assertThat(descriptor.getDeclaringClass()).isEqualTo(InheritedAnnotationInterface.class);
        assertThat(descriptor.getAnnotation()).isEqualTo(rawAnnotation);
    ...
    void findAnnotationDescriptorForNonInheritedAnnotationOnInterface() {
        ...
        descriptor =
                findAnnotationDescriptor(SubNonInheritedAnnotationInterface.class, Order.class);
        assertThat(descriptor).isNotNull();
        assertThat(descriptor.getRootDeclaringClass())
    ...
    void findAnnotationDescriptorWithMetaComponentAnnotation() {
        assertAtComponentOnComposedAnnotation(
                HasMetaComponentAnnotation.class, "meta1", Meta1.class);
    }
    ...
    void findAnnotationDescriptorForClassWithMetaAnnotatedInterface() {
        Component rawAnnotation =
                AnnotationUtils.findAnnotation(
                        ClassWithMetaAnnotatedInterface.class, Component.class);
        AnnotationDescriptor<Component> descriptor =
                findAnnotationDescriptor(ClassWithMetaAnnotatedInterface.class, Component.class);

        assertThat(descriptor).isNotNull();
        assertThat(descriptor.getRootDeclaringClass())
                .isEqualTo(ClassWithMetaAnnotatedInterface.class);
    ...
    void findAnnotationDescriptorOnAnnotatedClassWithMissingTargetMetaAnnotation() {
        ...
        assertThat(descriptor)
                .as("Should not find @Component on InheritedAnnotationClass")
                .isNull();
    }
    ...
    void findAnnotationDescriptorForTypesForNonInheritedAnnotationOnClass() {
        ...
        assertThat(
                        findAnnotationDescriptorForTypes(
                                        NonInheritedAnnotationClass.class, Order.class)
                                .getRootDeclaringClass())
                .isEqualTo(NonInheritedAnnotationClass.class);
        assertThat(
                        findAnnotationDescriptorForTypes(
                                        SubNonInheritedAnnotationClass.class, Order.class)
                                .getRootDeclaringClass())
                .isEqualTo(NonInheritedAnnotationClass.class);
    }
    ...
    void findAnnotationDescriptorForTypesWithMetaAnnotationWithDefaultAttributes() {
        ...
        assertThat(descriptor.getAnnotationAttributes().getClassArray("classes"))
                .isEqualTo(
                        new Class<?>[] {
                            MetaConfig.DevConfig.class, MetaConfig.ProductionConfig.class
                        });
    ...
    @Test
    void
            findAnnotationDescriptorForTypesForClassWithLocalMetaAnnotationAndMetaAnnotatedInterface() {
    ...
    @SuppressWarnings("unchecked")
    void
            findAnnotationDescriptorForTypesOnMetaCycleAnnotatedClassWithMissingTargetMetaAnnotation() {
        UntypedAnnotationDescriptor descriptor =
                findAnnotationDescriptorForTypes(
