...
class SimpleNamingContextTests {
    ...
    void namingContextBuilder() throws NamingException {
        ...
        assertThat("value1".equals(context2.getEnvironment().get("key1")))
                .as("Correct key1")
                .isTrue();
        ...
        assertThat("value2".equals(context3.getEnvironment().get("key2")))
                .as("key2 added")
                .isTrue();
        ...
        assertThat(
                        SimpleNamingContext.class
                                .getName()
                                .equals(bindingMap.get("jdbc").getClassName()))
