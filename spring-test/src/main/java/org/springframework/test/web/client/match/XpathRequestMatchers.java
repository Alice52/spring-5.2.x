...
/**
 * Factory methods for request content {@code RequestMatcher} implementations that use an XPath
 * expression.
 *
 * <p>An instance of this class is typically accessed via {@link
 * MockRestRequestMatchers#xpath(String, Object...)} or {@link MockRestRequestMatchers#xpath(String,
 * Map, Object...)}.
 *
...
public class XpathRequestMatchers {
     ...
     *
     * <p>Use {@link MockRestRequestMatchers#xpath(String, Object...)} or {@link
    ...
    public RequestMatcher exists() {
        return (XpathRequestMatcher)
                request -> this.xpathHelper.exists(request.getBodyAsBytes(), DEFAULT_ENCODING);
    }
    ...
    public RequestMatcher string(String content) {
        return (XpathRequestMatcher)
                request ->
                        this.xpathHelper.assertString(
                                request.getBodyAsBytes(), DEFAULT_ENCODING, content);
    }
    ...
    public RequestMatcher number(Double value) {
        return (XpathRequestMatcher)
                request ->
                        this.xpathHelper.assertNumber(
                                request.getBodyAsBytes(), DEFAULT_ENCODING, value);
    }
