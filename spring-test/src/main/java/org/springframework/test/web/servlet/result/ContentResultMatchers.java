...
public class ContentResultMatchers {
    ...
    /**
     * Assert the ServletResponse content type after parsing it as a MediaType. The given content
     * type must fully match including type, sub-type, and parameters. For checking only the type
     * and sub-type see {@link #contentTypeCompatibleWith(MediaType)}.
     */
    ...
    /**
     * Assert the ServletResponse content type is compatible with the given content type as defined
     * by {@link MediaType#isCompatibleWith(MediaType)}.
     */
    ...
    /**
     * Parse the response content and the given string as XML and assert the two are "similar" -
