...
public abstract class MockMvcWebConnectionBuilderSupport<
     ...
     *
     * <p>If the supplied value is {@code null} or empty, the first path segment of the request URL
     * is assumed to be the context path.
     *
     * <p>Default is {@code ""}.
     *
    ...
    /**
     * Add additional {@link WebRequestMatcher} instances that return {@code true} if a supplied
     * host matches &mdash; for example, {@code "example.com"} or {@code "example.com:8080"}.
     *
    ...
    private WebConnection createConnection(WebClient webClient, WebConnection defaultConnection) {
        WebConnection connection =
                new MockMvcWebConnection(this.mockMvc, webClient, this.contextPath);
