...
public abstract class MockMvcResultMatchers {
    ...
    public static ResultMatcher redirectedUrl(String expectedUrl) {
        return result ->
                assertEquals(
                        "Redirected URL", expectedUrl, result.getResponse().getRedirectedUrl());
    }
     ...
     * against the response body and assert the resulting value with the given Hamcrest {@link
     * Matcher}.
     *
     ...
     * Evaluate the given <a href="https://github.com/jayway/JsonPath">JsonPath</a> expression
     * against the response body and assert the resulting value with the given Hamcrest {@link
     * Matcher}, coercing the resulting value into the given target type before applying the
     * matcher.
     *
