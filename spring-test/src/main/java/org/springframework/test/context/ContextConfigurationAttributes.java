...
public class ContextConfigurationAttributes {
    ...
    /**
     * Construct a new {@link ContextConfigurationAttributes} instance for the {@linkplain Class
     * test class} that declared the {@link ContextConfiguration @ContextConfiguration} annotation
     ...
     *     {@code @ContextConfiguration}
     * @throws IllegalArgumentException if the {@code declaringClass} or {@code contextLoaderClass}
     *     is {@code null}
     */
    public ContextConfigurationAttributes(
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (ObjectUtils.nullSafeEquals(this.declaringClass, otherAttr.declaringClass)
                ...
                && ObjectUtils.nullSafeEquals(
                        this.contextLoaderClass, otherAttr.contextLoaderClass);
    }
