...
public class SpringClassRule implements TestRule {
     ...
     *
     * <p>Specifically, this method retrieves the {@link TestContextManager} used by this rule and
     * its associated {@link SpringMethodRule} and invokes the {@link
     * TestContextManager#beforeTestClass() beforeTestClass()} and {@link
     * TestContextManager#afterTestClass() afterTestClass()} methods on the {@code
     * TestContextManager}.
     *
     * <p>In addition, this method checks whether the test is enabled in the current execution
     * environment. This prevents classes with a non-matching {@code @IfProfileValue} annotation
     * from running altogether, even skipping the execution of {@code beforeTestClass()} methods in
