...
public abstract class AssertionErrors {
    ...
    /**
     * Assert the given condition is {@code false} and raise an {@link AssertionError} otherwise.
     *
     * @param message a message that describes the reason for the failure
     * @param condition the condition to test for
     * @since 5.2.1
    ...
    /**
     * Assert that the given object is {@code null} and raise an {@link AssertionError} otherwise.
     *
     * @param message a message that describes the reason for the failure
    ...
    /**
     * Assert that the given object is not {@code null} and raise an {@link AssertionError}
     * otherwise.
     *
     * @param message a message that describes the reason for the failure
     * @param object the object to check
    ...
    public static void assertEquals(
        ...
        if (!ObjectUtils.nullSafeEquals(expected, actual)) {
            fail(
                    message,
                    ObjectUtils.nullSafeToString(expected),
