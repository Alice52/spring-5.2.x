...
public class XpathExpectationsHelper {
     ...
     * @param args arguments to parameterize the XPath expression with using the formatting
    ...
    private static XPathExpression compileXpathExpression(
            String expression, @Nullable Map<String, String> namespaces)
            throws XPathExpressionException {
    ...
    /**
     * Parse the content, evaluate the XPath expression as a {@link NodeList}, and assert it with
     * the given {@code Matcher<NodeList>}.
     *
     * @since 5.2.2
     */
    public void assertNodeList(
            byte[] content, @Nullable String encoding, Matcher<? super NodeList> matcher)
            throws Exception {
    ...
    public void assertString(
            byte[] content, @Nullable String encoding, Matcher<? super String> matcher)
            throws Exception {
    ...
    public void assertNumber(
            byte[] content, @Nullable String encoding, Matcher<? super Double> matcher)
            throws Exception {
     ...
     * @param targetClass the target class, one of Number, String, Boolean, org.w3c.Node, or
     *     NodeList
     * @throws Exception if content parsing or expression evaluation fails
     * @since 5.1
     */
