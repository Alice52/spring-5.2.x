...
public class RequestPartMethodArgumentResolverTests {
    ...
    public void setup() throws Exception {
        ...
        resolver =
                new RequestPartMethodArgumentResolver(Collections.singletonList(messageConverter));
        ...
        paramRequestPart.initParameterNameDiscovery(
        ...
        optionalPartList.initParameterNameDiscovery(
                new LocalVariableTableParameterNameDiscoverer());
    ...
    public void resolveMultipartFileNotAnnotArgument() throws Exception {
        ...
        request.addFile(
                new MockMultipartFile("otherPart", "", "text/plain", "Hello World".getBytes()));
        webRequest = new ServletWebRequest(request);

        Object result =
                resolver.resolveArgument(paramMultipartFileNotAnnot, null, webRequest, null);
    ...
    public void resolveOptionalMultipartFileArgument() throws Exception {
        ...
        Object actualValue =
                resolver.resolveArgument(optionalMultipartFile, null, webRequest, null);
