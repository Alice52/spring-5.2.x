...
public class RequestResponseBodyMethodProcessorMockTests {
    ...
    public void setup() throws Exception {
        ...
        paramStringNotRequired =
                new MethodParameter(getClass().getMethod("handle3", String.class), 0);
        paramOptionalString =
                new MethodParameter(getClass().getMethod("handle4", Optional.class), 0);
    ...
    private void testResolveArgumentWithValidation(SimpleBean simpleBean) throws Exception {
        ...
        processor =
                new RequestResponseBodyMethodProcessor(Collections.singletonList(beanConverter));
        processor.resolveArgument(
    ...
    public void resolveArgumentCannotRead() throws Exception {
        ...
        assertThatExceptionOfType(HttpMediaTypeNotSupportedException.class)
                .isThrownBy(
                        () ->
                                processor.resolveArgument(
                                        paramRequestBodyString, mavContainer, webRequest, null));
    }
    ...
    public void handleReturnValue() throws Exception {
        ...
        assertThat(mavContainer.isRequestHandled())
                .as("The requestHandled flag wasn't set")
                .isTrue();
                ...
                .isThrownBy(
                        () ->
                                processor.handleReturnValue(
                                        "Foo", returnTypeString, mavContainer, webRequest));
    }
    ...
    public void handleReturnValueMediaTypeSuffix() throws Exception {
        ...
        List<MediaType> supported =
                Collections.singletonList(MediaType.valueOf("application/*+xml"));
    ...
    public void handleReturnTypeResourceByteRange() throws Exception {
        ...
        given(
                        resourceRegionMessageConverter.canWrite(
                                any(), eq(MediaType.APPLICATION_OCTET_STREAM)))
                .willReturn(true);
