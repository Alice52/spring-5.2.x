...
class HandlerMethodAnnotationDetectionTests {
    ...
    static Object[][] handlerTypes() {
        return new Object[][] {
            ...
            // ParameterizedSubclassDoesNotOverrideConcreteImplementationsFromGenericAbstractSuperclass test cases
            // {
    ...
    void testRequestMappingMethod(Class<?> controllerType, boolean useAutoProxy) throws Exception {
        ...
        assertThat(mav.getModel().get("attr1"))
                .as("model attr1:")
                .isEqualTo(dateFormat.parse(dateA));
        assertThat(mav.getModel().get("attr2"))
                .as("model attr2:")
                .isEqualTo(dateFormat.parse(dateB));
    ...
    static class SimpleController {
        ...
        public void initBinder(
                WebDataBinder dataBinder, @RequestParam("datePattern") String pattern) {
    ...
    static class InterfaceController implements MappingInterface {
        ...
        public void initBinder(
            ...
            CustomDateEditor dateEditor =
                    new CustomDateEditor(new SimpleDateFormat(thePattern), false);
            dataBinder.registerCustomEditor(Date.class, dateEditor);
        }
