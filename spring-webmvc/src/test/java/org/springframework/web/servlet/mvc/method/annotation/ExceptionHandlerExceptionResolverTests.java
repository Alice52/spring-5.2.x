...
public class ExceptionHandlerExceptionResolverTests {
    ...
    public void nullHandler() {
        ...
        ModelAndView mav =
                this.resolver.resolveException(this.request, this.response, handler, null);
    ...
    public void resolveExceptionModelAtArgument() throws Exception {
        ...
        assertThat(mav.getModelMap().get("exceptionClassName"))
    ...
    public void resolveRedirectAttributesAtArgument() throws Exception {
        ...
        HandlerMethod handlerMethod =
                new HandlerMethod(new RedirectAttributesController(), "handle");
        this.resolver.afterPropertiesSet();
        ModelAndView mav =
                this.resolver.resolveException(this.request, this.response, handlerMethod, ex);
    ...
    public void resolveExceptionControllerAdviceAgainstProxy() throws Exception {
        ...
        HandlerMethod handlerMethod =
                new HandlerMethod(
                        new ProxyFactory(new ResponseBodyController()).getProxy(), "handle");
        ModelAndView mav =
                this.resolver.resolveException(this.request, this.response, handlerMethod, ex);
    ...
    private void assertMethodProcessorCount(int resolverCount, int handlerCount) {
        assertThat(this.resolver.getArgumentResolvers().getResolvers().size())
                .isEqualTo(resolverCount);
        assertThat(this.resolver.getReturnValueHandlers().getHandlers().size())
