...
public class MvcNamespaceTests {
    ...
    public void testDefaultConfig() throws Exception {
        ...
        RequestMappingHandlerAdapter adapter =
                appContext.getBean(RequestMappingHandlerAdapter.class);
        assertThat(adapter).isNotNull();
        assertThat(
                        new DirectFieldAccessor(adapter)
                                .getPropertyValue("ignoreDefaultModelOnRedirect"))
                .isEqualTo(false);
        ...
        assertThat(chain.getInterceptors()[0] instanceof ConversionServiceExposingInterceptor)
                .isTrue();
    ...
    public void testResources() throws Exception {
        ...
        BeanNameUrlHandlerMapping beanNameMapping =
                appContext.getBean(BeanNameUrlHandlerMapping.class);
    ...
    public void testResourcesWithOptionalAttributes() throws Exception {
        ...
        ResourceHttpRequestHandler handler =
                appContext.getBean(
                        (String) mapping.getUrlMap().get("/resources/**"),
    ...
    public void testResourcesWithResolversTransformers() throws Exception {
        ...
        assertThat(locationCharsets.values().iterator().next())
    ...
    public void testViewControllers() throws Exception {
        ...
        assertThat(chain.getInterceptors().length).isEqualTo(4);
        assertThat(chain.getInterceptors()[1] instanceof ConversionServiceExposingInterceptor)
                .isTrue();
        ...
        ModelAndView mv =
                adapter.handle(request, new MockHttpServletResponse(), chain.getHandler());
    ...
    public void testContentNegotiationManager() throws Exception {
        ...
        ViewResolverComposite compositeResolver =
                this.appContext.getBean(ViewResolverComposite.class);
    ...
    public void testAsyncSupportOptions() throws Exception {
        ...
        CallableProcessingInterceptor[] callableInterceptors =
                (CallableProcessingInterceptor[])
                        fieldAccessor.getPropertyValue("callableInterceptors");
    ...
    public void testPathMatchingHandlerMappings() throws Exception {
        ...
        for (SimpleUrlHandlerMapping handlerMapping :
            ...
            assertThat(handlerMapping.getUrlPathHelper().getClass())
                    .isEqualTo(TestPathHelper.class);
    ...
    public static class TestCallableProcessingInterceptor
