        ...
        FilterChain chain =
                (req, res) -> {
                    ResponseEntity<String> returnValue =
                            ResponseEntity.ok().eTag(eTagValue).body(content);
                    try {
                        ...
                        new HttpEntityMethodProcessor(
                                ...
                                .handleReturnValue(
                                        returnValue, returnType, mavContainer, requestToUse);

                        assertThat(this.servletResponse.getContentAsString())
                                .as(
                                        "Response body was cached? It should be written directly to the raw response")
                                .isEqualTo(content);
                    } catch (Exception ex) {
