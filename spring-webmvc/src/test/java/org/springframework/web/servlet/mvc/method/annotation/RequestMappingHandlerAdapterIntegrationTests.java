...
public class RequestMappingHandlerAdapterIntegrationTests {
    ...
    public void setup() throws Exception {
        ConfigurableWebBindingInitializer bindingInitializer =
    ...
    public void handle() throws Exception {
        ...
        bindingResult =
                (BindingResult) model.get(BindingResult.MODEL_KEY_PREFIX + conventionAttrName);
    ...
    public void handleHttpEntityWithCacheControl() throws Exception {
        ...
        HandlerMethod handlerMethod =
                handlerMethod("handleHttpEntityWithCacheControl", parameterTypes);
        ModelAndView mav = handlerAdapter.handle(request, response, handlerMethod);
    ...
    public void handleRequestPart() throws Exception {
        ...
        multipartRequest.addFile(
                new MockMultipartFile(
                        "requestPart", "", "text/plain", "content".getBytes("UTF-8")));
    ...
    public void handleAndValidateRequestPart() throws Exception {
        ...
        HandlerMethod handlerMethod =
                handlerMethod(
                        "handleAndValidateRequestPart", String.class, Errors.class, Model.class);
        ModelAndView mav = handlerAdapter.handle(multipartRequest, response, handlerMethod);
    ...
    public void handleAndCompleteSession() throws Exception {
        HandlerMethod handlerMethod =
                handlerMethod("handleAndCompleteSession", SessionStatus.class);
    ...
    private HandlerMethod handlerMethod(String methodName, Class<?>... paramTypes)
            throws Exception {
    ...
    private interface HandlerIfc {
        ...
        String handleInInterface(
                ...
                @RequestHeader(defaultValue = "#{systemProperties.systemHeader}")
                        String systemHeader,
    ...
    private static class Handler implements HandlerIfc {
        ...
        public ResponseEntity<String> handleHttpEntityWithCacheControl(
                HttpEntity<byte[]> httpEntity) throws Exception {
            String responseBody =
                    "Handled requestBody=[" + new String(httpEntity.getBody(), "UTF-8") + "]";
        ...
        public void handleAndValidateRequestPart(
                @RequestPart @Valid String requestPart, Errors errors, Model model)
                throws Exception {
