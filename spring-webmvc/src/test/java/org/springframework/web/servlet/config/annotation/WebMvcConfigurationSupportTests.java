...
public class WebMvcConfigurationSupportTests {
    ...
    public void requestMappingHandlerMapping() throws Exception {
        ...
        HandlerExecutionChain chain =
                handlerMapping.getHandler(new MockHttpServletRequest("GET", "/"));
                        ...
                        converter -> {
                            ...
                            assertThat(
                                            mapper.getDeserializationConfig()
                                                    .isEnabled(DEFAULT_VIEW_INCLUSION))
                                    .isFalse();
                            assertThat(
    ...
    public void handlerExceptionResolver() throws Exception {
        ...
        HandlerExceptionResolverComposite compositeResolver =
                context.getBean(
                        "handlerExceptionResolver", HandlerExceptionResolverComposite.class);

        assertThat(compositeResolver.getOrder()).isEqualTo(0);
        List<HandlerExceptionResolver> expectedResolvers =
                compositeResolver.getExceptionResolvers();
        ...
        List<Object> interceptors =
                (List<Object>) fieldAccessor.getPropertyValue("responseBodyAdvice");
    ...
    static class WebConfig {
        ...
        public MessageSource messageSource() {
            ...
            messageSource.addMessage(
                    "exception.user.exists", Locale.ENGLISH, "User already exists!");
