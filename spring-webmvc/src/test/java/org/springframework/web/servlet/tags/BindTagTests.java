...
public class BindTagTests extends AbstractTagTests {
    ...
    public void bindTagWithoutErrors() throws JspException {
        ...
        BindStatus status =
                (BindStatus)
                        pc.getAttribute(BindTag.STATUS_VARIABLE_NAME, PageContext.REQUEST_SCOPE);
    ...
    public void bindTagWithFieldErrors() throws JspException {
        ...
        assertThat("message &amp; 1".equals(status.getErrorMessages()[0]))
                .as("Correct errorMessage")
                .isTrue();
        assertThat("message2".equals(status.getErrorMessages()[1]))
                .as("Correct errorMessage")
                .isTrue();
        ...
        assertThat("message2".equals(status.getErrorMessages()[1]))
                .as("Correct errorMessage")
                .isTrue();
        assertThat("message2".equals(status.getErrorMessages()[2]))
                .as("Correct errorMessage")
                .isTrue();
    }
    ...
    public void bindTagWithIndexedProperties() throws JspException {
        ...
        assertThat("code1".equals(status.getErrorCodes()[0])).as("Correct errorCode").isTrue();
        assertThat("code2".equals(status.getErrorCodes()[1])).as("Correct errorCode").isTrue();
        assertThat("message1".equals(status.getErrorMessages()[0]))
                .as("Correct errorMessage")
                .isTrue();
        assertThat("message2".equals(status.getErrorMessages()[1]))
                .as("Correct errorMessage")
    ...
    public void bindErrorsTagWithoutErrors() throws JspException {
        ...
        tag.setPageContext(pc);
        tag.setName("tb");
        assertThat(tag.doStartTag() == Tag.SKIP_BODY)
                .as("Correct doStartTag return value")
                .isTrue();
    ...
    public void bindErrorsTagWithErrors() throws JspException {
        ...
        assertThat(
                        pc.getAttribute(
                                        BindErrorsTag.ERRORS_VARIABLE_NAME,
    ...
    public void transformTagCorrectBehavior() throws JspException {
        ...
        pc.getRequest()
                .setAttribute(BindingResult.MODEL_KEY_PREFIX + "tb", binder.getBindingResult());
