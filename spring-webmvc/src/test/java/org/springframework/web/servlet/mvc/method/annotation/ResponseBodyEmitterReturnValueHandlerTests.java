...
public class ResponseBodyEmitterReturnValueHandlerTests {
    ...
    public void supportsReturnTypes() throws Exception {
        ...
        assertThat(
                        this.handler.supportsReturnType(
                                on(TestController.class)
                                        .resolveReturnType(ResponseBodyEmitter.class)))
                .isTrue();
        ...
        assertThat(
                        this.handler.supportsReturnType(
                                on(TestController.class)
                                        .resolveReturnType(
                                                ResponseEntity.class, ResponseBodyEmitter.class)))
                .isTrue();

        assertThat(
                        this.handler.supportsReturnType(
                                on(TestController.class)
                                        .resolveReturnType(Flux.class, String.class)))
                .isTrue();
    ...
    public void doesNotSupportReturnTypes() throws Exception {
        ...
        assertThat(
                        this.handler.supportsReturnType(
                                on(TestController.class)
                                        .resolveReturnType(ResponseEntity.class, String.class)))
                .isFalse();
