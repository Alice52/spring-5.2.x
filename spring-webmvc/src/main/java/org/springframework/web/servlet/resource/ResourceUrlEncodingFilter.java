...
public class ResourceUrlEncodingFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
        ...
        ResourceUrlEncodingResponseWrapper wrappedResponse =
                new ResourceUrlEncodingResponseWrapper(
        ...
        private void initLookupPath(ResourceUrlProvider urlProvider) {
            ...
            if (this.indexLookupPath == null) {
                ...
                if (StringUtils.matchesCharacter(lookupPath, '/')
                        && !StringUtils.matchesCharacter(requestUri, '/')) {
    ...
    /**
     * Runtime exception to get far enough (to ResourceUrlProviderExposingInterceptor) where it can
     * be re-thrown as ServletRequestBindingException to result in a 400 response.
     */
