...
public abstract class AbstractCachingViewResolver extends WebApplicationObjectSupport
     ...
     *
     * <p>Default is "true": unresolved view names are being cached, as of Spring 3.1. Note that
     * this flag only applies if the general {@link #setCache "cache"} flag is kept at its default
     * of "true" as well.
     *
     ...
     *
     * <p>This can be handy in case developer are able to modify views (e.g. FreeMarker templates)
     * at runtime after which you'd need to clear the cache for the specified view.
     *
     ...
     *
     * <p>The default implementation delegates to {@link #loadView}. This can be overridden to
     * resolve certain view names in a special fashion, before delegating to the actual {@code
     * loadView} implementation provided by the subclass.
     *
    ...
    public interface CacheFilter {
        ...
        /**
         * Indicates whether the given view should be cached. The name and locale used to resolve
         * the view are also provided.
         *
         * @param view the view
