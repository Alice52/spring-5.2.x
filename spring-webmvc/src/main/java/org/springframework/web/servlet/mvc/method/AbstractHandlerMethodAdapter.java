...
public abstract class AbstractHandlerMethodAdapter extends WebContentGenerator
     ...
     * @param handlerMethod handler method to use. This object must have previously been passed to
     *     the {@link #supportsInternal(HandlerMethod)} this interface, which must have returned
     *     {@code true}.
     * @return a ModelAndView object with the name of the view and the required model data, or
