...
public class WebContentInterceptor extends WebContentGenerator implements HandlerInterceptor {
     ...
     *
     * <p>Overrides the default cache seconds setting of this interceptor. Can specify "-1" to
     * exclude a URL path from default caching.
     *
     * <p>Supports direct matches, e.g. a registered "/test" matches "/test", and a various
     * Ant-style pattern matches, e.g. a registered "/t*" matches both "/test" and "/team". For
     * details, see the AntPathMatcher javadoc.
     *
     * <p><b>NOTE:</b> Path patterns are not supposed to overlap. If a request matches several
     * mappings, it is effectively undefined which one will apply (due to the lack of key ordering
     ...
     *
     * <p>Overrides the default cache seconds setting of this interceptor. Can specify a empty
     * {@link org.springframework.http.CacheControl} instance to exclude a URL path from default
     * caching.
     *
     * <p>Supports direct matches, e.g. a registered "/test" matches "/test", and a various
     * Ant-style pattern matches, e.g. a registered "/t*" matches both "/test" and "/team". For
     ...
     * <p><b>NOTE:</b> Path patterns are not supposed to overlap. If a request matches several
     * mappings, it is effectively undefined which one will apply (due to the lack of key ordering
     * in the underlying {@code java.util.HashMap}).
     *
