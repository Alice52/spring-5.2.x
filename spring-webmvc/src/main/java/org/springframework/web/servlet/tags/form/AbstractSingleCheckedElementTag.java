...
public abstract class AbstractSingleCheckedElementTag extends AbstractCheckedElementTag {
    ...
    /**
     * Renders the '{@code input(radio)}' element with the configured {@link #setValue(Object)
     * value}. Marks the element as checked if the value matches the {@link #getValue bound value}.
     */
    @Override
