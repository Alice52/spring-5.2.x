...
public interface RenderingResponse extends ServerResponse {
    ...
    /**
     * Create a builder with the template name, status code, headers and model of the given
     * response.
     *
    ...
    interface Builder {
         ...
         * this method because we cannot correctly determine the true convention name. View code
         * should check for {@code null} rather than for empty collections.</em>
         *
        ...
        /**
         * Copy all attributes in the supplied array into the model, using attribute name generation
         * for each element.
         *
