...
public abstract class AbstractUrlViewController extends AbstractController {
     ...
     * within the current servlet mapping is used if applicable (i.e. in the case of a ".../*"
     * servlet mapping in web.xml). Default is "false".
     *
     ...
     * Called by {@link #handleRequestInternal}.
     *
