...
public final class ProducesRequestCondition
    ...
    /**
     * Creates a new instance with "produces" and "header" expressions. "Header" expressions where
     * the header name is not 'Accept' or have no header value defined are ignored. If 0 expressions
    ...
    private List<ProduceMediaTypeExpression> parseExpressions(
     ...
     *   <li>If both indexes are equal, the media types at the index are compared further with
     *       {@link MediaType#SPECIFICITY_COMPARATOR}.
     * </ol>
     *
    ...
    private List<MediaType> getAcceptedMediaTypes(HttpServletRequest request)
        ...
        if (result == null) {
            result =
                    this.contentNegotiationManager.resolveMediaTypes(
