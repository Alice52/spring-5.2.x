...
public abstract class WebContentGenerator extends WebApplicationObjectSupport {
     ...
     *
     * @deprecated as of 4.2, since going forward, the HTTP 1.1 cache-control header will be
     *     required, with the HTTP 1.0 headers disappearing
     */
    @Deprecated
    ...
    /**
     * Set whether to use the HTTP 1.1 cache-control header value "no-store" when preventing
     * caching. Default is "true".
     *
     ...
     * described in {@link
     * org.springframework.web.context.request.WebRequest#checkNotModified(long)}.
     *
     * <p>Default is "false".
     *
     * @deprecated as of 4.2, in favor of {@link #setCacheControl}
     ...
     * @since 4.2
     */
    protected final void applyCacheControl(
            HttpServletResponse response, CacheControl cacheControl) {
