...
final class DefaultEntityResponseBuilder<T> implements EntityResponse.Builder<T> {
    ...
    private static class DefaultEntityResponse<T>
        ...
        protected void writeEntityWithMessageConverters(
            ...
            if (entityClass != InputStreamResource.class
                    && Resource.class.isAssignableFrom(entityClass)) {
                ...
                if (messageConverter instanceof GenericHttpMessageConverter<?>) {
                    ...
                    if (genericMessageConverter.canWrite(entityType, entityClass, contentType)) {
                        genericMessageConverter.write(
                                entity, entityType, contentType, serverResponse);
                        return;
                    }
                }
    ...
    private static class PublisherEntityResponse<T> extends DefaultEntityResponse<Publisher<T>> {
        ...
        private class ProducingSubscriber implements Subscriber<T> {
            ...
            public void onNext(T element) {
                ...
                tryWriteEntityWithMessageConverters(
                        element, servletRequest, servletResponse, this.context);
            }
