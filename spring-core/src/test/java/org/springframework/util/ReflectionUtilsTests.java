...
class ReflectionUtilsTests {
    ...
    void findField() {
        ...
        field =
                ReflectionUtils.findField(
                        TestObjectSubclassWithNewField.class, "prot", String.class);
        assertThat(field).isNotNull();
        ...
        field =
                ReflectionUtils.findField(
                        TestObjectSubclassWithNewField.class, "name", String.class);
        assertThat(field).isNotNull();
        assertThat(field.getName()).isEqualTo("name");
        assertThat(field.getType()).isEqualTo(String.class);
        assertThat(Modifier.isPrivate(field.getModifiers()))
                .as("Field should be private.")
                .isTrue();
    }
    ...
    void declaresException() throws Exception {
        ...
        assertThat(ReflectionUtils.declaresException(remoteExMethod, RemoteException.class))
                .isTrue();
        assertThat(ReflectionUtils.declaresException(remoteExMethod, ConnectException.class))
                .isTrue();
        ...
        assertThat(
                        ReflectionUtils.declaresException(
                                illegalExMethod, IllegalArgumentException.class))
                .isTrue();
    ...
    void doWithProtectedMethods() {
        ...
        assertThat(mc.getMethodNames().contains("absquatulate"))
                .as("Public, not protected")
                .isFalse();
    }
    ...
    void isCglibRenamedMethod() throws SecurityException, NoSuchMethodException {
        ...
        assertThat(ReflectionUtils.isCglibRenamedMethod(C.class.getMethod("CGLIB$m1$123")))
                .isTrue();
