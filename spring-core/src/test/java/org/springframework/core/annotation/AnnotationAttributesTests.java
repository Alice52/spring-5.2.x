...
class AnnotationAttributesTests {
    ...
    void typeSafeAttributeAccess() {
        ...
        assertThat(attributes.getStringArray("names"))
                .isEqualTo(new String[] {"dave", "frank", "hal"});
    ...
    void getAliasedStringWithImplicitAliases() {
        ...
        List<String> aliases =
                Arrays.asList(
                        "value", "location1", "location2", "location3", "xmlFile", "groovyScript");
    ...
    void getAliasedStringArrayWithImplicitAliases() {
        ...
        aliases.stream()
                .forEach(
                        alias ->
                                assertThat(attributes.getStringArray(alias))
