...
class AnnotationTypeMappingsTests {
    ...
    void forAnnotationTypeWhenMetaAnnotationsReturnsMappings() {
        AnnotationTypeMappings mappings =
                AnnotationTypeMappings.forAnnotationType(MetaAnnotated.class);
        assertThat(mappings.size()).isEqualTo(6);
        assertThat(getAll(mappings))
                .flatExtracting(AnnotationTypeMapping::getAnnotationType)
                .containsExactly(
                        MetaAnnotated.class, A.class, B.class, AA.class, AB.class, ABC.class);
    }
    ...
    void forAnnotationTypeWhenRepeatableMetaAnnotationIsFiltered() {
        AnnotationTypeMappings mappings =
                AnnotationTypeMappings.forAnnotationType(
                        WithRepeatedMetaAnnotations.class, Repeating.class.getName()::equals);
        assertThat(getAll(mappings))
                .flatExtracting(AnnotationTypeMapping::getAnnotationType)
    ...
    void forAnnotationTypeWhenSelfAnnotatedReturnsMapping() {
        AnnotationTypeMappings mappings =
                AnnotationTypeMappings.forAnnotationType(SelfAnnotated.class);
        assertThat(mappings.size()).isEqualTo(1);
        assertThat(getAll(mappings))
                .flatExtracting(AnnotationTypeMapping::getAnnotationType)
    ...
    void forAnnotationTypeWhenHasAliasForWithBothValueAndAttributeThrowsException() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForWithBothValueAndAttribute.class))
                .withMessage(
    ...
    void forAnnotationTypeWhenAliasForToSelfNonExistingAttribute() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForToSelfNonExistingAttribute.class))
                .withMessage(
    ...
    void forAnnotationTypeWhenAliasForToOtherNonExistingAttribute() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForToOtherNonExistingAttribute.class))
                .withMessage(
    ...
    void forAnnotationTypeWhenAliasForWithIncompatibleReturnTypes() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForWithIncompatibleReturnTypes.class))
                .withMessage(
        ...
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                ...
                .withMessage(
                        "Attribute 'b' in annotation ["
                                + annotationType
                                + "] must be declared as an @AliasFor attribute 'a' in annotation ["
                                + annotationType
                                + "], not attribute 'c' in annotation ["
                                + annotationType
                                + "].");
    }
    ...
    void forAnnotationTypeWhenAliasForHasMixedImplicitAndExplicitAliases() {
        assertMixedImplicitAndExplicitAliases(
                AliasForWithMixedImplicitAndExplicitAliasesV1.class, "b");
        assertMixedImplicitAndExplicitAliases(
                AliasForWithMixedImplicitAndExplicitAliasesV2.class, "a");
    }

    private void assertMixedImplicitAndExplicitAliases(
            Class<? extends Annotation> annotationType, String overriddenAttribute) {
    ...
    void forAnnotationTypeWhenAliasForNonMetaAnnotated() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForNonMetaAnnotated.class))
                .withMessage(
                        "@AliasFor declaration on attribute 'test' in annotation ["
    ...
    void forAnnotationTypeWhenAliasForSelfWithDifferentDefaults() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForSelfWithDifferentDefaults.class))
                .withMessage(
    ...
    void forAnnotationTypeWhenAliasForSelfWithMissingDefault() {
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                AnnotationTypeMappings.forAnnotationType(
                                        AliasForSelfWithMissingDefault.class))
                .withMessage(
                        "Misconfigured aliases: attribute 'a' in annotation ["
    ...
    void getMetaTypeReturnsTypes() {
        AnnotationTypeMappings mappings =
                AnnotationTypeMappings.forAnnotationType(ThreeDeepA.class);
    ...
    void getAttributesReturnsAttributes() {
        AnnotationTypeMapping mapping =
                AnnotationTypeMappings.forAnnotationType(Mapped.class).get(0);
    ...
    void getAliasMappingReturnsAttributes() throws Exception {
        AnnotationTypeMapping mapping =
                AnnotationTypeMappings.forAnnotationType(Mapped.class).get(1);
    ...
    void resolveMirrorsWhenHasSameValuesUsesFirst() {
        AnnotationTypeMapping mapping =
                AnnotationTypeMappings.forAnnotationType(AliasPair.class).get(0);
        Method[] resolved =
                resolveMirrorSets(mapping, WithSameValueAliasPair.class, AliasPair.class);
        ...
        assertThatExceptionOfType(AnnotationConfigurationException.class)
                .isThrownBy(
                        () ->
                                resolveMirrorSets(
                                        mapping,
                                        WithDifferentValueAliasPair.class,
                                        AliasPair.class))
                .withMessage(
    ...
    void resolveMirrorsWhenHasWithMultipleRoutesToAliasReturnsMirrors() {
        AnnotationTypeMappings mappings =
                AnnotationTypeMappings.forAnnotationType(MultipleRoutesToAliasA.class);
    ...
    void getConventionMappingWhenConventionToExplicitAliasesReturnsMappedAttributes() {
        ...
        AnnotationTypeMapping mapping =
                getMapping(mappings, ConventionToExplicitAliasesTarget.class);
    ...
    void isEquivalentToDefaultValueWhenValueAndDefaultAreNullReturnsTrue() {
        ...
        assertThat(mapping.isEquivalentToDefaultValue(0, null, ReflectionUtils::invokeMethod))
                .isTrue();
    }
    ...
    void isEquivalentToDefaultValueWhenValueAndDefaultMatchReturnsTrue() {
        ...
        assertThat(
                        mapping.isEquivalentToDefaultValue(
                                0, InputStream.class, ReflectionUtils::invokeMethod))
                .isTrue();
    }
    ...
    void
        ...
        assertThat(
                        mapping.isEquivalentToDefaultValue(
                                0, value, TypeMappedAnnotation::extractFromMap))
                .isTrue();
    }

    @Test // gh-24375
    void
            isEquivalentToDefaultValueWhenNestedAnnotationAndExtractedValuesMatchReturnsTrueAndValueSuppliedAsTypeMappedAnnotation() {
        AnnotationTypeMapping mapping =
                AnnotationTypeMappings.forAnnotationType(NestedValue.class).get(0);
        Map<String, String> attributes = Collections.singletonMap("value", "java.io.InputStream");
        MergedAnnotation<ClassValue> value =
                TypeMappedAnnotation.of(
                        getClass().getClassLoader(), null, ClassValue.class, attributes);
        assertThat(
                        mapping.isEquivalentToDefaultValue(
                                0, value, TypeMappedAnnotation::extractFromMap))
                .isTrue();
    ...
    @interface AliasForToOtherNonExistingAttribute {
        ...
        @AliasFor(
                annotation = AliasForToOtherNonExistingAttributeTarget.class,
                attribute = "missing")
        String test() default "";
    }
    ...
    @interface AliasWithExplicitMirrorAndDifferentDefaults {
        ...
        @AliasFor(
                annotation = AliasWithExplicitMirrorAndDifferentDefaultsTarget.class,
                attribute = "a")
        String a() default "x";
