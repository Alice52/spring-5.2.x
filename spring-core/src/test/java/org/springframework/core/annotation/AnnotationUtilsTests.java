...
class AnnotationUtilsTests {
    ...
    void findClassAnnotationOnMetaMetaMetaAnnotatedClass() {
        ...
        assertThat(component)
                .as(
                        "Should find meta-annotation on meta-annotation on composed annotation on class")
                .isNotNull();
        assertThat(component.value()).isEqualTo("meta2");
    }
    ...
    void findClassAnnotationOnSubInheritedAnnotationInterface() {
        Transactional tx =
                findAnnotation(SubInheritedAnnotationInterface.class, Transactional.class);
        assertThat(tx)
    ...
    void findAnnotationDeclaringClassForAllScenarios() {
        ...
        assertThat(
                        (Object)
                                findAnnotationDeclaringClass(
                                        Transactional.class, NonAnnotatedInterface.class))
                .isNull();
        assertThat(
                        (Object)
                                findAnnotationDeclaringClass(
                                        Transactional.class, NonAnnotatedClass.class))
                .isNull();

        // inherited class-level annotation; note: @Transactional is inherited
        assertThat(
                        findAnnotationDeclaringClass(
                                Transactional.class, InheritedAnnotationInterface.class))
        ...
        assertThat(
                        findAnnotationDeclaringClass(
                                Transactional.class, InheritedAnnotationClass.class))
                .isEqualTo(InheritedAnnotationClass.class);
        assertThat(
                        findAnnotationDeclaringClass(
                                Transactional.class, SubInheritedAnnotationClass.class))
                .isEqualTo(InheritedAnnotationClass.class);
        ...
        assertThat(
                        findAnnotationDeclaringClass(
                                Order.class, SubNonInheritedAnnotationInterface.class))
                .isNull();
    ...
    void findAnnotationDeclaringClassForTypesWithMultipleCandidateTypes() {
        ...
        assertThat(
                        (Object)
                                findAnnotationDeclaringClassForTypes(
                                        candidates, NonAnnotatedInterface.class))
                .isNull();
        assertThat(
                        (Object)
                                findAnnotationDeclaringClassForTypes(
                                        candidates, NonAnnotatedClass.class))
                .isNull();

        // inherited class-level annotation; note: @Transactional is inherited
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, InheritedAnnotationInterface.class))
                .isEqualTo(InheritedAnnotationInterface.class);
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, SubInheritedAnnotationInterface.class))
                .isNull();
        assertThat(findAnnotationDeclaringClassForTypes(candidates, InheritedAnnotationClass.class))
                .isEqualTo(InheritedAnnotationClass.class);
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, SubInheritedAnnotationClass.class))
                .isEqualTo(InheritedAnnotationClass.class);
        ...
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, NonInheritedAnnotationInterface.class))
                .isEqualTo(NonInheritedAnnotationInterface.class);
        assertThat(
                        findAnnotationDeclaringClassForTypes(
        ...
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, NonInheritedAnnotationClass.class))
                .isEqualTo(NonInheritedAnnotationClass.class);
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, SubNonInheritedAnnotationClass.class))
                .isEqualTo(NonInheritedAnnotationClass.class);
        ...
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, TransactionalAndOrderedClass.class))
                .isEqualTo(TransactionalAndOrderedClass.class);
        assertThat(
                        findAnnotationDeclaringClassForTypes(
                                candidates, SubTransactionalAndOrderedClass.class))
                .isEqualTo(TransactionalAndOrderedClass.class);
    }
    ...
    void isAnnotationDeclaredLocallyForAllScenarios() {
        ...
        assertThat(isAnnotationDeclaredLocally(Transactional.class, NonAnnotatedInterface.class))
                .isFalse();
        assertThat(isAnnotationDeclaredLocally(Transactional.class, NonAnnotatedClass.class))
                .isFalse();
    ...
    void isAnnotationInheritedForAllScenarios() {
        // no class-level annotation
        assertThat(isAnnotationInherited(Transactional.class, NonAnnotatedInterface.class))
                .isFalse();
        ...
        // non-inherited class-level annotation; note: @Order is not inherited
        assertThat(isAnnotationInherited(Order.class, NonInheritedAnnotationInterface.class))
                .isFalse();
        ...
        assertThat(isAnnotationInherited(Order.class, SubNonInheritedAnnotationClass.class))
                .isFalse();
    }
    ...
    void getAnnotationAttributesWithAttributeAliases() throws Exception {
        ...
        AnnotationAttributes attributes =
                (AnnotationAttributes) getAnnotationAttributes(webMapping);
        assertThat(attributes).isNotNull();
    ...
    void getRepeatableAnnotationsDeclaredOnClassWithAttributeAliases() {
        ...
        List<String> locations =
                annotations.stream().map(ContextConfig::location).collect(toList());
    ...
    void getDeclaredRepeatableAnnotationsDeclaredOnClass() {
        ...
        // Java 8
        MyRepeatable[] array =
                MyRepeatableClass.class.getDeclaredAnnotationsByType(MyRepeatable.class);
        assertThat(array).isNotNull();
        List<String> values = stream(array).map(MyRepeatable::value).collect(toList());
        assertThat(values).isEqualTo(expectedValuesJava);
    ...
    void getDeclaredRepeatableAnnotationsDeclaredOnSuperclass() {
        ...
        Set<MyRepeatable> set =
                getDeclaredRepeatableAnnotations(
                        clazz, MyRepeatable.class, MyRepeatableContainer.class);
        assertThat(set).isNotNull();
    ...
    void synthesizeAnnotationWithImplicitAliasesWithDuplicateValues() throws Exception {
        ...
        ImplicitAliasesWithDuplicateValuesContextConfig config =
                clazz.getAnnotation(annotationType);
        assertThat(config).isNotNull();
    ...
    void synthesizeAnnotationFromMapWithNestedMap() throws Exception {
        ...
        assertThat(componentScan).isNotNull();
        assertThat(componentScan.value().pattern())
                .as("value from ComponentScan: ")
                .isEqualTo("*Foo");
    ...
    void synthesizeAnnotationFromMapWithNestedArrayOfMaps() throws Exception {
        ...
        List<String> patterns =
                stream(filters).map(m -> (String) m.get("pattern")).collect(toList());
        assertThat(patterns).isEqualTo(asList("*Foo", "*Bar"));
        ...
        assertThat(synthesizedComponentScan).isNotSameAs(componentScan);
        patterns =
                stream(synthesizedComponentScan.excludeFilters())
                        .map(Filter::pattern)
                        .collect(toList());
    ...
    private void assertMissingTextAttribute(Map<String, Object> attributes) {
        assertThatExceptionOfType(NoSuchElementException.class)
                .isThrownBy(
                        () ->
                                synthesizeAnnotation(
                                                attributes, AnnotationWithoutDefaults.class, null)
                                        .text())
                .withMessageContaining(
    ...
    void synthesizeAnnotationFromMapWithAttributeOfIncorrectType() throws Exception {
        ...
        assertThatIllegalStateException()
                .isThrownBy(() -> synthesizeAnnotation(map, Component.class, null).value())
                .withMessageContaining(
    ...
    @Test // gh-23856
    void
            findAnnotationFindsRepeatableContainerOnComposedAnnotationMetaAnnotatedWithRepeatableAnnotations()
                    throws Exception {
        MyRepeatableContainer annotation =
                AnnotationUtils.findAnnotation(
                        MyRepeatableMeta1And2.class, MyRepeatableContainer.class);

        assertThat(annotation).isNotNull();
        assertThat(annotation.value())
                .extracting(MyRepeatable::value)
                .containsExactly("meta1", "meta2");
    }

    @Test // gh-23856
    void
            findAnnotationFindsRepeatableContainerOnComposedAnnotationMetaAnnotatedWithRepeatableAnnotationsOnMethod()
                    throws Exception {
        Method method =
                getClass()
                        .getDeclaredMethod(
                                "methodWithComposedAnnotationMetaAnnotatedWithRepeatableAnnotations");
        MyRepeatableContainer annotation =
                AnnotationUtils.findAnnotation(method, MyRepeatableContainer.class);
