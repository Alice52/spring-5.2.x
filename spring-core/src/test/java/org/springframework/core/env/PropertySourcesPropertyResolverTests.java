...
class PropertySourcesPropertyResolverTests {
    ...
    void getPropertySources_replacePropertySource() {
        ...
        propertySources.addLast(
                new MockPropertySource("system").withProperty("foo", "systemValue"));
        ...
        propertySources.replace(
                "local", new MockPropertySource("new").withProperty("foo", "newValue"));
    ...
    void resolvePlaceholders() {
        ...
        assertThat(resolver.resolvePlaceholders("Replace this ${key}"))
