...
class CollectionToCollectionConverterTests {
    ...
    void scalarList() throws Exception {
        ...
        List<Integer> result =
                (List<Integer>) conversionService.convert(list, sourceType, targetType);
    ...
    void emptyListToListDifferentTargetType() throws Exception {
        ...
        TypeDescriptor targetType =
                new TypeDescriptor(getClass().getField("emptyListDifferentTarget"));
        assertThat(conversionService.canConvert(sourceType, targetType)).isTrue();
        @SuppressWarnings("unchecked")
    ...
    void collectionsEmptyList() throws Exception {
        ...
        converter.convert(
                list,
                type,
                TypeDescriptor.valueOf(Class.forName("java.util.Collections$EmptyList")));
    }
