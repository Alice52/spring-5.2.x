...
class GenericConversionServiceTests {
    ...
    void canConvertNullSourceType() {
        ...
        assertThat(conversionService.canConvert(null, TypeDescriptor.valueOf(Integer.class)))
                .isTrue();
    }
    ...
    void convert() {
        conversionService.addConverterFactory(new StringToNumberConverterFactory());
        assertThat(conversionService.convert("3", Integer.class))
                .isEqualTo((int) Integer.valueOf(3));
    }
    ...
    void convertNotNullSourceNullSourceTypeDescriptor() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                conversionService.convert(
                                        "3", null, TypeDescriptor.valueOf(int.class)));
    }
    ...
    void convertToNullTargetTypeDescriptor() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                conversionService.convert(
                                        "3", TypeDescriptor.valueOf(String.class), null));
    }
    ...
    void interfaceArrayToStringArray() {
        ...
        String[] converted =
                conversionService.convert(
                        new MyInterface[] {new MyInterfaceImplementer()}, String[].class);
    ...
    void stringArrayToResourceArray() {
        ...
        Resource[] converted =
                conversionService.convert(new String[] {"x1", "z3"}, Resource[].class);
    ...
    void conditionalConversionForAllTypes() {
        ...
        assertThat(
                        converter.getSourceTypes().stream()
                                .allMatch(td -> Integer.class.equals(td.getType())))
                .isTrue();
    }
    ...
    void subclassOfEnumToString() throws Exception {
        conversionService.addConverter(new EnumToStringConverter(conversionService));
        assertThat(conversionService.convert(EnumWithSubclass.FIRST, String.class))
                .isEqualTo("FIRST");
    }
                ...
                .isThrownBy(
                        () ->
                                conversionService.convert(
                                        ...
                                        TypeDescriptor.valueOf(String.class),
                                        new TypeDescriptor(
                                                getClass().getField("integerCollection"))));
    }
    ...
    void genericCollectionAsSource() throws Exception {
        ...
        // The following is unpleasant but a consequence of the generic collection converter
        // above...
        assertThat(
                        conversionService.convert(
                                "test",
    ...
    private static class StringToMyEnumBaseInterfaceConverterFactory
        ...
        @Override
        @SuppressWarnings({"unchecked", "rawtypes"})
        public <T extends MyEnumBaseInterface> Converter<String, T> getConverter(
                Class<T> targetType) {
