...
/**
 * {@link Collector} implementations that provide various reduction operations for {@link
...
public abstract class MergedAnnotationCollectors {
     ...
     *
     * <p>The collector returned by this method is effectively equivalent to {@code
     * Collectors.mapping(MergedAnnotation::synthesize,
     * Collectors.toCollection(LinkedHashSet::new))} but avoids the creation of a composite
     * collector.
     *
    ...
    public static <A extends Annotation>
        ...
        return Collector.of(
                LinkedHashSet::new,
                (set, annotation) -> set.add(annotation.synthesize()),
    ...
    /**
     * Create a new {@link Collector} that accumulates merged annotations to a {@link MultiValueMap}
     ...
     *
     * <p>This method is only invoked if the {@link java.util.stream.Stream} is processed in
     ...
     * {@linkplain java.util.stream.Stream#parallel() parallel}.
     */
    private static <K, V> MultiValueMap<K, V> combiner(
