...
final class AttributeMethods {
    ...
    static String describe(@Nullable Class<?> annotationType, @Nullable String attributeName) {
        ...
        String in =
                (annotationType != null ? " in annotation [" + annotationType.getName() + "]" : "");
    ...
    /**
     * Determine if values from the given annotation can be safely accessed without causing any
     * {@link TypeNotPresentException TypeNotPresentExceptions}.
     *
     ...
     * cover Google App Engine's late arrival of such exceptions for {@code Class} values (instead
     * of the more typical early {@code Class.getAnnotations() failure}.
     *
    ...
    /**
     * Determine if the attribute at the specified index could throw a {@link
     * TypeNotPresentException} when accessed.
     *
    ...
    /**
     * Get the index of the attribute with the specified name, or {@code -1} if there is no
