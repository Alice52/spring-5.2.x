...
public abstract class MergedAnnotationPredicates {
    ...
    /**
     * Create a new {@link Predicate} that evaluates to {@code true} if the name of the {@linkplain
    ...
    /**
     * Create a new {@link Predicate} that evaluates to {@code true} if the {@linkplain
     * MergedAnnotation#getType() merged annotation type} is contained in the specified collection.
     *
     * @param <A> the annotation type
     ...
     * annotation, and any subsequent runs that have the same distance.
     *
     * <p>NOTE: This predicate only matches the first run. Once the extracted value changes, the
     * predicate always returns {@code false}. For example, if you have a set of annotations with
     * distances {@code [1, 1, 2, 1]} then only the first two will match.
     *
