...
/**
 * {@link MergedAnnotations} implementation backed by a {@link Collection} of {@link
 * MergedAnnotation} instances that represent direct annotations.
 *
 * @author Phillip Webb
 * @since 5.2
...
final class MergedAnnotationsCollection implements MergedAnnotations {
    ...
    private MergedAnnotationsCollection(Collection<MergedAnnotation<?>> annotations) {
        ...
        for (int i = 0; i < this.annotations.length; i++) {
            ...
            Assert.isTrue(
                    annotation.getAggregateIndex() == 0,
                    "Annotation must have aggregate index of zero");
    ...
    private class AnnotationsSpliterator<A extends Annotation>
        ...
        private AnnotationTypeMapping getMapping(int annotationIndex, int mappingIndex) {
            AnnotationTypeMappings mappings =
                    MergedAnnotationsCollection.this.mappings[annotationIndex];
