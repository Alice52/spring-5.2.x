...
final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation>
    ...
    @Nullable private volatile String string;
    ...
    private Object getAttributeValue(Method method) {
        Object value =
                this.valueCache.computeIfAbsent(
                        method.getName(),
                        attributeName -> {
                            Class<?> type =
                                    ClassUtils.resolvePrimitiveIfNecessary(method.getReturnType());
                            return this.annotation
                                    .getValue(attributeName, type)
                                    .orElseThrow(
                                            () ->
