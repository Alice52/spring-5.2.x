...
public class SynthesizingMethodParameter extends MethodParameter {
    ...
    /**
     * Create a new {@code SynthesizingMethodParameter} for the given constructor, with nesting
     * level 1.
     *
    ...
    /**
     * Copy constructor, resulting in an independent {@code SynthesizingMethodParameter} based on
