...
public class MethodParameter {
    ...
    /**
     * Copy constructor, resulting in an independent MethodParameter object based on the same
    ...
    /**
     * Return a variant of this {@code MethodParameter} with the type for the current level set to
     * the specified value.
     *
    ...
    /**
     * Return {@code true} if the parameter has at least one annotation, {@code false} if it has
     * none.
     *
    ...
    private static class KotlinDelegate {
        ...
        /**
         * Check whether the specified {@link MethodParameter} represents a nullable Kotlin type, an
         * optional parameter (with a default value in the Kotlin declaration) or a {@code
        ...
        /**
         * Return the generic return type of the method, with support of suspending functions via
         * Kotlin reflection.
         */
