...
public interface Encoder<T> {
     ...
     * @param elementType the expected type of elements in the input stream; this type must have
     *     been previously passed to the {@link #canEncode} method and it must have returned {@code
     *     true}.
    ...
    /**
     * Encode an Object of type T to a data buffer. This is useful for scenarios, that distinct
     * messages (or events) are encoded and handled individually, in fully aggregated form.
     *
     * <p>By default this method raises {@link UnsupportedOperationException} and it is expected
     * that some encoders cannot produce a single buffer or cannot do so synchronously (e.g.
     * encoding a {@code Resource}).
     *
