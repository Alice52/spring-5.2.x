...
public interface Decoder<T> {
     ...
     * @param mimeType the mime type associated with the stream to decode (can be {@code null} if
     *     not specified)
     ...
     * @param elementType the expected type of elements in the output stream; this type must have
     *     been previously passed to the {@link #canDecode} method and it must have returned {@code
     *     true}.
    ...
    /**
     * Decode a data buffer to an Object of type T. This is useful for scenarios, that distinct
     * messages (or events) are decoded and handled individually, in fully aggregated form.
     *
