...
public class ResolvableType implements Serializable {
    ...
    /**
     * Private constructor used to create a new {@link ResolvableType} for cache key purposes, with
     * no upfront resolution.
     */
     ...
     * against the raw class only (analogous to {@link Class#isAssignableFrom}, which this serves as
     * a wrapper for. For example: {@code ResolvableType.forRawClass(List.class)}.
     *
     * @param clazz the class to introspect ({@code null} is semantically equivalent to {@code
     *     Object.class} for typical use cases here)
     * @return a {@link ResolvableType} for the specified class
     ...
     * implementation. Use this variant when the class that declares the constructor includes
    ...
    /**
     * Return a {@link ResolvableType} for the specified {@link Method} return type. Use this
    ...
    /**
     * Return a {@link ResolvableType} for the specified {@link MethodParameter} at a specific
    ...
    /**
     * Return a {@link ResolvableType} for the specified {@link Type} backed by the given owner
     * type.
     *
     * <p>Note: The resulting {@link ResolvableType} instance may not be {@link Serializable}.
     *
    ...
    /**
     * Return the ResolvableType representing the component type of the array or {@link #NONE} if
    ...
    /**
     * Convenience method to return this type as a resolvable {@link Collection} type. Returns
    ...
    /**
     * Convenience method to return this type as a resolvable {@link Map} type. Returns {@link
    ...
    /**
     * Return a {@link ResolvableType} representing the direct supertype of this type. If no
     ...
     * multiple indexes; for example {@code getGeneric(1, 0)} will access the {@code String} from
     * the nested {@code List}. For convenience, if no indexes are specified the first generic is
     * returned.
     *
     ...
     * of this type. If no generics are available an empty array is returned. If you need to access
     * a specific generic consider using the {@link #getGeneric(int...)} method as it allows access
     * to nested generics and protects against {@code IndexOutOfBoundsExceptions}.
     *
    ...
    /**
     * Convenience method that will {@link #getGenerics() get} and {@link #resolve() resolve}
     * generic parameters.
     *
     ...
     * WildcardType WildcardTypes} if direct resolution fails; however, bounds of {@code
    ...
    /**
     * Resolve this type to a {@link java.lang.Class}, returning the specified {@code fallback} if
     * the type cannot be resolved. This method will consider bounds of {@link TypeVariable
    ...
    private static class WildcardBounds {
        ...
        /**
         * Get a {@link WildcardBounds} instance for the specified type, returning {@code null} if
         * the specified type cannot be resolved to a {@link WildcardType}.
         *
