...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
     ...
     * Create a new PathMatchingResourcePatternResolver with a DefaultResourceLoader.
     *
     * @param classLoader the ClassLoader to load classpath resources with, or {@code null} for
    ...
    /**
     * Search all {@link URLClassLoader} URLs for jar file references and add them to the given set
     * of resources in the form of pointers to the root of the jar file content.
     *
    ...
    /**
     * Determine jar file references from the "java.class.path." manifest property and add them to
     * the given set of resources in the form of pointers to the root of the jar file content.
     *
     * @param result the set of resources to add jar roots to
     * @since 4.3
     */
     ...
     * resources. This template method allows for detecting further kinds of jar-like resources,
     * e.g. through {@code instanceof} checks on the resource handle type.
     *
     * @param resource the resource handle to check (usually the root directory to start path
     *     matching from)
     * @see #doFindPathMatchingJarResources
        ...
        if (con instanceof JarURLConnection) {
            ...
            try {
                ...
                if (separatorIndex != -1) {
                    ...
                    rootEntryPath =
                            urlFile.substring(separatorIndex + 2); // both separators are 2 chars
    ...
    private static class VfsResourceMatchingDelegate {
        ...
        public static Set<Resource> findMatchingResources(
                URL rootDirURL, String locationPattern, PathMatcher pathMatcher)
                throws IOException {
    ...
    private static class PatternVirtualFileVisitor implements InvocationHandler {
        ...
        public PatternVirtualFileVisitor(
                String rootPath, String subPattern, PathMatcher pathMatcher) {
            this.subPattern = subPattern;
            this.pathMatcher = pathMatcher;
            this.rootPath =
                    (rootPath.isEmpty() || rootPath.endsWith("/") ? rootPath : rootPath + "/");
        }
