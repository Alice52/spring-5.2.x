...
public class FileSystemResource extends AbstractResource implements WritableResource {
     ...
     *
     * <p>Note: When building relative resources via {@link #createRelative}, the relative path will
     * apply <i>at the same directory level</i>: e.g. Paths.get("C:/dir1"), relative path "dir2" ->
     * "C:/dir2"! If you prefer to have relative paths built underneath the given root directory,
     * use the {@link #FileSystemResource(String) constructor with a file path} to append a trailing
     * slash to the root path: "C:/dir1/", which indicates this directory as root for all relative
     * paths. Alternatively, consider using {@link PathResource#PathResource(Path)} for {@code
     * java.nio.path.Path} resolution in {@code createRelative}, always nesting relative paths.
     *
