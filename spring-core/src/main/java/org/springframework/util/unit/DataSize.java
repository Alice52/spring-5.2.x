 ...
 *
 * <p>The terms and units used in this class are based on <a
 * href="https://en.wikipedia.org/wiki/Binary_prefix">binary prefixes</a> indicating multiplication
 * by powers of 2. Consult the following table and the Javadoc for {@link DataUnit} for details.
 *
 * <p>
 *
 * <table border="1">
...
public final class DataSize implements Comparable<DataSize>, Serializable {
    ...
    /**
     * Obtain a {@link DataSize} from a text string such as {@code 12MB} using {@link
     ...
     *
     * <p>The string starts with a number followed optionally by a unit matching one of the
