 ...
 *
 * <p>Unlike {@link java.io.ByteArrayOutputStream}, this implementation is backed by an {@link
 * java.util.ArrayDeque} of {@code byte[]} instead of 1 constantly resizing {@code byte[]}. It does
...
public class FastByteArrayOutputStream extends OutputStream {
     ...
     *
     * <p>All currently accumulated output in the output stream is discarded. The output stream can
     * be used again.
     */
    public void reset() {
        this.buffers.clear();
     ...
     *
     * <p>Note that if any methods are called on the OutputStream (including, but not limited to,
     * any of the write methods, {@link #reset()}, {@link #toByteArray()}, and {@link
    ...
    public void resize(int targetCapacity) {
        Assert.isTrue(
                targetCapacity >= size(), "New capacity must not be smaller than current size");
    ...
    private static final class FastByteArrayInputStream extends UpdateMessageDigestInputStream {
            ...
            if (this.buffersIterator.hasNext()) {
                ...
                if (this.currentBuffer == fastByteArrayOutputStream.buffers.getLast()) {
                    ...
                    this.currentBufferLength =
                            (this.currentBuffer != null ? this.currentBuffer.length : 0);
                }
            }
        }
        ...
        /**
         * Update the message digest with the next len bytes in this stream. Avoids creating new
         * byte arrays and use internal buffers for performance.
         *
         * @param messageDigest the message digest to update
            ...
            if (this.currentBuffer == null) {
                ...
                if (this.nextIndexInCurrentBuffer < this.currentBufferLength) {
                    ...
                    messageDigest.update(
                            this.currentBuffer, this.nextIndexInCurrentBuffer, bytesToCopy);
                    this.nextIndexInCurrentBuffer += bytesToCopy;
