...
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    /**
     * Copy-constructor that copies the type and subtype of the given {@code MimeType}, and allows
    ...
    /**
     * Indicates whether the {@linkplain #getType() type} is the wildcard character <code>&#42;
     * </code> or not.
     */
    ...
    /**
     * Indicates whether this MIME Type is concrete, i.e. whether neither the type nor the subtype
     * is a wildcard character <code>&#42;</code>.
     *
        ...
        public int compare(T mimeType1, T mimeType2) {
            if (mimeType1.isWildcardType() && !mimeType2.isWildcardType()) { // */* < audio/*
                ...
                return -1;
                    ...
                    .getType()
                    .equals(mimeType2.getType())) { // audio/basic == text/html
                return 0;
