...
abstract class AbstractStaxXMLReader extends AbstractXMLReader {
            ...
            case IS_STANDALONE_FEATURE_NAME:
                if (this.isStandalone != null) {
                    ...
                    throw new SAXNotSupportedException(
                            "startDocument() callback not completed yet");
                }
            default:
    ...
    /**
     * Indicates whether the SAX feature {@code http://xml.org/sax/features/namespaces} is turned
     * on.
     */
    ...
    /**
     * Convert a {@code QName} to a qualified name, as used by DOM and SAX. The returned string has
     * a format of {@code prefix:localName} if the prefix is set, or just {@code localName} if not.
     *
     ...
     */
    protected void startPrefixMapping(@Nullable String prefix, String namespace)
            throws SAXException {
