...
public class StopWatch {
     ...
     *
     * <p>Handy when we have output from multiple stop watches and need to distinguish between them
     * in log or console output.
     */
     ...
     *
     * <p>The results are undefined if timing methods are called without invoking at least one pair
     * of {@code start()} / {@code stop()} methods.
     *
     * @see #start()
     * @see #start(String)
     */
    ...
    public String prettyPrint() {
        ...
        if (!this.keepTaskList) {
            ...
            for (TaskInfo task : getTaskInfo()) {
                ...
                sb.append(pf.format((double) task.getTimeNanos() / getTotalTimeNanos()))
                        .append("  ");
