...
public abstract class ReflectionUtils {
    ...
    /**
     * Pre-built MethodFilter that matches all non-bridge non-synthetic methods which are not
    ...
    /**
     * Cache for {@link Class#getDeclaredMethods()} plus equivalent default methods from Java 8
     ...
     * default methods from locally implemented interfaces, since those are effectively to be
     ...
     * @param target the target object on which to set the field (or {@code null} for a static
     *     field)
