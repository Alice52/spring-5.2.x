...
public class NullSafeComparator<T> implements Comparator<T> {
    ...
    /**
     * Create a NullSafeComparator that sorts {@code null} based on the provided flag, decorating
     * the given Comparator.
     *
     * <p>When comparing two non-null objects, the specified Comparator will be used. The given
     * underlying Comparator must be able to handle the elements that this Comparator will be
     * applied to.
     *
