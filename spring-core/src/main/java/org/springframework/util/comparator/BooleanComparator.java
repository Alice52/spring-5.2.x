...
public class BooleanComparator implements Comparator<Boolean>, Serializable {
    ...
    /**
     * A shared default instance of this comparator, treating {@code true} higher than {@code
     * false}.
     */
     ...
     *
     * <p>Alternatively, you can use the default shared instances: {@code
     * BooleanComparator.TRUE_LOW} and {@code BooleanComparator.TRUE_HIGH}.
     *
