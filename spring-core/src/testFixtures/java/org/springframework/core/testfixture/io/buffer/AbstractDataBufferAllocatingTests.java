...
public abstract class AbstractDataBufferAllocatingTests {
        ...
        return Stream.of(
                ...
                arguments(
                        ...
                        new NettyDataBufferFactory(
                                new PooledByteBufAllocator(true, 1, 1, 4096, 4, 0, 0, 0, true))),
                arguments(
                        "NettyDataBufferFactory - PooledByteBufAllocator - preferDirect = false",
                        new NettyDataBufferFactory(
                                new PooledByteBufAllocator(false, 1, 1, 4096, 4, 0, 0, 0, true))),
                arguments(
        ...
        if (this.bufferFactory instanceof NettyDataBufferFactory) {
            ...
            if (allocator instanceof PooledByteBufAllocator) {
                ...
                while (true) {
                    ...
                    assertThat(total)
                            .as("ByteBuf Leak: " + total + " unreleased allocations")
                            .isEqualTo(0);
                }
            }
        }
    ...
    @MethodSource(
            "org.springframework.core.testfixture.io.buffer.AbstractDataBufferAllocatingTests#dataBufferFactories()")
