...
public class JndiDestinationResolver extends JndiLocatorSupport
     ...
     *
     * <p>This flag can be turned off to re-lookup a destination for each operation, which allows
     * for hot restarting of destinations. This is mainly useful during development.
     *
    ...
    /**
     * Set whether this resolver is supposed to create dynamic destinations if the destination name
     * is not found in JNDI. Default is "false".
     *
