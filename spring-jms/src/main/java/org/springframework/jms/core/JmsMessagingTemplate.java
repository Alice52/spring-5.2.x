...
public class JmsMessagingTemplate extends AbstractMessagingTemplate<Destination>
    ...
    /**
     * Set the {@link MessageConverter} to use to convert a {@link Message} from the messaging to
     * and from a {@link javax.jms.Message}. By default, a {@link MessagingMessageConverter} is
     * defined using a {@link SimpleMessageConverter} to convert the payload of the message.
     *
    ...
    public void afterPropertiesSet() {
        Assert.notNull(
                this.jmsTemplate, "Property 'connectionFactory' or 'jmsTemplate' is required");
    ...
    public <T> T convertSendAndReceive(
        ...
        return convertSendAndReceive(
                destinationName, request, null, targetClass, requestPostProcessor);
    }
        ...
        public javax.jms.Message createMessage(Session session) throws JMSException {
            try {
                ...
                throw new MessageConversionException(
                        "Could not convert '" + this.message + "'", ex);
            }
        }
    }
}
