...
public class DelegatingConnectionFactory
    ...
    /**
     * Indicate whether Connections obtained from the target factory are supposed to be stopped
     * before closed ("true") or simply closed ("false"). An extra stop call may be necessary for
     * some connection pools that simply return released connections to the pool, not stopping them
