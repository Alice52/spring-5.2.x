...
public class JmsTransactionManager extends AbstractPlatformTransactionManager
     ...
     *
     * <p>Turns off transaction synchronization by default, as this manager might be used alongside
     * a datastore-based Spring transaction manager like DataSourceTransactionManager, which has
     * stronger needs for synchronization. Only one manager is allowed to drive synchronization at
     * any point of time.
     *
    ...
    /**
     * Specify whether this transaction manager should lazily retrieve a JMS Connection and Session
     * on access within a transaction ({@code true}). By default, it will eagerly create a JMS
     * Connection and Session at transaction begin ({@code false}).
     *
     * @since 5.1.6
    ...
    protected void doResume(@Nullable Object transaction, Object suspendedResources) {
        TransactionSynchronizationManager.bindResource(
                obtainConnectionFactory(), suspendedResources);
    }
    ...
    private class LazyJmsResourceHolder extends JmsResourceHolder {
        ...
        public <S extends Session> S getSession(
                Class<S> sessionType, @Nullable Connection connection) {
            initializeSession();
