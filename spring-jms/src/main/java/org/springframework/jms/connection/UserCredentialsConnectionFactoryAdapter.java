...
public class UserCredentialsConnectionFactoryAdapter
    ...
    /**
     * Set user credententials for this proxy and the current thread. The given username and
     * password will be applied to all subsequent {@code createConnection()} calls on this
     * ConnectionFactory proxy.
     *
    ...
    /**
     * This implementation delegates to the {@code createConnection(username, password)} method of
     * the target ConnectionFactory, passing in the specified user credentials. If the specified
     * username is empty, it will simply delegate to the standard {@code createConnection()} method
