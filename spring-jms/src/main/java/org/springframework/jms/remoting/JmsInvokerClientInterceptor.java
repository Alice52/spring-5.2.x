...
public class JmsInvokerClientInterceptor implements MethodInterceptor, InitializingBean {
     ...
     *
     * <p>Custom implementations may generally adapt {@link java.io.Serializable} objects into
     * special kinds of messages, or might be specifically tailored for translating {@code
    ...
    /**
     * Actually execute the given request, sending the invoker request message to the specified
     * target queue and waiting for a corresponding response.
     *
    ...
    protected RemoteAccessException convertJmsInvokerAccessException(JMSException ex) {
        return new RemoteAccessException(
                "Could not access JMS invoker queue [" + this.queue + "]", ex);
    }
}
