...
public class JmsListenerAnnotationBeanPostProcessorTests {
    ...
    public void simpleMessageListener() throws Exception {
        ...
        assertThat(methodEndpoint.getBean().getClass())
                .isEqualTo(SimpleMessageListenerTestBean.class);
    ...
    public void sendToAnnotationFoundOnInterfaceProxy() throws Exception {
        ...
        try {
            ...
            assertThat(methodEndpoint.getMethod())
                    .isEqualTo(
                            SimpleService.class.getMethod("handleIt", String.class, String.class));
            assertThat(methodEndpoint.getMostSpecificMethod())
                    .isEqualTo(
                            InterfaceProxyTestBean.class.getMethod(
                                    "handleIt", String.class, String.class));

            Method method =
                    ReflectionUtils.findMethod(
                            endpoint.getClass(), "getDefaultResponseDestination");
    ...
    public void sendToAnnotationFoundOnCglibProxy() throws Exception {
        ...
        try {
            ...
            assertThat(methodEndpoint.getMethod())
                    .isEqualTo(
                            ClassProxyTestBean.class.getMethod(
                                    "handleIt", String.class, String.class));
            assertThat(methodEndpoint.getMostSpecificMethod())
                    .isEqualTo(
                            ClassProxyTestBean.class.getMethod(
