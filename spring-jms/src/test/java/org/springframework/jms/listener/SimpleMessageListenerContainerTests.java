...
public class SimpleMessageListenerContainerTests {
    ...
    public void testContextRefreshedEventDoesNotStartTheConnectionIfAutoStartIsSetToFalse()
        ...
        given(
                        connection.createSession(
                                this.container.isSessionTransacted(),
                                this.container.getSessionAcknowledgeMode()))
                .willReturn(session);
    ...
    @Test
    public void testCorrectSessionExposedForSessionAwareMessageListenerInvocation()
            throws Exception {
    ...
    public void testRegisteredExceptionListenerIsInvokedOnException() throws Exception {
        ...
        this.container.setMessageListener(
                new SessionAwareMessageListener<Message>() {
                    @Override
                    public void onMessage(Message message, @Nullable Session session)
                            throws JMSException {
                        throw theException;
                    }
                });
