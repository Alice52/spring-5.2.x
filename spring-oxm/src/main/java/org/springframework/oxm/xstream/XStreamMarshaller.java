 ...
 *
 * <p>This marshaller requires XStream 1.4.7 or higher, as of Spring 5.2.17. Note that {@link
 * XStream} construction has been reworked in 4.0, with the stream driver and the class loader
 * getting passed into XStream itself now.
 *
 * @author Peter Meijer
...
public class XStreamMarshaller extends AbstractMarshaller
    ...
    @Nullable private TypePermission[] typePermissions;
    ...
    /**
     * Set a custom XStream {@link ConverterLookup} to use. Also used as {@link ConverterRegistry}
     * if the given reference implements it as well.
     *
     * @since 4.0
    ...
    /**
     * Set XStream type permissions such as {@link
     * com.thoughtworks.xstream.security.AnyTypePermission}, {@link
     * com.thoughtworks.xstream.security.ExplicitTypePermission} etc, as an alternative to
     * overriding the {@link #customizeXStream} method.
     *
     * <p>Note: As of XStream 1.4.18, the default type permissions are restricted to well-known core
     * JDK types. For any custom types, explicit type permissions need to be registered.
     *
     * @since 5.2.17
     */
     ...
     *
     * <p><b>Note</b>: Autodetection implies that the XStream instance is being configured while it
     * is processing the XML streams, and thus introduces a potential concurrency problem.
     *
    ...
    /**
     * Set a custom XStream {@link NameCoder} to use. The default is an {@link
                        ...
                        try {
                            ...
                            try {
                                ...
                                throw new IllegalStateException(
                                        "No appropriate MapperWrapper constructor found: "
                                                + mapperWrapper);
                            }
                        }
                        try {
            ...
            if (this.fieldAliases != null) {
                for (Map.Entry<String, String> entry : this.fieldAliases.entrySet()) {
                    ...
                    if (idx != -1) {
                        ...
                        throw new IllegalArgumentException(
                                "Field name [" + field + "] does not contain '.'");
                    }
                }
            }
                ...
                if (entry.getKey() instanceof String) {
                    if (entry.getValue() instanceof Class) {
                        xstream.useAttributeFor(
                                (String) entry.getKey(), (Class<?>) entry.getValue());
                    } else {
                        throw new IllegalArgumentException(
            ...
            this.implicitCollections.forEach(
                    (key, fields) -> {
                        String[] collectionFields =
                                StringUtils.commaDelimitedListToStringArray(fields);
     ...
     *
     * <p><b>NOTE: This method has been marked as final as of Spring 4.0.</b> It can be used to
     * access the fully configured XStream for marshalling but not configuration purposes anymore.
     *
     * <p>As of Spring Framework 5.1.16, creation of the {@link XStream} instance returned by this
     ...
     * unmarshalling, since XStream itself does not make this distinction in its exception
     * hierarchy.
     *
