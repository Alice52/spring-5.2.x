...
public class WebSphereDataSourceAdapter extends IsolationLevelDataSourceAdapter {
    ...
    public WebSphereDataSourceAdapter() {
        try {
            this.wsDataSourceClass =
                    getClass()
                            .getClassLoader()
                            .loadClass("com.ibm.websphere.rsadapter.WSDataSource");
    ...
    public void afterPropertiesSet() {
        ...
        if (!this.wsDataSourceClass.isInstance(getTargetDataSource())) {
            throw new IllegalStateException(
                    "Specified 'targetDataSource' is not a WebSphere WSDataSource: "
                            + getTargetDataSource());
        }
    }
     ...
     *
     * <p>The default implementation uses reflection to apply the given settings. Can be overridden
     * in subclasses to customize the JDBCConnectionSpec object (<a
