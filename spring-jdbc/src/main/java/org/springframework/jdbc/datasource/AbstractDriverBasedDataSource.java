...
public abstract class AbstractDriverBasedDataSource extends AbstractDataSource {
    ...
    /**
     * This implementation delegates to {@code getConnectionFromDriver}, using the given username
     * and password.
     *
     * @see #getConnectionFromDriver(String, String)
     */
    ...
    /**
     * Build properties for the Driver, including the given username and password (if any), and
     * obtain a corresponding Connection.
     *
