...
public class SqlRowSetResultSetExtractor implements ResultSetExtractor<SqlRowSet> {
     ...
     *
     * <p>This implementation creates a Spring {@link ResultSetWrappingSqlRowSet} instance that
     * wraps a standard JDBC {@link CachedRowSet} instance. Can be overridden to use a different
     * implementation.
     *
    ...
    static {
        try {
            ...
            throw new IllegalStateException(
                    "Cannot create RowSetFactory through RowSetProvider", ex);
        }
    }
}
