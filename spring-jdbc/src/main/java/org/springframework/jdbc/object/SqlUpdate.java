...
public class SqlUpdate extends SqlOperation {
    ...
    /**
     * Set the <i>exact</i> number of rows that must be affected by this update. The default value
     * is 0, which allows any number of rows to be affected.
     *
     ...
     * @throws JdbcUpdateAffectedIncorrectNumberOfRowsException if the actually affected rows are
     *     out of bounds
    ...
    /**
     * Method to execute the update given arguments and retrieve the generated keys using a
     * KeyHolder.
     *
    ...
    public int updateByNamedParam(Map<String, ?> paramMap, KeyHolder generatedKeyHolder)
        ...
        int rowsAffected =
                getJdbcTemplate()
                        .update(newPreparedStatementCreator(sqlToUse, params), generatedKeyHolder);
        checkRowsAffected(rowsAffected);
        return rowsAffected;
    }
}
