...
public class SQLErrorCodeSQLExceptionTranslatorTests {
    ...
    public void errorCodeTranslation() {
        ...
        BadSqlGrammarException bsgex =
                (BadSqlGrammarException) sext.translate("task", "SQL", badSqlEx);
        ...
        BadSqlGrammarException bsgex2 =
                (BadSqlGrammarException) sext.translate("task", "SQL2", sex);
    ...
    public void customExceptionTranslation() {
        ...
        final CustomSQLErrorCodesTranslation customTranslation =
        ...
        SQLErrorCodeSQLExceptionTranslator sext =
                new SQLErrorCodeSQLExceptionTranslator(customErrorCodes);
    ...
    public void dataSourceInitialization() throws Exception {
        ...
        assertThat(sext.translate("test", null, duplicateKeyException))
