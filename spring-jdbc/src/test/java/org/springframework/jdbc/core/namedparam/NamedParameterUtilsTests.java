...
public class NamedParameterUtilsTests {
    ...
    public void convertParamMapToArray() {
        ...
        paramMap.put("b", "b");
        paramMap.put("c", "c");
        assertThat(NamedParameterUtils.buildValueArray("xxx :a :b :c", paramMap).length)
                .isSameAs(3);
    ...
    public void convertTypeMapToArray() {
        ...
        assertThat(
                        NamedParameterUtils.buildSqlTypeArray(
                                        NamedParameterUtils.parseSqlStatement("xxx :a :b :c"),
                                        namedParams)
                                .length)
                .isSameAs(3);
        assertThat(
        ...
        assertThat(
                        NamedParameterUtils.buildSqlTypeArray(
                                NamedParameterUtils.parseSqlStatement("xxx :a :b :c xx :a :b"),
                                namedParams)[4])
                .isEqualTo(2);
    }
    ...
    public void buildValueArrayWithMissingParameterValue() {
        ...
        assertThatExceptionOfType(InvalidDataAccessApiUsageException.class)
                .isThrownBy(
                        () ->
                                NamedParameterUtils.buildValueArray(
                                        sql, Collections.<String, Object>emptyMap()));
    }
    ...
    public void substituteNamedParametersWithStringContainingQuotes() {
        ...
        String newSql =
                NamedParameterUtils.substituteNamedParameters(sql, new MapSqlParameterSource());
    ...
    public void substituteNamedParametersWithLogicalAnd() {
        ...
        String newSql =
                NamedParameterUtils.substituteNamedParameters(
                        expectedSql, new MapSqlParameterSource());
        assertThat(newSql).isEqualTo(expectedSql);
    }
