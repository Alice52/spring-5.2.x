...
public class StoredProcedureTests {
    ...
    public void testStoredProcedureConfiguredViaJdbcTemplateWithCustomExceptionTranslator()
        ...
        given(
                        connection.prepareCall(
                                "{call "
                                        + StoredProcedureConfiguredViaJdbcTemplate.SQL
                                        + "(?, ?)}"))
                .willReturn(callableStatement);
        ...
        StoredProcedureConfiguredViaJdbcTemplate sp =
                new StoredProcedureConfiguredViaJdbcTemplate(t);
    ...
    public void testNullArg() throws Exception {
        given(callableStatement.execute()).willReturn(false);
        given(callableStatement.getUpdateCount()).willReturn(-1);
        given(connection.prepareCall("{call " + NullArg.SQL + "(?)}"))
                .willReturn(callableStatement);
    ...
    public void testStoredProcedureExceptionTranslator() throws Exception {
        ...
        StoredProcedureExceptionTranslator sproc =
                new StoredProcedureExceptionTranslator(dataSource);
    ...
    public void testStoredProcedureWithResultSetMapped() throws Exception {
        ...
        StoredProcedureWithResultSetMapped sproc =
                new StoredProcedureWithResultSetMapped(dataSource);
    ...
    public void testStoredProcedureSkippingResultsProcessing() throws Exception {
        ...
        StoredProcedureWithResultSetMapped sproc =
                new StoredProcedureWithResultSetMapped(jdbcTemplate);
        Map<String, Object> res = sproc.execute();
