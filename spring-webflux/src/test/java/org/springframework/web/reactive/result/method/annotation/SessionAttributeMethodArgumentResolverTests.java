...
public class SessionAttributeMethodArgumentResolverTests {
    ...
    public void setup() {
        ...
        this.exchange =
                MockServerWebExchange.builder(MockServerHttpRequest.get("/"))
                        .session(this.session)
                        .build();
        this.handleMethod =
                ReflectionUtils.findMethod(
                        getClass(), "handleWithSessionAttribute", (Class<?>[]) null);
    }

    @Test
    public void supportsParameter() {
        assertThat(this.resolver.supportsParameter(new MethodParameter(this.handleMethod, 0)))
                .isTrue();
