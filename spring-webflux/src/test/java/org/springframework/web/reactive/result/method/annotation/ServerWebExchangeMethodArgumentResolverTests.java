...
public class ServerWebExchangeMethodArgumentResolverTests {
    ...
    private final ServerWebExchangeMethodArgumentResolver resolver =
            new ServerWebExchangeMethodArgumentResolver(
    ...
    public void supportsParameter() {
        ...
        assertThat(this.resolver.supportsParameter(this.testMethod.arg(WebSession.class)))
                .isFalse();
    ...
    public void resolveArgument() {
        ...
        testResolveArgument(
                this.testMethod.arg(ServerHttpRequest.class), this.exchange.getRequest());
        testResolveArgument(
                this.testMethod.arg(ServerHttpResponse.class), this.exchange.getResponse());
