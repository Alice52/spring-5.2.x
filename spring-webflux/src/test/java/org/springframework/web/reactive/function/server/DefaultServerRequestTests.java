...
public class DefaultServerRequestTests {
        ...
        DefaultServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(
                                MockServerHttpRequest.method(method, "https://example.com")),
                        this.messageReaders);
    ...
    public void uri() {
        ...
        DefaultServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(
                                MockServerHttpRequest.method(HttpMethod.GET, uri)),
                        this.messageReaders);
                ...
                new DefaultServerRequest(
                        MockServerWebExchange.from(
                                MockServerHttpRequest.method(
                                        HttpMethod.GET, "https://example.com?foo=bar")),
                        this.messageReaders);
    ...
    public void emptyQueryParam() {
        DefaultServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(
                                MockServerHttpRequest.method(
                                        HttpMethod.GET, "https://example.com?foo")),
                        this.messageReaders);
    ...
    public void pathVariable() {
        ...
        exchange.getAttributes()
                .put(RouterFunctions.URI_TEMPLATE_VARIABLES_ATTRIBUTE, pathVariables);
    ...
    public void header() {
        ...
        assertThat(headers.header(HttpHeaders.CONTENT_TYPE))
                .containsExactly(MediaType.TEXT_PLAIN_VALUE);
        assertThat(headers.firstHeader(HttpHeaders.CONTENT_TYPE))
    ...
    public void bodyToMonoDecodingException() {
        ...
        DefaultDataBuffer dataBuffer =
                factory.wrap(
                        ByteBuffer.wrap("{\"invalid\":\"json\" ".getBytes(StandardCharsets.UTF_8)));
        Flux<DataBuffer> body = Flux.just(dataBuffer);
        ...
        StepVerifier.create(result)
                .assertNext(
                        serverResponse -> {
                            ...
                            assertThat(serverResponse.headers().getLastModified())
