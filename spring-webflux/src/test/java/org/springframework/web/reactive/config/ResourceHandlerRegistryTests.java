...
public class ResourceHandlerRegistryTests {
    ...
    public void setup() {
        ...
        this.registration.addResourceLocations(
                "classpath:org/springframework/web/reactive/config/");
    }
    ...
    public void mapPathToLocation() {
        ...
        StepVerifier.create(exchange.getResponse().getBody())
                .consumeNextWith(
                        buf -> assertThat(buf.toString(UTF_8)).isEqualTo("test stylesheet content"))
                .expectComplete()
                .verify();
    }
    ...
    private ResourceWebHandler getHandler(String pathPattern) {
        SimpleUrlHandlerMapping mapping =
                (SimpleUrlHandlerMapping) this.registry.getHandlerMapping();
