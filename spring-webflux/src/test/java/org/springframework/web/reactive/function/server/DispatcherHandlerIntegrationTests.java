...
class DispatcherHandlerIntegrationTests extends AbstractHttpHandlerIntegrationTests {
    ...
    void mono(HttpServer httpServer) throws Exception {
        ...
        ResponseEntity<Person> result =
                this.restTemplate.getForEntity(
                        "http://localhost:" + this.port + "/mono", Person.class);
    ...
    static class TestConfiguration {
        ...
        @Bean
        public RouterFunction<EntityResponse<Person>> monoRouterFunction(
    ...
    private static class AttributesHandler {
        ...
        public Mono<ServerResponse> attributes(ServerRequest request) {
            assertThat(request.attributes().containsKey(RouterFunctions.REQUEST_ATTRIBUTE))
                    .isTrue();
            assertThat(
                            request.attributes()
            ...
            PathPattern pattern =
                    (PathPattern)
                            request.attributes().get(RouterFunctions.MATCHING_PATTERN_ATTRIBUTE);
