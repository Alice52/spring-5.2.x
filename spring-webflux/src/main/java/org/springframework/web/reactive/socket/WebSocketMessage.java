 ...
 * org.springframework.core.io.buffer.DataBufferFactory} for the session.
 *
...
public class WebSocketMessage {
     ...
     * encoding. This is useful for text WebSocket messages, or otherwise when the payload is
