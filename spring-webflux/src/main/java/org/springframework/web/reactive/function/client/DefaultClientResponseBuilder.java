...
final class DefaultClientResponseBuilder implements ClientResponse.Builder {
    ...
    @Nullable private ClientResponse originalResponse;
    ...
    public DefaultClientResponseBuilder(ClientResponse other) {
        ...
        this.request =
                (other instanceof DefaultClientResponse
                        ? ((DefaultClientResponse) other).request()
                        : EMPTY_REQUEST);
    }
    ...
    public DefaultClientResponseBuilder rawStatusCode(int statusCode) {
        Assert.isTrue(
                statusCode >= 100 && statusCode < 600, "StatusCode must be between 1xx and 5xx");
