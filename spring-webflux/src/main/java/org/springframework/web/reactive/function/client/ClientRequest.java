...
public interface ClientRequest {
     ...
     * this request. Use {@link #logPrefix()} to obtain a consistently formatted prefix based on
     * this attribute.
     *
     * @since 5.1
     * @see #logPrefix()
    ...
    /**
     * Return a log message prefix to use to correlate messages for this request. The prefix is
     * based on the value of the attribute {@link #LOG_ID_ATTRIBUTE LOG_ID_ATTRIBUTE} surrounded
     * with "[" and "]".
     *
