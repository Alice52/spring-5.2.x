...
public abstract class BodyInserters {
    ...
    public static <T> BodyInserter<T, ReactiveHttpOutputMessage> fromProducer(
        ...
        return (message, context) ->
                writeWithMessageWriters(
                        ...
                        context,
                        producer,
                        ResolvableType.forType(elementTypeRef),
                        adapter);
    }
    ...
    public static <T, P extends Publisher<T>>
        ...
        return (message, context) ->
                writeWithMessageWriters(
                        ...
                        context,
                        publisher,
                        ResolvableType.forType(elementTypeRef.getType()),
                        null);
    }
     ...
     *
     * <p>If the resource can be resolved to a {@linkplain Resource#getFile() file}, it will be
     * copied using <a href="https://en.wikipedia.org/wiki/Zero-copy">zero-copy</a>.
     *
    ...
    public static <T extends Resource> BodyInserter<T, ReactiveHttpOutputMessage> fromResource(
        ...
        return (outputMessage, context) -> {
            ...
            return write(
                    Mono.just(resource), elementType, contentType, outputMessage, context, writer);
        };
    }
    ...
    public static <T, S extends Publisher<ServerSentEvent<T>>>
        ...
        return (serverResponse, context) -> {
            ...
            HttpMessageWriter<ServerSentEvent<T>> writer =
                    findWriter(context, elementType, mediaType);
    ...
    /**
     * Return a {@link MultipartInserter} to write the given {@code MultiValueMap} as multipart
     * data. Values in the map can be an Object or an {@link HttpEntity}.
     *
