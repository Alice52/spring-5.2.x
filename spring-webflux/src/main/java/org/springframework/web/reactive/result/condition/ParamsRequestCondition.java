...
public final class ParamsRequestCondition extends AbstractRequestCondition<ParamsRequestCondition> {
    ...
    /**
     * Compare to another condition based on parameter expressions. A condition is considered to be
     * a more specific match, if it has:
     *
     * <ol>
    ...
    static class ParamExpression extends AbstractNameValueExpression<String> {
        ...
        protected boolean matchValue(ServerWebExchange exchange) {
            return (this.value != null
                    && this.value.equals(
                            exchange.getRequest().getQueryParams().getFirst(this.name)));
        }
    }
}
