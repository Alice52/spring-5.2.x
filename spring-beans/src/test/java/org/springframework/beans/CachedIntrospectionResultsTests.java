...
public class CachedIntrospectionResultsTests {
    ...
    public void acceptAndClearClassLoader() throws Exception {
        ...
        assertThat(CachedIntrospectionResults.strongClassCache.containsKey(TestBean.class))
                .isTrue();
    ...
    public void clearClassLoaderForSystemClassLoader() throws Exception {
        ...
        assertThat(CachedIntrospectionResults.strongClassCache.containsKey(ArrayList.class))
                .isTrue();
