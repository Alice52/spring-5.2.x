...
public class BeanFactoryGenericsTests {
    ...
    /**
     * Tests support for parameterized instance {@code factory-method} declarations such as
     * EasyMock's {@code IMocksControl.createMock()} method which has the following signature.
     *
     * <pre>{@code
    ...
    public void testGenericMatchingWithBeanNameDifferentiation() {
        ...
        bf.registerBeanDefinition(
                ...
                new RootBeanDefinition(
                        NumberBean.class, RootBeanDefinition.AUTOWIRE_CONSTRUCTOR, false));
        ...
        String[] numberStoreNames =
                bf.getBeanNamesForType(ResolvableType.forClass(NumberStore.class));
        ...
        String[] floatStoreNames =
                bf.getBeanNamesForType(
                        ResolvableType.forClassWithGenerics(NumberStore.class, Float.class));
