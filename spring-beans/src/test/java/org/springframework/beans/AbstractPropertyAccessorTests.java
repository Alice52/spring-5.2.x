...
public abstract class AbstractPropertyAccessorTests {
    ...
    public void setNestedPropertyPolymorphic() throws Exception {
        ...
        assertThat(
                        "Lewisham"
                                .equals(
                                        kerryAccessor.getPropertyValue(
    ...
    public void setValidPropertyValues() {
        ...
        assertThat(target.getName().equals(newName))
                .as("Name property should have changed")
                .isTrue();
    ...
    public void setNumberProperties() {
        ...
        assertThat(new Double("6.1").equals(accessor.getPropertyValue("double2")))
                ...
                .isTrue();
        assertThat(new Double("6.1").equals(target.getDouble2()))
                .as("Correct double2 value")
                .isTrue();
    ...
    public void setPrimitiveProperties() {
        ...
        assertThat((double) target.getMyFloat().floatValue())
                .isCloseTo(Float.MAX_VALUE, within(0.001));
    ...
    public void setIntArrayProperty() {
        ...
        assertThat(result.contains(4) && result.contains(5) && result.contains(3))
                .as("correct values")
                .isTrue();
