...
public class PagedListHolder<E> implements Serializable {
    ...
    public int getPageCount() {
        ...
        return (int)
                ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages);
    }
    ...
    /**
     * Return the element index of the last element on the current page. Element numbering starts
     * with 0.
     */
    ...
    /**
     * Create a deep copy of the given sort definition, for use as state holder to compare a
     * modified sort definition against.
     *
     ...
     * allowed to return null, which means that no sort state will be held, triggering actual
     * sorting for each {@code resort} call.
     *
