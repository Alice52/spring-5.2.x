...
public class FieldRetrievingFactoryBean
    ...
    public void setTargetField(@Nullable String targetField) {
        this.targetField =
                (targetField != null ? StringUtils.trimAllWhitespace(targetField) : null);
    }

    /**
     * Set a fully qualified static field name to retrieve, e.g.
     * "example.MyExampleClass.MY_EXAMPLE_FIELD". Convenient alternative to specifying targetClass
     * and targetField.
     *
     * @see #setTargetClass
     * @see #setTargetField
    ...
    /**
     * The bean name of this FieldRetrievingFactoryBean will be interpreted as "staticField"
     * pattern, if neither "targetClass" nor "targetObject" nor "targetField" have been specified.
