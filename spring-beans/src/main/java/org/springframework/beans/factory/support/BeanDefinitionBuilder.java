...
public final class BeanDefinitionBuilder {
    ...
    /**
     * Set the name of a static factory method to use for this definition, to be called on this
     * bean's class.
     */
    ...
    /**
     * Set the name of a non-static factory method to use for this definition, including the bean
     * name of the factory instance to call the method on.
     *
    ...
    public BeanDefinitionBuilder addDependsOn(String beanName) {
        if (this.beanDefinition.getDependsOn() == null) {
            ...
            String[] added =
                    ObjectUtils.addObjectToArray(this.beanDefinition.getDependsOn(), beanName);
