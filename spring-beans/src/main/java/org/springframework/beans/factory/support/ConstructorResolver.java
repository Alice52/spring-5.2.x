...
class ConstructorResolver {
    ...
    /**
     * Marker for autowired arguments in a cached argument array, to be replaced by a {@linkplain
     * #resolveAutowiredArgument resolved autowired argument}.
     */
            ...
            if (argsToResolve != null) {
                argsToUse =
                        resolvePreparedArguments(
                                beanName, mbd, bw, constructorToUse, argsToResolve);
            }
        }
    ...
    public BeanWrapper instantiateUsingFactoryMethod(
        ...
        if (explicitArgs != null) {
            ...
            if (argsToResolve != null) {
                argsToUse =
                        resolvePreparedArguments(
                                beanName, mbd, bw, factoryMethodToUse, argsToResolve);
            }
        }
        ...
        if (factoryMethodToUse == null || argsToUse == null) {
            ...
            if (factoryMethodToUse == null || argsToUse == null) {
                ...
                throw new BeanCreationException(
                        mbd.getResourceDescription(),
                        beanName,
                        "No matching factory method found on class ["
                ...
                throw new BeanCreationException(
                        mbd.getResourceDescription(),
                        beanName,
                        "Ambiguous factory method matches found on class ["
                                + factoryClass.getName()
                                + "] "
                                + "(hint: specify index/type/name arguments for simple parameters to avoid type ambiguities): "
