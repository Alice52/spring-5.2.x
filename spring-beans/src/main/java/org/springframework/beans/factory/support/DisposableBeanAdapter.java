...
class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
    ...
    @Nullable private final List<DestructionAwareBeanPostProcessor> beanPostProcessors;
     ...
     */
    @Nullable
    private static String inferDestroyMethodIfNecessary(
            ...
            if (AbstractBeanDefinition.INFER_METHOD.equals(destroyMethodName)
                ...
                if (!(bean instanceof DisposableBean)) {
                    try {
                        ...
                        try {
                            destroyMethodName =
                                    bean.getClass().getMethod(SHUTDOWN_METHOD_NAME).getName();
