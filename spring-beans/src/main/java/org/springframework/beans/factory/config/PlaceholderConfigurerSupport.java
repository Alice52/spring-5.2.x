 ...
 * #setProperties properties} property, or on a property-by-property basis using the value separator
 * which is {@code ":"} by default and customizable via {@link #setValueSeparator(String)}.
 *
