...
public class CustomCollectionEditor extends PropertyEditorSupport {
    ...
    /**
     * Create a new CustomCollectionEditor for the given target type, keeping an incoming {@code
     * null} as-is.
     *
     ...
     * Collection type. If the value is anything else, a target Collection with that single value
     * will be created.
     *
     ...
     * type of the passed-in Collection already matches. Override {@link
     * #alwaysCreateNewCollection()} to enforce creating a new Collection in every case.
     *
