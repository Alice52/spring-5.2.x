...
public class DummyFactory
    ...
    /**
     * Was this initialized by invocation of the afterPropertiesSet() method from the
    ...
    public Object getObject() throws BeansException {
        if (isSingleton()) {
            ...
            TestBean prototype =
                    new TestBean("prototype created at " + System.currentTimeMillis(), 11);
            if (this.beanFactory != null) {
                this.beanFactory.applyBeanPostProcessorsBeforeInitialization(
                        prototype, this.beanName);
            }
