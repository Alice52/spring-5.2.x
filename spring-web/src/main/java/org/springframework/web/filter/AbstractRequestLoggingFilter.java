...
public abstract class AbstractRequestLoggingFilter extends OncePerRequestFilter {
     ...
     *
     * <p>Should be configured using an {@code <init-param>} for parameter name "includeClientInfo"
     * in the filter definition in {@code web.xml}.
     */
    ...
    public void setMaxPayloadLength(int maxPayloadLength) {
        Assert.isTrue(
                maxPayloadLength >= 0, "'maxPayloadLength' should be larger than or equal to 0");
     ...
     * building).
     *
     * <p>The default implementation always returns {@code true}. Subclasses may override this with
     * a log level check.
     *
