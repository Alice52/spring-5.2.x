...
public class CookieGenerator {
    ...
    /**
     * Use the given path for cookies created by this generator. The cookie is only visible to URLs
     * in this path and below.
     *
    ...
    /**
     * Add a cookie with the given value to the response, using the cookie descriptor settings of
     * this generator.
     *
    ...
    /**
     * Remove the cookie that this generator describes from the response. Will generate a cookie
