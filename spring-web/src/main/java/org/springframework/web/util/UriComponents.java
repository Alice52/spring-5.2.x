...
public abstract class UriComponents implements Serializable {
    ...
    static String expandUriComponent(
        ...
        while (matcher.find()) {
            ...
            formatted =
                    encoder != null
                            ? encoder.apply(formatted)
                            : Matcher.quoteReplacement(formatted);
     ...
     * reserved meaning. For most cases, {@link UriComponentsBuilder#encode()} is more likely to
    ...
    /**
     * Normalize the path removing sequences like "path/..". Note that normalization is applied to
     * the full path, and not to individual path segments.
     *
    ...
    public interface UriTemplateVariables {
        ...
        /**
         * Get the value for the given URI variable name. If the value is {@code null}, an empty
         * String is expanded. If the value is {@link #SKIP_VALUE}, the URI variable is not
         * expanded.
         *
