...
public abstract class UriUtils {
     ...
     *
     * <p>This can be used with {@link UriComponentsBuilder#queryParams(MultiValueMap)} when
     * building a URI from an already encoded template.
     *
     * <pre class="code">
     ...
     * @since 5.2.3
     */
    public static MultiValueMap<String, String> encodeQueryParams(
        ...
        for (Map.Entry<String, List<String>> entry : params.entrySet()) {
            for (String value : entry.getValue()) {
                result.add(
                        encodeQueryParam(entry.getKey(), charset),
                        encodeQueryParam(value, charset));
            }
        }
        return result;
    }
    ...
    /**
     * Encode all characters that are either illegal, or have any reserved meaning, anywhere within
     * a URI, as defined in <a href="https://tools.ietf.org/html/rfc3986">RFC 3986</a>. This is
     * useful to ensure that the given String will be preserved as-is and will not have any o impact
    ...
    /**
     * Convenience method to apply {@link #encode(String, Charset)} to all given URI variable
     * values.
     *
