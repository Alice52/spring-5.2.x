...
public class WebAsyncTask<V> implements BeanFactoryAware {
     ...
     *
     * <p>This factory reference will automatically be set when {@code WebAsyncTask} is used within
    ...
    /**
     * Return the AsyncTaskExecutor to use for concurrent handling, or {@code null} if none
     * specified.
     */
    @Nullable
    public AsyncTaskExecutor getExecutor() {
        if (this.executor != null) {
            ...
            Assert.state(
                    ...
                    "BeanFactory is required to look up an executor bean by name");
     ...
     * should return without blocking. It may return an alternative value to use, including an
     * {@link Exception} or return {@link CallableProcessingInterceptor#RESULT_NONE RESULT_NONE}.
     */
     ...
     * thread and therefore should return without blocking. It may return an alternative value to
     * use, including an {@link Exception} or return {@link
     * CallableProcessingInterceptor#RESULT_NONE RESULT_NONE}.
     *
     * @since 5.0
     */
