...
public class ServletRequestAttributes extends AbstractRequestAttributes {
    ...
    /**
     * Constant identifying the {@link String} prefixed to the name of a destruction callback when
     * it is stored in a {@link HttpSession}.
     */
            ...
            if (session != null) {
                try {
                    for (Map.Entry<String, Object> entry :
                            this.sessionAttributesToUpdate.entrySet()) {
     ...
     * @return {@code true} if the value is to be considered as immutable for the purposes of
     *     session attribute management; {@code false} otherwise
