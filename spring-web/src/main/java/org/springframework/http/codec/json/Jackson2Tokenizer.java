...
final class Jackson2Tokenizer {
     ...
     * @param tokenizeArrays if {@code true} and the "top level" JSON object is an array, each
     *     element is returned individually immediately after it is received
     * @param forceUseOfBigDecimal if {@code true}, any floating point values encountered in source
     *     will use {@link java.math.BigDecimal}
    ...
    public static Flux<TokenBuffer> tokenize(
        ...
        try {
            ...
            Jackson2Tokenizer tokenizer =
                    new Jackson2Tokenizer(
                            parser, context, tokenizeArrays, forceUseOfBigDecimal, maxInMemorySize);
            return dataBuffers
