...
public final class ServerSentEvent<T> {
    ...
    public interface Builder<T> {
         ...
         * {@code String}, it will be turned into multiple {@code data} field lines as defined in
         * the Server-Sent Events W3C recommendation. If {@code data} is not a String, it will be
