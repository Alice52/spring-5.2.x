...
public class ProtobufDecoder extends ProtobufCodecSupport implements Decoder<Message> {
    ...
    private class MessageDecoderFunction
                ...
                do {
                    if (this.output == null) {
                        ...
                        if (this.maxMessageSize > 0
                                && this.messageBytesToRead > this.maxMessageSize) {
                    ...
                    if (this.messageBytesToRead == 0) {
                        CodedInputStream stream =
                                CodedInputStream.newInstance(this.output.asByteBuffer());
        ...
        /**
         * Parse message size as a varint from the input stream, updating {@code messageBytesToRead}
         * and {@code offset} fields if needed to allow processing of upcoming chunks. Inspired from
         ...
         * @see <a href ="https://developers.google.com/protocol-buffers/docs/encoding#varints">Base
         *     128 Varints</a>
         */
