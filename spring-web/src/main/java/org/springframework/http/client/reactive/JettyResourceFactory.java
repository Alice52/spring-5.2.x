...
public class JettyResourceFactory implements InitializingBean, DisposableBean {
    ...
    /**
     * Configure the thread prefix to initialize {@link QueuedThreadPool} executor with. This is
     * used only when a {@link Executor} instance isn't {@link #setExecutor(Executor) provided}.
     *
