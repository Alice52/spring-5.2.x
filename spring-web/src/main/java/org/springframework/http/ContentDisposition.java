...
public final class ContentDisposition {
    ...
    private static String encodeFilename(String input, Charset charset) {
        ...
        Assert.isTrue(
                !StandardCharsets.US_ASCII.equals(charset), "ASCII does not require encoding");
        Assert.isTrue(
                UTF_8.equals(charset) || ISO_8859_1.equals(charset),
    ...
    /**
     * Return the value of the {@literal filename} parameter (or the value of the {@literal
     * filename*} one decoded as defined in the RFC 5987), or {@code null} if not defined.
     */
    @Nullable
     ...
     *     6266, Apendix B</a>, to be removed in a future release.
     */
    @Deprecated
    @Nullable
    public Long getSize() {
    ...
    /**
     * Return the value of the {@literal modification-date} parameter, or {@code null} if not
     * defined.
     *
     * @deprecated since 5.2.3 as per <a href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC
     *     6266, Apendix B</a>, to be removed in a future release.
    ...
    public int hashCode() {
        ...
        result =
                31 * result
                        + (this.modificationDate != null ? this.modificationDate.hashCode() : 0);
    ...
    public interface Builder {
        ...
        /**
         * Set the value of the {@literal filename} parameter. The given filename will be formatted
         * as quoted-string, as defined in RFC 2616, section 2.2, and any quote characters within
         * the filename value will be escaped with a backslash, e.g. {@code "foo\"bar.txt"} becomes
         * {@code "foo\\\"bar.txt"}.
         */
        Builder filename(String filename);

        /**
         * Set the value of the {@literal filename*} that will be encoded as defined in the RFC
         * 5987. Only the US-ASCII, UTF-8 and ISO-8859-1 charsets are supported.
         *
         * <p><strong>Note:</strong> Do not use this for a {@code "multipart/form-data"} requests as
         * per <a link="https://tools.ietf.org/html/rfc7578#section-4.2">RFC 7578, Section 4.2</a>
         ...
         *
         * @deprecated since 5.2.3 as per <a
         *     href="https://tools.ietf.org/html/rfc6266#appendix-B">RFC 6266, Apendix B</a>, to be
