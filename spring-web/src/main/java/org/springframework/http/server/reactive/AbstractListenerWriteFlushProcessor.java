...
public abstract class AbstractListenerWriteFlushProcessor<T>
     ...
     *
     * <p>This is primarily for the Servlet non-blocking I/O API where flush cannot be called
    ...
    private enum State {
        ...
        RECEIVED {
            ...
            private <T> void handleSubscriberCompleted(
                    AbstractListenerWriteFlushProcessor<T> processor) {
        ...
        /**
         * Subscriber to receive and delegate completion notifications for from the current
         * Publisher, i.e. for the current flush boundary.
         */
