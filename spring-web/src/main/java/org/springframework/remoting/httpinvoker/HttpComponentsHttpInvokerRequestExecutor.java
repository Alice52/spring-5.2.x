...
public class HttpComponentsHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
    ...
    /**
     * Create a {@link RequestConfig} for the given configuration. Can return {@code null} to
     * indicate that no custom request config should be set and the defaults of the {@link
     ...
     *
     * <p>The default implementation checks whether the HTTP "Content-Encoding" header contains
     * "gzip" (in any casing).
     *
