...
public class ContentDispositionTests {
    ...
    public void parseFilenameUnquoted() {
        assertThat(parse("form-data; filename=unquoted"))
                .isEqualTo(builder("form-data").filename("unquoted").build());
    }
    ...
    public void parseWithEscapedQuote() {
        ...
        BiConsumer<String, String> tester =
        ...
        tester.accept(
                "Escaped quotes preceded by escaped backslashes should be ignored",
                "\\\\\\\"The Twilight Zone\\\\\\\".txt");

        tester.accept("Escaped backslashes should not suppress quote", "The Twilight Zone \\\\");

        tester.accept(
                "Escaped backslashes should not suppress quote", "The Twilight Zone \\\\\\\\");
    }
    ...
    public void parseDates() {
        ZonedDateTime creationTime =
                ZonedDateTime.parse("Mon, 12 Feb 2007 10:15:30 -0500", formatter);
        ...
        assertThat(
                        parse(
                                "attachment; "
                                        ...
                                        + readTime.format(formatter)
                                        + "\""))
                .isEqualTo(builder("attachment").readDate(readTime).build());
    }
