...
public class ResponseEntityTests {
    ...
    public void createdLocation() throws URISyntaxException {
        ...
        assertThat(responseEntity.getHeaders().getFirst(HttpHeaders.LOCATION))
    ...
    public void headers() throws URISyntaxException {
        ...
        assertThat(responseHeaders.getFirst(HttpHeaders.LAST_MODIFIED))
                .isEqualTo("Thu, 01 Jan 1970 00:00:12 GMT");
        assertThat(responseHeaders.getFirst(HttpHeaders.LOCATION))
                .isEqualTo(location.toASCIIString());
        assertThat(responseHeaders.getFirst(HttpHeaders.CONTENT_LENGTH))
                .isEqualTo(String.valueOf(contentLength));
        assertThat(responseHeaders.getFirst(HttpHeaders.CONTENT_TYPE))
