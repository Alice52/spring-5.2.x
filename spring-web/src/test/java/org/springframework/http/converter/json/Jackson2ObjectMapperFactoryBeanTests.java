...
public class Jackson2ObjectMapperFactoryBeanTests {
    ...
    public void booleanSetters() {
        ...
        assertThat(
                        objectMapper
                                ...
                                .isEnabled(MapperFeature.AUTO_DETECT_FIELDS))
                .isFalse();
        assertThat(
                        objectMapper
        ...
        assertThat(
                        objectMapper
                                .getSerializationConfig()
                                .isEnabled(MapperFeature.AUTO_DETECT_GETTERS))
                .isFalse();
        assertThat(
                        objectMapper
                                .getDeserializationConfig()
    ...
    public void setTimeZone() {
        ...
        assertThat(this.factory.getObject().getSerializationConfig().getTimeZone())
                .isEqualTo(timeZone);
    ...
    public void completeSetup() {
        ...
        assertThat(
                        objectMapper
                                ...
                                .isEnabled(MapperFeature.AUTO_DETECT_FIELDS))
                .isFalse();
        assertThat(objectMapper.getFactory().isEnabled(JsonParser.Feature.AUTO_CLOSE_SOURCE))
                .isFalse();
