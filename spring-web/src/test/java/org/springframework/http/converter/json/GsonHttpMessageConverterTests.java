...
public class GsonHttpMessageConverterTests {
    ...
    @Test
    public void canRead() {
        assertThat(this.converter.canRead(MyBean.class, new MediaType("application", "json")))
                .isTrue();
        assertThat(this.converter.canRead(Map.class, new MediaType("application", "json")))
                .isTrue();
    }
    ...
    public void canWrite() {
        assertThat(this.converter.canWrite(MyBean.class, new MediaType("application", "json")))
                .isTrue();
        assertThat(this.converter.canWrite(Map.class, new MediaType("application", "json")))
                .isTrue();
    }
    ...
    public void canReadAndWriteMicroformats() {
        assertThat(
                        this.converter.canRead(
                                MyBean.class,
                                new MediaType("application", "vnd.test-micro-type+json")))
                .isTrue();
        assertThat(
    ...
    public void readAndWriteParameterizedType() throws Exception {
        ...
        List<MyBean> results =
                (List<MyBean>) converter.read(beansList.getType(), null, inputMessage);
        assertThat(results.size()).isEqualTo(1);
        MyBean result = results.get(0);
        assertThat(result.getString()).isEqualTo("Foo");
        assertThat(result.getNumber()).isEqualTo(42);
