...
public class BufferedImageHttpMessageConverterTests {
    ...
    public void canWrite() {
        assertThat(converter.canWrite(BufferedImage.class, null))
                .as("Image not supported")
                .isTrue();
    ...
    public void read() throws IOException {
        Resource logo =
                new ClassPathResource("logo.jpg", BufferedImageHttpMessageConverterTests.class);
    ...
    public void write() throws IOException {
        ...
        BufferedImage result =
                ImageIO.read(new ByteArrayInputStream(outputMessage.getBodyAsBytes()));
        assertThat(result.getHeight()).as("Invalid height").isEqualTo(500);
        assertThat(result.getWidth()).as("Invalid width").isEqualTo(750);
    }
