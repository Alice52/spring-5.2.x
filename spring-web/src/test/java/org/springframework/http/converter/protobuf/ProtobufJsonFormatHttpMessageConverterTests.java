...
public class ProtobufJsonFormatHttpMessageConverterTests {
    ...
    public void canRead() {
        ...
        assertThat(this.converter.canRead(Msg.class, ProtobufHttpMessageConverter.PROTOBUF))
                .isTrue();
    ...
    public void canWrite() {
        ...
        assertThat(this.converter.canWrite(Msg.class, ProtobufHttpMessageConverter.PROTOBUF))
                .isTrue();
