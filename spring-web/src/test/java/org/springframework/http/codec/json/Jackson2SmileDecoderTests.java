...
public class Jackson2SmileDecoderTests extends AbstractDecoderTests<Jackson2SmileDecoder> {
    ...
    public void canDecode() {
        assertThat(decoder.canDecode(ResolvableType.forClass(Pojo.class), SMILE_MIME_TYPE))
                .isTrue();
        assertThat(decoder.canDecode(ResolvableType.forClass(Pojo.class), STREAM_SMILE_MIME_TYPE))
                .isTrue();
        ...
        assertThat(decoder.canDecode(ResolvableType.forClass(Pojo.class), APPLICATION_JSON))
                .isFalse();
    }
    ...
    public void decodeToMono() {
        ...
        Flux<DataBuffer> input =
                Flux.just(expected).map(this::writeObject).flatMap(this::dataBuffer);
