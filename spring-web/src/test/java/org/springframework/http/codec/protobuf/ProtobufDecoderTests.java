...
public class ProtobufDecoderTests extends AbstractDecoderTests<ProtobufDecoder> {
    ...
    public void canDecode() {
        ...
        assertThat(this.decoder.canDecode(forClass(Msg.class), MediaType.APPLICATION_OCTET_STREAM))
                .isTrue();
        assertThat(this.decoder.canDecode(forClass(Msg.class), MediaType.APPLICATION_JSON))
                .isFalse();
    ...
    public void decodeToMono() {
        ...
        testDecodeToMonoAll(
                input, Msg.class, step -> step.expectNext(this.testMsg1).verifyComplete());
    }
    ...
    public void decodeMergedChunks() throws IOException {
        ...
        Flux<Message> messages =
                this.decoder.decode(Mono.just(buffer), elementType, null, emptyMap());
