...
public class Jackson2TokenizerTests extends AbstractLeakCheckingTests {
    ...
    public void errorInStream() {
        ...
        Flux<TokenBuffer> result =
                Jackson2Tokenizer.tokenize(
                        source, this.jsonFactory, this.objectMapper, true, false, -1);
    ...
    public void jsonEOFExceptionIsWrappedAsDecodingError() {
        ...
        Flux<TokenBuffer> tokens =
                Jackson2Tokenizer.tokenize(
                        source, this.jsonFactory, this.objectMapper, false, false, -1);
                        ...
                        tokenBuffer -> {
                            try {
                                ...
                                if (useBigDecimalForFloats) {
                                    assertThat(numberType)
                                            .isEqualTo(JsonParser.NumberType.BIG_DECIMAL);
                                } else {
