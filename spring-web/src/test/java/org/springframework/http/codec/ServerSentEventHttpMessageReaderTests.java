...
public class ServerSentEventHttpMessageReaderTests extends AbstractLeakCheckingTests {
    ...
    private ServerSentEventHttpMessageReader reader =
            new ServerSentEventHttpMessageReader(this.jsonDecoder);
                ...
                this.reader
                        .read(
                                ResolvableType.forClassWithGenerics(
                                        ServerSentEvent.class, String.class),
                                request,
    ...
    public void readString() {
        ...
        Flux<String> data =
                reader.read(ResolvableType.forClass(String.class), request, Collections.emptyMap())
                        .cast(String.class);
    ...
    public void readPojo() {
        ...
        Flux<Pojo> data =
                reader.read(ResolvableType.forClass(Pojo.class), request, Collections.emptyMap())
                        .cast(Pojo.class);
    ...
    public void maxInMemoryLimitAllowsReadingPojoLargerThanDefaultSize() {
        ...
        MockServerHttpRequest request =
                MockServerHttpRequest.post("/").body(Mono.just(stringBuffer(content)));

        Jackson2JsonDecoder jacksonDecoder = new Jackson2JsonDecoder();
        ServerSentEventHttpMessageReader messageReader =
                new ServerSentEventHttpMessageReader(jacksonDecoder);
