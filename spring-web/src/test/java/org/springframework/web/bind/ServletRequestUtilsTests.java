...
class ServletRequestUtilsTests {
    ...
    void testFloatParameter() throws ServletRequestBindingException {
        ...
        assertThat(ServletRequestUtils.getRequiredFloatParameter(request, "param1") == 5.5f)
                .isTrue();
    ...
    void testDoubleParameter() throws ServletRequestBindingException {
        ...
        assertThat(
                        ServletRequestUtils.getDoubleParameter(request, "param1")
                                .equals(new Double(5.5)))
                .isTrue();
        assertThat(ServletRequestUtils.getDoubleParameter(request, "param1", 6.5) == 5.5).isTrue();
        assertThat(ServletRequestUtils.getRequiredDoubleParameter(request, "param1") == 5.5)
                .isTrue();
    ...
    void testBooleanParameter() throws ServletRequestBindingException {
        ...
        assertThat(ServletRequestUtils.getRequiredBooleanParameter(request, "paramEmpty"))
                .isFalse();
    }
    ...
    void testStringParameter() throws ServletRequestBindingException {
        ...
        assertThat(ServletRequestUtils.getStringParameter(request, "param1", "string"))
                .isEqualTo("str");
        assertThat(ServletRequestUtils.getRequiredStringParameter(request, "param1"))
                .isEqualTo("str");
