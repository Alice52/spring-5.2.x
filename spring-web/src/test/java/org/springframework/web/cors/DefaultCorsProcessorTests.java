...
public class DefaultCorsProcessorTests {
    ...
    public void actualRequestWithOriginHeaderAndAllowedOrigin() throws Exception {
        ...
        assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_EXPOSE_HEADERS))
                .isFalse();
        assertThat(this.response.getHeaders(HttpHeaders.VARY))
                .contains(
                        HttpHeaders.ORIGIN,
    ...
    public void actualRequestCredentials() throws Exception {
        ...
        assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_CREDENTIALS))
                .isTrue();
    ...
    public void preflightRequestWithEmptyHeaders() throws Exception {
        ...
        this.processor.processRequest(this.conf, this.request, this.response);
        assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN)).isTrue();
        assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS))
                .isFalse();
        assertThat(this.response.getHeaders(HttpHeaders.VARY))
                .contains(
                        HttpHeaders.ORIGIN,
