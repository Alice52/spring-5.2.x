...
public class CommonsMultipartResolverTests {
    ...
    private void doTestWithApplicationContext(boolean lazy) throws Exception {
        ...
        wac.getServletContext()
                .setAttribute(WebUtils.TEMP_DIR_CONTEXT_ATTRIBUTE, new File("mytemp"));
        wac.refresh();
    ...
    private void doTestBinding(
        ...
        binder.registerCustomEditor(
                String.class, "field2", new StringMultipartFileEditor("UTF-16"));
        binder.bind(request);
    ...
    public void withServletContextAndFilter() throws Exception {
        ...
        wac.registerSingleton(
                ...
                MockCommonsMultipartResolver.class,
