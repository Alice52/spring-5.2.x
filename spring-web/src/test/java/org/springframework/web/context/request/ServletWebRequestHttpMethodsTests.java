...
class ServletWebRequestHttpMethodsTests {
    ...
    private final ServletWebRequest request =
            new ServletWebRequest(servletRequest, servletResponse);
    ...
    void checkModifiedUnpaddedETag(String method) {
        ...
        assertThat(request.checkNotModified(currentETag)).isFalse();
        assertThat(servletResponse.getStatus()).isEqualTo(200);
        assertThat(servletResponse.getHeader("ETag"))
    ...
    void checkNotModifiedTimestampWithLengthPart(String method) {
        ...
        servletRequest.addHeader(
                "If-Modified-Since", "Wed, 09 Apr 2014 09:57:42 GMT; length=13774");

        assertThat(request.checkNotModified(epochTime)).isTrue();
        assertThat(servletResponse.getStatus()).isEqualTo(304);
        assertThat(servletResponse.getDateHeader("Last-Modified") / 1000)
                .isEqualTo(epochTime / 1000);
    }
    ...
    void checkModifiedTimestampWithLengthPart(String method) {
        ...
        servletRequest.setMethod("GET");
        servletRequest.addHeader(
                "If-Modified-Since", "Wed, 08 Apr 2014 09:57:42 GMT; length=13774");
