...
public class ServletWebRequestTests {
    ...
    public void nativeRequest() {
        ...
        assertThat(request.getNativeResponse(MockHttpServletResponse.class))
    ...
    public void decoratedNativeRequest() {
        ...
        assertThat(request.getNativeResponse(HttpServletResponse.class))
                .isSameAs(decoratedResponse);
        assertThat(request.getNativeResponse(MockHttpServletResponse.class))
                .isSameAs(servletResponse);
        assertThat(request.getNativeResponse(MultipartRequest.class)).isNull();
    }
