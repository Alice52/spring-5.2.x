...
public class PathPatternTests {
    ...
    public void pathRemainderBasicCases_spr15336() {
        ...
        assertThat(getPathRemaining("/{*bar}", "/foo/bar").getPathRemaining().value())
                .isEqualTo("");
        ...
        assertThat(getPathRemaining("/", "/a/").getPathRemaining().value()).isEqualTo("a/");
        assertThat(getPathRemaining("/a{abc}", "/a/bar").getPathRemaining().value())
                .isEqualTo("/bar");
        assertThat(getPathRemaining("/foo//", "/foo///bar").getPathRemaining().value())
                .isEqualTo("/bar");
    }
    ...
    public void encodingAndBoundVariablesCapturePathElement() {
        ...
        checkCapture(
                ...
                "f o",
                "var2",
                "f|o"); // lower case encoding
        checkCapture("{var:foo}", "foo", "var", "foo");
        checkCapture(
                "{var:f o}", "f%20o", "var", "f o"); // constraint is expressed in non encoded form
    ...
    public void encodingAndBoundVariablesRegexPathElement() {
        ...
        checkCapture(
                "/{var1:f o}_ _{var2:f\\|o}", "/f%20o_%20_f%7co", "var1", "f o", "var2", "f|o");
    }
    ...
    public void pathRemainingCornerCases_spr15336() {
        ...
        assertThat((Object) parse("/foo").matchStartOfPath(toPathContainer("/footastic/bar")))
                .isNull();
        assertThat((Object) parse("/f?o").matchStartOfPath(toPathContainer("/footastic/bar")))
                .isNull();
        ...
        assertThat(parse("/resource/{*foo}").matchStartOfPath(toPathContainer("/resourceX")))
                .isNull();
        assertThat(
                        parse("/resource/{*foo}")
                                .matchStartOfPath(toPathContainer("/resource"))
    ...
    public void extractPathWithinPattern() throws Exception {
        ...
        checkExtractPathWithinPattern(
                "/doo/{*foobar}", "/doo/daa/customer.html", "daa/customer.html");
        ...
        checkExtractPathWithinPattern("/docs/**", "/docs/cvs/commit/", "cvs/commit");
        checkExtractPathWithinPattern(
                "/docs/c?s/*.html", "/docs/cvs/commit.html", "cvs/commit.html");
        checkExtractPathWithinPattern(
    ...
    public void combineWithTwoFileExtensionPatterns() {
        TestPathCombiner pathMatcher = new TestPathCombiner();
        assertThatIllegalArgumentException()
                .isThrownBy(() -> pathMatcher.combine("/*.html", "/*.txt"));
    }
    ...
    public void patternComparator() {
        ...
        assertThat(comparator.compare(parse("/hotels/new"), parse("/hotels/{hotel}")))
                .isEqualTo(-1);
        assertThat(comparator.compare(parse("/hotels/{hotel}"), parse("/hotels/new"))).isEqualTo(1);
        assertThat(comparator.compare(parse("/hotels/{hotel}"), parse("/hotels/{hotel}")))
                .isEqualTo(0);
        assertThat(
                        comparator.compare(
    ...
    public void patternComparatorSort() {
        ...
        comparator =
                (p1, p2) -> {
                    ...
                    return (index != 0
                            ? index
                            : p1.getPatternString().compareTo(p2.getPatternString()));
                };
