...
public class SessionAttributesHandlerTests {
    ...
    public void isSessionAttribute() throws Exception {
        assertThat(sessionAttributesHandler.isHandlerSessionAttribute("attr1", String.class))
                .isTrue();
        assertThat(sessionAttributesHandler.isHandlerSessionAttribute("attr2", String.class))
                .isTrue();
    ...
    public void retrieveAttributes() throws Exception {
        ...
        assertThat(sessionAttributesHandler.retrieveAttributes(request).keySet())
                .as(
                        "Named attributes (attr1, attr2) and resolved attribute (att3) should be 'known'")
