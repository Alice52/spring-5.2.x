...
class RestTemplateIntegrationTests extends AbstractMockWebServerTests {
     ...
     *
     * <p>If the test method throws an {@link HttpServerErrorException}, this extension will throw
     * an {@link AssertionError} that wraps the {@code HttpServerErrorException} using the {@link
    ...
    void patchForObject(ClientHttpRequestFactory clientHttpRequestFactory) throws Exception {
        ...
        String s =
                template.patchForObject(baseUrl + "/{method}", helloWorld, String.class, "patch");
        assertThat(s).as("Invalid content").isEqualTo(helloWorld);
    }
    ...
    void notFound(ClientHttpRequestFactory clientHttpRequestFactory) {
        ...
        assertThatExceptionOfType(HttpClientErrorException.class)
                .isThrownBy(
                        () ->
                                template.execute(
                                        baseUrl + "/status/notfound", HttpMethod.GET, null, null))
                .satisfies(
                        ex -> {
    ...
    void badRequest(ClientHttpRequestFactory clientHttpRequestFactory) {
        ...
        assertThatExceptionOfType(HttpClientErrorException.class)
                .isThrownBy(
                        () ->
                                template.execute(
                                        baseUrl + "/status/badrequest", HttpMethod.GET, null, null))
                .satisfies(
                        ex -> {
    ...
    void serverError(ClientHttpRequestFactory clientHttpRequestFactory) {
        ...
        assertThatExceptionOfType(HttpServerErrorException.class)
                .isThrownBy(
                        () ->
                                template.execute(
                                        baseUrl + "/status/server", HttpMethod.GET, null, null))
                .satisfies(
                        ex -> {
    ...
    void uri(ClientHttpRequestFactory clientHttpRequestFactory) throws Exception {
        ...
        String result =
                template.getForObject(baseUrl + "/uri/{query}", String.class, "Z\u00fcrich");
        ...
        result =
                template.getForObject(
                        baseUrl + "/uri/query={query}", String.class, "T\u014dky\u014d");
