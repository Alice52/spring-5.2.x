...
public class MockRequestDispatcher implements RequestDispatcher {
     ...
     *
     * @param resource the server resource to dispatch to, located at a particular path or given by
     *     a particular name
     */
    ...
    public void forward(ServletRequest request, ServletResponse response) {
        ...
        Assert.state(
                !response.isCommitted(), "Cannot perform forward - response is already committed");
