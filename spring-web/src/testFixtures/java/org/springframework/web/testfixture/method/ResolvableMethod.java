...
public class ResolvableMethod {
     ...
     * org.springframework.web.testfixture.method.MvcAnnotationPredicates}.
     */
    @SafeVarargs
    ...
    public static class Builder<T> {
        ...
        public Builder<T> returning(ResolvableType returnType) {
            ...
            addFilter(
                    message,
                    m -> expected.equals(ResolvableType.forMethodReturnType(m).toString()));
            return this;
        }

        /**
         * Build a {@code ResolvableMethod} from the provided filters which must resolve to a
         * unique, single method.
         *
         * <p>See additional resolveXxx shortcut methods going directly to {@link Method} or return
         * type parameter.
         *
    ...
    public class ArgResolver {
        ...
        public final ArgResolver annotPresent(Class<? extends Annotation>... annotationTypes) {
            this.filters.add(
                    param ->
                            Arrays.stream(annotationTypes).allMatch(param::hasParameterAnnotation));
            return this;
        }
            ...
            this.filters.add(
                    param ->
                            (annotationTypes.length > 0
                                    ? Arrays.stream(annotationTypes)
                                            .noneMatch(param::hasParameterAnnotation)
