...
public class HibernateEntityManagerFactoryIntegrationTests
    ...
    public void testCanCastSharedEntityManagerProxyToHibernateEntityManager() {
        boolean condition1 =
                sharedEntityManager instanceof org.hibernate.jpa.HibernateEntityManager;
        assertThat(condition1).isTrue();
        // as of Hibernate 5.2
        boolean condition =
                ((EntityManagerProxy) sharedEntityManager).getTargetEntityManager()
                        instanceof Session;
        assertThat(condition).isTrue();
    }
    ...
    public void testCanUnwrapAopProxy() {
        ...
        EntityManager proxy =
                ProxyFactory.getProxy(EntityManager.class, new SingletonTargetSource(em));
