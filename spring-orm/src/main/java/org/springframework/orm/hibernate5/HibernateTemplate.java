...
public class HibernateTemplate implements HibernateOperations, InitializingBean {
    ...
    /**
     * Set one or more names of Hibernate filters to be activated for all Sessions that this
     * accessor works with.
     *
     * <p>Each of those filters will be enabled at the beginning of each operation and
     * correspondingly disabled at the end of the operation. This will work for newly opened
     * Sessions as well as for existing Sessions (for example, within a transaction).
     *
     ...
     *
     * <p>If this is "true", all Query and Criteria objects created by this template will be marked
     * as cacheable (including all queries through find methods).
     *
     ...
     *
     * <p>The cache region will not take effect unless queries created by this template are
     ...
     * sets: Setting this higher than the default value will increase processing speed at the cost
     * of memory consumption; setting this lower can avoid transferring row data that will never be
                                ...
                                session -> {
                                    ...
                                    for (int i = 0; i < values.length; i++) {
                                        applyNamedParameterToQuery(
                                                queryObject, paramNames[i], values[i]);
                                    }
                                    return queryObject.list();
                                }));
    }
    ...
    public List<?> findByNamedQueryAndNamedParam(String queryName, String paramName, Object value)
        ...
        return findByNamedQueryAndNamedParam(
                queryName, new String[] {paramName}, new Object[] {value});
    }
    ...
    public List<?> findByNamedQueryAndNamedParam(
            ...
            @Nullable final String[] paramNames,
    ...
    protected void applyNamedParameterToQuery(
            org.hibernate.Query queryObject, String paramName, Object value)
