...
public class JpaTransactionManager extends AbstractPlatformTransactionManager
     ...
     * resolving it by its persistence unit name instead. If no EntityManagerFactory and no
     * persistence unit name have been specified, a default EntityManagerFactory will be retrieved
     * by finding a single unique bean of type EntityManagerFactory.
     *
     * @see #setEntityManagerFactory
     */
    ...
    /**
     * Specify JPA properties, to be passed into {@code
     ...
     * DataSource will be autodetected: You can still explicitly specify the DataSource, but you
     ...
     * be taken from the JPA EntityManager.
     *
     ...
     *
     * <p>If the EntityManagerFactory uses a known JpaDialect, it will be autodetected: You can
     * still explicitly specify the DataSource, but you don't need to in this case.
     *
    ...
    /**
     * Retrieves an EntityManagerFactory by persistence unit name, if none set explicitly. Falls
     * back to a default EntityManagerFactory bean if no persistence unit specified.
     *
     * @see #setPersistenceUnitName
     */
    @Override
        ...
        try {
            ...
            if (getDataSource() != null) {
                ConnectionHandle conHandle =
                        getJpaDialect().getJdbcConnection(em, definition.isReadOnly());
                if (conHandle != null) {
    ...
    /**
     * Close the current transaction's EntityManager. Called after a transaction begin attempt
     * failed.
     *
    ...
    protected Object doSuspend(Object transaction) {
        ...
        if (getDataSource() != null
                && TransactionSynchronizationManager.hasResource(getDataSource())) {
            connectionHolder =
                    (ConnectionHolder)
    ...
    private class JpaTransactionObject extends JdbcTransactionObjectSupport {
        ...
        public boolean hasTransaction() {
            return (this.entityManagerHolder != null
                    && this.entityManagerHolder.isTransactionActive());
        }
