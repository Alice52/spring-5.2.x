...
public abstract class SharedEntityManagerCreator {
     ...
     *
     * @param emf the EntityManagerFactory to delegate to.
     * @param properties the properties to be passed into the {@code createEntityManager} call (may
     *     be {@code null})
     * @return a shareable transaction EntityManager proxy
     */
    ...
    /**
     * Invocation handler that delegates all calls to the current transactional EntityManager, if
     * any; else, it will fall back to a newly created EntityManager per operation.
     */
    ...
    private static class SharedEntityManagerInvocationHandler
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (method.getName().equals("equals")) {
                ...
                // JPA 2.0: return EntityManagerFactory's CriteriaBuilder/Metamodel (avoid creation
                // of EntityManager)
                try {
                    return EntityManagerFactory.class
                            .getMethod(method.getName())
                            .invoke(this.targetFactory);
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                if (this.entityManager == null) {
                    ...
                    if (this.outputParameters == null || !this.outputParameters.containsKey(key)) {
                        throw new IllegalArgumentException(
                                "OUT/INOUT parameter not available: " + key);
                    }
            ...
            try {
                ...
                if (queryTerminatingMethods.contains(method.getName())) {
                    ...
                    if (this.outputParameters != null
                            && this.target instanceof StoredProcedureQuery) {
                        ...
                        for (Map.Entry<Object, Object> entry : this.outputParameters.entrySet()) {
                            try {
                                ...
                                if (key instanceof Integer) {
                                    entry.setValue(
                                            storedProc.getOutputParameterValue((Integer) key));
                                } else {
                                    entry.setValue(
                                            storedProc.getOutputParameterValue(key.toString()));
                                }
