            ...
            interfaces =
                    cachedEntityManagerInterfaces.computeIfAbsent(
                            ...
                            key -> {
                                Set<Class<?>> ifcs =
                                        new LinkedHashSet<>(
                                                ClassUtils.getAllInterfacesForClassAsSet(key, cl));
                                ifcs.add(EntityManagerProxy.class);
                                return ClassUtils.toClassArray(ifcs);
                            });
        }
    ...
    private static final class ExtendedEntityManagerInvocationHandler
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (method.getName().equals("equals")) {
                ...
                if (synch != null) {
                    // Local transaction joined - don't actually call close() before transaction
                    // completion
         ...
         *
         * @param enforce whether to enforce the transaction (i.e. whether failure to join is
         *     considered fatal)
         */
