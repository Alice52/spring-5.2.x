...
public class TransactionAspectTests {
    ...
    public void defaultCommitOnAnnotatedClass() throws Throwable {
        ...
        assertThatExceptionOfType(Exception.class)
                .isThrownBy(
                        () ->
                                testRollback(
                                        () -> annotationOnlyOnClassWithNoInterface.echo(ex), false))
                .isSameAs(ex);
    }
    ...
    public void defaultRollbackOnAnnotatedClass() throws Throwable {
        ...
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(
                        () ->
                                testRollback(
                                        () -> annotationOnlyOnClassWithNoInterface.echo(ex), true))
                .isSameAs(ex);
    }
        ...
        assertThatExceptionOfType(Exception.class)
                .isThrownBy(
                        () ->
                                testRollback(
                                        () ->
                                                new SubclassOfClassWithTransactionalAnnotation()
                                                        .echo(ex),
                                        false))
                .isSameAs(ex);
    }
    ...
    protected void testRollback(TransactionOperationCallback toc, boolean rollback)
            throws Throwable {
        txManager.clear();
        assertThat(txManager.begun).isEqualTo(0);
        try {
