    ...
    */
    ...
    public void qualifiedAsyncMethodsAreRoutedToCorrectExecutor()
        ...
        beanFactory.registerBeanDefinition(
                "e1", new RootBeanDefinition(ThreadPoolTaskExecutor.class));
    ...
    public void exceptionHandlerCalled() {
        ...
        try {
            assertThat(exceptionHandler.isCalled())
                    .as("Handler should not have been called")
                    .isFalse();
        ...
        public synchronized void waitForCompletion() {
            try {
                ...
                throw new AssertionError(
                        "Didn't finish the async job in " + WAIT_TIME + " milliseconds");
            }
        }
    }
    ...
    static class ClassWithoutAsyncAnnotation {
        ...
        /**
         * It should raise an error to attach @Async to a method that returns a non-void or
         * non-Future. This method must remain commented-out, otherwise there will be a compile-time
         * error. Uncomment to manually verify that the compiler produces an error message due to
         * the 'declare error' statement in {@link AnnotationAsyncExecutionAspect}.
         */
