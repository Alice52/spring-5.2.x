...
/**
 * Copy of the shared {@code AbstractCacheAnnotationTests}: necessary due to issues with Gradle test
...
public abstract class AbstractCacheAnnotationTests {
    ...
    protected void testRootVars(CacheableService<?> service) {
        ...
        // assert the method name is used
        String expectedKey =
                "rootVarsrootVars" + AopProxyUtils.ultimateTargetClass(service) + service;
