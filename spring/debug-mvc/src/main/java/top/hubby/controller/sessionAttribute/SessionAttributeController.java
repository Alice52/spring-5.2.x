package top.hubby.controller.sessionAttribute;
...
public class SessionAttributeController {
    ...
    @RequestMapping("/get")
    public String getBySessionAttributes(
            @ModelAttribute("book") String book, ModelMap model, SessionStatus sessionStatus) {
