...
public abstract class AbstractIdentityColumnMaxValueIncrementer
     ...
     * - the default), or the specifically generated values ({@code true}). The former mode will use
     * a where range clause whereas the latter will use an in clause starting with the lowest value
     ...
     *
     * <p>The default implementation either deletes the entire range below the current maximum
     * value, or the specifically generated values (starting with the lowest minus 1, just
     * preserving the maximum value) - according to the {@link #isDeleteSpecificValues()} setting.
     *
