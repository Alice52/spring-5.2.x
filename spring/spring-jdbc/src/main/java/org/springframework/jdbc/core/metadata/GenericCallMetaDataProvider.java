...
public class GenericCallMetaDataProvider implements CallMetaDataProvider {
    ...
    @Override
    public SqlParameter createDefaultOutParameter(
    ...
    private void processProcedureColumns(
        ...
        try {
            ...
            if (found.isEmpty()) {
                ...
                try (ResultSet functions =
                    ...
                    while (functions.next()) {
                        found.add(
                                functions.getString("FUNCTION_CAT")
                                        + '.'
            ...
            if (logger.isDebugEnabled()) {
                logger.debug(
                        "Retrieving column meta-data for "
            ...
            if (logger.isWarnEnabled()) {
                logger.warn(
                        "Error while retrieving meta-data for procedure columns. "
