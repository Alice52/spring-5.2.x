...
public class EmbeddedDatabaseBuilder {
     ...
     *
     * <p>If the configuration for this builder is reused across multiple application contexts
     * within a single JVM, this flag should be <em>enabled</em> (i.e., set to {@code true}) in
     * order to ensure that each application context gets its own embedded database.
     *
    ...
    /**
     * Set the factory to use to create the {@link DataSource} instance that connects to the
     * embedded database.
     *
     ...
     * may be set to {@link ScriptUtils#EOF_STATEMENT_SEPARATOR} to signal that each script contains
     * a single statement without a separator.
     *
     ...
     */
    public EmbeddedDatabaseBuilder setBlockCommentStartDelimiter(
     ...
     *
     * <p>This is useful for a database whose SQL dialect does not support an {@code IF EXISTS}
     * clause in a {@code DROP} statement.
     *
