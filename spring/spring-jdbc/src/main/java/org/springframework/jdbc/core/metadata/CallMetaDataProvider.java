...
public interface CallMetaDataProvider {
    ...
    /**
     * Initialize the database specific management of procedure column meta-data. This is only
     * called for databases that are supported. This initialization can be turned off by specifying
     * that column meta-data should not be used.
     *
     * @param databaseMetaData used to retrieve database specific information
    ...
    /**
     * Provide any modification of the procedure name passed in to match the meta-data currently
     * used. This could include altering the case.
     */
    @Nullable
    ...
    /**
     * Create a default in/out parameter based on the provided meta-data. This is used when no
