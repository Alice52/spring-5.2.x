...
public class SingleConnectionDataSource extends DriverManagerDataSource
     ...
     * Returns the single Connection if given the same username and password; throws an SQLException
     * else.
     */
    @Override
    ...
    public void initConnection() throws SQLException {
        ...
        synchronized (this.connectionMonitor) {
            ...
            this.connection =
                    (isSuppressClose()
                            ? getCloseSuppressingConnectionProxy(this.target)
                            : this.target);
        }
    }
     ...
     *
     * <p>The default implementation applies the auto-commit flag, if necessary. Can be overridden
     * in subclasses.
     *
