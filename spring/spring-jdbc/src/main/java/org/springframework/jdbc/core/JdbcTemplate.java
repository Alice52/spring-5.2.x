...
public class JdbcTemplate extends JdbcAccessor implements JdbcOperations {
     ...
     * a corresponding SqlOutParameter declaration will be bypassed. All other results processing
     * will be take place unless the variable {@code skipResultsProcessing} is set to {@code true}.
     */
     ...
     *
     * <p>Default is "true", swallowing and logging all warnings. Switch this flag to "false" to
     * make the JdbcTemplate throw an SQLWarningException instead.
     *
     ...
     *
     * <p>Default is -1, indicating to use the JDBC driver's default configuration (i.e. to not pass
     * a specific fetch size setting on to the driver).
     *
     * <p>Note: As of 4.3, negative values other than -1 will get passed on to the driver, since
     * e.g. MySQL supports special behavior for {@code Integer.MIN_VALUE}.
     *
     ...
     *
     * <p>Default is -1, indicating to use the JDBC driver's default configuration (i.e. to not pass
     * a specific max rows setting on to the driver).
     *
     ...
     * method.
     *
     * <p>The proxy also prepares returned JDBC Statements, applying statement settings such as
     ...
     *     {@code null}, the SQL will be assumed to contain no bind parameters.
    ...
    @Override
    public void query(String sql, @Nullable Object[] args, RowCallbackHandler rch)
            throws DataAccessException {
    ...
    public <T> T queryForObject(String sql, Object[] args, int[] argTypes, RowMapper<T> rowMapper)
        ...
        List<T> results =
                query(sql, args, argTypes, new RowMapperResultSetExtractor<>(rowMapper, 1));
        return DataAccessUtils.nullableSingleResult(results);
    }
                                ...
                                ps -> {
                                    ...
                                    try {
                                        boolean batchSupported =
                                                JdbcUtils.supportsBatchUpdates(ps.getConnection());
                                        int n = 0;
                                        for (T obj : batchArgs) {
     ...
     * LinkedCaseInsensitiveMap} will be created; otherwise, a {@link LinkedHashMap} will be
     * created.
     *
     ...
     *
     * <p>By default, we'll create an {@link ArgumentPreparedStatementSetter}. This method allows
     ...
     *
     * <p>By default, we'll create an {@link ArgumentTypePreparedStatementSetter}. This method
