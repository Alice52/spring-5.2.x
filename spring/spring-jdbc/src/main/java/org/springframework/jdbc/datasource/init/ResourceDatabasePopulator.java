...
public class ResourceDatabasePopulator implements DatabasePopulator {
     ...
     *
     * @param continueOnError flag to indicate that all failures in SQL should be logged but not
     *     cause a failure
     ...
     *
     * @param sqlScriptEncoding the encoding used in scripts (may be {@code null} or empty to
     ...
     * <p>Defaults to {@code "/*"}.
     *
     * @param blockCommentStartDelimiter the start delimiter for block comments (never {@code null}
     *     or empty)
     * @since 4.0.3
