...
public final class CallMetaDataProviderFactory {
    ...
    public static final List<String> supportedDatabaseProductsForFunctions =
            Arrays.asList("MariaDB", "Microsoft SQL Server", "MySQL", "Oracle", "PostgreSQL");
            ...
            return JdbcUtils.extractDatabaseMetaData(
                    ...
                    databaseMetaData -> {
                        ...
                        if (context.isFunction()) {
                            if (!supportedDatabaseProductsForFunctions.contains(
                                    databaseProductName)) {
                            ...
                            if (!supportedDatabaseProductsForProcedures.contains(
                                    databaseProductName)) {
                                if (logger.isInfoEnabled()) {
                                    logger.info(
                                            databaseProductName
