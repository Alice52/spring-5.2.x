...
public class MapDataSourceLookup implements DataSourceLookup {
     ...
     *
     * <p>The returned {@link Map} is {@link Collections#unmodifiableMap(java.util.Map)
     * unmodifiable}.
     *
    ...
    /**
     * Set the {@link Map} of {@link DataSource DataSources}; the keys are {@link String Strings},
     * the values are actual {@link DataSource} instances.
     *
    ...
    /**
     * Add the supplied {@link DataSource} to the map of {@link DataSource DataSources} maintained
     * by this object.
     *
     * @param dataSourceName the name under which the supplied {@link DataSource} is to be added
