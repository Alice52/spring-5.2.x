...
public class BeanPropertyRowMapper<T> implements RowMapper<T> {
     ...
     *
     * @param mappedClass the class that each row should be mapped to
     * @param conversionService the {@link ConversionService} for binding JDBC values to bean
    ...
    /**
     * Return a {@link ConversionService} for binding JDBC values to bean properties, or {@code
     * null} if none.
     *
     * @since 4.3
     */
    ...
    /**
     * Set a {@link ConversionService} for binding JDBC values to bean properties, or {@code null}
     * for none.
     *
    ...
    /**
     * Convert the given name to lower case. By default, conversions will happen within the US
     * locale.
     *
     * @param name the original name
     * @return the converted name
    ...
    public T mapRow(ResultSet rs, int rowNumber) throws SQLException {
        ...
        for (int index = 1; index <= columnCount; index++) {
            ...
            PropertyDescriptor pd =
                    (this.mappedFields != null ? this.mappedFields.get(field) : null);
            if (pd != null) {
                try {
     ...
     *
     * <p>The default implementation applies the configured {@link ConversionService}, if any. Can
     ...
     * int, Class)}. Subclasses may override this to check specific value types upfront, or to
