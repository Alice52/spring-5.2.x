...
public abstract class NamedParameterUtils {
    ...
    /**
     * Set of characters that qualify as parameter separators, indicating that a parameter name in
     * an SQL String has ended.
     */
    private static final String PARAMETER_SEPARATORS = "\"':&,;()|=+-*%/\\<>^";

    /**
     * An index with separator flags per character code. Technically only needed between 34 and 124
     * at this point.
     */
     ...
     * will be grouped and enclosed with parentheses. This allows for the use of "expression lists"
     * in the SQL statement like: <br>
     * <br>
     * {@code select id, name, state from table where (name, age) in (('John', 35), ('Ann', 50))}
     *
     * <p>The parameter values passed in are used to determine the number of placeholders to be used
     * for a select list. Select lists should be limited to 100 or fewer elements. A larger number
     * of elements is not guaranteed to be supported by the database and is strictly
     * vendor-dependent.
     *
     ...
     * substituted for a JDBC placeholder.
     *
     * <p>This is a shortcut version of {@link #parseSqlStatement(String)} in combination with
