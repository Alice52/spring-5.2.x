...
public abstract class SqlOperation extends RdbmsOperation {
    ...
    protected final void compileInternal() {
        ...
        if (getGeneratedKeysColumnNames() != null) {
            this.preparedStatementFactory.setGeneratedKeysColumnNames(
    ...
    /**
     * Hook method that subclasses may override to post-process compilation. This implementation
     * does nothing.
     *
     * @see #compileInternal
     */
    ...
    protected final PreparedStatementSetter newPreparedStatementSetter(@Nullable Object[] params) {
        Assert.state(
                this.preparedStatementFactory != null, "No PreparedStatementFactory available");
