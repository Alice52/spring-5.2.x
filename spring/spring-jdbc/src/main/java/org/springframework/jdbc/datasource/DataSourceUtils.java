...
public abstract class DataSourceUtils {
     ...
     * hierarchy of unchecked generic data access exceptions, simplifying calling code and making
     * any exception that is thrown more meaningful.
     *
    ...
    public static Connection doGetConnection(DataSource dataSource) throws SQLException {
        ...
        if (TransactionSynchronizationManager.isSynchronizationActive()) {
            try {
                ...
                // Unexpected exception from external delegation call -> close Connection and
                // rethrow.
            ...
            try {
                ...
                while (exToCheck != null) {
                    if (exToCheck.getClass().getSimpleName().contains("Timeout")) {
                        // Assume it's a connection timeout that would otherwise get lost: e.g. from
                        // JDBC 4.0
                        throw ex;
                    }
     ...
     *
     * <p>Reset the given Connection after a transaction, regarding read-only flag and isolation
     * level.
     *
     ...
     * @param con the Connection to reset
     * @param previousIsolationLevel the isolation level to restore, if any
     * @deprecated as of 5.1.11, in favor of {@link #resetConnectionAfterTransaction(Connection,
     *     Integer, boolean)}
     */
    @Deprecated
    public static void resetConnectionAfterTransaction(
     ...
     * 释放连接
     *
     * <p>Close the given Connection, obtained from the given DataSource, if it is not managed
     ...
     * 获取连接持有器，释放连接，然后关闭连接
     *
     * <p>Actually close the given Connection, obtained from the given DataSource. Same as {@link
     ...
     *
     * <p>Close the Connection, unless a {@link SmartDataSource} doesn't want us to.
     *
    ...
    /**
     * Determine whether the given two Connections are equal, asking the target Connection in case
     * of a proxy. Used to detect equality even if the user passed in a raw target Connection while
     * the held one is a proxy.
     *
     ...
     * every level of nesting that a DataSource has, checked through the level of
     * DelegatingDataSource nesting.
     *
