...
public abstract class AbstractRoutingDataSource extends AbstractDataSource
     ...
     * (to be resolved via a {@link #setDataSourceLookup DataSourceLookup}).
     *
     * <p>The key can be of arbitrary type; this class implements the generic lookup process only.
     * The concrete key representation will be handled by {@link #resolveSpecifiedLookupKey(Object)}
     ...
     * DataSource could be found for the current lookup key.
     *
     ...
     *
     * <p>Switch this flag to "false" if you would prefer the fallback to only apply if the lookup
     * key was {@code null}. Lookup keys without a DataSource entry will then lead to an
     ...
     *
     * @param dataSource the data source value object as specified in the {@link
     *     #setTargetDataSources targetDataSources} map
     ...
     * map, falls back to the specified {@link #setDefaultTargetDataSource default target
