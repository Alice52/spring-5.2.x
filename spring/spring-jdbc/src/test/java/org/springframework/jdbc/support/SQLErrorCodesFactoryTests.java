...
public class SQLErrorCodesFactoryTests {
    ...
    private void assertIsSQLServer(SQLErrorCodes sec) {
        ...
        assertThat(Arrays.binarySearch(sec.getDataAccessResourceFailureCodes(), "4060") >= 0)
                .isTrue();
    ...
    private void assertIsHana(SQLErrorCodes sec) {
        ...
        assertThat(Arrays.binarySearch(sec.getDataAccessResourceFailureCodes(), "-813") >= 0)
                .isTrue();
        ...
        assertThat(Arrays.binarySearch(sec.getCannotSerializeTransactionCodes(), "138") >= 0)
                .isTrue();
    ...
    public void testLookupOrder() {
        ...
        assertThat(sf.getErrorCodes("Oracle").getDataIntegrityViolationCodes().length == 0)
                .isTrue();
    }
            ...
            protected Resource loadResource(String path) {
                if (SQLErrorCodesFactory.SQL_ERROR_CODE_OVERRIDE_PATH.equals(path)) {
                    return new ClassPathResource(
                            "test-error-codes.xml", SQLErrorCodesFactoryTests.class);
                }
                return null;
            }
        }
    ...
    public void testFindCustomCodes() {
        class TestSQLErrorCodesFactory extends SQLErrorCodesFactory {
            ...
            protected Resource loadResource(String path) {
                if (SQLErrorCodesFactory.SQL_ERROR_CODE_OVERRIDE_PATH.equals(path)) {
                    return new ClassPathResource(
                            "custom-error-codes.xml", SQLErrorCodesFactoryTests.class);
                }
                return null;
            }
        }
    ...
    private SQLErrorCodes getErrorCodesFromDataSource(
        ...
        SQLErrorCodesFactory secf =
                (factory != null ? factory : SQLErrorCodesFactory.getInstance());
    ...
    public void testWildCardNameRecognized() throws Exception {
        class WildcardSQLErrorCodesFactory extends SQLErrorCodesFactory {
            ...
            protected Resource loadResource(String path) {
                if (SQLErrorCodesFactory.SQL_ERROR_CODE_OVERRIDE_PATH.equals(path)) {
                    return new ClassPathResource(
                            "wildcard-error-codes.xml", SQLErrorCodesFactoryTests.class);
                }
                return null;
            }
        }
