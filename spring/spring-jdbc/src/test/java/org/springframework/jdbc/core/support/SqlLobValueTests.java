...
class SqlLobValueTests {
    ...
    void test3() throws SQLException {
        SqlLobValue lob =
                new SqlLobValue(
                        new InputStreamReader(new ByteArrayInputStream("Bla".getBytes())), 12);
    ...
    void test5() throws Exception {
        ...
        verify(creator)
                .setClobAsAsciiStream(
                        eq(preparedStatement), eq(1), inputStreamCaptor.capture(), eq(3));
    ...
    void testOtherConstructors() throws SQLException {
        ...
        SqlLobValue lob3 =
                new SqlLobValue(
                        new InputStreamReader(new ByteArrayInputStream("bla".getBytes())), 3);
        assertThatIllegalArgumentException()
