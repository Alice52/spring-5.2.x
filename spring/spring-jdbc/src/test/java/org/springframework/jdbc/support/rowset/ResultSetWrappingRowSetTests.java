...
public class ResultSetWrappingRowSetTests {
    ...
    public void testGetBigDecimalInt() throws Exception {
        ...
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getBigDecimal", int.class);
    ...
    public void testGetStringString() throws Exception {
        Method rset = ResultSet.class.getDeclaredMethod("getString", int.class);
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getString", String.class);
    ...
    public void testGetTimestampInt() throws Exception {
        ...
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getTimestamp", int.class);
    ...
    public void testGetObjectString() throws Exception {
        Method rset = ResultSet.class.getDeclaredMethod("getObject", int.class);
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getObject", String.class);
    ...
    public void testGetFloatString() throws Exception {
        Method rset = ResultSet.class.getDeclaredMethod("getFloat", int.class);
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getFloat", String.class);
    ...
    public void testGetDoubleString() throws Exception {
        Method rset = ResultSet.class.getDeclaredMethod("getDouble", int.class);
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getDouble", String.class);
    ...
    public void testGetBooleanString() throws Exception {
        Method rset = ResultSet.class.getDeclaredMethod("getBoolean", int.class);
        Method rowset =
                ResultSetWrappingSqlRowSet.class.getDeclaredMethod("getBoolean", String.class);
    ...
    private void doTest(Method rsetMethod, Method rowsetMethod, Object arg, Object ret)
        ...
        if (arg instanceof String) {
            ...
            given(rsetMethod.invoke(resultSet, 1))
                    .willReturn(ret)
                    .willThrow(new SQLException("test"));
        } else {
            given(rsetMethod.invoke(resultSet, arg))
                    .willReturn(ret)
                    .willThrow(new SQLException("test"));
        }
