...
class SimpleJdbcCallTests {
    ...
    void noSuchStoredProcedure() throws Exception {
        ...
        given(connection.prepareCall("{call " + NO_SUCH_PROC + "()}"))
    ...
    /**
     * This test demonstrates that a CALL statement will still be generated if an exception occurs
     * while retrieving metadata, potentially resulting in missing metadata and consequently a
     * failure while invoking the stored procedure.
     */
    @Test // gh-26486
    void exceptionThrownWhileRetrievingColumnNamesFromMetadata() throws Exception {
        ...
        given(databaseMetaData.getProcedures("", "ME", "ADD_INVOICE"))
                .willReturn(proceduresResultSet);
