...
public class JdbcTemplateTests {
    ...
    public void testSqlUpdate() throws Exception {
        ...
        assertThat(actualRowsAffected == rowsAffected)
                .as("Actual rows affected is correct")
                .isTrue();
    ...
    public void testSqlUpdateWithArguments() throws Exception {
        final String sql =
                "UPDATE NOSUCHTABLE SET DATE_DISPATCHED = SYSDATE WHERE ID = ? and PR = ?";
        int rowsAffected = 33;
        ...
        given(this.statement.executeBatch())
                .willThrow(
                        new BatchUpdateException(
                                new int[] {
                                    1, Statement.EXECUTE_FAILED, 1, Statement.EXECUTE_FAILED
                                }));
        mockDatabaseMetaData(true);
        given(this.connection.createStatement()).willReturn(this.statement);
    ...
    public void testCouldNotGetConnectionForOperationWithLazyExceptionTranslator()
        ...
        assertThatExceptionOfType(CannotGetJdbcConnectionException.class)
                .isThrownBy(
                        () ->
                                this.template.query(
                                        "SELECT ID, FORENAME FROM CUSTMR WHERE ID < 3", rcch))
                .withCause(sqlException);
    }
    ...
    private void doTestCouldNotGetConnectionInOperationWithExceptionTranslatorInitialized(
        ...
        if (beanProperty) {
            ...
            this.template.setExceptionTranslator(
    ...
    public void testPreparedStatementSetterSucceeds() throws Exception {
        ...
        assertThat(expectedRowsUpdated)
                .as("updated correct # of rows")
                .isEqualTo(actualRowsUpdated);
