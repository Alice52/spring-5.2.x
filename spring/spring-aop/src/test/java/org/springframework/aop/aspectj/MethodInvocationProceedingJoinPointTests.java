        ...
        pf.addAdvice(
                (MethodBeforeAdvice)
                        (method, args, target) -> {
                            ...
                            assertThat(AbstractAspectJAdvice.currentJoinPoint().getTarget())
                                    .isSameAs(target);
                            assertThat(
                                            AopUtils.isAopProxy(
                            ...
                            ITestBean thisProxy =
                                    (ITestBean) AbstractAspectJAdvice.currentJoinPoint().getThis();
                            assertThat(
                                            AopUtils.isAopProxy(
                                                    AbstractAspectJAdvice.currentJoinPoint()
                                                            .getThis()))
                            ...
                            assertThat(AbstractAspectJAdvice.currentJoinPoint().getThis())
                                    .isSameAs(thisProxy);
                            ...
                            assertThat(msig.getDeclaringType())
                                    .isEqualTo(method.getDeclaringClass());
                            assertThat(
                                            Arrays.equals(
                ...
                (MethodBeforeAdvice)
                        (method, args, target) -> {
                            ...
                            assertThat(AbstractAspectJAdvice.currentJoinPoint().getSourceLocation())
                                    .as(
                                            "Same source location must be returned on subsequent requests")
                                    .isEqualTo(sloc);
                ...
                (MethodBeforeAdvice)
                        (method, args, target) -> {
                            StaticPart staticPart =
                                    AbstractAspectJAdvice.currentJoinPoint().getStaticPart();
                            ...
                            assertThat(staticPart.getKind())
                                    .isEqualTo(ProceedingJoinPoint.METHOD_EXECUTION);
        ...
        pf.addAdvice(
                (MethodBeforeAdvice)
                        (method, args, target) -> {
                            ...
                            assertThat(jp.toLongString())
                                    .isEqualTo(aspectJVersionJp.toLongString());
                            assertThat(jp.toShortString())
                                    .isEqualTo(aspectJVersionJp.toShortString());
