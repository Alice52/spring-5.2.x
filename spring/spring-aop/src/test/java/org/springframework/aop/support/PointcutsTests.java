...
public class PointcutsTests {
    ...
    public void testTrue() {
        ...
        assertThat(Pointcuts.matches(Pointcut.TRUE, TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isTrue();
        assertThat(Pointcuts.matches(Pointcut.TRUE, TEST_BEAN_SET_AGE, TestBean.class, 6)).isTrue();
        assertThat(Pointcuts.matches(Pointcut.TRUE, TEST_BEAN_GET_AGE, TestBean.class)).isTrue();
        assertThat(Pointcuts.matches(Pointcut.TRUE, TEST_BEAN_ABSQUATULATE, TestBean.class))
    ...
    public void testMatches() {
        ...
        assertThat(
                        Pointcuts.matches(
                                allClassSetterPointcut, TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isFalse();
        assertThat(Pointcuts.matches(allClassGetterPointcut, TEST_BEAN_SET_AGE, TestBean.class, 6))
                .isFalse();
        assertThat(Pointcuts.matches(allClassGetterPointcut, TEST_BEAN_GET_AGE, TestBean.class))
                .isTrue();
        assertThat(
                        Pointcuts.matches(
                                allClassGetterPointcut, TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isFalse();
    }
    ...
    /**
     * Tests vertical composition. First pointcut matches all setters. Second one matches all
     * getters in the MyTestBean class. TestBean getters shouldn't pass.
     */
    @Test
    public void testUnionOfAllSettersAndSubclassSetters() {
        assertThat(
                        Pointcuts.matches(
                                myTestBeanSetterPointcut, TEST_BEAN_SET_AGE, TestBean.class, 6))
                .isFalse();
        assertThat(
                        Pointcuts.matches(
                                myTestBeanSetterPointcut, TEST_BEAN_SET_AGE, MyTestBean.class, 6))
                .isTrue();
    ...
    /**
     * Intersection should be MyTestBean getAge() only: it's the union of allClassGetAge and
     * subclass getters
     */
    @Test
    public void testIntersectionOfSpecificGettersAndSubclassGetters() {
        ...
        assertThat(
                        Pointcuts.matches(
                                myTestBeanGetterPointcut, TEST_BEAN_GET_NAME, MyTestBean.class))
                .isTrue();
        ...
        // Still matches subclass of MyTestBean
        assertThat(Pointcuts.matches(union, TEST_BEAN_GET_NAME, MyTestBeanSubclass.class))
                .isFalse();
    ...
    public void testSimpleIntersection() {
        Pointcut intersection =
                Pointcuts.intersection(allClassGetterPointcut, allClassSetterPointcut);
        assertThat(Pointcuts.matches(intersection, TEST_BEAN_SET_AGE, TestBean.class, 6)).isFalse();
        assertThat(Pointcuts.matches(intersection, TEST_BEAN_GET_AGE, TestBean.class)).isFalse();
        assertThat(Pointcuts.matches(intersection, TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isFalse();
    }
