...
public class AspectProxyFactoryTests {
    ...
    public void testWithNonAspect() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> proxyFactory.addAspect(TestBean.class));
    }
    ...
    public void testWithSimpleAspect() throws Exception {
        ...
        assertThat(proxy.getAge())
                .as("Multiplication did not occur")
                .isEqualTo((bean.getAge() * 2));
    }
    ...
    public void testWithInstance() throws Exception {
        ...
        ITestBean serializedProxy =
                (ITestBean) SerializationTestUtils.serializeAndDeserialize(proxy);
