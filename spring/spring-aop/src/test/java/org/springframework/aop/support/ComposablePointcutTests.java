...
public class ComposablePointcutTests {
    ...
    public void testMatchAll() throws NoSuchMethodException {
        ...
        assertThat(
                        pc.getMethodMatcher()
                                .matches(Object.class.getMethod("hashCode"), Exception.class))
                .isTrue();
    }
    ...
    public void testUnionMethodMatcher() {
        ...
        assertThat(Pointcuts.matches(pc, PointcutsTests.TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isFalse();
        assertThat(Pointcuts.matches(pc, PointcutsTests.TEST_BEAN_GET_AGE, TestBean.class))
                .isTrue();
        assertThat(Pointcuts.matches(pc, PointcutsTests.TEST_BEAN_GET_NAME, TestBean.class))
                .isFalse();
        ...
        assertThat(Pointcuts.matches(pc, PointcutsTests.TEST_BEAN_SET_AGE, TestBean.class))
                .isFalse();
    }
    ...
    public void testIntersectionMethodMatcher() {
        ...
        assertThat(
                        pc.getMethodMatcher()
                                .matches(PointcutsTests.TEST_BEAN_ABSQUATULATE, TestBean.class))
                .isTrue();
