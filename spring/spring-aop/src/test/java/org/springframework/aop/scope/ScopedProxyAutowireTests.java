...
public class ScopedProxyAutowireTests {
    ...
    public void testScopedProxyInheritsAutowireCandidateFalse() {
        ...
        new XmlBeanDefinitionReader(bf)
                .loadBeanDefinitions(
                        qualifiedResource(
                                ScopedProxyAutowireTests.class, "scopedAutowireFalse.xml"));

        assertThat(
                        Arrays.asList(bf.getBeanNamesForType(TestBean.class, false, false))
                                .contains("scoped"))
                .isTrue();
        assertThat(
                        Arrays.asList(bf.getBeanNamesForType(TestBean.class, true, false))
                                .contains("scoped"))
                .isTrue();
    ...
    public void testScopedProxyReplacesAutowireCandidateTrue() {
        ...
        new XmlBeanDefinitionReader(bf)
                .loadBeanDefinitions(
                        qualifiedResource(
                                ScopedProxyAutowireTests.class, "scopedAutowireTrue.xml"));
