...
public abstract class AopUtils {
     ...
     * org.springframework.util.ClassUtils#getMostSpecificMethod}, this method resolves Java 5
     * bridge methods in order to retrieve attributes from the <i>original</i> method definition.
     *
    ...
    public static boolean canApply(
            Advisor advisor, Class<?> targetClass, boolean hasIntroductions) {
     ...
     *
     * <p>Determine the sublist of the {@code candidateAdvisors} list that is applicable to the
     * given class.
     *
