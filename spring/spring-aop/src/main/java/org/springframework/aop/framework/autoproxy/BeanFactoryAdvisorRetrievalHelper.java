...
public class BeanFactoryAdvisorRetrievalHelper {
     ...
     *
     * <p>Find all eligible Advisor beans in the current bean factory, ignoring FactoryBeans and
                    ...
                    try {
                        ...
                        if (rootCause instanceof BeanCurrentlyInCreationException) {
                            ...
                            if (bceBeanName != null
                                ...
                                // Ignore: indicates a reference back to the bean we're trying to
                                // advise.
                                // We want to find advisors other than the currently created bean
                                // itself.
                                continue;
                            }
                        }
