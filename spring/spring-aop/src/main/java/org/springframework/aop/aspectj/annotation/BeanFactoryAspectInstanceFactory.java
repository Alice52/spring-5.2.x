...
public class BeanFactoryAspectInstanceFactory
     ...
     * create AJType metadata. Use if the BeanFactory may consider the type to be a subclass (as
     * when using CGLIB), and the information should relate to a superclass.
     *
     * @param beanFactory the BeanFactory to obtain instance(s) from
     * @param name the name of the bean
    ...
    public BeanFactoryAspectInstanceFactory(
        ...
        if (type == null) {
            ...
            Assert.notNull(
                    resolvedType, "Unresolvable bean type - explicitly specify the aspect class");
        }
