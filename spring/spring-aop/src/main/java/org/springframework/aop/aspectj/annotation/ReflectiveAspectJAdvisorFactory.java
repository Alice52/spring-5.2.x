 ...
 *
 * <p>Factory that can create Spring AOP Advisors given AspectJ classes from classes honoring
 * AspectJ's annotation syntax, using reflection to invoke the corresponding advice methods.
 *
 * @author Rod Johnson
...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory
    ...
    /**
     * Create a new {@code ReflectiveAspectJAdvisorFactory}, propagating the given {@link
     * BeanFactory} to the created {@link AspectJExpressionPointcut} instances, for bean pointcut
     * handling as well as consistent {@link ClassLoader} resolution.
     *
    ...
    public List<Advisor> getAdvisors(MetadataAwareAspectInstanceFactory aspectInstanceFactory) {
        ...
        for (Method method : getAdvisorMethods(aspectClass)) {
            ...
            // discovered via reflection in order to support reliable advice ordering across JVM
            // launches.
    ...
    /**
     * 获取所有不包含Pointcut注解的方法，然后进行排序，根据对应的顺序Around.class, Before.class, After.class,
