...
public abstract class AbstractRegexpMethodPointcut extends StaticMethodMatcherPointcut
    ...
    /**
     * Set the regular expressions defining methods to match. Matching will be the union of all
    ...
    /**
     * Set the regular expressions defining methods to match for exclusion. Matching will be the
     * union of all these; if any match, the pointcut matches.
     *
