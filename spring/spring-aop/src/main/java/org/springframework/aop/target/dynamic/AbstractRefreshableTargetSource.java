 ...
 *
 * <p>Abstract {@link org.springframework.aop.TargetSource} implementation that wraps a refreshable
...
public abstract class AbstractRefreshableTargetSource implements TargetSource, Refreshable {
     ...
     * checks at all.
     *
     * <p>Note that an actual refresh will only happen when {@link #requiresRefresh()} returns
     * {@code true}.
     */
     ...
     *
     * <p>The default implementation always returns {@code true}, triggering a refresh every time
     * the delay has elapsed. To be overridden by subclasses with an appropriate check of the
