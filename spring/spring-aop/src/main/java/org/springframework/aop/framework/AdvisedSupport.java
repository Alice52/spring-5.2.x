...
public class AdvisedSupport extends ProxyConfig implements Advised {
     ...
     * class.
     *
     * <p>Internally, an {@link org.springframework.aop.target.EmptyTargetSource} for the given
     * target class will be used. The kind of proxy needed will be determined on actual creation of
     * the proxy.
     *
     * <p>This is a replacement for setting a "targetSource" or "target", for the case where we want
     * a proxy based on a target class (which can be an interface or a concrete class) without
     * having a fully capable TargetSource available.
     *
     * @see #setTargetSource
     * @see #setTarget
     */
    ...
    AdvisedSupport getConfigurationOnlyCopy() {
        ...
        copy.copyFrom(this);
        copy.targetSource =
                EmptyTargetSource.forClass(getTargetClass(), getTargetSource().isStatic());
    ...
    private static final class MethodCacheKey implements Comparable<MethodCacheKey> {
        ...
        public boolean equals(@Nullable Object other) {
            return (this == other
                    || (other instanceof MethodCacheKey
