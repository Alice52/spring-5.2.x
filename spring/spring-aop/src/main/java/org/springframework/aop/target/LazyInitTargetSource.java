...
/**
 * AbstractBeanFactoryBasedTargetSource的子类。 从BeanFactory中获取单例Bean。支持延迟初始化。
 *
 * <p>{@link org.springframework.aop.TargetSource} that lazily accesses a singleton bean from a
...
public class LazyInitTargetSource extends AbstractBeanFactoryBasedTargetSource {
    ...
    /**
     * Subclasses may override this method to perform additional processing on the target object
