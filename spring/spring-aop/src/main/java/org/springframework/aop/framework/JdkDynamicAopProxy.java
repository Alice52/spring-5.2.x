 ...
 *
 * <p>JDK-based {@link AopProxy} implementation for the Spring AOP framework, based on JDK {@link
...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
     ...
     *
     * <p>Callers will see exactly the exception thrown by the target, unless a hook method throws
     * an exception.
     */
    @Override
    @Nullable
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
             ...
             * 比如在目标对象方法中再次获取代理对象可以使用这个AopContext.currentProxy() 还有的就是事务方法调用事务方法的时候也是用到这个
             */
     ...
     *
     * <p>The compared object may be a JdkDynamicAopProxy instance itself or a dynamic proxy
