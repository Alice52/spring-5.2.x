...
class RuntimeTestWalker {
    ...
    public boolean testsSubtypeSensitiveVars() {
        return (this.runtimeTest != null
                && new SubtypeSensitiveVarTypeTestVisitor()
                        .testsSubtypeSensitiveVars(this.runtimeTest));
    }

    public boolean testThisInstanceOfResidue(Class<?> thisClass) {
        return (this.runtimeTest != null
                && new ThisInstanceOfResidueTestVisitor(thisClass)
                        .thisInstanceOfMatches(this.runtimeTest));
    }
    ...
    private abstract static class InstanceOfResidueTestVisitor extends TestVisitorAdapter {
        ...
        public void visit(Instanceof i) {
            ...
            try {
                ...
                if (typeClass == null) {
                    typeClass =
                            ClassUtils.forName(type.getName(), this.matchClass.getClassLoader());
                }
    ...
    private static class SubtypeSensitiveVarTypeTestVisitor extends TestVisitorAdapter {
        ...
        public void visit(Instanceof i) {
            ...
            Object varUnderTest =
                    v.getBindingAtJoinPoint(this.thisObj, this.targetObj, this.argsObjs);
