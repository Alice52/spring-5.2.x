...
public class CommonsPool2TargetSource extends AbstractPoolingTargetSource
    ...
    /**
     * Create a CommonsPoolTargetSource with default settings. Default maximum size of the pool is
     * 8.
     *
     * @see #setMaxSize
    ...
    /**
     * Set the time between eviction runs that check idle objects whether they have been idle for
     * too long or have become invalid. Default is -1, not performing any eviction.
     *
    ...
    /**
     * Subclasses can override this if they want to return a specific Commons pool. They should
     * apply any configuration properties to the pool here.
     *
