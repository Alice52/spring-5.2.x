...
public class CustomizableTraceInterceptor extends AbstractTraceInterceptor {
    ...
    /**
     * The {@code $[returnValue]} placeholder. Replaced with the {@code String} representation of
     * the value returned by the method invocation.
     */
    public static final String PLACEHOLDER_RETURN_VALUE = "$[returnValue]";

    /**
     * The {@code $[argumentTypes]} placeholder. Replaced with a comma-separated list of the
     * argument types for the method invocation. Argument types are written as short class names.
     */
     ...
     * exitMessage}. If an exception occurs during invocation, then a message is written based on
     * the value of {@code exceptionMessage}.
     *
     * @see #setEnterMessage
     * @see #setExitMessage
     * @see #setExceptionMessage
    ...
    /**
     * Replace the placeholders in the given message with the supplied values, or values derived
     * from those supplied.
     *
    ...
    protected String replacePlaceholders(
        ...
        while (matcher.find()) {
            ...
            if (PLACEHOLDER_METHOD_NAME.equals(match)) {
                ...
                String shortName =
                        ClassUtils.getShortName(getClassForLogging(methodInvocation.getThis()));
     ...
     *
     * @param methodInvocation the {@code MethodInvocation} being logged. Arguments will be
     *     retrieved from the corresponding {@code Method}.
    ...
    private void appendArgumentTypes(
        ...
        matcher.appendReplacement(
                output,
                Matcher.quoteReplacement(
                        StringUtils.arrayToCommaDelimitedString(argumentTypeShortNames)));
    }
