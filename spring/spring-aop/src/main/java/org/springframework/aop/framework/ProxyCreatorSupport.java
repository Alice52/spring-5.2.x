...
public class ProxyCreatorSupport extends AdvisedSupport {
    ...
    /**
     * Customize the AopProxyFactory, allowing different strategies to be dropped in without
     * changing the core framework.
     *
     * <p>Default is {@link DefaultAopProxyFactory}, using dynamic JDK proxies or CGLIB proxies
