 ...
 * AOP命名空间解析工具类
 *
 * <p>Utility class for handling registration of auto-proxy creators used internally by the '{@code
 * aop}' namespace tags.
 *
        ...
        if (beanDefinition != null) {
            parserContext.registerComponent(
                    new BeanComponentDefinition(
                            beanDefinition, AopConfigUtils.AUTO_PROXY_CREATOR_BEAN_NAME));
        }
    }
}
