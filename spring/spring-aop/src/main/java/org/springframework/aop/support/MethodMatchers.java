...
public abstract class MethodMatchers {
    ...
    private static class UnionIntroductionAwareMethodMatcher extends UnionMethodMatcher
        ...
        public boolean matches(Method method, Class<?> targetClass, boolean hasIntroductions) {
            return (matchesClass1(targetClass)
                            && MethodMatchers.matches(
                                    this.mm1, method, targetClass, hasIntroductions))
                    || (matchesClass2(targetClass)
                            && MethodMatchers.matches(
                                    this.mm2, method, targetClass, hasIntroductions));
        }
    }
    ...
    /**
     * MethodMatcher implementation for an intersection of two given MethodMatchers of which at
