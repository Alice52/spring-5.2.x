 ...
 *
 * <p>All methods return {@code ComposablePointcut}, so we can use concise idioms like in the
 * following example.
 *
...
public class ComposablePointcut implements Pointcut, Serializable {
     ...
     *
     * <p>Note that for a Pointcut union, methods will only match if their original ClassFilter
     * (from the originating Pointcut) matches as well. MethodMatchers and ClassFilters from
     * different Pointcuts will never get interleaved with each other.
     *
    ...
    public ComposablePointcut intersection(Pointcut other) {
        ...
        this.methodMatcher =
                MethodMatchers.intersection(this.methodMatcher, other.getMethodMatcher());
        return this;
    }
