...
public class JdkRegexpMethodPointcut extends AbstractRegexpMethodPointcut {
    ...
    /**
     * Returns {@code true} if the {@link Pattern} at index {@code patternIndex} matches the
    ...
    /**
     * Returns {@code true} if the exclusion {@link Pattern} at index {@code patternIndex} matches
