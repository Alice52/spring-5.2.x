...
public class AspectJAfterThrowingAdvice extends AbstractAspectJAdvice
    ...
    /**
     * In AspectJ semantics, after throwing advice that specifies a throwing clause is only invoked
     * if the thrown exception is a subtype of the given throwing type.
     */
