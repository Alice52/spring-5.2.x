...
public class AnnotationAwareAspectJAutoProxyCreator extends AspectJAwareAdvisorAutoProxyCreator {
    ...
    protected void initBeanFactory(ConfigurableListableBeanFactory beanFactory) {
        ...
        this.aspectJAdvisorsBuilder =
                new BeanFactoryAspectJAdvisorsBuilderAdapter(
     ...
     *
     * <p>If no &lt;aop:include&gt; elements were used then "includePatterns" will be {@code null}
     * and all beans are included. If "includePatterns" is non-null, then one of the patterns must
     * match.
     */
