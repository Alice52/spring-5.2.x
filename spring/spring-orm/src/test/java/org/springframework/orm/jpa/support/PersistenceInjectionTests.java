    ...
    public void testPrivateVendorSpecificPersistenceContextField() {
        ...
        DefaultVendorSpecificPrivatePersistenceContextField bean =
                (DefaultVendorSpecificPrivatePersistenceContextField)
                        gac.getBean(
                                DefaultVendorSpecificPrivatePersistenceContextField.class
                                        .getName());
        assertThat(bean.em).isNotNull();
    }
                ...
                .isThrownBy(
                        () ->
                                pabpp.postProcessProperties(
                                        null,
                                        new FieldOfWrongTypeAnnotatedWithPersistenceUnit(),
                                        "bean"));
    }
        ...
        assertThatIllegalStateException()
                .isThrownBy(
                        () ->
                                pabpp.postProcessProperties(
                                        null,
                                        new SetterOfWrongTypeAnnotatedWithPersistenceUnit(),
                                        "bean"));
    }
