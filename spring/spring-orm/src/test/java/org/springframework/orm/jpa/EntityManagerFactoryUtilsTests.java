...
public class EntityManagerFactoryUtilsTests {
    ...
    public void testTranslatesIllegalStateException() {
        ...
        DataAccessException dex =
                EntityManagerFactoryUtils.convertJpaAccessExceptionIfPossible(ise);
    ...
    public void testTranslatesIllegalArgumentException() {
        ...
        DataAccessException dex =
                EntityManagerFactoryUtils.convertJpaAccessExceptionIfPossible(iae);
    ...
    public void testConvertJpaPersistenceException() {
        ...
        assertThat(
                        EntityManagerFactoryUtils.convertJpaAccessExceptionIfPossible(noResult)
                                .getClass())
        ...
        assertThat(
                        EntityManagerFactoryUtils.convertJpaAccessExceptionIfPossible(entityExists)
                                .getClass())
        ...
        assertThat(
                        EntityManagerFactoryUtils.convertJpaAccessExceptionIfPossible(unknown)
                                .getClass())
