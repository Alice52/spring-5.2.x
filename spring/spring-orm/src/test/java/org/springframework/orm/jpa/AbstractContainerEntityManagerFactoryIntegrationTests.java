...
public abstract class AbstractContainerEntityManagerFactoryIntegrationTests
    ...
    public void testEntityManagerProxyIsProxy() {
        ...
        assertThat(sharedEntityManager.isOpen())
                .as("Close should have been silently ignored")
                .isTrue();
    }
        ...
        try {
            ...
            Person newTony =
                    entityManagerFactory
                            .createEntityManager()
                            .getReference(Person.class, tony.getId());
    ...
    public void testCanSerializeProxies() throws Exception {
        assertThat(SerializationTestUtils.serializeAndDeserialize(entityManagerFactory))
                .isNotNull();
