...
public class HibernateNativeEntityManagerFactorySpringBeanContainerIntegrationTests
    ...
    public void testCanRetrieveBeanByTypeWithNativeOptions() {
        ...
        // Due to the lifecycle options, and because the bean has the "prototype" scope, we should
    ...
    /**
     * The lifecycle options used by libraries integrating into Hibernate ORM and that want a
     * behavior closer to Spring's native behavior, such as Hibernate Search.
     */
