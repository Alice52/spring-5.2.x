...
public class PersistenceXmlParsingTests {
    ...
    public void testExampleComplex() throws Exception {
        ...
        assertThat(pu1.getJarFileUrls().get(0))
                .isEqualTo(new ClassPathResource("order.jar").getURL());

        assertThat(pu1.excludeUnlistedClasses()).isFalse();

        assertThat(pu1.getTransactionType())
                .isSameAs(PersistenceUnitTransactionType.RESOURCE_LOCAL);
    ...
    public void testPersistenceUnitRootUrl() throws Exception {
        ...
        url =
                PersistenceUnitReader.determinePersistenceUnitRootUrl(
                        new ClassPathResource(
                                "/org/springframework/orm/jpa/META-INF/persistence.xml"));
    ...
    public void testJpa1ExcludeUnlisted() throws Exception {
        ...
        assertThat(emptyExclude.excludeUnlistedClasses())
                .as("emptyExclude should be true.")
                .isTrue();
        ...
        assertThat(falseExclude.excludeUnlistedClasses())
                .as("falseExclude should be false.")
                .isFalse();
    }
