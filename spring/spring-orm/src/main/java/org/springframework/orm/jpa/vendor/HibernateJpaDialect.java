 ...
 * Developed against Hibernate 5.1/5.2/5.3/5.4.
 *
...
public class HibernateJpaDialect extends DefaultJpaDialect {
     ...
     * JDBCException}, overriding Hibernate's own {@code SQLException} translation (which is based
     * on a Hibernate Dialect for a specific target database).
     *
     * @since 5.1
    ...
    private static class HibernateConnectionHandle implements ConnectionHandle {
        ...
        public static Connection doGetConnection(Session session) {
            try {
                ...
                if (methodToUse == null) {
                    // Reflective lookup to find SessionImpl's connection() method on Hibernate
                    // 4.x/5.x
                ...
                throw new IllegalStateException(
                        "Cannot find connection() method on Hibernate Session", ex);
            }
        }
