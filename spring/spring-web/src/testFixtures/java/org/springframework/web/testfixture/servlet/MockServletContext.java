...
public class MockServletContext implements ServletContext {
    ...
    /**
     * Create a new {@code MockServletContext}, using no base path and a {@link
    ...
    /**
     * Create a new {@code MockServletContext}, using the specified {@link ResourceLoader} and no
     * base path.
     *
        ...
        Assert.isTrue(
                ...
                () ->
                        "RequestDispatcher path ["
                                + path
                                + "] at ServletContext level must start with '/'");
    ...
    /**
     * Register a {@link RequestDispatcher} (typically a {@link MockRequestDispatcher}) that acts as
     ...
     *
     * @param defaultServletName the name of the <em>default</em> {@code Servlet}; never {@code
     *     null} or empty
