...
public class CommonsMultipartFile implements MultipartFile, Serializable {
    ...
    /**
     * Return the underlying {@code org.apache.commons.fileupload.FileItem} instance. There is
     ...
     *
     * <p>Default is "false", stripping off path information that may prefix the actual filename
     * e.g. from Opera. Switch this to "true" for preserving the client-specified filename as-is,
     * including potential path separators.
     *
     * @since 4.3.5
    ...
    /**
     * Determine whether the multipart content is still available. If a temporary file has been
     * moved, the content is no longer available.
     */
    ...
    /**
     * Return a description for the storage location of the multipart content. Tries to be as
     * specific as possible: mentions the file location in case of a temporary file.
     */
    public String getStorageDescription() {
        if (this.fileItem.isInMemory()) {
            ...
            return "at ["
                    + ((DiskFileItem) this.fileItem).getStoreLocation().getAbsolutePath()
                    + "]";
        } else {
            return "on disk";
        }
