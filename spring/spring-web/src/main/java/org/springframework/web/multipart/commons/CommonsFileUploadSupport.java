...
public abstract class CommonsFileUploadSupport {
    ...
    /**
     * Set the maximum allowed size (in bytes) before uploads are written to disk. Uploaded files
     * will still be received past this amount, but they will not be stored in memory. Default is
     * 10240, according to Commons FileUpload.
     *
     ...
     *
     * <p>Default implementation returns the shared FileUpload instance if the encoding matches,
     * else creates a new FileUpload instance with the same configuration other than the desired
     * encoding.
     *
