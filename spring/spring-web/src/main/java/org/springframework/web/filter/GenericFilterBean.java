...
public abstract class GenericFilterBean
     ...
     * property they expose) is mandatory, and must be supplied as a config parameter. This should
     * be called from the constructor of a subclass.
     *
     * <p>This method is only relevant in case of traditional initialization driven by a
     ...
     *
     * <p>Note: This method will be called from standard filter initialization as well as filter
     * bean initialization in a Spring application context. Filter name and ServletContext will be
     ...
     *
     * <p>Only relevant in case of initialization as bean, to have a ServletContext as fallback to
     * the context usually provided by a FilterConfig instance.
     *
