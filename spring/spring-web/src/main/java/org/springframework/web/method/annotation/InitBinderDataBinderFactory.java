...
public class InitBinderDataBinderFactory extends DefaultDataBinderFactory {
     ...
     *
     * <p>If the {@code @InitBinder} annotation specifies attributes names, it is invoked only if
     * the names include the target object name.
     *
     ...
     * 判断指定的方式是否需要进行初始化操作
     *
     * <p>Determine whether the given {@code @InitBinder} method should be used to initialize the
     * given {@link WebDataBinder} instance. By default we check the specified attribute names in
