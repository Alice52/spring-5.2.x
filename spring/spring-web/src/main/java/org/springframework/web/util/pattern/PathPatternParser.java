...
public class PathPatternParser {
    ...
    /**
     * Whether a {@link PathPattern} produced by this parser should automatically match request
     ...
     * paths.
     *
     * <p>{@link org.springframework.http.server.PathContainer.Options#HTTP_PATH} is used by
     * default.
     *
     * @since 5.2
     */
    ...
    /**
     * Process the path pattern content, a character at a time, breaking it into path elements
     * around separator boundaries and verifying the structure at each stage. Produces a PathPattern
     * object that can be used for fast matching against paths. Each invocation of this method
     * delegates to a new instance of the {@link InternalPathPatternParser} because that class is
     * not thread-safe.
     *
