 ...
 *
 * <p>Resolves method arguments annotated with {@code @Value}.
 *
...
public class ExpressionValueMethodArgumentResolver
    ...
    protected Object resolveName(
            String name, MethodParameter parameter, NativeWebRequest webRequest) throws Exception {
        // No name to resolve
        return null;
    }
    ...
    protected void handleMissingValue(String name, MethodParameter parameter)
        ...
        throw new UnsupportedOperationException(
                "@Value is never required: " + parameter.getMethod());
    }
