...
public class ModelAttributeMethodProcessor
     ...
     *
     * <p>The default implementation typically uses the unique public no-arg constructor if
     * available but also handles a "primary constructor" approach for data classes: It understands
     * the JavaBeans {@link ConstructorProperties} annotation as well as runtime-retained parameter
    ...
    protected Object constructAttribute(
        ...
        for (int i = 0; i < paramNames.length; i++) {
            ...
            try {
                ...
                binder.getBindingErrorProcessor()
            ...
            for (int i = 0; i < paramNames.length; i++) {
                ...
                if (!failedParams.contains(paramName)) {
                    ...
                    validateValueIfApplicable(
                            binder, parameter, ctor.getDeclaringClass(), paramName, value);
                }
            }
     ...
     * org.springframework.validation.annotation.Validated}, and custom annotations whose name
     * starts with "Valid".
     *
