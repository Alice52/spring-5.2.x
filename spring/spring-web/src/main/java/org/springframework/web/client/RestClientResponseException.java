...
public class RestClientResponseException extends RestClientException {
    ...
    /**
     * Return the response body converted to String. The charset used is that of the response
     * "Content-Type" or otherwise {@code "UTF-8"}.
     */
    ...
    /**
     * Return the response body converted to String. The charset used is that of the response
     * "Content-Type" or otherwise the one given.
     *
