...
public class UrlPathHelper {
    ...
    /**
     * Whether URL lookups should always use the full path within the current web application
     * context, i.e. within {@link javax.servlet.ServletContext#getContextPath()}.
     *
    ...
    /**
     * Set the default character encoding to use for URL decoding. Default is ISO-8859-1, according
     * to the Servlet spec.
     *
     ...
     * the HttpServletRequest are stripped of semicolon content unlike the requestUri.
     */
    @Nullable
     ...
     * within a RequestDispatcher include.
     *
     * <p>As the value returned by {@code request.getServletPath()} is already decoded by the
     ...
     *
     * <p>The default implementation checks the request encoding, falling back to the default
    ...
    /**
     * Decode the given matrix variables via {@link #decodeRequestString} unless {@link
     * #setUrlDecode} is set to {@code true} in which case it is assumed the URL path from which the
     * variables were extracted is already decoded through a call to {@link
     * #getLookupPathForRequest(HttpServletRequest)}.
     *
