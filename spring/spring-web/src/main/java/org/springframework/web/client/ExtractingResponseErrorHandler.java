...
public class ExtractingResponseErrorHandler extends DefaultResponseErrorHandler {
    ...
    /**
     * Create a new {@code ExtractingResponseErrorHandler} with the given {@link
    ...
    /**
     * Set the mapping from HTTP status code to {@code RestClientException} subclass. If this
    ...
    private void extract(
            @Nullable Class<? extends RestClientException> exceptionClass,
