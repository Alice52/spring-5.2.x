...
public class AsyncRestTemplate
     ...
     *
     * <p>This constructor uses a {@link SimpleClientHttpRequestFactory} in combination with a
     * {@link SimpleAsyncTaskExecutor} for asynchronous execution.
     */
     ...
     * AsyncTaskExecutor}.
     *
     * <p>This constructor uses a {@link SimpleClientHttpRequestFactory} in combination with the
     * given {@code AsyncTaskExecutor} for asynchronous execution.
     */
     ...
     * org.springframework.http.client.AsyncClientHttpRequestFactory}.
     *
     * <p>This constructor will cast the given asynchronous {@code AsyncClientHttpRequestFactory} to
     * a {@link ClientHttpRequestFactory}. Since all implementations of {@code
     * ClientHttpRequestFactory} provided in Spring also implement {@code
     * AsyncClientHttpRequestFactory}, this should not result in a {@code ClassCastException}.
     */
    public AsyncRestTemplate(
    ...
    private static ListenableFuture<URI> adaptToLocationHeader(
    ...
    public ListenableFuture<URI> postForLocation(
            String url, @Nullable HttpEntity<?> request, Object... uriVars)
            throws RestClientException {
    ...
    @Override
    public <T> ListenableFuture<ResponseEntity<T>> postForEntity(
            URI url, @Nullable HttpEntity<?> request, Class<T> responseType)
            throws RestClientException {
     ...
     * @param responseExtractor object that extracts the return value from the response (can be
     *     {@code null})
    ...
    private static class AsyncRequestCallbackAdapter implements AsyncRequestCallback {
        ...
        public void doWithRequest(
                final org.springframework.http.client.AsyncClientHttpRequest request)
                throws IOException {
    ...
    private class ResponseExtractorFuture<T>
        ...
        protected T convertResponse(ClientHttpResponse response) throws IOException {
            return (this.responseExtractor != null
                    ? this.responseExtractor.extractData(response)
                    : null);
        }
    }
}
