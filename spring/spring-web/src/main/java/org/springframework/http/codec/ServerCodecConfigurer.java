...
public interface ServerCodecConfigurer extends CodecConfigurer {
     ...
     * {@inheritDoc}
     *
     * <p>On the server side, built-in default also include customizations related to the encoder
     * for SSE.
     */
    @Override
    ...
    interface ServerDefaultCodecs extends DefaultCodecs {
         ...
         *
         * <p>By default, if <a href="https://github.com/synchronoss/nio-multipart">Synchronoss NIO
         * Multipart</a> is present, this is set to {@link
         * org.springframework.http.codec.multipart.MultipartHttpMessageReader
         * MultipartHttpMessageReader} created with an instance of {@link
         * org.springframework.http.codec.multipart.SynchronossPartHttpMessageReader
         * SynchronossPartHttpMessageReader}.
         *
         * <p>Note that {@link #maxInMemorySize(int)} and/or {@link
         * #enableLoggingRequestDetails(boolean)}, if configured, will be applied to the given
         ...
         * #jackson2JsonEncoder} override is used instead. Use this method to customize the SSE
         * encoder.
         */
