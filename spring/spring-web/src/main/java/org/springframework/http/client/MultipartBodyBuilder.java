...
/**
 * Prepare the body of a multipart request, resulting in a {@code MultiValueMap<String,
 * HttpEntity>}. Parts may be concrete values or via asynchronous types such as Reactor {@code
 * Mono}, {@code Flux}, and others registered in the {@link
 * org.springframework.core.ReactiveAdapterRegistry ReactiveAdapterRegistry}.
 *
 * <p>This builder is intended for use with the reactive {@link
 * org.springframework.web.reactive.function.client.WebClient WebClient}. For multipart requests
 * with the {@code RestTemplate}, simply create and populate a {@code MultiValueMap<String,
 * HttpEntity>} as shown in the Javadoc for {@link
 * org.springframework.http.converter.FormHttpMessageConverter FormHttpMessageConverter} and in the
 * <a
 * href="https://docs.spring.io/spring/docs/current/spring-framework-reference/integration.html#rest-template-multipart">reference
 * docs</a>.
 *
...
public final class MultipartBodyBuilder {
    ...
    private final LinkedMultiValueMap<String, DefaultPartBuilder> parts =
    ...
    public interface PartBuilder {
         ...
         * org.springframework.core.io.Resource Resource} based parts that expose a filename but may
         * be useful for {@link Publisher} parts.
         *
    ...
    private static class DefaultPartBuilder implements PartBuilder {
        ...
        public DefaultPartBuilder(
                String name, @Nullable HttpHeaders headers, @Nullable Object body) {
            this.name = name;
    ...
    /**
     * Specialization of {@link HttpEntity} for use with a {@link Publisher}-based body, for which
     * we also need to keep track of the element type.
     *
