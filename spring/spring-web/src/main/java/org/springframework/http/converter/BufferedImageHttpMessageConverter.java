...
public class BufferedImageHttpMessageConverter implements HttpMessageConverter<BufferedImage> {
    ...
    /**
     * Returns the default {@code Content-Type} to be used for writing. Called when {@link #write}
    ...
    /**
     * Sets the cache directory. If this property is set to an existing directory, this converter
    ...
    private boolean isWritable(@Nullable MediaType mediaType) {
        ...
        Iterator<ImageWriter> imageWriters =
                ImageIO.getImageWritersByMIMEType(mediaType.toString());
        ...
        try {
            ...
            if (imageWriters.hasNext()) {
                ...
                throw new HttpMessageNotWritableException(
                        "Could not find javax.imageio.ImageWriter for Content-Type ["
                                + contentType
                                + "]");
            }
        } finally {
