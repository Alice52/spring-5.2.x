...
public interface PathContainer {
    ...
    /**
     * Extract a sub-path from the given start offset into the element list (inclusive) and to the
    ...
    class Options {
         ...
         *     parameters. If set to false, only escape sequences for the separator char are
         *     decoded.
         */
