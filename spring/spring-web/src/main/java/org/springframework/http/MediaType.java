...
public class MediaType extends MimeType implements Serializable {
     ...
     *     <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464">now comply with
     *     the specification</a> and interpret correctly UTF-8 special characters without requiring
     ...
     *     Chrome <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464">now comply
     ...
     * @see <a href="https://tools.ietf.org/html/rfc7807#section-6.1">Problem Details for HTTP APIs,
     *     6.1. application/problem+json</a>
     * @deprecated as of 5.2 in favor of {@link #APPLICATION_PROBLEM_JSON} since major browsers like
     *     Chrome <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=438464">now comply
     *     with the specification</a> and interpret correctly UTF-8 special characters without
     *     requiring a {@code charset=UTF-8} parameter.
     */
     ...
     *
     * @since 5.0
     * @deprecated as of 5.2 in favor of {@link #APPLICATION_PROBLEM_JSON_VALUE} since major
     *     browsers like Chrome <a
            ...
            (mediaType1, mediaType2) -> {
                ...
                if (qualityComparison != 0) {
                    return qualityComparison; // audio/*;q=0.7 < audio/*;q=0.3
                        ...
                        && !mediaType2.isWildcardType()) { // */* < audio/*
                    return 1;
                    ...
                    if (mediaType1.isWildcardSubtype()
                        ...
                        return Integer.compare(
                                paramsSize2, paramsSize1); // audio/basic;level=1 < audio/basic
                    }
                }
            };
    ...
    /**
     * Parse the given list of (potentially) comma-separated strings into a list of {@code
     * MediaType} objects.
     *
     * <p>This method can be used to parse an Accept or Content-Type header.
     *
     ...
     *   <li>if the two media types have different {@linkplain #getSubtype() subtypes}, then they
     *       are considered equal and remain their current order.
     *   <li>if the two media types have different {@linkplain #getQualityValue() quality value},
    ...
    public static void sortBySpecificityAndQuality(List<MediaType> mediaTypes) {
        ...
        if (mediaTypes.size() > 1) {
            mediaTypes.sort(
                    MediaType.SPECIFICITY_COMPARATOR.thenComparing(
     ...
     *
     * @param other the reference media type with which to compare
     * @return {@code true} if this media type is compatible with the given media type; {@code
     *     false} otherwise
     */
