...
public abstract class HttpAccessor {
    ...
    private final List<ClientHttpRequestInitializer> clientHttpRequestInitializers =
            new ArrayList<>();
     ...
     *
     * <p>The returned {@link List} is active and may be modified. Note, however, that the
     * initializers will not be resorted according to their {@linkplain
     * AnnotationAwareOrderComparator#sort(List) order} before the {@link ClientHttpRequest} is
     * initialized.
     *
     * @since 5.2
     ...
     *
     * <p>The initializers will get immediately sorted according to their {@linkplain
     * AnnotationAwareOrderComparator#sort(List) order}.
     *
     * @since 5.2
     */
