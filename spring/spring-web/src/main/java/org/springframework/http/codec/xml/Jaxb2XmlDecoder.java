...
public class Jaxb2XmlDecoder extends AbstractDecoder<Object> {
    ...
    private Unmarshaller initUnmarshaller(Class<?> outputClass)
            throws CodecException, JAXBException {
     ...
     * method returns a flux of two lists, each of which containing the events of a particular
