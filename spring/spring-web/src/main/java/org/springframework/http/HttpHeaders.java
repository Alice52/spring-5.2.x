...
public class HttpHeaders implements MultiValueMap<String, String>, Serializable {
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.3.2">Section 5.3.2 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.3.3">Section 5.3.3 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.3.4">Section 5.3.4 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.3.5">Section 5.3.5 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-7.4.1">Section 7.4.1 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7230#section-3.3.2">Section 3.3.2 of RFC
     *     7230</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc2109#section-4.3.4">Section 4.3.4 of RFC
     *     2109</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.1.1">Section 5.1.1 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.5.1">Section 5.5.1 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-7.1.2">Section 7.1.2 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.1.2">Section 5.1.2 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.5.2">Section 5.5.2 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-7.1.3">Section 7.1.3 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-7.4.2">Section 7.4.2 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc2109#section-4.2.2">Section 4.2.2 of RFC
     *     2109</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7230#section-3.3.1">Section 3.3.1 of RFC
     *     7230</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-5.5.3">Section 5.5.3 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-7.1.4">Section 7.1.4 of RFC
     *     7231</a>
     */
     ...
     *
     * @see <a href="https://tools.ietf.org/html/rfc7230#section-5.7.1">Section 5.7.1 of RFC
     *     7230</a>
     */
    ...
    public static HttpHeaders readOnlyHttpHeaders(HttpHeaders headers) {
        ...
        return (headers instanceof ReadOnlyHttpHeaders
                ? headers
                : new ReadOnlyHttpHeaders(headers.headers));
    }

    /**
     * Remove any read-only wrapper that may have been previously applied around the given headers
    ...
    public static HttpHeaders writableHttpHeaders(HttpHeaders headers) {
        ...
        return (headers instanceof ReadOnlyHttpHeaders
                ? new HttpHeaders(headers.headers)
                : headers);
    }

    /**
     * Helps to format HTTP header values, as HTTP header values themselves can contain
     * comma-separated values, can become confusing with regular {@link Map} formatting that also
     * uses commas between entries.
     *
     ...
     *
     * <p>If you only need sorted, preferred locales only use {@link #getAcceptLanguageAsLocales()}
     * or if you need to filter based on a list of supported locales you can pass the returned list
     * to {@link Locale#filter(List, Collection)}.
     *
                        ...
                        .map(
                                range ->
                                        range.getWeight() == Locale.LanguageRange.MAX_WEIGHT
                                                ...
                                                : range.getRange()
                                                        + ";q="
                                                        + decimal.format(range.getWeight()))
    ...
    public void setAccessControlRequestMethod(@Nullable HttpMethod requestMethod) {
        setOrRemove(
                ...
                (requestMethod != null ? requestMethod.name() : null));
    }
     ...
     *
     * <p>It can also be used for a {@code "multipart/form-data"} request. For more details see
     * notes on {@link #setContentDispositionFormData}.
     *
     * @since 5.0
     * @see #getContentDisposition()
     */
    ...
    /**
     * Get the first {@link Locale} of the content languages, as specified by the {@code
     * Content-Language} header.
     *
     * <p>Use {@link #getValuesAsList(String)} if you need to get multiple content languages.
     *
    ...
    /**
     * Set the {@link Locale} of the content language, as specified by the {@literal
     * Content-Language} header.
     *
    ...
    public void setContentType(@Nullable MediaType mediaType) {
        if (mediaType != null) {
            Assert.isTrue(
                    !mediaType.isWildcardType(), "Content-Type cannot contain wildcard type '*'");
            Assert.isTrue(
     ...
     *
     * @param headerName the header name
     * @param rejectInvalid whether to reject invalid values with an {@link
     *     IllegalArgumentException} ({@code true}) or rather return -1 in that case ({@code false})
    ...
    /**
     * Parse the first header value for the given header name as a date, return {@code null} if
     * there is no value, or raise {@link IllegalArgumentException} if the value cannot be parsed as
     * a date.
     *
     * @param headerName the header name
    ...
    /**
     * Parse the first header value for the given header name as a date, return {@code null} if
     * there is no value or also in case of an invalid value (if {@code rejectInvalid=false}), or
     * raise {@link IllegalArgumentException} if the value cannot be parsed as a date.
     *
     * @param headerName the header name
     * @param rejectInvalid whether to reject invalid values with an {@link
     *     IllegalArgumentException} ({@code true}) or rather return {@code null} in that case
     *     ({@code false})
     ...
     *
     * <p>Such headers should be cleared from the response if the intended body can't be written due
     * to errors.
     *
     * @since 5.2.3
     */
