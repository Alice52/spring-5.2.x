...
public class CorsConfigurationTests {
    ...
    public void combineWithDuplicatedElements() {
        ...
        assertThat(combinedConfig.getAllowedHeaders())
                .isEqualTo(Arrays.asList("header1", "header2"));
        assertThat(combinedConfig.getExposedHeaders())
                .isEqualTo(Arrays.asList("header3", "header4"));
        assertThat(combinedConfig.getAllowedMethods())
    ...
    public void checkHeadersAllowed() {
        ...
        config.addAllowedHeader("header1");
        config.addAllowedHeader("header2");
        assertThat(config.checkHeaders(Arrays.asList("header1")))
                .isEqualTo(Arrays.asList("header1"));
    ...
    public void changePermitDefaultValues() {
        ...
        assertThat(config.getAllowedHeaders()).isEqualTo(Arrays.asList("*", "header1"));
        assertThat(config.getAllowedMethods())
                .isEqualTo(Arrays.asList("GET", "HEAD", "POST", "PATCH"));
    }
}
