...
class RequestLoggingFilterTests {
    ...
    void defaultPrefix() throws Exception {
        ...
        assertThat(filter.beforeRequestMessage)
                .startsWith(AbstractRequestLoggingFilter.DEFAULT_BEFORE_MESSAGE_PREFIX);
        assertThat(filter.afterRequestMessage)
                .startsWith(AbstractRequestLoggingFilter.DEFAULT_AFTER_MESSAGE_PREFIX);
    }
    ...
    void defaultSuffix() throws Exception {
        ...
        assertThat(filter.beforeRequestMessage)
                .endsWith(AbstractRequestLoggingFilter.DEFAULT_BEFORE_MESSAGE_SUFFIX);
        assertThat(filter.afterRequestMessage)
                .endsWith(AbstractRequestLoggingFilter.DEFAULT_AFTER_MESSAGE_SUFFIX);
    }
                ...
                (filterRequest, filterResponse) -> {
                    ...
                    ContentCachingRequestWrapper wrapper =
                            WebUtils.getNativeRequest(
                                    filterRequest, ContentCachingRequestWrapper.class);
