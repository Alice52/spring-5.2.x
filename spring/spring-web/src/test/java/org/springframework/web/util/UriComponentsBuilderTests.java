...
class UriComponentsBuilderTests {
    ...
    void fromUriEncodedQuery() throws URISyntaxException {
        ...
        String fromUri =
                UriComponentsBuilder.fromUri(uri).build().getQueryParams().get("param").get(0);
    ...
    void fromUriString() {
        ...
        result =
                UriComponentsBuilder.fromUriString("docs/guide/collections/designfaq.html#28")
                        .build();
    ...
    void fromUriStringIPv6Host() {
        ...
        UriComponents resultIPv4compatible =
                UriComponentsBuilder.fromUriString("http://[::192.168.1.1]:8080/resource")
                        .build()
                        .encode();
    ...
    void fromHttpRequestWithForwardedIPv6HostAndPort() {
        ...
        assertThat(result.toString())
                .isEqualTo("http://[1abc:2abc:3abc::5ABC:6abc]:8080/mvc-showcase");
    }
    ...
    void pathThenPathSegments() {
        UriComponentsBuilder builder =
                UriComponentsBuilder.fromPath("/foo/bar").pathSegment("ba/z");
        UriComponents result = builder.build().encode();
    ...
    void pathSegmentsThenPath() {
        UriComponentsBuilder builder =
                UriComponentsBuilder.newInstance().pathSegment("foo").path("/");
        UriComponents result = builder.build();
    ...
    void queryParam() {
        UriComponents result =
                UriComponentsBuilder.newInstance().queryParam("baz", "qux", 42).build();
    ...
    void replaceQueryParam() {
        UriComponentsBuilder builder =
                UriComponentsBuilder.newInstance().queryParam("baz", "qux", 42);
    ...
    void relativeUrls() {
        ...
        assertThat(
                        UriComponentsBuilder.fromUriString(baseUrl + "/foo/../bar")
                                .build()
                                .toUriString())
                .isEqualTo(baseUrl + "/foo/../bar");
        assertThat(
    ...
    void fromHttpRequestForwardedHeaderWithHostPortAndWithoutServerPort() {
        ...
        assertThat(result.getPath()).isEqualTo("/rest/mobile/users/1");
        assertThat(result.getPort()).isEqualTo(9090);
        assertThat(result.toUriString())
                .isEqualTo("https://84.198.58.199:9090/rest/mobile/users/1");
    }
    ...
    void fromHttpRequestForwardedHeaderComma() {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader(
                "Forwarded", "for=192.0.2.0,for=192.0.2.1;proto=https;host=192.0.2.3:9090");
        request.setScheme("http");
        request.setServerPort(8080);
        request.setServerName("example.com");
        request.setRequestURI("/rest/mobile/users/1");
    ...
    void uriComponentsNotEqualAfterNormalization() {
        UriComponents uri1 =
                UriComponentsBuilder.fromUriString("http://test.com").build().normalize();
    ...
    void uriComponentsWithMergedQueryParams() {
        String uri =
                UriComponentsBuilder.fromUriString("http://localhost:8081")
                        .uriComponents(
                                UriComponentsBuilder.fromUriString("/{path}?sort={sort}").build())
