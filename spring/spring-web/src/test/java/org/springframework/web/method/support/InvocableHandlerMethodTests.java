...
public class InvocableHandlerMethodTests {
    ...
    public void cannotResolveArg() throws Exception {
        assertThatIllegalStateException()
                .isThrownBy(
                        () ->
                                getInvocable(Integer.class, String.class)
    ...
    public void resolveProvidedArg() throws Exception {
        Object value =
                getInvocable(Integer.class, String.class)
                        .invokeForRequest(request, null, 99, "value");
    ...
    public void resolveProvidedArgFirst() throws Exception {
        ...
        Object value =
                getInvocable(Integer.class, String.class)
                        .invokeForRequest(request, null, 2, "value2");
    ...
    public void invocationTargetException() throws Exception {
        ...
        assertThatExceptionOfType(Error.class)
                .isThrownBy(
                        () ->
                                getInvocable(Throwable.class)
                                        .invokeForRequest(this.request, null, error))
                .isSameAs(error);
        ...
        assertThatExceptionOfType(Exception.class)
                .isThrownBy(
                        () ->
                                getInvocable(Throwable.class)
                                        .invokeForRequest(this.request, null, exception))
                .isSameAs(exception);
        ...
        assertThatIllegalStateException()
                .isThrownBy(
                        () ->
                                getInvocable(Throwable.class)
                                        .invokeForRequest(this.request, null, throwable))
                .withCause(throwable)
