...
public class PathPatternParserTests {
    ...
    public void toStringTests() {
        ...
        assertThat(checkStructure("{foobar}").toChainString())
                .isEqualTo("CaptureVariable({foobar})");
        ...
        assertThat(checkStructure("?a?b?c").toChainString())
                .isEqualTo("SingleCharWildcarded(?a?b?c)");
    ...
    public void captureTheRestPatterns() {
        ...
        checkError(
                "/{*foobar}abc", 10, PatternMessage.NO_MORE_DATA_EXPECTED_AFTER_CAPTURE_THE_REST);
    ...
    public void regexPathElementPatterns() {
        ...
        pathPattern =
                checkStructure("{symbolicName:[\\p{L}\\.]+}-sources-{version:[\\p{N}\\.]+}.jar");
        assertThat(pathPattern.getHeadSection().getClass().getName())
    ...
    public void illegalCapturePatterns() {
        ...
        checkError(
                "/{0abc}/abc", 2, PatternMessage.ILLEGAL_CHARACTER_AT_START_OF_CAPTURE_DESCRIPTOR);
    ...
    public void badPatterns() {
        ...
        checkError(
                "/{?}/", 2, PatternMessage.ILLEGAL_CHARACTER_AT_START_OF_CAPTURE_DESCRIPTOR, "?");
    ...
    public void patternPropertyGetLengthTests() {
        ...
        assertThat(parse("/{foo}/{bar}_{goo}_{wibble}/abc/bar").getNormalizedLength())
                .isEqualTo(16);
    }
    ...
    public void doubleWildcardWithinPatternNotSupported() {
        ...
        assertThat(pattern.matches(PathContainer.parsePath("/resources/projects/spring/details")))
                .isFalse();
    }
    ...
    /**
     * Delegates to {@link #checkError(String, int, PatternMessage, String...)}, passing {@code -1}
     * as the {@code expectedPos}.
     *
     * @since 5.2
     */
    private void checkError(
            String pattern, PatternMessage expectedMessage, String... expectedInserts) {
    ...
    private void checkError(
            String pattern,
            int expectedPos,
            PatternMessage expectedMessage,
        ...
        assertThatExceptionOfType(PatternParseException.class)
                ...
                .satisfies(
                        ex -> {
                            if (expectedPos >= 0) {
                                assertThat(ex.getPosition())
                                        .as(ex.toDetailedString())
                                        .isEqualTo(expectedPos);
                            }
                            assertThat(ex.getMessageType())
                                    .as(ex.toDetailedString())
