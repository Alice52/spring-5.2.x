...
public class RequestParamMethodArgumentResolverTests {
    ...
    public void supportsParameter() {
        ...
        param =
                this.testMethod
                        ...
                        .arg(List.class, MultipartFile.class);
        assertThat(resolver.supportsParameter(param)).isTrue();
        ...
        param =
                this.testMethod
                        .annotPresent(RequestParam.class)
                        .arg(Optional.class, MultipartFile.class);
        assertThat(resolver.supportsParameter(param)).isTrue();
    ...
    public void isMultipartRequestHttpPut() throws Exception {
        MockMultipartHttpServletRequest request = new MockMultipartHttpServletRequest();
        MultipartFile expected =
                new MockMultipartFile("multipartFileList", "Hello World".getBytes());
        request.addFile(expected);
    ...
    public void missingRequestParamEmptyValueNotRequired() throws Exception {
        ...
        MethodParameter param =
                this.testMethod.annot(requestParam().notRequired()).arg(String.class);
        Object arg = resolver.resolveArgument(param, null, webRequest, binderFactory);
        assertThat(arg).isNull();
    }
    ...
    public void resolveOptionalParamArray() throws Exception {
        ...
        MethodParameter param =
                this.testMethod
                        .annotPresent(RequestParam.class)
                        .arg(Optional.class, Integer[].class);
        Object result = resolver.resolveArgument(param, null, webRequest, binderFactory);
        assertThat(result).isEqualTo(Optional.empty());
