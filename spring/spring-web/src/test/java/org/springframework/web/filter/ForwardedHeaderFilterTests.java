...
public class ForwardedHeaderFilterTests {
    ...
    public void forwardedRequest() throws Exception {
        ...
        assertThat(actual.getRequestURL().toString())
                .isEqualTo("https://84.198.58.199/mvc-showcase");
    ...
    public void forwardedRequestWithServletForward() throws Exception {
        ...
        assertThat(actual.getRequestURL().toString())
                .isEqualTo("https://www.mycompany.example/bar");
    }
    ...
    public void requestUriWithForwardedPrefix() throws Exception {
        ...
        HttpServletRequest actual = filterAndGetWrappedRequest();
        assertThat(actual.getRequestURL().toString())
                .isEqualTo("http://localhost/prefix/mvc-showcase");
    }
    ...
    @Test
    public void sendRedirectWhenRequestOnlyAndXForwardedThenUsesRelativeRedirects()
            throws Exception {
        this.request.addHeader(X_FORWARDED_PROTO, "https");
        this.request.addHeader(X_FORWARDED_HOST, "example.com");
        this.request.addHeader(X_FORWARDED_PORT, "443");
