...
public class UriTemplateTests {
    ...
    public void matches() throws Exception {
        UriTemplate template = new UriTemplate("/hotels/{hotel}/bookings/{booking}");
        assertThat(template.matches("/hotels/1/bookings/42"))
                .as("UriTemplate does not match")
                .isTrue();
    ...
    public void matchCustomRegexWithNestedCurlyBraces() throws Exception {
        ...
        assertThat(result)
                .as("Invalid match")
                .isEqualTo(Collections.singletonMap("domain", "co.eu"));
    }
    ...
    public void matchDuplicate() throws Exception {
        ...
        Map<String, String> result =
                template.match("/order/cheeseburger/cheeseburger/cheeseburger");
