...
public class Jackson2JsonEncoderTests extends AbstractEncoderTests<Jackson2JsonEncoder> {
    ...
    public void canEncode() {
        ...
        assertThat(
                        this.encoder.canEncode(
                                ResolvableType.forClass(Object.class), APPLICATION_OCTET_STREAM))
                .isFalse();
    }
    ...
    public void classLevelJsonView() {
        ...
        testEncode(
                ...
                step ->
                        step.consumeNextWith(
                                        expectString("{\"withoutView\":\"without\"}")
                                                .andThen(DataBufferUtils::release))
                                .verifyComplete(),
                null,
                hints);
    ...
    public void encodeAscii() {
        ...
        testEncode(
                ...
                step ->
                        step.consumeNextWith(expectString("{\"foo\":\"foo\",\"bar\":\"bar\"}"))
                                .verifyComplete(),
                new MimeType("application", "json", StandardCharsets.US_ASCII),
                null);
    }
