...
public class MediaTypeTests {
    ...
    public void getDefaultQualityValue() {
        ...
        assertThat(mediaType.getQualityValue())
                .as("Invalid quality value")
                .isCloseTo(1D, within(0D));
    }
    ...
    public void specificityComparator() throws Exception {
        ...
        // equal
        assertThat(comp.compare(audioBasic, audioBasic))
                .as("Invalid comparison result")
                .isEqualTo(0);
        ...
        // different subtypes
        assertThat(comp.compare(audioBasic, audioWave))
                .as("Invalid comparison result")
                .isEqualTo(0);
        assertThat(comp.compare(audioWave, audioBasic))
                .as("Invalid comparison result")
                .isEqualTo(0);
    }
    ...
    public void testWithConversionService() {
        ...
        assertThat(conversionService.convert("application/xml", MediaType.class))
                .isEqualTo(mediaType);
    }
    ...
    void serialize() throws Exception {
        ...
        MediaType deserialized =
                (MediaType) SerializationTestUtils.serializeAndDeserialize(original);
