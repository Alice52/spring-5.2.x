...
public class HttpHeadersTests {
    ...
    public void ifMatch() {
        ...
        assertThat(headers.getFirst("If-Match"))
    ...
    public void expiresZonedDateTime() {
        ZonedDateTime zonedDateTime =
                ZonedDateTime.of(2008, 12, 18, 10, 20, 0, 0, ZoneId.of("GMT"));
    ...
    public void firstZonedDateTime() {
        ...
        assertThat(headers.get(HttpHeaders.DATE))
                .isEqualTo(
                        Arrays.asList(
                                "Fri, 02 Jun 2017 02:22:00 GMT", "Sat, 18 Dec 2010 10:20:00 GMT"));
    ...
    public void basicAuthIllegalChar() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> headers.setBasicAuth(username, password));
    }
