...
public class RequestEntityTests {
    ...
    public void uriVariablesExpansion() throws URISyntaxException {
        URI uri =
                UriComponentsBuilder.fromUriString("https://example.com/{foo}")
                        .buildAndExpand("bar")
                        .toUri();
    ...
    public void headers() throws URISyntaxException {
        ...
        assertThat(responseHeaders.getFirst(HttpHeaders.ACCEPT))
                .isEqualTo(MediaType.TEXT_PLAIN_VALUE);
        assertThat(responseHeaders.getFirst(HttpHeaders.ACCEPT_CHARSET)).isEqualTo("utf-8");
        assertThat(responseHeaders.getFirst(HttpHeaders.IF_MODIFIED_SINCE))
