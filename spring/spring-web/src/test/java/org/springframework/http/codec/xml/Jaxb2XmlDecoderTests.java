...
public class Jaxb2XmlDecoderTests extends AbstractLeakCheckingTests {
    ...
    public void canDecode() {
        assertThat(
                        this.decoder.canDecode(
                                ResolvableType.forClass(Pojo.class), MediaType.APPLICATION_XML))
                .isTrue();
        assertThat(this.decoder.canDecode(ResolvableType.forClass(Pojo.class), MediaType.TEXT_XML))
                .isTrue();
        assertThat(
                        this.decoder.canDecode(
                                ResolvableType.forClass(Pojo.class), MediaType.APPLICATION_JSON))
                .isFalse();
        assertThat(
                        this.decoder.canDecode(
        ...
        assertThat(
                        this.decoder.canDecode(
                                ResolvableType.forClass(getClass()), MediaType.APPLICATION_XML))
                .isFalse();
    }
    ...
    public void splitOneBranches() {
        Flux<XMLEvent> xmlEvents =
                this.xmlEventDecoder.decode(toDataBufferMono(POJO_ROOT), null, null, HINTS);
    ...
    public void splitMultipleBranches() {
        Flux<XMLEvent> xmlEvents =
                this.xmlEventDecoder.decode(toDataBufferMono(POJO_CHILD), null, null, HINTS);
        Flux<List<XMLEvent>> result = this.decoder.split(xmlEvents, new QName("pojo"));
    ...
    public void decodeSingleXmlRootElement() {
        ...
        Mono<Object> output =
                this.decoder.decodeToMono(source, ResolvableType.forClass(Pojo.class), null, HINTS);
    ...
    public void decodeSingleXmlTypeElement() {
        ...
        Mono<Object> output =
                this.decoder.decodeToMono(
                        source, ResolvableType.forClass(TypePojo.class), null, HINTS);
    ...
    public void decodeMultipleXmlRootElement() {
        ...
        Flux<Object> output =
                this.decoder.decode(source, ResolvableType.forClass(Pojo.class), null, HINTS);
    ...
    public void decodeMultipleXmlTypeElement() {
        Mono<DataBuffer> source = toDataBufferMono(POJO_CHILD);
        Flux<Object> output =
                this.decoder.decode(source, ResolvableType.forClass(TypePojo.class), null, HINTS);
    ...
    public void decodeError() {
        Flux<DataBuffer> source =
                Flux.concat(toDataBufferMono("<pojo>"), Flux.error(new RuntimeException()));
    ...
    public void decodeErrorWithXmlNotWellFormed() {
        ...
        StepVerifier.create(result)
                .verifyErrorSatisfies(
                        ex ->
                                assertThat(Exceptions.unwrap(ex))
    ...
    public void toExpectedQName() {
        ...
        assertThat(this.decoder.toQName(XmlTypeWithName.class))
                .isEqualTo(new QName("namespace", "name"));
        assertThat(this.decoder.toQName(XmlType.class))
                .isEqualTo(new QName("namespace", "xmlType"));
    }
