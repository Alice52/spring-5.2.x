...
public class ContextPathCompositeHandlerTests {
                        ...
                        () ->
                                new ContextPathCompositeHandler(
                                        Collections.singletonMap(
                                                contextPath, new TestHttpHandler())))
    ...
    public void matchWithNativeContextPath() {
        ...
        assertThat(handler.getRequest().getPath().contextPath().value())
                .isEqualTo("/yet/another/path");
    }
    ...
    private ServerHttpResponse testHandle(
            String pathToHandle, Map<String, HttpHandler> handlerMap) {
