...
public class SourceHttpMessageConverterTests {
    ...
    public void canRead() {
        ...
        assertThat(converter.canRead(Source.class, new MediaType("application", "soap+xml")))
                .isTrue();
    }
    ...
    public void canWrite() {
        ...
        assertThat(converter.canWrite(Source.class, new MediaType("application", "soap+xml")))
                .isTrue();
    ...
    public void readDOMSourceExternal() throws Exception {
        MockHttpInputMessage inputMessage =
                new MockHttpInputMessage(bodyExternal.getBytes("UTF-8"));
        inputMessage.getHeaders().setContentType(new MediaType("application", "xml"));
