...
public class BeanFactoryTransactionAttributeSourceAdvisor
    ...
    /**
     * Set the transaction attribute source which is used to find transaction attributes. This
     * should usually be identical to the source reference set on the transaction interceptor
     * itself.
     *
