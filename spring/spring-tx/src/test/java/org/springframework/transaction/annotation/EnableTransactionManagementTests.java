...
public class EnableTransactionManagementTests {
    ...
    public void transactionProxyIsCreated() {
        ...
        assertThat(services.containsKey("testBean"))
                .as("Stereotype annotation not visible")
                .isTrue();
        ctx.close();
    }
    ...
    public void transactionProxyIsCreatedWithEnableOnExcludedSuperclass() {
        AnnotationConfigApplicationContext ctx =
                new AnnotationConfigApplicationContext(
                        ParentEnableTxConfig.class,
                        ChildEnableTxConfig.class,
    ...
    public void txManagerIsResolvedOnInvocationOfTransactionalMethod() {
        ...
        CallCountingTransactionManager txManager =
                ctx.getBean("txManager", CallCountingTransactionManager.class);

        // invoke a transactional method, causing the PlatformTransactionManager bean to be
        // resolved.
        bean.findAllFoos();
    ...
    public void txManagerIsResolvedCorrectlyWhenMultipleManagersArePresentAndOneIsPrimary() {
        ...
        CallCountingTransactionManager primary =
                ctx.getBean("primary", CallCountingTransactionManager.class);
        CallCountingTransactionManager txManager2 =
                ctx.getBean("txManager2", CallCountingTransactionManager.class);
    ...
    public void txManagerIsResolvedCorrectlyWithTxMgmtConfigurerAndPrimaryPresent() {
        ...
        CallCountingTransactionManager annotationDriven =
                ctx.getBean(
                        "annotationDrivenTransactionManager", CallCountingTransactionManager.class);
    ...
    public void spr14322FindsOnInterfaceWithInterfaceProxy() {
        ...
        CallCountingTransactionManager txManager =
                ctx.getBean(CallCountingTransactionManager.class);
    ...
    @Configuration
    static class PrimaryTxManagerAndTxMgmtConfigurerConfig
            implements TransactionManagementConfigurer {
