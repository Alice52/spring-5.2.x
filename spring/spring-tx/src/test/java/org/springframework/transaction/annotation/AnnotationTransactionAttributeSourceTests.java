...
public class AnnotationTransactionAttributeSourceTests {
    ...
    public void serializable() throws Exception {
        ...
        ITestBean1 serializedProxy =
                (ITestBean1) SerializationTestUtils.serializeAndDeserialize(proxy);
    ...
    /**
     * Test the important case where the invocation is on a proxied interface method but the
     * attribute is defined on the target class.
     */
    @Test
    ...
    public void transactionAttributeOnTargetClassMethodOverridesAttributeOnInterfaceMethod()
        ...
        AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
        TransactionAttribute actual =
                atas.getTransactionAttribute(interfaceMethod, TestBean3.class);
        ...
        TransactionAttribute actual2 =
                atas.getTransactionAttribute(interfaceMethod2, TestBean3.class);
    ...
    public void customClassAttributeWithReadOnlyOverrideOnInterface() throws Exception {
        ...
        assertThat(annotation)
                .as(
                        "AnnotationUtils.findAnnotation should not find @Transactional for TestBean9.getAge()")
                .isNull();
    ...
    public void customMethodAttributeWithReadOnlyOverrideOnInterface() throws Exception {
        ...
        assertThat(annotation)
                .as(
                        "AnnotationUtils.findAnnotation failed to find @Transactional for TestBean10.getAge()")
                .isNotNull();
