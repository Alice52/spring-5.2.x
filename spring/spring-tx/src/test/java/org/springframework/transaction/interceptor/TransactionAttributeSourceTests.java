...
public class TransactionAttributeSourceTests {
    ...
    public void matchAlwaysTransactionAttributeSource() throws Exception {
        ...
        TransactionAttribute ta =
                tas.getTransactionAttribute(Object.class.getMethod("hashCode"), null);
        assertThat(ta).isNotNull();
        assertThat(TransactionDefinition.PROPAGATION_REQUIRED == ta.getPropagationBehavior())
                .isTrue();
        ...
        assertThat(ta).isNotNull();
        assertThat(TransactionDefinition.PROPAGATION_SUPPORTS == ta.getPropagationBehavior())
                .isTrue();
    }
