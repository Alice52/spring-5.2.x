...
public class ConfigurationClassProcessingTests {
    ...
    public void configurationWithAdaptivePrototypes() {
        ...
        assertThat(adaptive.adaptiveInjectionPoint2.getName())
                .isEqualTo("setAdaptiveInjectionPoint2");
    ...
    public void configurationWithAdaptiveResourcePrototypes() {
        ...
        AdaptiveResourceInjectionPoints adaptive =
    ...
    public void configurationWithOverloadedBeanMismatchWithAsm() {
        ...
        ctx.registerBeanDefinition(
                "config", new RootBeanDefinition(OverloadedBeanMismatch.class.getName()));
        ctx.refresh();
