...
public class EventPublicationInterceptorTests {
    ...
    public void testWithApplicationEventClassThatDoesntExposeAValidCtor() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () -> {
                            interceptor.setApplicationEventClass(
                                    TestEventWithNoValidOneArgObjectCtor.class);
                            interceptor.afterPropertiesSet();
                        });
    }
    ...
    public void testExpectedBehavior() {
        ...
        assertThat(listener.getEventCount() == 2)
                ...
                .isTrue();
        TestApplicationListener otherListener =
                (TestApplicationListener) ctx.getBean("&otherListener");
