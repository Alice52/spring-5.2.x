...
public class PropertySourceAnnotationTests {
    ...
    public void withMissingPropertySource() {
        assertThatExceptionOfType(BeanDefinitionStoreException.class)
                .isThrownBy(
                        () ->
                                new AnnotationConfigApplicationContext(
                                        ConfigWithMissingPropertySource.class))
    ...
    public void orderingWithAndWithoutNameAndMultipleResourceLocations() {
        ...
        assertThat(ctxWithName.getEnvironment().getProperty("testbean.name"))
                .isEqualTo("p2TestBean");
    }
    ...
    public void orderingDoesntReplaceExisting() throws Exception {
        ...
        MapPropertySource mySource =
                new MapPropertySource(
                        "mine", Collections.singletonMap("testbean.name", "myTestBean"));
    ...
    @PropertySource(
            value =
                    "classpath:${unresolvable:org/springframework/context/annotation}/p1.properties")
