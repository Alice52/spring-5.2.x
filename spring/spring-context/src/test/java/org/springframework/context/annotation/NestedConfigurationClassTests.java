...
public class NestedConfigurationClassTests {
    ...
    public void twoLevelsDeep() {
        ...
        assertThat(ctx.getBeanFactory().containsSingleton(L0Config.L1Config.class.getName()))
                .isTrue();
        ctx.getBean(L0Config.L1Config.class);
        ctx.getBean("l1Bean");
        ...
        assertThat(
                        ctx.getBeanFactory()
                                .containsSingleton(L0Config.L1Config.L2Config.class.getName()))
                .isFalse();
        ctx.getBean(L0Config.L1Config.L2Config.class);
        ctx.getBean("l2Bean");
    ...
    public void twoLevelsInLiteMode() {
        ...
        assertThat(
                        ctx.getBeanFactory()
                                .containsSingleton("nestedConfigurationClassTests.L0ConfigLight"))
                .isFalse();
        ...
        assertThat(
                        ctx.getBeanFactory()
                                .containsSingleton(L0ConfigLight.L1ConfigLight.class.getName()))
                .isTrue();
        ...
        assertThat(
                        ctx.getBeanFactory()
                                .containsSingleton(
                                        L0ConfigLight.L1ConfigLight.L2ConfigLight.class.getName()))
                .isFalse();
    ...
    public void twoLevelsDeepWithInheritance() {
        ...
        assertThat(pb1.getFriends().iterator().next() != pb2.getFriends().iterator().next())
                .isTrue();
    }
