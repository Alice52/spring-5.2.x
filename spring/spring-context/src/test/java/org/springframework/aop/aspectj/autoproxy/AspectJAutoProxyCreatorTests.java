...
public class AspectJAutoProxyCreatorTests {
    ...
    public void testAspectsAreApplied() {
        ...
        MethodInvokingFactoryBean factoryBean =
                (MethodInvokingFactoryBean) bf.getBean("&factoryBean");
    ...
    public void testAspectsAndAdvisorNotAppliedToManySingletonsIsFastEnough() {
        ...
        for (int i = 0; i < 10000; i++) {
            ac.registerBeanDefinition(
                    "singleton" + i, new RootBeanDefinition(NestedTestBean.class));
        }
        StopWatch sw = new StopWatch();
    ...
    public void testPerTargetAspect() throws SecurityException, NoSuchMethodException {
        ...
        assertThat(adrian1.getAge())
                .as("Setter does not initiate advice")
                .isEqualTo(explicitlySetAge);
        // Fire aspect
    ...
    public void testAdviceUsingJoinPoint() {
        ...
        assertThat(aspectInstance.getLastMethodEntered().indexOf("TestBean.getAge())") != 0)
                .isTrue();
    }
