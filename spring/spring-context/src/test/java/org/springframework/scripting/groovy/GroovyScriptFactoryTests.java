...
public class GroovyScriptFactoryTests {
    ...
    public void testStaticScript() throws Exception {
        ...
        assertThat(condition3)
                .as("Scripted object should not be instance of Refreshable")
                .isFalse();
    ...
    public void testStaticPrototypeScript() throws Exception {
        ...
        ConfigurableMessenger messenger2 =
                (ConfigurableMessenger) ctx.getBean("messengerPrototype");
    ...
    public void testWithTwoClassesDefinedInTheOneGroovyFile_WrongClassFirst() throws Exception {
        assertThatExceptionOfType(Exception.class)
                .as(
                        "two classes defined in GroovyScriptFactory source, non-Messenger class defined first")
                .isThrownBy(
                        () -> {
                            ApplicationContext ctx =
                                    new ClassPathXmlApplicationContext(
                                            "twoClassesWrongOneFirst.xml", getClass());
    ...
    public void testWithInlineScriptWithLeadingWhitespace() throws Exception {
        assertThatExceptionOfType(BeanCreationException.class)
                ...
                .isThrownBy(
                        () ->
                                new ClassPathXmlApplicationContext(
                                        "lwspBadGroovyContext.xml", getClass()))
    ...
    public void testRefreshableFromTagProxyTargetClass() throws Exception {
        ApplicationContext ctx =
                new ClassPathXmlApplicationContext(
                        "groovy-with-xsd-proxy-target-class.xml", getClass());
        assertThat(
                        Arrays.asList(ctx.getBeanNamesForType(Messenger.class))
                                .contains("refreshableMessenger"))
                .isTrue();
        ...
        assertThat(ctx.getBeansOfType(ConcreteMessenger.class).values().contains(messenger))
                .isTrue();

        // Check that AnnotationUtils works with concrete proxied script classes
        assertThat(AnnotationUtils.findAnnotation(messenger.getClass(), Component.class))
                .isNotNull();
    }
