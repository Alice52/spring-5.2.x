...
final class TestNamespaceHandler extends NamespaceHandlerSupport {
    ...
    private static class TestBeanDefinitionParser implements BeanDefinitionParser {
        ...
        public BeanDefinition parse(Element element, ParserContext parserContext) {
            ...
            parserContext
                    .getRegistry()
                    .registerBeanDefinition(element.getAttribute("id"), definition);
            return null;
        }
    }
    ...
    private static class PropertyModifyingBeanDefinitionDecorator
    ...
    private static class ObjectNameBeanDefinitionDecorator implements BeanDefinitionDecorator {
        ...
        public BeanDefinitionHolder decorate(
            ...
            definition
                    .getBeanDefinition()
                    .setAttribute("objectName", objectNameAttribute.getValue());
            return definition;
        }
    }
}
