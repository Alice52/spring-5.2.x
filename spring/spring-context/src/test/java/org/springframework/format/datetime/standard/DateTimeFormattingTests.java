...
public class DateTimeFormattingTests {
    ...
    public void testBindYear() {
        ...
        binder.bind(propertyValues);
        assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
        assertThat(binder.getBindingResult().getFieldValue("year").toString().equals("2007"))
                .isTrue();
    }
    ...
    public void testBindMonth() {
        ...
        binder.bind(propertyValues);
        assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
        assertThat(binder.getBindingResult().getFieldValue("month").toString().equals("JULY"))
                .isTrue();
    }
