...
public class MBeanExporterTests extends AbstractMBeanServerTests {
    ...
    public void testUserCreatedMBeanRegWithDynamicMBean() throws Exception {
        ...
        try {
            ...
            Object name =
                    server.getAttribute(
                            ObjectNameManager.getInstance("spring:name=dynBean"), "Name");
    ...
    public void testAutodetectMBeans() throws Exception {
        ...
        try {
            ...
            instance =
                    server.getObjectInstance(ObjectNameManager.getInstance("spring:mbean2=true"));
            assertThat(instance).isNotNull();
            instance =
                    server.getObjectInstance(ObjectNameManager.getInstance("spring:mbean3=true"));
            assertThat(instance).isNotNull();
        } finally {
            ctx.close();
        }
                    ...
                    .isThrownBy(
                            () ->
                                    server.getObjectInstance(
                                            ObjectNameManager.getInstance("spring:mbean=false")));
        } finally {
            ctx.close();
        }
    }
    ...
    public void testBonaFideMBeanIsNotExportedWhenAutodetectIsTotallyTurnedOff() throws Exception {
        ...
        // MBean has a bad ObjectName, so if said MBean is autodetected, an exception will be
        // thrown...
        start(exporter);
    }
    ...
    public void testOnlyBonaFideMBeanIsExportedWhenAutodetectIsMBeanOnly() throws Exception {
        ...
        exporter.setAssembler(
                new NamedBeanAutodetectCapableMBeanInfoAssemblerStub(exportedBeanName));
        exporter.setBeanFactory(factory);
                ...
                .isThrownBy(
                        () ->
                                exporter.setAutodetectModeName(
                                        "That Hansel is... *sssooo* hot right now!"));
    }
    ...
    public void testBeanNameCanBeUsedInNotificationListenersMap() throws Exception {
        ...
        BeanDefinitionBuilder testBean =
                BeanDefinitionBuilder.rootBeanDefinition(JmxTestBean.class);
    ...
    public void testMBeanIsUnregisteredForRuntimeExceptionDuringInitialization() throws Exception {
        ...
        BeanDefinitionBuilder builder2 =
                BeanDefinitionBuilder.rootBeanDefinition(
                        RuntimeExceptionThrowingConstructorBean.class);
    ...
    public void testIgnoreBeanName() throws MalformedObjectNameException {
        ...
        exporter.setServer(getServer());
        exporter.setAssembler(
                new NamedBeanAutodetectCapableMBeanInfoAssemblerStub(
                        firstBeanName, secondBeanName));
        exporter.setBeanFactory(factory);
        exporter.setAutodetectMode(MBeanExporter.AUTODETECT_ALL);
