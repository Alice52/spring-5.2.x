...
public abstract class AbstractSlsbInvokerInterceptor extends JndiObjectLocator
     ...
     * for each EJB invocation, as needed by WebLogic for EJBs with authorization requirements.
     */
     ...
     *
     * <p>Default implementation returns the home created on initialization, if any; else, it
    ...
    /**
     * Perform the given invocation on the current EJB home, within the thread context being
     * prepared accordingly. Template method to be implemented by subclasses.
     *
