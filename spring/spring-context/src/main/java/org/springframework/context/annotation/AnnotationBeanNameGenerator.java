...
public class AnnotationBeanNameGenerator implements BeanNameGenerator {
     ...
     *
     * <p>A convenient constant for a default {@code AnnotationBeanNameGenerator} instance, as used
     * for component scanning purposes.
     *
     * @since 5.2
     */
     ...
     *
     * <p>Derive a bean name from one of the annotations on the class.
     *
     ...
     * 检查给定的注释是否允许通过其注释的value属性构造bean名称
     *
     * <p>Check whether the given annotation is a stereotype that is allowed to suggest a component
     * name through its annotation {@code value()}.
     *
     ...
     *
     * <p>Derive a default bean name from the given bean definition.
     *
