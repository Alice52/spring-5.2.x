 ...
 * @see org.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor see
...
public abstract class AnnotationConfigUtils {
    ...
    public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
        ...
        if (!registry.containsBeanDefinition(CONFIGURATION_ANNOTATION_PROCESSOR_BEAN_NAME)) {
            ...
            beanDefs.add(
                    registerPostProcessor(
                            registry, def, CONFIGURATION_ANNOTATION_PROCESSOR_BEAN_NAME));
        }
        ...
        if (jpaPresent
            ...
            beanDefs.add(
                    registerPostProcessor(
                            registry, def, PERSISTENCE_ANNOTATION_PROCESSOR_BEAN_NAME));
        }
    ...
    static Set<AnnotationAttributes> attributesForRepeatable(
        ...
        return attributesForRepeatable(
                metadata, containerClass.getName(), annotationClass.getName());
    }
    ...
    static Set<AnnotationAttributes> attributesForRepeatable(
        ...
        addAttributesIfNotNull(
                result, metadata.getAnnotationAttributes(annotationClassName, false));
        ...
        jpaPresent =
                ClassUtils.isPresent("javax.persistence.EntityManagerFactory", classLoader)
                        && ClassUtils.isPresent(
                                PERSISTENCE_ANNOTATION_PROCESSOR_CLASS_NAME, classLoader);
    }
}
