...
public class ClassPathScanningCandidateComponentProvider
     ...
     *     Component @Component}, {@link Repository @Repository}, {@link Service @Service}, and
    ...
    /**
     * Determine whether the given class does not match any exclude filter and does match at least
     * one include filter.
     *
        ...
        if (this.conditionEvaluator == null) {
            this.conditionEvaluator =
                    new ConditionEvaluator(
                            getRegistry(), this.environment, this.resourcePatternResolver);
        }
     ...
     *
     * <p>The default implementation checks whether the class is not an interface and not dependent
