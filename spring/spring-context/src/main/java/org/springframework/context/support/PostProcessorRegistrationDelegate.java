 ...
 *
 * <p>Delegate for AbstractApplicationContext's post-processor handling.
 *
...
final class PostProcessorRegistrationDelegate {
     ...
     *
     * <p>Invoke the given BeanDefinitionRegistryPostProcessor beans.
     */
    private static void invokeBeanDefinitionRegistryPostProcessors(
        ...
        for (BeanDefinitionRegistryPostProcessor postProcessor : postProcessors) {
            // 调用 postProcessor 的
            // postProcessBeanDefinitionRegistry以使得postProcess往registry注册BeanDefinition对象
     ...
     *
     * <p>Invoke the given BeanFactoryPostProcessor beans.
     */
     ...
     *
     * <p>Register the given BeanPostProcessor beans.
     */
     ...
     *
     * <p>BeanPostProcessor that logs an info message when a bean is created during
     * BeanPostProcessor instantiation, i.e. when a bean is not eligible for getting processed by
    ...
    private static final class BeanPostProcessorChecker implements BeanPostProcessor {
        ...
        public Object postProcessAfterInitialization(Object bean, String beanName) {
            // 如果bean不是BeanPostProcessor实例 && beanName 不是 完全内部使用 &&
            // beanFactory当前注册的BeanPostProcessor
