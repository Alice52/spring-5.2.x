...
public class ResourceBundleMessageSource extends AbstractResourceBasedMessageSource
    ...
    /**
     * Cache to hold loaded ResourceBundles. This Map is keyed with the bundle basename, which holds
     * a Map that is keyed with the Locale and in turn holds the ResourceBundle instances. This
     * allows for very efficient hash lookups, significantly faster than the ResourceBundle class's
     * own cache.
     */
    ...
    /**
     * Resolves the given message code as key in the registered resource bundles, returning the
