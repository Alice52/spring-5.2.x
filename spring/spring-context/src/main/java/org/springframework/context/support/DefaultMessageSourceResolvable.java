...
public class DefaultMessageSourceResolvable implements MessageSourceResolvable, Serializable {
     ...
     *
     * @return {@code true} if the default message may contain argument placeholders; {@code false}
     *     if it definitely does not contain placeholders or custom escaping and can therefore be
     *     simply exposed as-is
     * @since 5.1.7
    ...
    protected final String resolvableToString() {
        ...
        result.append("]; arguments [")
                .append(StringUtils.arrayToDelimitedString(this.arguments, ","));
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (ObjectUtils.nullSafeEquals(getCodes(), otherResolvable.getCodes())
                ...
                && ObjectUtils.nullSafeEquals(
                        getDefaultMessage(), otherResolvable.getDefaultMessage()));
    }
