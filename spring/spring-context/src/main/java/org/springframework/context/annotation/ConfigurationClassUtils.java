 ...
 *
 * <p>Utilities for identifying {@link Configuration} classes.
 *
 * @author Chris Beams
...
abstract class ConfigurationClassUtils {
     ...
     *
     * <p>Check whether the given bean definition is a candidate for a configuration class (or a
     * nested component class declared within a configuration/component class, to be auto-registered
     * as well), and mark it accordingly.
     *
     ...
     *
     * <p>Check the given metadata for a configuration class candidate (or nested component class
    ...
    public static boolean isConfigurationCandidate(AnnotationMetadata metadata) {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug(
                        "Failed to introspect @Bean methods on class ["
    ...
    public static Integer getOrder(AnnotationMetadata metadata) {
        Map<String, Object> orderAttributes =
                metadata.getAnnotationAttributes(Order.class.getName());
