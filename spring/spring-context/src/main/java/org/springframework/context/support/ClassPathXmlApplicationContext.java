...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
    ...
    /**
     * Create a new ClassPathXmlApplicationContext with the given parent, loading the definitions
     ...
     *     creating all singletons. Alternatively, call refresh manually after further configuring
     *     the context.
     * @throws BeansException if context creation failed
     * @see #refresh()
     */
