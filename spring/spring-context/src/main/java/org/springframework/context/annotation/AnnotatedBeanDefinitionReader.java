...
public class AnnotatedBeanDefinitionReader {
     ...
     *
     * <p>Calls to {@code register} are idempotent; adding the same component class more than once
     ...
     *
     * @param beanClass the class of the bean
     * @param name an explicit name for the bean (or {@code null} for generating a default bean
     *     name)
     * @since 5.2
     */
     ...
     *
     * @param beanClass the class of the bean
     * @param qualifiers specific qualifier annotations to consider, in addition to qualifiers at
     *     the bean class level
     */
     ...
     * @param qualifiers specific qualifier annotations to consider, if any, in addition to
