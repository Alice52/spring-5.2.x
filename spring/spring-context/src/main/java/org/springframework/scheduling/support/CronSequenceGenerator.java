...
public class CronSequenceGenerator {
    ...
    /**
     * Construct a {@link CronSequenceGenerator} from the pattern provided, using the specified
     * {@link TimeZone}.
     *
     * @param expression a space-separated list of time fields
    ...
    public Date next(Date date) {
        ...
        */
        ...
        if (calendar.getTimeInMillis() == originalTimestamp) {
            // We arrived at the original timestamp - round up to the next whole second and try
            // again...
    ...
    private void doNext(Calendar calendar, int dot) {
        ...
        int updateDayOfMonth =
                findNextDay(
                        calendar, this.daysOfMonth, dayOfMonth, this.daysOfWeek, dayOfWeek, resets);
    ...
    /**
     * Search the bits provided for the next set bit after the value provided, and reset the
     * calendar.
     *
    ...
    /**
     * Replace the values in the comma-separated list (case insensitive) with their index in the
     * list.
     *
    ...
    private void setMonths(BitSet bits, String value) {
        ...
        // Months start with 1 in Cron and 0 in Calendar, so push the values first into a longer bit
        // set
