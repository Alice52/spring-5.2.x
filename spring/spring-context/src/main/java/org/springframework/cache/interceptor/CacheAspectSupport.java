...
public abstract class CacheAspectSupport extends AbstractCacheInvoker
    ...
    public void setCacheOperationSources(CacheOperationSource... cacheOperationSources) {
        Assert.notEmpty(
                cacheOperationSources, "At least 1 CacheOperationSource needs to be specified");
    ...
    /**
     * Set the default {@link CacheResolver} that this cache aspect should delegate to if no
     * specific cache resolver has been set for the operation.
     *
     * <p>The default resolver resolves the caches against their names and the default cache
     * manager.
     *
     * @see #setCacheManager
    ...
    public void afterSingletonsInstantiated() {
        if (getCacheResolver() == null) {
            ...
            Assert.state(
                    ...
                    "CacheResolver or BeanFactory must be set on cache aspect");
            try {
     ...
     *
     * <p>Resolve the {@link CacheResolver} and the {@link KeyGenerator} to be used for the
     * operation.
     *
    ...
    protected CacheOperationMetadata getCacheOperationMetadata(
        ...
        CacheOperationCacheKey cacheKey =
                new CacheOperationCacheKey(operation, method, targetClass);
        ...
        if (metadata == null) {
            ...
            if (StringUtils.hasText(operation.getCacheResolver())) {
                ...
                CacheManager cacheManager =
                        getBean(operation.getCacheManager(), CacheManager.class);
    ...
    /**
     * Return a bean with the specified name and type. Used to resolve services that are referenced
     * by name in a {@link CacheOperation}.
     *
     ...
     * the invocation. If an exception occurs it will be wrapped in a {@link
        ...
        for (CacheOperationContext context : cachePutContexts) {
            try {
                if (!context.isConditionPassing(
                        CacheOperationExpressionEvaluator.RESULT_UNAVAILABLE)) {
    ...
    /**
     * Metadata of a cache operation that does not depend on a particular invocation which makes it
    ...
    private class CacheOperationContexts {
        ...
        private final MultiValueMap<Class<? extends CacheOperation>, CacheOperationContext>
                contexts;
        ...
        public Collection<CacheOperationContext> get(
        ...
        private boolean determineSyncFlag(Method method) {
            ...
            if (syncEnabled) {
                ...
                CacheOperationContext cacheOperationContext =
                        cacheOperationContexts.iterator().next();
                CacheableOperation operation =
                        (CacheableOperation) cacheOperationContext.getOperation();
    ...
    protected class CacheOperationContext
        ...
        public CacheOperationContext(
                CacheOperationMetadata metadata, Object[] args, Object target) {
        ...
        protected Object generateKey(@Nullable Object result) {
            if (StringUtils.hasText(this.metadata.operation.getKey())) {
                ...
                return evaluator.key(
                        this.metadata.operation.getKey(),
                        this.metadata.methodKey,
                        evaluationContext);
            }
            return this.metadata.keyGenerator.generate(
                    this.target, this.metadata.method, this.args);
        }
