...
public class FormattingConversionService extends GenericConversionService
    ...
    public void addFormatterForFieldAnnotation(
        ...
        for (Class<?> fieldType : fieldTypes) {
            addConverter(
                    new AnnotationPrinterConverter(
    ...
    private static class ParserConverter implements GenericConverter {
        ...
        public Object convert(
            ...
            try {
                ...
                throw new IllegalArgumentException(
                        "Parse attempt failed for value [" + text + "]", ex);
            }
    ...
    private static class AnnotationConverterKey {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return (this.fieldType == otherKey.fieldType
                    && this.annotation.equals(otherKey.annotation));
        }
            ...
            if (converter == null) {
                ...
                converter =
                        new PrinterConverter(
                                this.fieldType, printer, FormattingConversionService.this);
    ...
    private class AnnotationParserConverter implements ConditionalGenericConverter {
        ...
        public Object convert(
            ...
            if (converter == null) {
                ...
                converter =
                        new ParserConverter(
                                this.fieldType, parser, FormattingConversionService.this);
