...
public class LocalValidatorFactoryBean extends SpringValidatorAdapter
    ...
    /**
     * Specify a JSR-303 {@link ValidationProviderResolver} for bootstrapping the provider of
     * choice, as an alternative to {@code META-INF} driven resolution.
     *
     * @since 4.3
     */
     ...
     * on JSR-303's default "ValidationMessages.properties" bundle in the classpath. This may refer
     * to a Spring context's shared "messageSource" bean, or to some special MessageSource setup for
     ...
     * both. If you would like to build a custom MessageInterpolator, consider deriving from
     * Hibernate Validator's {@link ResourceBundleMessageInterpolator} and passing in a Spring-based
     ...
     * MessageSource} must be configured for optional resolution (usually the default). In
     * particular, the {@code MessageSource} instance specified here should not apply {@link
    ...
    /**
     * Set the ParameterNameDiscoverer to use for resolving method and constructor parameter names
     * if needed for message interpolation.
     *
        ...
        if (this.applicationContext != null) {
            try {
                Method eclMethod =
                        configuration
                                .getClass()
                                .getMethod("externalClassLoader", ClassLoader.class);
    ...
    private void configureParameterNameProvider(
        ...
        final ParameterNameProvider defaultProvider =
