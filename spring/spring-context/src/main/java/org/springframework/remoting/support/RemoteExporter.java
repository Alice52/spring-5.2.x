...
public abstract class RemoteExporter extends RemotingSupport {
    ...
    /**
     * Set whether to register a RemoteInvocationTraceInterceptor for exported services. Only
     * applied when a subclass uses {@code getProxyForService} for creating the proxy to expose.
     *
     ...
     * RemoteInvocationTraceInterceptor will <i>not</i> be registered by default if the
     * "interceptors" property has been specified.
     *
     * @see #setInterceptors
     ...
     *
     * <p>You may specify any AOP Alliance MethodInterceptors or other Spring AOP Advices, as well
     * as Spring AOP Advisors.
     *
     * @see #getProxyForService
