...
class BeanUtilsTests {
    ...
    void instantiateClassWithOptionalPrimitiveTypes() throws NoSuchMethodException {
        ...
        BeanWithPrimitiveTypes bean =
                BeanUtils.instantiateClass(
                        constructor, null, null, null, null, null, null, null, null, "foo");
    ...
    private Constructor<BeanWithPrimitiveTypes> getBeanWithPrimitiveTypesConstructor()
            throws NoSuchMethodException {
        return BeanWithPrimitiveTypes.class.getConstructor(
                boolean.class,
                byte.class,
                short.class,
                int.class,
    ...
    void testInstantiatePrivateClassWithPrivateConstructor() throws NoSuchMethodException {
        Constructor<PrivateBeanWithPrivateConstructor> ctor =
                PrivateBeanWithPrivateConstructor.class.getDeclaredConstructor();
    ...
    void testGetPropertyDescriptors() throws Exception {
        PropertyDescriptor[] actual =
                Introspector.getBeanInfo(TestBean.class).getPropertyDescriptors();
        ...
        for (PropertyDescriptor descriptor : descriptors) {
            if ("containedBeans".equals(descriptor.getName())) {
                assertThat(descriptor.getPropertyType().isArray())
                        ...
                        .isTrue();
                assertThat(ContainedBean.class)
                        .isEqualTo(descriptor.getPropertyType().getComponentType());
            }
        }
    }
                ...
                .isThrownBy(
                        () ->
                                BeanUtils.resolveSignature(
                                        "doSomething(", MethodSignatureBean.class));
    }
    ...
    void testResolveWithAndWithoutArgList() throws Exception {
        ...
        assertThat(BeanUtils.resolveSignature("doSomethingElse()", MethodSignatureBean.class))
                .isNull();
    }
    ...
    @ValueSource(
            classes = {
                boolean.class, char.class, byte.class, short.class, int.class, long.class,
                        float.class, double.class,
                Boolean.class, Character.class, Byte.class, Short.class, Integer.class, Long.class,
                        Float.class, Double.class,
                DayOfWeek.class, String.class, LocalDateTime.class, Date.class, URI.class,
    ...
    private static class BeanWithNullableTypes {
        ...
        @SuppressWarnings("unused")
        public BeanWithNullableTypes(
                @Nullable Integer counter, @Nullable Boolean flag, String value) {
