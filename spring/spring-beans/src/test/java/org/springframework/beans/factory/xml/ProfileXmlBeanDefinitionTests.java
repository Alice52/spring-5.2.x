...
public class ProfileXmlBeanDefinitionTests {
    ...
    private static final String MULTI_ELIGIBLE_XML =
    ...
    public void testProfilePermutations() {
        ...
        assertThat(beanFactoryFor(MULTI_NOT_DEV_ELIGIBLE_XML, UNKNOWN_ACTIVE))
                .is(containingTarget());
        assertThat(beanFactoryFor(MULTI_NOT_DEV_ELIGIBLE_XML, DEV_ACTIVE))
    ...
    public void testDefaultProfile() {
        ...
        }
        {
            ...
            reader.loadBeanDefinitions(
                    new ClassPathResource(CUSTOM_DEFAULT_ELIGIBLE_XML, getClass()));
    ...
    public void testDefaultAndNonDefaultProfile() {
...

        {
            ...
            reader.setEnvironment(env);
            reader.loadBeanDefinitions(
                    new ClassPathResource(DEFAULT_AND_DEV_ELIGIBLE_XML, getClass()));
            assertThat(beanFactory).is(containingTarget());
        }
        {
            DefaultListableBeanFactory beanFactory = new DefaultListableBeanFactory();
