...
public class QualifierAnnotationAutowireBeanFactoryTests {
        ...
        assertThat(
                        lbf.isAutowireCandidate(
                                ...
                                new DependencyDescriptor(
                                        Person.class.getDeclaredField("name"), false)))
                .isTrue();
        assertThat(
                        lbf.isAutowireCandidate(
                                JUERGEN,
                                new DependencyDescriptor(
                                        Person.class.getDeclaredField("name"), true)))
                .isTrue();
    }
    ...
    public void testAutowireCandidateWithConstructorDescriptor() throws Exception {
        ...
        MethodParameter param =
                new MethodParameter(
                        QualifiedTestBean.class.getDeclaredConstructor(Person.class), 0);
    ...
    public void testAutowireCandidateWithMethodDescriptor() throws Exception {
        ...
        MethodParameter qualifiedParam =
                new MethodParameter(
                        QualifiedTestBean.class.getDeclaredMethod(
                                "autowireQualified", Person.class),
                        0);
        MethodParameter nonqualifiedParam =
                new MethodParameter(
                        QualifiedTestBean.class.getDeclaredMethod(
                                "autowireNonqualified", Person.class),
                        0);
