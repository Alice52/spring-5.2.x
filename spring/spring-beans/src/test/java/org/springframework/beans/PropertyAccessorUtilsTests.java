...
public class PropertyAccessorUtilsTests {
    ...
    public void getFirstNestedPropertySeparatorIndex() {
        assertThat(PropertyAccessorUtils.getFirstNestedPropertySeparatorIndex("[user]"))
                .isEqualTo(-1);
    ...
    public void getLastNestedPropertySeparatorIndex() {
        assertThat(PropertyAccessorUtils.getLastNestedPropertySeparatorIndex("[user]"))
                .isEqualTo(-1);
    ...
    public void canonicalPropertyName() {
        ...
        assertThat(PropertyAccessorUtils.canonicalPropertyName("map['key1']"))
                .isEqualTo("map[key1]");
        assertThat(PropertyAccessorUtils.canonicalPropertyName("map[\"key1\"]"))
                .isEqualTo("map[key1]");
