...
public class BeanFactoryUtilsTests {
    ...
    public void testHierarchicalNamesWithMatchOnlyInRoot() {
        ...
        assertThat(listableBeanFactory.getBeanNamesForType(IndexedTestBean.class).length == 0)
                .isTrue();
    }
    ...
    public void findAnnotationOnBean() {
        ...
        this.listableBeanFactory.registerSingleton(
                "restControllerAdvice", new RestControllerAdviceClass());
    ...
    private void assertControllerAdvice(ListableBeanFactory lbf, String beanName) {
        ControllerAdvice controllerAdvice =
                lbf.findAnnotationOnBean(beanName, ControllerAdvice.class);
