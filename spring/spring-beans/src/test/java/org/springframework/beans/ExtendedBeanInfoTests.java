...
public class ExtendedBeanInfoTests {
    ...
    public void standardReadMethodsAndOverloadedNonStandardWriteMethods() throws Exception {
        ...
        for (PropertyDescriptor pd : ebi.getPropertyDescriptors()) {
            if (pd.getName().equals("foo")) {
                assertThat(pd.getWriteMethod())
                        .isEqualTo(C.class.getMethod("setFoo", String.class));
                return;
            }
        }
    ...
    @Test
    public void standardReadMethodInSuperclassAndNonStandardWriteMethodInSubclass()
            throws Exception {
        @SuppressWarnings("unused")
        class B {
            public String getFoo() {
    ...
    public void indexedReadAndNonStandardIndexedWrite() throws IntrospectionException {
        ...
        assertThat(hasIndexedReadMethodForProperty(bi, "foos")).isTrue();
        // interesting! standard Inspector picks up non-void return types on indexed write methods
        // by default
        assertThat(hasIndexedWriteMethodForProperty(bi, "foos")).isFalse();
    ...
    public void indexedReadAndNonStandardWriteAndNonStandardIndexedWrite()
        ...
        assertThat(hasIndexedReadMethodForProperty(bi, "foos")).isTrue();
        assertThat(hasWriteMethodForProperty(bi, "foos")).isFalse();
        // again as above, standard Inspector picks up non-void return types on indexed write
        // methods by default
        assertThat(hasIndexedWriteMethodForProperty(bi, "foos")).isFalse();
     ...
     * intermittently (approximately one out of every four times) under JDK 7 due to
     * non-deterministic results from {@link Class#getDeclaredMethods()}. See
    ...
    public void subclassWriteMethodWithCovariantReturnType() throws IntrospectionException {
        ...
        assertThat(ebi.getPropertyDescriptors().length)
                .isEqualTo(bi.getPropertyDescriptors().length);
    }
     ...
     * corresponding indexed read method would fail to be processed correctly by ExtendedBeanInfo.
     * The local class C below represents the relevant methods from Google's GsonBuilder class.
    ...
    public void propertyDescriptorComparator() throws IntrospectionException {
        ...
        assertThat(
                        c.compare(
                                new PropertyDescriptor("a", null, null),
                                new PropertyDescriptor("a", null, null)))
                .isEqualTo(0);
        assertThat(
                        c.compare(
        ...
        assertThat(
                        c.compare(
                                new PropertyDescriptor("a", null, null),
                                new PropertyDescriptor("b", null, null)))
                .isLessThan(0);
        assertThat(
                        c.compare(
                                new PropertyDescriptor("b", null, null),
        ...
        assertThat(
                        c.compare(
                                new PropertyDescriptor("1", null, null),
                                new PropertyDescriptor("a", null, null)))
                .isLessThan(0);
        assertThat(
                        c.compare(
    ...
    public void cornerSpr8937AndSpr12582() throws IntrospectionException {
        ...
        assertThat(hasIndexedWriteMethodForProperty(ebi, "address"))
                .isEqualTo(hasIndexedWriteMethod);
    }
    ...
    public void shouldSupportStaticWriteMethod() throws IntrospectionException {
        ...
        {
            BeanInfo bi =
                    new ExtendedBeanInfo(Introspector.getBeanInfo(WithStaticWriteMethod.class));
            assertThat(hasReadMethodForProperty(bi, "prop1")).isFalse();
