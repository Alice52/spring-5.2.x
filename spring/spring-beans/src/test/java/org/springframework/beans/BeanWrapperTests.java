...
public class BeanWrapperTests extends AbstractPropertyAccessorTests {
    ...
    public void setReadOnlyMapProperty() {
        TypedReadOnlyMap map =
                new TypedReadOnlyMap(Collections.singletonMap("key", new TestBean()));
    ...
    public void notWritablePropertyExceptionContainsAlternativeMatch() {
        ...
        try {
            ...
            assertThat(ex.getPossibleMatches().length)
                    .as("Invalid amount of alternatives")
                    .isEqualTo(1);
        }
    }
    ...
    public void propertyDescriptors() {
        ...
        assertThat(accessor.getPropertyDescriptor("name").getPropertyType())
