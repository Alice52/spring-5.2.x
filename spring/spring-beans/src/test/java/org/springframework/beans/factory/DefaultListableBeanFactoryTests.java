...
class DefaultListableBeanFactoryTests {
    ...
    void unreferencedSingletonWasInstantiated() {
        ...
        assertThat(!KnowsIfInstantiated.wasInstantiated())
                .as("singleton not instantiated")
                .isTrue();
        ...
        assertThat(
                        lbf.isTypeMatch(
                                ...
                                ResolvableType.forClassWithGenerics(
                                        FactoryBean.class, Object.class)))
                .isTrue();
        assertThat(
                        lbf.isTypeMatch(
                                "&x1",
                                ResolvableType.forClassWithGenerics(
                                        FactoryBean.class, String.class)))
                .isFalse();
        assertThat(lbf.getType("x1")).isEqualTo(TestBean.class);
    ...
    void possibleMatches() {
        ...
        assertThatExceptionOfType(BeanCreationException.class)
                ...
                .satisfies(
                        ex -> {
                            NotWritablePropertyException cause =
                                    (NotWritablePropertyException) ex.getCause();
    ...
    void prototypeCircleLeadsToException() {
        ...
        assertThatExceptionOfType(BeanCreationException.class)
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.contains(BeanCurrentlyInCreationException.class))
                                        .isTrue());
    }
    ...
    void canReferenceParentBeanFromChildViaAlias() {
        ...
        assertThat(mergedBeanDefinition1)
                .as("Use cached merged bean definition")
                .isSameAs(mergedBeanDefinition2);
    }
    ...
    void autowireWithNoDependencies() {
        ...
        Object registered =
                lbf.autowire(
                        NoDependencies.class, AutowireCapableBeanFactory.AUTOWIRE_BY_TYPE, false);
        assertThat(lbf.getBeanDefinitionCount()).isEqualTo(1);
    ...
    void resolveNamedBeanByTypeWithNullRequiredType() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> lbf.resolveNamedBean((Class<?>) null));
    }
    ...
    void getBeanByTypeInstanceFiltersOutNonAutowireCandidates() {
        ...
        lbf.registerBeanDefinition("bd1", bd1);
        lbf.registerBeanDefinition("na1", na1);
        ConstructorDependency actual =
                lbf.getBean(ConstructorDependency.class, 42); // na1 was filtered
    ...
    void getBeanWithArgsNotCreatedForFactoryBeanChecking() {
        ...
        assertThat(lbf.getBeanNamesForType(ConstructorDependencyFactoryBean.class).length)
                .isEqualTo(1);
        assertThat(
    ...
    void autowireExistingBeanByTypeWithNoDependencyCheck() {
        DependenciesBean existingBean = new DependenciesBean();
        lbf.autowireBeanProperties(
                existingBean, AutowireCapableBeanFactory.AUTOWIRE_BY_TYPE, false);
        assertThat(existingBean.getSpouse()).isNull();
    }
    ...
    void extensiveCircularReference() {
        for (int i = 0; i < 1000; i++) {
            ...
            pvs.addPropertyValue(
                    new PropertyValue(
                            "spouse", new RuntimeBeanReference("bean" + (i < 99 ? i + 1 : 0))));
            RootBeanDefinition bd = new RootBeanDefinition(TestBean.class);
            bd.setPropertyValues(pvs);
    ...
    void constructorDependencyWithClassResolution() {
        RootBeanDefinition bd =
                new RootBeanDefinition(ConstructorDependencyWithClassResolution.class);
    ...
    void prototypeFactoryBeanNotEagerlyCalledInCaseOfBeanClassName() {
        lbf.registerBeanDefinition(
                "test",
                new RootBeanDefinition(
                        FactoryBeanThatShouldntBeCalled.class.getName(), null, null));
        lbf.preInstantiateSingletons();
    }
    ...
    void prototypeStringCreatedRepeatedly() {
        ...
        stringDef
                ...
                .addGenericArgumentValue(new TypedStringValue("value"));
    ...
    void prototypeCreationWithResolvedConstructorArgumentsIsFastEnough() {
        ...
        rbd.getConstructorArgumentValues()
                .addGenericArgumentValue(new RuntimeBeanReference("spouse"));
        lbf.registerBeanDefinition("test", rbd);
     ...
     *     1.2.4 to determine the type of a prototype created from invoking a factory method on a
     *     bean instance in the factory.
     */
        ...
        TestSecuredBean bean =
                (TestSecuredBean)
                        Subject.doAsPrivileged(
                                subject, (PrivilegedAction) () -> lbf.getBean("test"), null);
    ...
    /**
     * Test that by-type bean lookup caching is working effectively by searching for a bean of type
     * B 10K times within a container having 1K additional beans of type A. Prior to by-type
     * caching, each bean lookup would traverse the entire container (all 1001 beans), performing
     * expensive assignability checks, etc. Now these operations are necessary only once, providing
     * a dramatic performance improvement. On load-free modern hardware (e.g. an 8-core MPB), this
     * method should complete well under the 1000 ms timeout, usually ~= 300ms. With caching removed
     * and on the same hardware the method will take ~13000 ms. See SPR-6870.
     */
    @Test
    @Timeout(1)
    @EnabledForTestGroups(TestGroup.PERFORMANCE)
