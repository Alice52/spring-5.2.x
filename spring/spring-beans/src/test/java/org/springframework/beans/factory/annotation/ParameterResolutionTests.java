...
public class ParameterResolutionTests {
    ...
    private void assertAutowirableParameters(Executable executable) {
        ...
        for (int parameterIndex = startIndex;
    ...
    public void nonAnnotatedParametersInTopLevelClassConstructorAreNotCandidatesForAutowiring()
            throws Exception {
        Constructor<?> notAutowirableConstructor =
                AutowirableClass.class.getConstructor(String.class);
    ...
    @Test
    public void resolveDependencyForAnnotatedParametersInTopLevelClassConstructor()
            throws Exception {
        Constructor<?> constructor =
                AutowirableClass.class.getConstructor(
                        String.class, String.class, String.class, String.class);
        ...
        for (int parameterIndex = 0; parameterIndex < parameters.length; parameterIndex++) {
            ...
            assertThat(intermediateDependencyDescriptor.getAnnotatedElement())
