...
public interface PropertyAccessor {
     ...
     * @throws InvalidPropertyException if there is no such property or if the property isn't
     *     readable
     * @throws PropertyAccessException if the property was valid but the accessor method failed
     */
    @Nullable
     ...
     *
     * <p>Bulk updates from PropertyValues are more powerful: This method is provided for
     * convenience. Behavior will be identical to that of the {@link
     * #setPropertyValues(PropertyValues)} method.
     *
