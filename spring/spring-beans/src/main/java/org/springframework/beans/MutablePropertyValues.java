...
public class MutablePropertyValues implements PropertyValues, Serializable {
    ...
    /**
     * Overloaded version of {@code addPropertyValue} that takes a property name and a property
     * value.
     *
    ...
    public boolean contains(String propertyName) {
        return (getPropertyValue(propertyName) != null
                || (this.processedProperties != null
                        && this.processedProperties.contains(propertyName)));
    }
    ...
    /**
     * Return whether this holder contains converted values only ({@code true}), or whether the
     * values still need to be converted ({@code false}).
     */
    ...
    public boolean equals(@Nullable Object other) {
        return (this == other
                || (other instanceof MutablePropertyValues
                        && this.propertyValueList.equals(
                                ((MutablePropertyValues) other).propertyValueList)));
    }
