 ...
 *
 * <p>entityResolver的作用是项目本身就可以提供一个如何寻找DTD的声明方法，即由程序来实现寻找DTD声明的过程。比如我们将DTD放在项目的某处在实现时直接将
 * 此文档读取并返回SAX即可，这样就避免了通过网络来寻找DTD的声明
 *
 * <p>{@link EntityResolver} implementation that delegates to a {@link BeansDtdResolver} and a
 * {@link PluggableSchemaResolver} for DTDs and XML schemas, respectively.
 *
 * @author Rob Harrop
...
public class DelegatingEntityResolver implements EntityResolver {
    ...
    /**
     * Create a new DelegatingEntityResolver that delegates to a default {@link BeansDtdResolver}
     * and a default {@link PluggableSchemaResolver}.
     *
