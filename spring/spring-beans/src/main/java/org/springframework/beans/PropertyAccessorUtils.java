...
public abstract class PropertyAccessorUtils {
     ...
     *
     * @param propertyPath the property path to determine the property name for (can include
     *     property keys, for example for specifying a map entry)
    ...
    /**
     * Determine the first nested property separator in the given property path, ignoring dots in
     * keys (like "map[my.key]").
     *
     * @param propertyPath the property path to check
