 ...
 *
 * <p>Support base class for singleton registries which need to handle {@link
...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
    ...
    /**
     * 由FactoryBeans创建的单例对象的缓存:FactoryBean名称到对象 Cache of singleton objects created by FactoryBeans:
     * FactoryBean name to object.
     */
     ...
     *
     * <p>Determine the type for the given FactoryBean.
     *
        ...
        try {
            ...
            if (System.getSecurityManager() != null) {
                ...
                return AccessController.doPrivileged(
                        (PrivilegedAction<Class<?>>) factoryBean::getObjectType,
     ...
     *
     * <p>Obtain an object to expose from the given FactoryBean, if available in cached form. Quick
     * check for minimal synchronization.
     *
     ...
     *
     * <p>Obtain an object to expose from the given FactoryBean.
     *
        ...
        if (factory.isSingleton() && containsSingleton(beanName)) {
            ...
            synchronized (getSingletonMutex()) {
                ...
                if (object == null) {
                    ...
                    // Only post-process and store if not put there already during getObject() call
                    // above
                    // (e.g. because of circular reference processing triggered by custom getBean
                    // calls)
                    ...
                    if (alreadyThere != null) {
                        ...
                        if (shouldPostProcess) {
                            ...
                            if (isSingletonCurrentlyInCreation(beanName)) {
                                // Temporarily return non-post-processed object, not storing it
                                // yet..
                                // 暂时返回未处理的对象,尚未存储
                                // 直接返回object
                                return object;
     ...
     *
     * <p>Post-process the given object that has been obtained from the FactoryBean. The resulting
     * object will get exposed for bean references.
     *
     ...
     *
     * <p>Overridden to clear the FactoryBean object cache as well.
     */
    @Override
     ...
     *
     * <p>Return the security context for this bean factory. If a security manager is set,
     * interaction with the user code will be executed using the privileged of the security context
