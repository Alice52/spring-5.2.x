...
public class MutableSortDefinition implements SortDefinition, Serializable {
     ...
     *
     * @param toggleAscendingOnSameProperty whether to toggle the ascending flag if the same
     *     property gets set again (that is, {@code setProperty} gets called with already set
     *     property name again).
     */
