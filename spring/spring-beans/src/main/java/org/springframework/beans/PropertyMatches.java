...
public abstract class PropertyMatches {
     ...
     * @param maxDistance the maximum property distance allowed for matches
     */
    public static PropertyMatches forField(
            String propertyName, Class<?> beanClass, int maxDistance) {
    ...
    private static class BeanPropertyMatches extends PropertyMatches {
        ...
        public BeanPropertyMatches(String propertyName, Class<?> beanClass, int maxDistance) {
            super(
                    ...
                    calculateMatches(
                            propertyName,
                            BeanUtils.getPropertyDescriptors(beanClass),
                            maxDistance));
        }

        /**
         * Generate possible property alternatives for the given property and class. Internally uses
         * the {@code getStringDistance} method, which in turn uses the Levenshtein algorithm to
