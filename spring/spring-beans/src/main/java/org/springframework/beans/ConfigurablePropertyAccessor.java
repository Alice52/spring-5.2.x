...
public interface ConfigurablePropertyAccessor
    ...
    /**
     * Return whether to extract the old property value when applying a property editor to a new
     ...
     * null} value.
     *
     * <p>If {@code true}, a {@code null} path location will be populated with a default object
     * value and traversed instead of resulting in a {@link NullValueInNestedPathException}.
     *
