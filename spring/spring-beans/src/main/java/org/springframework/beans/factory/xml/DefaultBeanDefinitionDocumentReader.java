...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
    ...
    /**
     * Allow the XML to be extensible by processing any custom element types first, before we start
     * to process the bean definitions. This method is a natural extension point for any other
     ...
     * processing the bean definitions. This method is a natural extension point for any other
