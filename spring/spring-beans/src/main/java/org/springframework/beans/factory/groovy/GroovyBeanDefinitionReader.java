...
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader
     ...
     * XmlBeanDefinitionReader}, loading bean definitions into its {@code BeanDefinitionRegistry}
     ...
     *     from and to delegate Groovy DSL loading to
     */
    ...
    public AbstractBeanDefinition bean(Class<?> type, Object... args) {
        ...
        try {
            ...
            this.currentBeanDefinition =
                    new GroovyBeanDefinitionWrapper(null, type, constructorArgs);
            if (callable != null) {
            ...
            for (Map.Entry<String, String> entry : definition.entrySet()) {
                ...
                if (uri == null) {
                    throw new IllegalArgumentException(
                            "Namespace definition must supply a non-null URI");
                }
                NamespaceHandler namespaceHandler =
                        this.groovyDslXmlBeanDefinitionReader
    ...
    /**
     * Import Spring bean definitions from either XML or Groovy sources into the current bean
     * builder instance.
     *
    ...
    /**
     * This method overrides method invocation to create beans for each method name that takes a
     * class argument.
     */
    @Override
        ...
        if (args[0] instanceof Class) {
            ...
            if (hasClosureArgument) {
                if (args.length - 1 != 1) {
                    ...
                    this.currentBeanDefinition =
                            new GroovyBeanDefinitionWrapper(beanName, beanClass);
                }
            } else {
                this.currentBeanDefinition =
                        new GroovyBeanDefinitionWrapper(
            ...
            // factory method syntax
                ...
                Map.Entry<?, ?> factoryBeanEntry =
                        ((Map<?, ?>) args[0]).entrySet().iterator().next();
            ...
            List<Object> constructorArgs =
                    resolveConstructorArguments(
                            args, 0, hasClosureArgument ? args.length - 1 : args.length);
            this.currentBeanDefinition =
                    new GroovyBeanDefinitionWrapper(beanName, null, constructorArgs);
        }
        ...
        if (addDeferredProperty(name, value)) {
            ...
            try {
                ...
                if (Object.class == parameterType) {
                    ...
                    this.currentBeanDefinition =
                            new GroovyBeanDefinitionWrapper(null, parameterType);
        ...
        if (binding != null && binding.hasVariable(name)) {
            ...
            // statement in a closure (hence the return value)
                ...
                if (pvs.contains(name)) {
                    ...
                    DeferredProperty dp =
                            this.deferredProperties.get(
                                    this.currentBeanDefinition.getBeanName() + name);
                    if (dp != null) {
                        return dp.value;
                    } else {
    ...
    /**
     * This class is used to defer the adding of a property to a bean definition until later. This
     * is for a case where you assign a property to a list that may not contain bean references at
    ...
    private static class DeferredProperty {
        ...
        public DeferredProperty(
                GroovyBeanDefinitionWrapper beanDefinition, String name, Object value) {
    ...
    private class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
        ...
        /**
         * Wraps a bean definition property and ensures that any RuntimeBeanReference additions to
         * it are deferred for resolution later.
         */
        private class GroovyPropertyValue extends GroovyObjectSupport {
            ...
            public boolean add(Object value) {
                boolean retVal =
                        (Boolean) InvokerHelper.invokeMethod(this.propertyValue, "add", value);
                updateDeferredProperties(value);
                return retVal;
            }
            ...
            public boolean addAll(Collection<?> values) {
                boolean retVal =
                        (Boolean) InvokerHelper.invokeMethod(this.propertyValue, "addAll", values);
            ...
            private void updateDeferredProperties(Object value) {
                if (value instanceof RuntimeBeanReference) {
                    deferredProperties.put(
                            ...
                            new DeferredProperty(
                                    beanDefinition, this.propertyName, this.propertyValue));
                }
            }
        }
    }
