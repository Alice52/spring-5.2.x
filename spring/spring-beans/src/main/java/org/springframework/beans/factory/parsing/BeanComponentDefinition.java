...
public class BeanComponentDefinition extends BeanDefinitionHolder implements ComponentDefinition {
     ...
     * Create a new BeanComponentDefinition for the given bean.
     *
     * @param beanDefinitionHolder the BeanDefinitionHolder encapsulating the bean definition as
     *     well as the name of the bean
     */
    ...
    /**
     * This implementations expects the other object to be of type BeanComponentDefinition as well,
     * in addition to the superclass's equality requirements.
     */
    @Override
