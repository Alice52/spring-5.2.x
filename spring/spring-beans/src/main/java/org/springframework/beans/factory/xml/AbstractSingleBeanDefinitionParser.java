...
public abstract class AbstractSingleBeanDefinitionParser extends AbstractBeanDefinitionParser {
     ...
     * class. The BeanDefinitionParser and its NamespaceHandler can be used within an IDE plugin
     * then, even if the application classes are not available on the plugin's classpath.
     *
     * @param element the {@code Element} that is being parsed
