...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
     ...
     *
     * <p>Subclasses may override this to select one of the instances or to opt out with no result
     * at all through returning {@code null}.
     *
     ...
     *
     * <p>The resolution algorithm will first attempt to resolve a shortcut through this method
     * before going into the regular type matching algorithm across all beans. Subclasses may
     * override this method to improve resolution performance based on pre-cached information while
     * still receiving {@link InjectionPoint} exposure etc.
     *
     ...
     *
     * <p>Resolve the specified bean name, as a candidate result of the matching algorithm for this
     * dependency, to a bean instance from the given factory.
     *
     * <p>The default implementation calls {@link BeanFactory#getBean(String)}. Subclasses may
     * provide additional arguments or other customizations.
     *
            ...
            resolvableType =
                    (this.field != null
                            ? ResolvableType.forField(
                                    this.field, this.nestingLevel, this.containingClass)
    ...
    public TypeDescriptor getTypeDescriptor() {
        ...
        if (typeDescriptor == null) {
            typeDescriptor =
                    (this.field != null
                            ? new TypeDescriptor(
                                    getResolvableType(), getDependencyType(), getAnnotations())
     ...
     * suggest to an {@link org.springframework.beans.factory.support.AutowireCandidateResolver}
