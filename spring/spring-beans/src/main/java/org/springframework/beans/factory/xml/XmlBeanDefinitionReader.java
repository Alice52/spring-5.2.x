...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
     ...
     *
     * <p>This is typically not needed when schema validation is active. However, without
     * validation, this has to be switched to "true" in order to properly process schema namespaces.
     */
    ...
    public void setEventListener(@Nullable ReaderEventListener eventListener) {
        this.eventListener =
                (eventListener != null ? eventListener : new EmptyReaderEventListener());
    }

    /**
     * Specify the {@link SourceExtractor} to use.
     *
     * <p>The default implementation is {@link NullSourceExtractor} which simply returns {@code
     * null} as the source object. This means that - during normal runtime execution - no additional
     * source metadata is attached to the bean configuration metadata.
     */
    public void setSourceExtractor(@Nullable SourceExtractor sourceExtractor) {
        this.sourceExtractor =
                (sourceExtractor != null ? sourceExtractor : new NullSourceExtractor());
    }
    ...
    public void setDocumentLoader(@Nullable DocumentLoader documentLoader) {
        this.documentLoader =
                (documentLoader != null ? documentLoader : new DefaultDocumentLoader());
    }
     ...
     *
     * <p>By default, {@link ResourceEntityResolver} will be used. Can be overridden for custom
     * entity resolution, for example relative to some specific base path.
     */
    ...
    /**
     * Set an implementation of the {@code org.xml.sax.ErrorHandler} interface for custom handling
     * of XML parsing errors and warnings.
     *
     ...
     * mode has been configured, then the validation mode gets {@link #detectValidationMode
     * detected} from the given resource.
     *
