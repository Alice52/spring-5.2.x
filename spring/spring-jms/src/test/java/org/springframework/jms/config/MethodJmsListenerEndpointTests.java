...
class MethodJmsListenerEndpointTests {
    ...
    void setExtraCollaborators() {
        ...
        MessagingMessageListenerAdapter listener =
                createInstance(
                        this.factory,
                        getListenerMethod("resolveObjectPayload", MyBean.class),
                        this.container);
    ...
    void processAndReplyWithSendToQueue() throws JMSException {
        ...
        MessagingMessageListenerAdapter listener =
                createInstance(
                        this.factory, getListenerMethod(methodName, String.class), container);
    ...
    private void processAndReplyWithSendTo(
        ...
        verify(destinationResolver)
                .resolveDestinationName(session, replyDestinationName, pubSubDomain);
        verify(reply).setJMSCorrelationID(correlationId);
    ...
    void validatePayloadInvalid() throws JMSException {
        ...
        assertThatExceptionOfType(ListenerExecutionFailedException.class)
                .isThrownBy(
                        () ->
                                listener.onMessage(
                                        createSimpleJmsTextMessage("invalid value"), session));
    }
    ...
    static class JmsEndpointSampleBean {
        ...
        public void resolveMessageHeaders(MessageHeaders headers) {
            ...
            assertThat((long) headers.get("customLong"))
                    .as("Missing custom header")
                    .isEqualTo(4567);
        }
        ...
        public void resolveJmsMessageHeaderAccessor(JmsMessageHeaderAccessor headers) {
            ...
            assertThat(headers.getHeader("customBoolean"))
                    .as("Missing custom header")
                    .isEqualTo(true);
        }
