...
abstract class AbstractJmsAnnotationDrivenTests {
    ...
    protected void testSampleConfiguration(ApplicationContext context) {
        JmsListenerContainerTestFactory defaultFactory =
                context.getBean(
                        "jmsListenerContainerFactory", JmsListenerContainerTestFactory.class);
    ...
    /**
     * Test for {@link CustomBean} and an manually endpoint registered with "myCustomEndpointId".
     * The custom endpoint does not provide any factory so it's registered with the default one
     */
    ...
    /**
     * Test for {@link DefaultBean} that does not define the container factory to use as a default
     * is registered with an explicit default.
     */
    ...
    /**
     * Test for {@link DefaultBean} that does not define the container factory to use as a default
     * is registered with the default name.
     */
    ...
    /**
     * Test for {@link ValidationBean} with a validator ({@link TestValidator}) specified in a
     * custom {@link
    ...
    /**
     * Test for {@link JmsListenerRepeatableBean} and {@link JmsListenersBean} that validates that
     * the {@code @JmsListener} annotation is repeatable and generate one specific container per
     * annotation.
     */
