...
public class JmsInvokerTests {
    ...
    public void setUpMocks() throws Exception {
        ...
        given(mockConnection.createSession(false, Session.AUTO_ACKNOWLEDGE))
    ...
    @Test
    public void testJmsInvokerProxyFactoryBeanAndServiceExporterWithDynamicQueue()
            throws Throwable {
        ...
        JmsInvokerProxyFactoryBean pfb =
                new JmsInvokerProxyFactoryBean() {
                    ...
                    protected Message doExecuteRequest(
                            Session session, Queue queue, Message requestMessage)
                            throws JMSException {
