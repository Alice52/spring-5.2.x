...
public class JmsNamespaceHandlerTests {
    ...
    public void testJcaContainerConfiguration() throws Exception {
        ...
        Object endpointFactory =
                new DirectFieldAccessor(listener3).getPropertyValue("endpointFactory");
    ...
    public void testListeners() throws Exception {
        ...
        MessageListener listener3 =
                getListener(DefaultMessageListenerContainer.class.getName() + "#0");
    ...
    private void validateComponentDefinition(ComponentDefinition compDef) {
        ...
        for (BeanDefinition beanDef : beanDefs) {
            assertThat(beanDef.getSource())
                    .as("BeanDefinition has no source attachment")
                    .isNotNull();
        }
    }
