...
public abstract class AbstractJmsListeningContainer extends JmsDestinationAccessor
    ...
    /**
     * Return the JMS client ID for the shared Connection created and used by this container, if
     * any.
     */
    @Nullable
     ...
     * this value is Integer.MAX_VALUE meaning that this container starts as late as possible and
    ...
    /**
     * Determine whether this container is currently running, that is, whether it has been started
     * and not stopped yet.
     *
     * @see #start()
     * @see #stop()
     ...
     * 'running' state, returning {@code false} if such a restriction prevents listeners from
     * running.
     */
     ...
     *
     * <p>The default implementation simply logs a corresponding message at warn level.
     *
