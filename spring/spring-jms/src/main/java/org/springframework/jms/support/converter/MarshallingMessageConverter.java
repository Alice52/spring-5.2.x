...
public class MarshallingMessageConverter implements MessageConverter, InitializingBean {
    ...
    public Object fromMessage(Message message) throws JMSException, MessageConversionException {
        ...
        try {
            ...
            throw new MessageConversionException(
                    "Could not access message content: " + message, ex);
     ...
     */
    protected TextMessage marshalToTextMessage(
    ...
    /**
     * Template method that allows for custom message marshalling. Invoked when {@link
