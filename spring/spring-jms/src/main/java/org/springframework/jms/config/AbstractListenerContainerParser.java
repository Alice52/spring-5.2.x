...
abstract class AbstractListenerContainerParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        MutablePropertyValues commonProperties =
                parseCommonContainerProperties(element, parserContext);
        ...
        if (StringUtils.hasText(factoryId)) {
            ...
            if (beanDefinition != null) {
                ...
                parserContext.registerBeanComponent(
                        new BeanComponentDefinition(beanDefinition, factoryId));
            }
        }
    ...
    protected MutablePropertyValues parseCommonContainerProperties(
        ...
        if (DESTINATION_TYPE_SHARED_DURABLE_TOPIC.equals(destinationType)) {
            ...
            pubSubDomain = true;
        } else if (!StringUtils.hasLength(destinationType)
        ...
        String replyDestinationType =
                containerEle.getAttribute(RESPONSE_DESTINATION_TYPE_ATTRIBUTE);
        ...
        if (containerEle.hasAttribute(CLIENT_ID_ATTRIBUTE)) {
            ...
            if (!StringUtils.hasText(clientId)) {
                parserContext
                        .getReaderContext()
                        .error(
                                "Listener 'client-id' attribute contains empty value.",
                                containerEle);
            }
    ...
    /**
     * Create the {@link BeanDefinition} for the container factory using the specified shared
     * property values.
     */
    @Nullable
