...
public class MappingJackson2MessageConverter
    ...
    /**
     * Specify whether {@link #toMessage(Object, Session)} should marshal to a {@link BytesMessage}
     * or a {@link TextMessage}.
     *
     ...
     *
     * <p>When reading from a text-based message, an encoding may have been suggested through a
    ...
    /**
     * Specify the name of the JMS message property that carries the encoding from bytes to String
     * and back is BytesMessage is used during the conversion process.
     *
    ...
    /**
     * Specify the name of the JMS message property that carries the type id for the contained
     * object: either a mapped id value or a raw Java class name.
     *
        ...
        try {
            switch (this.targetType) {
                ...
                default:
                    message =
                            mapToMessage(
                                    object, session, this.objectMapper.writer(), this.targetType);
            }
     ...
     */
    protected TextMessage mapToTextMessage(
    ...
    /**
     * Template method that allows for custom message mapping. Invoked when {@link #setTargetType}
    ...
    protected Object convertFromBytesMessage(BytesMessage message, JavaType targetJavaType)
        ...
        if (this.encodingPropertyName != null
                && message.propertyExists(this.encodingPropertyName)) {
