...
public class JmsActivationSpecConfig {
     ...
     *
     * <p>Note that JCA resource adapters generally only support auto and dups-ok (see Spring's
     * {@link StandardJmsActivationSpecFactory}). ActiveMQ also supports "SESSION_TRANSACTED" in the
     * form of RA-managed transactions (automatically translated by Spring's {@link
     ...
     * org.springframework.jms.listener.DefaultMessageListenerContainer}. For this activation
     * config, generally use {@link #setMaxConcurrency} instead.
     */
    ...
    /**
     * Specify the maximum number of consumers/sessions to use, effectively controlling the number
     * of concurrent invocations on the target listener.
     */
