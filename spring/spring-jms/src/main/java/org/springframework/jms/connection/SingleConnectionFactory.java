...
public class SingleConnectionFactory
    ...
    /**
     * Return the target ConnectionFactory which will be used to lazily create a single Connection,
     * if any.
     */
    @Nullable
     ...
     *
     * <p>Internally, this will lead to a special JMS ExceptionListener (this
     * SingleConnectionFactory itself) being registered with the underlying Connection. This can
     * also be combined with a user-specified ExceptionListener, if desired.
     *
    ...
    public void afterPropertiesSet() {
        if (this.connection == null && getTargetConnectionFactory() == null) {
            throw new IllegalArgumentException(
                    "Target Connection or ConnectionFactory is required");
        }
    }
    ...
    public QueueConnection createQueueConnection() throws JMSException {
        ...
        if (!(con instanceof QueueConnection)) {
            throw new javax.jms.IllegalStateException(
                    "This SingleConnectionFactory does not hold a QueueConnection but rather: "
                            + con);
        }
    ...
    public TopicConnection createTopicConnection() throws JMSException {
        ...
        if (!(con instanceof TopicConnection)) {
            throw new javax.jms.IllegalStateException(
                    "This SingleConnectionFactory does not hold a TopicConnection but rather: "
                            + con);
        }
        ...
        public Object invoke(Object proxy, Method method, @Nullable Object[] args)
            ...
            if (method.getName().equals("equals") && args != null) {
                ...
                return (otherHandler instanceof SharedConnectionInvocationHandler
                        && factory()
                                == ((SharedConnectionInvocationHandler) otherHandler).factory());
                    ...
                    if (aggregatedExceptionListener != null) {
                        ...
                        if (listener != this.localExceptionListener) {
                            if (this.localExceptionListener != null) {
                                aggregatedExceptionListener.delegates.remove(
