...
public class JibxMarshaller extends AbstractMarshaller implements InitializingBean {
    ...
    /**
     * Set the root element name for the DTD declaration written when marshalling. By default, this
     * is {@code null} (i.e. no DTD declaration is written).
     *
    ...
    /**
     * Set the system id for the DTD declaration written when marshalling. By default, this is
    ...
    /**
     * Set the public id for the DTD declaration written when marshalling. By default, this is
     * {@code null}. Only used when the root element also has been set.
     *
    ...
    public void afterPropertiesSet() throws JiBXException {
        if (this.targetClass != null) {
            ...
            throw new IllegalArgumentException(
                    "Either 'targetClass' or 'targetPackage' is required");
        }
    }
    ...
    protected void marshalDomNode(Object graph, Node node) throws XmlMappingException {
        try {
            // JiBX does not support DOM natively, so we write to a buffer first, and transform that
            // to the Node
    ...
    protected void marshalSaxHandlers(
            ...
            throws XmlMappingException {
        try {
            // JiBX does not support SAX natively, so we write to a buffer first, and transform that
            // to the handlers
    ...
    protected Object unmarshalSaxReader(XMLReader xmlReader, InputSource inputSource)
        ...
        return transformAndUnmarshal(
                new SAXSource(xmlReader, inputSource), inputSource.getEncoding());
    }
