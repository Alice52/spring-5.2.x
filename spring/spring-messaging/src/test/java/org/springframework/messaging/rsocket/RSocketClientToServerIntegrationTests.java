...
public class RSocketClientToServerIntegrationTests {
    ...
    public void voidReturnValue() {
        Mono<String> result =
                requester.route("void-return-value").data("Hello").retrieveMono(String.class);
    ...
    public void voidReturnValueFromExceptionHandler() {
        Mono<String> result =
                requester.route("void-return-value").data("bad").retrieveMono(String.class);
        StepVerifier.create(result).expectComplete().verify(Duration.ofSeconds(5));
    }
    ...
    public void handleWithThrownException() {
        Mono<String> result =
                requester.route("thrown-exception").data("a").retrieveMono(String.class);
        StepVerifier.create(result)
    ...
    public void noMatchingRoute() {
        Mono<String> result =
                requester.route("invalid").data("anything").retrieveMono(String.class);
        StepVerifier.create(result)
