...
public class ProtobufMessageConverterTests {
    ...
    public void setup() {
        ...
        this.testMsg =
                Msg.newBuilder()
                        ...
                        .build();
        this.message =
                MessageBuilder.withPayload(this.testMsg.toByteArray())
                        .setHeader(CONTENT_TYPE, ProtobufMessageConverter.PROTOBUF)
                        .build();
        this.messageWithoutContentType =
                MessageBuilder.withPayload(this.testMsg.toByteArray()).build();
        this.messageJson =
    ...
    public void canConvertTo() {
        ...
        assertThat(converter.canConvertTo(testMsg, messageWithoutContentType.getHeaders()))
                .isTrue();
    ...
    public void defaultContentType() {
        assertThat(converter.getDefaultContentType(testMsg))
                .isEqualTo(ProtobufMessageConverter.PROTOBUF);
    }
    ...
    public void testJsonWithGoogleProtobuf() {
        ...
        final Message<?> message =
                this.converter.toMessage(this.testMsg, new MessageHeaders(headers));
        assertThat(message).isNotNull();
