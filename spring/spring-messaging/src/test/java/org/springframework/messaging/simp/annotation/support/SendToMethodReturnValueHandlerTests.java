...
public class SendToMethodReturnValueHandlerTests {
    ...
    private MethodParameter sendToUserDefaultDestReturnType =
            param("handleAndSendToUserDefaultDest");
    ...
    public void supportsReturnType() throws Exception {
        ...
        assertThat(
                        this.handlerAnnotationNotRequired.supportsReturnType(
                                this.noAnnotationsReturnType))
                .isTrue();
    ...
    private void assertResponse(
        ...
        assertThat(accessor.getSubscriptionId())
                .as("Subscription id should not be copied")
                .isNull();
    ...
    public void sendToUserDefaultDestination() throws Exception {
        ...
        assertThat(accessor.getDestination())
                .isEqualTo(("/user/" + user.getName() + "/queue/dest"));
    }
    ...
    public void sendToUserDefaultDestinationSingleSession() throws Exception {
        ...
        this.handler.handleReturnValue(
                PAYLOAD, this.sendToUserInSessionDefaultDestReturnType, message);
    ...
    private Message<?> createMessage(
        ...
        if (dest != null && destPrefix != null) {
            ...
            headerAccessor.setHeader(
                    DestinationPatternsMessageCondition.LOOKUP_DESTINATION_HEADER, dest);
        }
        if (user != null) {
