...
public class HeaderMethodArgumentResolverTests {
    ...
    public void setup() {
        ...
        this.resolver =
                new HeaderMethodArgumentResolver(
                        new DefaultConversionService(), context.getBeanFactory());
    }
    ...
    public void supportsParameter() {
        ...
        assertThat(
                        this.resolver.supportsParameter(
                                this.resolvable.annotNotPresent(Header.class).arg()))
                .isFalse();
    }
    ...
    public void resolveArgumentNativeHeaderAmbiguity() {
        ...
        assertThat(
                        this.<Object>resolveArgument(
                                this.resolvable.annot(header("nativeHeaders.param1")).arg(),
                                message))
    ...
    public void resolveArgumentDefaultValue() {
        Message<byte[]> message = MessageBuilder.withPayload(new byte[0]).build();
        Object result =
                resolveArgument(this.resolvable.annot(header("name", "bar")).arg(), message);
    ...
    public void resolveDefaultValueSystemProperty() {
        ...
        try {
            ...
            MethodParameter param =
                    this.resolvable
                            .annot(header("name", "#{systemProperties.systemProperty}"))
                            .arg();
    ...
    public void resolveOptionalHeaderWithValue() {
        ...
        MethodParameter param =
                this.resolvable.annot(header("foo")).arg(Optional.class, String.class);
        Object result = resolveArgument(param, message);
