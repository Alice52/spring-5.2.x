...
public class MessageBrokerConfigurationTests {
    ...
    public void customPathMatcher() {
        ...
        DefaultUserDestinationResolver resolver =
                context.getBean(DefaultUserDestinationResolver.class);
    ...
    public void userBroadcasts() {
        ...
        UserDestinationMessageHandler handler1 =
                context.getBean(UserDestinationMessageHandler.class);
        assertThat(handler1.getBroadcastDestination())
                .isEqualTo("/topic/unresolved-user-destination");
        ...
        StompBrokerRelayMessageHandler relay =
                context.getBean(StompBrokerRelayMessageHandler.class);
        ...
        assertThat(relay.getSystemSubscriptions().get("/topic/unresolved-user-destination"))
                .isSameAs(handler1);
        assertThat(relay.getSystemSubscriptions().get("/topic/simp-user-registry"))
                .isSameAs(handler2);
    }
