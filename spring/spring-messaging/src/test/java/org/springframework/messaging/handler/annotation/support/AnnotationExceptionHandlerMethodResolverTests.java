...
public class AnnotationExceptionHandlerMethodResolverTests {
    ...
    public void resolveMethodExceptionSubType() {
        ...
        assertThat(this.resolver.resolveMethod(ioException).getName())
                .isEqualTo("handleIOException");
    ...
    public void ambiguousExceptionMapping() {
        assertThatIllegalStateException()
                .isThrownBy(
                        () ->
                                new AnnotationExceptionHandlerMethodResolver(
                                        AmbiguousController.class));
    }
