...
public class MessageBuilderTests {
    ...
    public void copyHeadersIfAbsent() {
        Message<String> message1 =
                MessageBuilder.withPayload("test1").setHeader("foo", "bar").build();
        Message<String> message2 =
                MessageBuilder.withPayload("test2")
                        .setHeader("foo", 123)
    ...
    public void createErrorMessageFromErrorMessage() {
        ...
        ErrorMessage errorMessage1 =
                new ErrorMessage(ex, Collections.singletonMap("baz", "42"), source);
    ...
    public void createIdRegenerated() {
        Message<String> message1 =
                MessageBuilder.withPayload("test").setHeader("foo", "bar").build();
        Message<String> message2 =
                MessageBuilder.fromMessage(message1).setHeader("another", 1).build();
        assertThat(message2.getHeaders().get("foo")).isEqualTo("bar");
    ...
    public void testRemove() {
        ...
        Message<Integer> message2 =
                MessageBuilder.fromMessage(message1).removeHeader("foo").build();
    ...
    public void testSettingToNullRemoves() {
        Message<Integer> message1 = MessageBuilder.withPayload(1).setHeader("foo", "bar").build();
        Message<Integer> message2 =
                MessageBuilder.fromMessage(message1).setHeader("foo", null).build();
        assertThat(message2.getHeaders().containsKey("foo")).isFalse();
    }
    ...
    public void testBuildMessageWithoutIdAndTimestamp() {
        ...
        Message<?> message =
                MessageBuilder.createMessage("foo", headerAccessor.getMessageHeaders());
