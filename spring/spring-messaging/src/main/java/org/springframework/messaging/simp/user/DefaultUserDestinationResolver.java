...
public class DefaultUserDestinationResolver implements UserDestinationResolver {
    ...
    /**
     * Create an instance that will access user session id information through the provided
     * registry.
     *
     ...
     * which makes sense with brokers that support destinations with slash as separator. When a
     * {@code PathMatcher} is provided that supports an alternative separator, then resulting
     * destinations won't have a leading slash, e.g. {@code jms.queue.position-updates}.
     *
     ...
     *     #setRemoveLeadingSlash(boolean)} that indicates more explicitly whether to keep the
     *     leading slash which may or may not be the case regardless of how the {@code PathMatcher}
     *     is configured.
     */
    @Deprecated
