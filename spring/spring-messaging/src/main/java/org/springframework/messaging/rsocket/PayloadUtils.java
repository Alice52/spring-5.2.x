...
public abstract class PayloadUtils {
    ...
    /**
     * Use this method to slice, retain and wrap the data portion of the {@code Payload}, and also
     * to release the {@code Payload}. This assumes the Payload metadata has been read by now and
     * ensures downstream code need only be aware of {@code DataBuffer}s.
     *
    ...
    /**
     * Create a Payload with data only. The created payload is {@link ByteBufPayload} if the input
     * is {@link NettyDataBuffer} or otherwise it is {@link DefaultPayload}.
     *
     * @param data the data part for the payload
