...
public interface StompSession {
    ...
    /**
     * Send an acknowledgement whether a message was consumed or not resulting in an ACK or NACK
     * frame respectively.
     *
    ...
    interface Receiptable {
        ...
        /**
         * Return the receipt id, or {@code null} if the STOMP frame for which the handle was
         * returned did not have a "receipt" header.
         */
        @Nullable
        String getReceiptId();
    ...
    interface Subscription extends Receiptable {
        ...
        /**
         * Alternative to {@link #unsubscribe()} with additional custom headers to send to the
         * server.
         *
