 ...
 *
 * <p>This converter supports by default {@code "application/x-protobuf"} with the official {@code
 * "com.google.protobuf:protobuf-java"} library.
 *
 * <p>{@code "application/json"} can be supported with the official {@code
...
public class ProtobufMessageConverter extends AbstractMessageConverter {
    ...
    protected Object convertFromInternal(
        ...
        try {
            ...
            throw new MessageConversionException(
                    message, "Could not read proto message" + ex.getMessage(), ex);
        }
    ...
    protected Object convertToInternal(
        ...
        try {
            ...
            throw new MessageConversionException(
                    "Failed to print Protobuf message: " + ex.getMessage(), ex);
        }
        return payload;
    }
    ...
    static class ProtobufJavaUtilSupport implements ProtobufFormatSupport {
        ...
        @Override
        public void print(
                Message message, OutputStream output, MimeType contentType, Charset charset)
                throws IOException, MessageConversionException {
