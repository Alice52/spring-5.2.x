...
public abstract class StompClientSupport {
     ...
     * number represents how often the client will write or send a heart-beat. The second is how
     * often the server should write. A value of 0 means no heart-beats.
     *
     ...
     *
     * <p>Returns {@code false} if {@link #setDefaultHeartbeat defaultHeartbeat} is set to "0,0",
