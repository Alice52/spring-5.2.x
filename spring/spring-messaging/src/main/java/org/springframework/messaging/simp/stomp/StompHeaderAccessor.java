...
public class StompHeaderAccessor extends SimpMessageHeaderAccessor {
     ...
     * headers may not have been created from a STOMP frame but may have rather originated from
     * using the more generic {@link org.springframework.messaging.simp.SimpMessageHeaderAccessor}.
     */
    ...
    /**
     * Create headers for a heartbeat. While a STOMP heartbeat frame does not have headers, a
     * session id is needed for processing purposes at a minimum.
     */
