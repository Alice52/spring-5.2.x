...
public class WebMvcStompWebSocketEndpointRegistrationTests {
    ...
    public void minimalRegistration() {
        ...
        assertThat(((WebSocketHttpRequestHandler) entry.getKey()).getWebSocketHandler())
                .isNotNull();
    ...
    public void allowedOriginsWithSockJsService() {
        ...
        DefaultSockJsService sockJsService =
                (DefaultSockJsService) requestHandler.getSockJsService();
