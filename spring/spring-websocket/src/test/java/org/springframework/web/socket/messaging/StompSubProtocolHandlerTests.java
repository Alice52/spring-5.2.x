...
public class StompSubProtocolHandlerTests {
    ...
    public void handleMessageToClientWithSimpConnectAck() {
        ...
        ackAccessor.setHeader(
                SimpMessageHeaderAccessor.HEART_BEAT_HEADER, new long[] {15000, 15000});
    ...
    public void handleMessageToClientWithBinaryWebSocketMessage() {
        ...
        Message<byte[]> message =
                MessageBuilder.createMessage(payload, headers.getMessageHeaders());
        this.protocolHandler.handleMessageToClient(this.session, message);
    ...
    public void handleMessageFromClient() {
        ...
        assertThat(SimpMessageHeaderAccessor.getUser(actual.getHeaders()).getName())
                .isEqualTo("joe");
    ...
    public void eventPublication() {
        ...
        assertThat(publisher.events.size())
                .as("Unexpected events " + publisher.events)
                .isEqualTo(5);
