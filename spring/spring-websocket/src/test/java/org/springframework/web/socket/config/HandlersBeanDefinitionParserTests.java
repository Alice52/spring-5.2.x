...
public class HandlersBeanDefinitionParserTests {
    ...
    public void webSocketHandlers() {
        ...
        Map<String, HandlerMapping> handlersMap =
                this.appContext.getBeansOfType(HandlerMapping.class);
        ...
        for (HandlerMapping hm : handlersMap.values()) {
            ...
            if (shm.getUrlMap().keySet().contains("/foo")) {
                ...
                boolean condition =
                        handler.getHandshakeInterceptors().get(0)
                                instanceof OriginHandshakeInterceptor;
    ...
    public void sockJs() {
        ...
        SimpleUrlHandlerMapping handlerMapping =
                this.appContext.getBean(SimpleUrlHandlerMapping.class);
        assertThat(handlerMapping).isNotNull();
        ...
        unwrapAndCheckDecoratedHandlerType(
                fooHandler.getWebSocketHandler(), FooWebSocketHandler.class);
        ...
        Map<TransportType, TransportHandler> handlerMap =
                defaultSockJsService.getTransportHandlers();
    ...
    public void sockJsAttributes() {
        ...
        assertThat(interceptors)
                .extracting("class")
                .containsExactly(OriginHandshakeInterceptor.class);
        assertThat(transportService.shouldSuppressCors()).isTrue();
        assertThat(transportService.getAllowedOrigins().contains("https://mydomain1.example"))
                .isTrue();
        assertThat(transportService.getAllowedOrigins().contains("https://mydomain2.example"))
                .isTrue();
    }
