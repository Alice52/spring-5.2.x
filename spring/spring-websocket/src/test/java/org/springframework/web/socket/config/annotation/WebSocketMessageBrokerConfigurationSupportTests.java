...
public class WebSocketMessageBrokerConfigurationSupportTests {
    ...
    public void clientInboundChannelSendMessage() throws Exception {
        ...
        webSocketHandler.handleMessage(
                session,
                StompTextMessageBuilder.create(StompCommand.SEND)
                        .headers("destination:/foo")
                        .build());
    ...
    public void webSocketHandler() {
        ApplicationContext config = createConfig(TestChannelConfig.class, TestConfigurer.class);
        SubProtocolWebSocketHandler subWsHandler =
                config.getBean(SubProtocolWebSocketHandler.class);
        ...
        StompSubProtocolHandler protocolHandler =
    ...
    @Configuration
    static class WebSocketHandlerDecoratorConfig
