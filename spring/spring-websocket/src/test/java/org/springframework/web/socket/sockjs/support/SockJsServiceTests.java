...
public class SockJsServiceTests extends AbstractHttpRequestTests {
    ...
    public void validateRequest() {
        ...
        resetResponseAndHandleRequest(
                "GET", "/echo/server/session/websocket", HttpStatus.NOT_FOUND);
        ...
        resetResponseAndHandleRequest(
                "GET", "/echo/s.erver/session/websocket", HttpStatus.NOT_FOUND);
        resetResponseAndHandleRequest(
                "GET", "/echo/server/s.ession/websocket", HttpStatus.NOT_FOUND);
        resetResponseAndHandleRequest(
    ...
    public void handleInfoGet() throws IOException {
        ...
        assertThat(this.servletResponse.getContentType())
    ...
    public void handleInfoGetWithOrigin() throws IOException {
        ...
        this.service.setAllowedOrigins(
                Arrays.asList(
                        "http://mydomain1.example",
                        "http://mydomain2.example",
    ...
    public void handleInfoOptionsWithForbiddenOrigin() {
        ...
        CorsConfiguration corsConfiguration =
                this.service.getCorsConfiguration(this.servletRequest);
    ...
    public void handleInfoOptionsWithOriginAndCorsHeadersDisabled() {
        ...
        this.service.setAllowedOrigins(
                Arrays.asList(
                        "https://mydomain1.example",
                        "https://mydomain2.example",
                        "http://mydomain3.example"));
        resetResponseAndHandleRequest("OPTIONS", "/echo/info", HttpStatus.NO_CONTENT);
        assertThat(this.service.getCorsConfiguration(this.servletRequest)).isNull();
    }
    ...
    private void resetResponseAndHandleRequest(
            String httpMethod, String uri, HttpStatus httpStatus) {
        resetResponse();
