...
class StompWebSocketIntegrationTests extends AbstractWebSocketIntegrationTests {
    ...
    protected Class<?>[] getAnnotatedConfigClasses() {
        return new Class<?>[] {
            TestMessageBrokerConfiguration.class, TestMessageBrokerConfigurer.class
        };
    }
    ...
    void sendMessageToController(
        ...
        WebSocketSession session =
                doHandshake(new TestClientWebSocketHandler(0, message), "/ws").get();
    ...
    void sendMessageToControllerAndReceiveReplyViaTopic(
        ...
        TextMessage m1 =
                create(StompCommand.SUBSCRIBE)
                        .headers("id:subs1", "destination:/topic/increment")
                        .build();
        TextMessage m2 =
    ...
    void sendMessageToBrokerAndReceiveReplyViaTopic(
        ...
        TextMessage m1 =
                create(StompCommand.SUBSCRIBE)
                        .headers("id:subs1", "destination:/topic/foo")
                        .build();
        TextMessage m2 =
                create(StompCommand.SEND).headers("destination:/topic/foo").body("5").build();
    ...
    void sendSubscribeToControllerAndReceiveReply(
        ...
        try {
            ...
            assertThat(payload.contains(destHeader))
                    ...
                    .isTrue();
            assertThat(payload.contains("42"))
                    .as("Expected STOMP Payload=42, got " + payload)
                    .isTrue();
        } finally {
            session.close();
        }
    ...
    void webSocketScope(
        ...
        TextMessage m1 =
                create(StompCommand.SUBSCRIBE)
                        ...
                        .build();
        TextMessage m2 =
                create(StompCommand.SEND).headers("destination:/app/scopedBeanValue").build();
    ...
    private static class TestClientWebSocketHandler extends TextWebSocketHandler {
        ...
        public TestClientWebSocketHandler(
                int expectedNumberOfMessages, TextMessage... messagesToSend) {
