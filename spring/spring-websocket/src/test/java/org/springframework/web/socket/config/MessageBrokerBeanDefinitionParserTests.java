...
public class MessageBrokerBeanDefinitionParserTests {
    ...
    public void simpleBroker() throws Exception {
        ...
        assertThat(interceptors)
                .extracting("class")
                .containsExactly(
                        FooTestInterceptor.class,
                        BarTestInterceptor.class,
        ...
        assertThat(
                        this.appContext.getBean(
                                MessageBrokerBeanDefinitionParser.WEB_SOCKET_HANDLER_BEAN_NAME))
                .isSameAs(wsHandler);
        ...
        StompSubProtocolHandler stompHandler =
                (StompSubProtocolHandler) handlerMap.get("v12.stomp");
        ...
        assertThat(stompHandler.getErrorHandler().getClass())
                .isEqualTo(TestStompErrorHandler.class);
        ...
        assertThat(wsTransportHandler.getHandshakeHandler())
                .isInstanceOf(TestHandshakeHandler.class);
        ...
        assertThat(interceptors)
                ...
                .containsExactly(
                        ...
                        BarTestInterceptor.class,
                        OriginHandshakeInterceptor.class);
        assertThat(defaultSockJsService.getAllowedOrigins().contains("https://mydomain3.com"))
                .isTrue();
        assertThat(defaultSockJsService.getAllowedOrigins().contains("https://mydomain4.com"))
                .isTrue();
    ...
    public void stompBrokerRelay() {
        ...
        HttpRequestHandler httpRequestHandler =
                (HttpRequestHandler) suhm.getUrlMap().get("/foo/**");
        assertThat(httpRequestHandler).isNotNull();
        assertThat(httpRequestHandler).isInstanceOf(SockJsHttpRequestHandler.class);
        SockJsHttpRequestHandler sockJsHttpRequestHandler =
                (SockJsHttpRequestHandler) httpRequestHandler;
    ...
    public void annotationMethodMessageHandler() {
        ...
        DirectFieldAccessor handlerAccessor =
                new DirectFieldAccessor(annotationMethodMessageHandler);
    ...
    public void customArgumentAndReturnValueTypes() {
        ...
        List<HandlerMethodReturnValueHandler> customHandlers =
                handler.getCustomReturnValueHandlers();
...
class CustomReturnValueHandler implements HandlerMethodReturnValueHandler {
    ...
    public void handleReturnValue(
            Object returnValue, MethodParameter returnType, Message<?> message) throws Exception {}
}
