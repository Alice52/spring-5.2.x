...
class TestExecutionListenersTests {
    ...
    void nonInheritedDefaultListeners() {
        assertRegisteredListeners(
                NonInheritedDefaultListenersTestCase.class,
                asList(QuuxTestExecutionListener.class));
    }
    ...
    void inheritedDefaultListeners() {
        ...
        assertRegisteredListeners(
                SubInheritedDefaultListenersTestCase.class,
                asList(QuuxTestExecutionListener.class));
        assertRegisteredListeners(
    ...
    static class ExplicitListenersOnTestInterfaceTestCase
            implements ExplicitListenersTestInterface {}
