...
class ExplicitPropertiesFileTestPropertySourceTests {
    ...
    static void setSystemProperty() {
        String path =
                ClassUtils.classPackageAsResourcePath(
                        ExplicitPropertiesFileTestPropertySourceTests.class);
    ...
    class ClasspathTests {
        ...
        @TestPropertySource(
                "/org/../org/springframework/test/../test/context/env/explicit.properties")
        class AbsolutePathWithInternalRelativePathTests
    ...
    class FileSystemTests {
        ...
        class PlaceholdersFollowedByRelativePathsTests
                extends AbstractExplicitPropertiesFileTests {}
    }
}
