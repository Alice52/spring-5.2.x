...
class GenericXmlContextLoaderResourceLocationsTests {
    ...
    static Stream<Arguments> contextConfigurationLocationsData() {
        return Stream.of(
                arguments(
                        ClasspathNonExistentDefaultLocationsTestCase.class.getSimpleName(),
                        array()),
                arguments(
    ...
    void assertContextConfigurationLocations(String testClassName, String[] expectedLocations)
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("----------------------------------------------------------------------");
            logger.debug(
                    "Configured locations: " + ObjectUtils.nullSafeToString(configuredLocations));
            logger.debug(
                    "Expected   locations: " + ObjectUtils.nullSafeToString(expectedLocations));
            logger.debug(
                    "Processed  locations: " + ObjectUtils.nullSafeToString(processedLocations));
        }
