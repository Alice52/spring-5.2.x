...
class ActiveProfilesUtilsTests extends AbstractContextConfigurationUtilsTests {
    ...
    void resolveActiveProfilesWithExtendedDefaultActiveProfilesResolver() {
        assertResolvedProfiles(
                ExtendedDefaultActiveProfilesResolverTestCase.class, "default", "foo");
    }
    ...
    private static class OverriddenInheritedFooActiveProfilesResolverTestCase
            extends InheritedFooActiveProfilesResolverTestCase {}
    ...
    @ActiveProfiles(
            resolver = BarActiveProfilesResolver.class,
            value = "ignored by custom resolver")
    ...
    private static class ExtendedDefaultActiveProfilesResolver
