...
public class HtmlUnitRequestBuilderTests {
    ...
    public void buildRequestBasicAuth() {
        ...
        UsernamePasswordCredentials credentials =
                new UsernamePasswordCredentials(base64Credentials);
    ...
    @Test
    public void buildRequestContextPathUsesNoFirstSegmentWithDefault()
    ...
    @Test
    public void
            buildRequestParameterMapViaWebRequestDotSetRequestParametersWithSingleRequestParam() {
    ...
    public void buildRequestSessionWithExistingSession() throws Exception {
        ...
        assertSingleSessionCookie(
                "JSESSIONID=" + session.getId() + "; Path=/test; Domain=example.com");
        ...
        assertSingleSessionCookie(
                "JSESSIONID="
                        + actualRequest.getSession().getId()
    ...
    public void mergeSessionNotInitialized() throws Exception {
        ...
        assertThat(mockMvc.perform(requestBuilder).andReturn().getRequest().getSession(false))
                .isNull();
    }
