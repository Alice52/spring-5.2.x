...
public class MockRestRequestMatchersTests {
    ...
    public void headerDoesNotExist() throws Exception {
        ...
        assertThatThrownBy(
                ...
                .isInstanceOf(AssertionError.class)
                .hasMessage(
                        "Expected header <foo> not to exist, but it exists with values: " + values);
    }
    ...
    public void headerContainsWithMissingHeader() throws Exception {
        assertThatThrownBy(
                        () ->
                                MockRestRequestMatchers.header("foo", containsString("baz"))
                                        .match(this.request))
                .isInstanceOf(AssertionError.class)
    ...
    public void headerContainsWithMissingValue() throws Exception {
        ...
        assertThatThrownBy(
                        () ->
                                MockRestRequestMatchers.header("foo", containsString("bx"))
                                        .match(this.request))
                .isInstanceOf(AssertionError.class)
    ...
    public void headersWithMissingValue() throws Exception {
        ...
        assertThatThrownBy(
                        () ->
                                MockRestRequestMatchers.header("foo", "bar", "baz")
                                        .match(this.request))
                .isInstanceOf(AssertionError.class)
    ...
    public void queryParamContainsWithMissingValue() throws Exception {
        ...
        assertThatThrownBy(
                        () ->
                                MockRestRequestMatchers.queryParam("foo", containsString("bx"))
                                        .match(this.request))
                .isInstanceOf(AssertionError.class)
                .hasMessageContaining("was \"bar\"");
    }
