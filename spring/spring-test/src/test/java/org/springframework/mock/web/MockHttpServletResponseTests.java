...
class MockHttpServletResponseTests {
    ...
    void contentTypeHeaderWithMoreComplexCharsetSyntax() {
        String contentType =
                "test/plain;charset=\"utf-8\";foo=\"charset=bar\";foocharset=bar;foo=bar";
        response.setHeader(CONTENT_TYPE, contentType);
        assertThat(response.getContentType()).isEqualTo(contentType);
        assertThat(response.getHeader(CONTENT_TYPE)).isEqualTo(contentType);
        assertThat(response.getCharacterEncoding()).isEqualTo("UTF-8");
    ...
    void addDateHeader() {
        ...
        assertThat(response.getHeaders(LAST_MODIFIED).get(0))
                .isEqualTo("Tue, 21 Jul 2015 10:00:00 GMT");
        assertThat(response.getHeaders(LAST_MODIFIED).get(1))
    ...
    void getInvalidDateHeader() {
        ...
        assertThatIllegalArgumentException()
                .isThrownBy(() -> response.getDateHeader(LAST_MODIFIED));
    }
    ...
    void setCookieHeaderWithMaxAgeAndExpiresAttributes() {
        ...
        String cookieValue =
                "SESSION=123; Path=/; Max-Age=100; Expires="
                        + expiryDate
        ...
        assertThat(mockCookie.getExpires())
                .isEqualTo(ZonedDateTime.parse(expiryDate, DateTimeFormatter.RFC_1123_DATE_TIME));
    }
