 ...
 * {@link ApplicationContext} testing support in a <strong>JUnit 4</strong> environment.
 *
 ...
 * ApplicationContext application context} {@linkplain ContextConfiguration#locations() resource
 * locations} or {@linkplain ContextConfiguration#classes() component classes}. <em>If your test
 * does not need to load an application context, you may choose to omit the {@link
 ...
 *   <li>If you wish to extend this class and use a runner other than the {@link SpringRunner}, you
 *       can use {@link org.springframework.test.context.junit4.rules.SpringClassRule
 *       SpringClassRule} and {@link org.springframework.test.context.junit4.rules.SpringMethodRule
 *       SpringMethodRule} and specify your runner of choice via {@link RunWith @RunWith(...)}.
 * </ul>
 *
