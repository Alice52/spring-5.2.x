...
public class RequestResultMatchers {
     ...
     * #asyncResult(Matcher)} or {@link #asyncResult(Object)} can be used to assert the resulting
     * value.
     *
     * <p>Neither a {@code Callable} nor a {@code DeferredResult} will complete processing all the
     * way since a {@link MockHttpServletRequest} does not perform asynchronous dispatches.
     *
     * @see #asyncNotStarted()
     */
