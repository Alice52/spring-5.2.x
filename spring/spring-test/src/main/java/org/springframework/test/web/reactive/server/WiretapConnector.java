    ...
    public Mono<ClientHttpResponse> connect(
        ...
        return this.delegate
                .connect(
                        ...
                        uri,
                        request -> {
                            WiretapClientHttpRequest wrapped =
                                    new WiretapClientHttpRequest(request);
                ...
                .map(
                        response -> {
                            ...
                            WiretapClientHttpResponse wrappedResponse =
                                    new WiretapClientHttpResponse(response);
                            this.exchanges.put(
                                    requestId, new Info(wrappedRequest, wrappedResponse));
            ...
            return Mono.defer(
                    () -> {
                        ...
                        if (!this.hasContentConsumer) {
                            ...
                            //  2. FluxExchangeResult: getResponseBodyContent called before
                            // getResponseBody
