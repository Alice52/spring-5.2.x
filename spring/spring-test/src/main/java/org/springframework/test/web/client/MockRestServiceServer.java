...
public final class MockRestServiceServer {
    ...
    /**
     * Return a builder for a {@code MockRestServiceServer} that should be used to reply to the
    ...
    /**
     * Return a builder for a {@code MockRestServiceServer} that should be used to reply to the
     * given {@code AsyncRestTemplate}.
     *
     * @since 4.3
     * @deprecated see deprecation notice on {@link
     *     org.springframework.web.client.AsyncRestTemplate} itself
     */
    @Deprecated
     ...
     *
     * <p>When request expectations have an expected count greater than one, only the first
     * execution is expected to match the order of declaration. Subsequent request executions may be
     * inserted anywhere thereafter.
     *
    ...
    public interface MockRestServiceServerBuilder {
        ...
        /**
         * Whether to allow expected requests to be executed in any order not necessarily matching
         ...
         * {@code AsyncRestTemplate} with a {@link ClientHttpRequestFactory} that creates mock
         * requests.
         */
    ...
    private class MockClientHttpRequestFactory
        ...
        private org.springframework.mock.http.client.MockAsyncClientHttpRequest
                createRequestInternal(URI uri, HttpMethod httpMethod) {
