 ...
 * {@linkplain org.springframework.test.context.TestExecutionListener#prepareTestInstance prepares
 * the test instance} before {@code @Before} lifecycle methods instead of immediately after
 * instantiation of the test class. In addition, the {@code SpringMethodRule} does
 * <strong>not</strong> support the {@code beforeTestExecution()} and {@code afterTestExecution()}
 * callbacks of the {@link org.springframework.test.context.TestExecutionListener
...
public class SpringMethodRule implements MethodRule {
    ...
    /**
     * Apply <em>instance-level</em> and <em>method-level</em> features of the <em>Spring
     * TestContext Framework</em> to the supplied {@code base} statement.
     *
     ...
     * environment. This prevents methods with a non-matching {@code @IfProfileValue} annotation
     * from running altogether, even skipping the execution of {@code prepareTestInstance()} methods
    ...
    public Statement apply(Statement base, FrameworkMethod frameworkMethod, Object testInstance) {
        ...
        statement =
                withBeforeTestMethodCallbacks(
                        statement, testMethod, testInstance, testContextManager);
        statement =
     ...
     */
    private Statement withProfileValueCheck(
            Statement next, Method testMethod, Object testInstance) {
