...
public class JsonPathResultMatchers {
    ...
    /**
     * Configures the current {@code JsonPathResultMatchers} instance to verify that the JSON
     * payload is prepended with the given prefix.
     *
    ...
    /**
     * Evaluate the JSON path expression against the response content and assert that a non-null
     * value does not exist at the given path.
     *
     * <p>If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method
