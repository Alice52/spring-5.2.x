...
public class StandaloneMockMvcBuilder extends AbstractMockMvcBuilder<StandaloneMockMvcBuilder> {
    ...
    public StandaloneMockMvcBuilder setContentNegotiationManager(
    ...
    /**
     * Set up view resolution with the given {@link ViewResolver ViewResolvers}. If not set, an
     * {@link InternalResourceViewResolver} is used by default.
     */
    ...
    /**
     * Sets up a single {@link ViewResolver} that always returns the provided view instance. This is
     * a convenient shortcut if you need to use one View instance only -- e.g. rendering generated
     ...
     *
     * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on the
     *     deprecation of path extension config options.
     */
    @Deprecated
    ...
    /**
     * Set if ";" (semicolon) content should be stripped from the request URI. The value, if
     * provided, is in turn set on {@link
    ...
    /**
     * In a standalone setup there is no support for placeholder values embedded in request
     * mappings. This method allows manually provided placeholder values so they can be resolved.
     * Alternatively consider creating a test that initializes a {@link WebApplicationContext}.
     *
     * @since 4.2.8
     */
    ...
    private class StandaloneConfiguration extends WebMvcConfigurationSupport {
        ...
        public RequestMappingHandlerMapping getHandlerMapping(
            ...
            handlerMapping.setEmbeddedValueResolver(
                    new StaticStringValueResolver(placeholderValues));
            ...
            for (HandlerExceptionResolver resolver : handlerExceptionResolvers) {
                if (resolver instanceof ApplicationContextAware) {
                    ...
                    if (applicationContext != null) {
                        ((ApplicationContextAware) resolver)
