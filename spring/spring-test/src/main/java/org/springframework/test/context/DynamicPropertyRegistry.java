...
/**
 * Registry used with {@link DynamicPropertySource @DynamicPropertySource} methods so that they can
 * add properties to the {@code Environment} that have dynamically resolved values.
 *
 * @author Phillip Webb
 * @author Sam Brannen
 * @since 5.2.5
