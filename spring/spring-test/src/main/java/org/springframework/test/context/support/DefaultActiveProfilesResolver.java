...
public class DefaultActiveProfilesResolver implements ActiveProfilesResolver {
    ...
    /**
     * Resolve the <em>bean definition profiles</em> for the given {@linkplain Class test class}
     * based on profiles configured declaratively via {@link ActiveProfiles#profiles} or {@link
