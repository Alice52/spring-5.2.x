...
public class MergedContextConfiguration implements Serializable {
     ...
     * activeProfiles}, {@code propertySourceLocations}, or {@code propertySourceProperties} an
     * empty array will be stored instead. If a {@code null} value is supplied for the {@code
     ...
     * <p>If a {@code null} value is supplied for {@code locations}, {@code classes}, {@code
     * activeProfiles}, {@code propertySourceLocations}, or {@code propertySourceProperties} an
     * empty array will be stored instead. If a {@code null} value is supplied for {@code
     * contextInitializerClasses} or {@code contextCustomizers}, an empty set will be stored
     * instead. Furthermore, active profiles will be sorted, and duplicate profiles will be removed.
     *
     * @param testClass the test class for which the configuration was merged
     * @param locations the merged context resource locations
     * @param classes the merged annotated classes
    ...
    public MergedContextConfiguration(
        ...
        this.contextInitializerClasses =
                processContextInitializerClasses(contextInitializerClasses);
     ...
     * based solely on the fully qualified name of the loader or &quot;null&quot; if the supplied
     * loader is {@code null}.
     */
    ...
    /**
     * Get the {@linkplain Class test class} associated with this {@code
    ...
    /**
     * Get the merged active bean definition profiles for the {@linkplain #getTestClass() test
     * class}.
     *
     * @see ActiveProfiles
     */
    ...
    /**
     * Get the merged test {@code PropertySource} properties for the {@linkplain #getTestClass()
     * test class}.
     *
     ...
     * #getContextInitializerClasses() context initializer classes}, {@linkplain
     * #getActiveProfiles() active profiles}, {@linkplain #getPropertySourceLocations() property
     * source locations}, {@linkplain #getPropertySourceProperties() property source properties},
     * {@linkplain #getContextCustomizers() context customizers}, the name of the {@link
     * #getContextLoader() ContextLoader}, and the {@linkplain #getParent() parent configuration}.
     */
    @Override
    public String toString() {
        return new ToStringCreator(this)
                ...
                .append(
                        "propertySourceLocations",
                        ObjectUtils.nullSafeToString(this.propertySourceLocations))
                .append(
                        "propertySourceProperties",
                        ObjectUtils.nullSafeToString(this.propertySourceProperties))
