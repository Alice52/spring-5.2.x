...
public abstract class TestContextResourceUtils {
     ...
     *
     * <p>Delegates to {@link #convertToClasspathResourcePaths(Class, boolean, String...)} with
     * {@code false} supplied for the {@code preservePlaceholders} flag.
     *
     ...
     *       defined. Such a path will be prepended with the {@code classpath:} prefix and the path
     *       to the package for the class.
    ...
    public static String[] convertToClasspathResourcePaths(
        ...
        for (int i = 0; i < paths.length; i++) {
            ...
            if (!(preservePlaceholders
                    && PLACEHOLDER_PATTERN.matcher(convertedPaths[i]).matches())) {
