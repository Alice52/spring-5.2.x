...
public class HeaderResultMatchers {
    ...
    /**
     * Assert the primary value of the response header with the given Hamcrest String {@code
     * Matcher}.
     */
     ...
     * response does not contain the specified header, or if the supplied {@code value} does not
    ...
    public ResultMatcher longValue(String name, long value) {
        return result -> {
            ...
            assertTrue(
                    "Response does not contain header '" + name + "'",
