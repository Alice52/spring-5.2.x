...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    private String getCookieHeader(Cookie cookie) {
        ...
        if (maxAge >= 0) {
            ...
            ZonedDateTime expires =
                    (cookie instanceof MockCookie ? ((MockCookie) cookie).getExpires() : null);
            if (expires != null) {
    ...
    /**
     * Return the primary value for the given header as a String, if any. Will return the first
     * value in case of multiple values.
     *
     * <p>As of Servlet 3.0, this method is also defined in {@link HttpServletResponse}. As of
     * Spring 3.1, it returns a stringified value for Servlet 3.0 compatibility. Consider using
     * {@link #getHeaderValue(String)} for raw Object access.
     *
     ...
     *
     * <p>As of Servlet 3.0, this method is also defined in {@link HttpServletResponse}. As of
     * Spring 3.1, it returns a List of stringified values for Servlet 3.0 compatibility. Consider
     * using {@link #getHeaderValues(String)} for raw Object access.
     *
     * @param name the name of the header
    ...
    public String getIncludedUrl() {
        ...
        Assert.state(
                count <= 1,
                () ->
                        "More than 1 URL included - check getIncludedUrls instead: "
                                + this.includedUrls);
