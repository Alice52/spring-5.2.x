...
public final class MockServerHttpRequest extends AbstractServerHttpRequest {
    ...
    @Nullable private final String customHttpMethod;
    ...
    private MockServerHttpRequest(
            ...
            @Nullable String customHttpMethod,
            URI uri,
        ...
        Assert.isTrue(
                httpMethod != null || customHttpMethod != null, "HTTP method must not be null");
    ...
    /**
     * Alternative to {@link #method(HttpMethod, URI)} that accepts a URI template. The given URI
     * may contain query parameters, or those may be added later via {@link BaseBuilder#queryParam
    ...
    public static BodyBuilder method(HttpMethod method, String urlTemplate, Object... vars) {
        Assert.notNull(
                method,
                "HttpMethod is required. If testing a custom HTTP method, "
    ...
    /**
     * Create a builder with a raw HTTP method value that is outside the range of {@link HttpMethod}
     * enum values.
     *
    ...
    public String getMethodValue() {
        return (this.httpMethod != null
                ...
                : Objects.requireNonNull(this.customHttpMethod));
    }
    ...
    public interface BaseBuilder<B extends BaseBuilder<B>> {
        ...
        /**
         * Append the given query parameter to the existing query parameters. If no values are
         * given, the resulting URI will contain the query parameter name only (i.e. {@code ?foo}
        ...
        /**
         * Add the given query parameters and values. The provided query name and corresponding
    ...
    public interface BodyBuilder extends BaseBuilder<BodyBuilder> {
         ...
         * Set the body of the request and build it.
         *
         * <p>The String is assumed to be UTF-8 encoded unless the request has a "content-type"
         * header with a charset attribute.
         *
    ...
    private static class DefaultBodyBuilder implements BodyBuilder {
        ...
        @Nullable private final String customMethod;
        ...
        private URI getUrlToUse() {
            ...
            if (!params.isEmpty()) {
                return UriComponentsBuilder.fromUri(this.url)
                        .queryParams(params)
                        .build(true)
                        .toUri();
            }
