...
public class DelegatingWebFluxConfigurationIntegrationTests {
    ...
    void requestMappingHandlerAdapterUsesWebFluxInfrastructureByDefault() {
        ...
        assertThat(mappingHandlerAdapter.getWebBindingInitializer())
                .hasFieldOrPropertyWithValue(
                        "conversionService", this.context.getBean("webFluxConversionService"));
        assertThat(mappingHandlerAdapter.getWebBindingInitializer())
                .hasFieldOrPropertyWithValue("validator", this.context.getBean("webFluxValidator"));
    }
    ...
    void requestMappingHandlerAdapterWithPrimaryUsesQualifiedValidator() {
        ...
        assertThat(this.context.getBeansOfType(Validator.class))
                .containsOnlyKeys("webFluxValidator", "testValidator");
    }
    ...
    void responseEntityResultHandlerUsesWebFluxInfrastructureByDefault() {
        ...
        ResponseEntityResultHandler responseEntityResultHandler =
                this.context.getBean(ResponseEntityResultHandler.class);
    ...
    void responseBodyResultHandlerUsesWebFluxInfrastructureByDefault() {
        ...
        ResponseBodyResultHandler responseBodyResultHandler =
                this.context.getBean(ResponseBodyResultHandler.class);
    ...
    void viewResolutionResultHandlerUsesWebFluxInfrastructureByDefault() {
        load(context -> {});
        ViewResolutionResultHandler viewResolutionResultHandler =
                this.context.getBean(ViewResolutionResultHandler.class);
    ...
    private <T> Consumer<AnnotationConfigApplicationContext> registerPrimaryBean(
