...
public class RequestMappingInfoHandlerMappingTests {
    ...
    private static final HandlerMethod handlerMethod =
            new HandlerMethod(
                    new TestController(), ClassUtils.getMethod(TestController.class, "dummy"));
    ...
    public void getHandlerDirectMatch() {
        Method expected =
                on(TestController.class).annot(getMapping("/foo").params()).resolveMethod();
    ...
    public void getHandlerGlobMatch() {
        Method expected =
                on(TestController.class)
                        .annot(requestMapping("/ba*").method(GET, HEAD))
                        .resolveMethod();
    ...
    public void handleMatchMatrixVariablesDecoding() {
        MockServerHttpRequest request =
                method(HttpMethod.GET, URI.create("/cars;mvar=a%2Fb")).build();
        ServerWebExchange exchange = MockServerWebExchange.from(request);
        handleMatch(exchange, "/{cars}");
