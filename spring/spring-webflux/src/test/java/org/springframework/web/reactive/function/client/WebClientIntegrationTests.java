...
class WebClientIntegrationTests {
    ...
    void retrieveJsonWithParameterizedTypeReference(ClientHttpConnector connector) {
        ...
        prepareResponse(
                response ->
                        response.setHeader("Content-Type", "application/json").setBody(content));

        Mono<ValueContainer<Pojo>> result =
                this.webClient
                        .get()
                        .uri("/json")
                        .accept(MediaType.APPLICATION_JSON)
        ...
        StepVerifier.create(result)
                .assertNext(
                        c ->
                                assertThat(c.getContainerValue())
                                        .isEqualTo(new Pojo("foofoo", "barbar")))
                .expectComplete()
                .verify(Duration.ofSeconds(3));
    ...
    void retrieveJsonArrayAsBodilessEntityShouldReleasesConnection() {
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            prepareResponse(
                    response ->
                            response.setHeader("Content-Type", "application/json").setBody(json));
    ...
    void retrieve404(ClientHttpConnector connector) {
        ...
        Mono<String> result =
                this.webClient.get().uri("/greeting").retrieve().bodyToMono(String.class);
        ...
        StepVerifier.create(result)
                .expectErrorSatisfies(
                        throwable -> {
                            ...
                            assertThat(ex.getHeaders().getContentType())
                            ...
                            assertThat(request.getURI())
                                    .isEqualTo(URI.create(this.server.url(path).toString()));
    ...
    void retrieve555UnknownStatus(ClientHttpConnector connector) {
        ...
        StepVerifier.create(result)
                .expectErrorSatisfies(
                        throwable -> {
                            assertThat(throwable instanceof UnknownHttpStatusCodeException)
                                    .isTrue();
                            UnknownHttpStatusCodeException ex =
                                    (UnknownHttpStatusCodeException) throwable;
                            assertThat(ex.getMessage())
                                    .isEqualTo(("Unknown status code [" + errorStatus + "]"));
        ...
        Mono<String> result =
                this.webClient
                        ...
                        .onStatus(
                                HttpStatus::isError,
                                response ->
                                        response.bodyToMono(Pojo.class)
                                                .flatMap(
                                                        pojo ->
                                                                Mono.error(
                                                                        new MyException(
    ...
    void statusHandlerSuppressedErrorSignalWithEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<String>> result =
                this.webClient
                        ...
                        .onStatus(
                                HttpStatus::is5xxServerError,
                                response -> Mono.empty()) // use normal response
                        .toEntity(String.class);
    ...
    void exchangeForJsonAsResponseEntity(ClientHttpConnector connector) {
        ...
        Mono<ResponseEntity<Pojo>> result =
                this.webClient
                        .get()
                        .uri("/json")
                        .accept(MediaType.APPLICATION_JSON)
    ...
    void filter(ClientHttpConnector connector) {
        ...
        Mono<String> result =
                filteredClient.get().uri("/greeting").retrieve().bodyToMono(String.class);
