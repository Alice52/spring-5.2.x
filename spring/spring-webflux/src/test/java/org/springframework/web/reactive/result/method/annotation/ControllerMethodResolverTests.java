...
public class ControllerMethodResolverTests {
    ...
    public void requestMappingArgumentResolvers() {
        ...
        assertThat(next(resolvers, index).getClass())
                .isEqualTo(HttpEntityMethodArgumentResolver.class);
        ...
        assertThat(next(resolvers, index).getClass())
                .isEqualTo(PrincipalMethodArgumentResolver.class);
        assertThat(next(resolvers, index).getClass())
                .isEqualTo(SessionStatusMethodArgumentResolver.class);
        assertThat(next(resolvers, index).getClass())
                .isEqualTo(WebSessionMethodArgumentResolver.class);
    ...
    static class CustomArgumentResolver implements HandlerMethodArgumentResolver {
        ...
        public Mono<Object> resolveArgument(
                MethodParameter p, BindingContext c, ServerWebExchange e) {
            return null;
        }
    }
