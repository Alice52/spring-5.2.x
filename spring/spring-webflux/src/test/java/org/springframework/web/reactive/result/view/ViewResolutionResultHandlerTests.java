...
public class ViewResolutionResultHandlerTests {
    ...
    public void supports() {
        ...
        testSupports(
                on(Handler.class)
                        .annotNotPresent(ModelAttribute.class)
                        .resolveReturnType(String.class));
        ...
        testSupports(
                on(Handler.class).annotPresent(ModelAttribute.class).resolveReturnType(Map.class));
        testSupports(
                on(Handler.class)
                        .annotNotPresent(ModelAttribute.class)
                        .resolveReturnType(Map.class));
    ...
    public void handleReturnValueTypes() {
        ...
        returnValue = "123";
        testHandle(
                "/account", returnType, returnValue, "account: {id=123, myString=123}", resolver);
        ...
        returnValue =
                new ConcurrentModel().addAttribute("name", "Joe").addAttribute("ignore", null);
        ...
        ServerWebExchange exchange =
                testHandle("/path", returnType, returnValue, expected, resolver);
    ...
    public void defaultViewName() {
        ...
        testDefaultViewName(
                Mono.empty(), on(Handler.class).resolveReturnType(Mono.class, Void.class));
        testDefaultViewName(
