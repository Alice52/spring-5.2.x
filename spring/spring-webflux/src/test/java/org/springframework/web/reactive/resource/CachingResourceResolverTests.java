...
public class CachingResourceResolverTests {
    ...
    public void resolveResourceInternalNoMatch() {
        ...
        assertThat(
                        this.chain
                                .resolveResource(exchange, "invalid.css", this.locations)
                                .block(TIMEOUT))
                .isNull();
    }
    ...
    public void resolverUrlPathFromCache() {
        ...
        this.cache.put(
                CachingResourceResolver.RESOLVED_URL_PATH_CACHE_KEY_PREFIX + "imaginary.css",
                expected);
    ...
    public void resolverUrlPathNoMatch() {
        assertThat(this.chain.resolveUrlPath("invalid.css", this.locations).block(TIMEOUT))
                .isNull();
    }

    @Test
    public void resolveResourceAcceptEncodingInCacheKey(GzippedFiles gzippedFiles)
            throws IOException {
