...
public class ProducesRequestConditionTests {
    ...
    public void matchParseError() {
        MockServerWebExchange exchange =
                MockServerWebExchange.from(get("/").header("Accept", "bogus"));
        ProducesRequestCondition condition = new ProducesRequestCondition("text/plain");
    ...
    public void matchAndCompare() {
        ...
        MockServerWebExchange exchange =
                MockServerWebExchange.from(get("/").header("Accept", "*/*"));
    ...
    private void assertConditions(ProducesRequestCondition condition, String... expected) {
        ...
        assertThat(expected.length)
                .as("Invalid number of conditions")
                .isEqualTo(expressions.size());
