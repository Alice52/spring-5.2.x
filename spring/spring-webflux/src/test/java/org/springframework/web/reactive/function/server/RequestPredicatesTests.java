...
public class RequestPredicatesTests {
    ...
    public void all() {
        MockServerHttpRequest mockRequest =
                MockServerHttpRequest.get("https://example.com").build();
    ...
    public void methodCorsPreFlight() {
        ...
        MockServerHttpRequest mockRequest =
                MockServerHttpRequest.options("https://example.com")
    ...
    public void allMethods() {
        ...
        MockServerHttpRequest mockRequest =
                MockServerHttpRequest.get("https://example.com/path").build();
        ServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(mockRequest), Collections.emptyList());
        assertThat(predicate.test(request)).isTrue();
    ...
    public void path() {
        ...
        ServerRequest request =
                new DefaultServerRequest(MockServerWebExchange.from(mockRequest), emptyList());
        assertThat(predicate.test(request)).isTrue();
    ...
    public void pathPredicates() {
        ...
        Function<String, RequestPredicate> pathPredicates =
    ...
    public void headers() {
        ...
        MockServerHttpRequest mockRequest =
                MockServerHttpRequest.get("https://example.com").header(name, value).build();
        ServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(mockRequest), Collections.emptyList());
        assertThat(predicate.test(request)).isTrue();
    ...
    public void queryParam() {
        MockServerHttpRequest mockRequest =
                MockServerHttpRequest.get("https://example.com").queryParam("foo", "bar").build();
        ServerRequest request =
                new DefaultServerRequest(
                        MockServerWebExchange.from(mockRequest), Collections.emptyList());
