...
public class ResponseEntityResultHandlerTests {
    ...
    public void supports() throws Exception {
        ...
        MethodParameter returnType =
                on(TestController.class).resolveReturnType(entity(String.class));
        ...
        returnType =
                on(TestController.class)
                        .resolveReturnType(CompletableFuture.class, entity(String.class));
        assertThat(this.resultHandler.supports(handlerResult(value, returnType))).isTrue();
    ...
    private void assertConditionalResponse(
        ...
        if (etag != null) {
            assertThat(exchange.getResponse().getHeaders().get(HttpHeaders.ETAG).size())
                    .isEqualTo(1);
