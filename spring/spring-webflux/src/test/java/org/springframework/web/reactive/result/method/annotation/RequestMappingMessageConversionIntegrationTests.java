...
public class RequestMappingMessageConversionIntegrationTests
    ...
    public void byteBufferResponseBodyWithObservable(HttpServer httpServer) throws Exception {
        ...
        String expected = "Hello!";
        assertThat(
                        performGet("/raw-response/observable", new HttpHeaders(), String.class)
                                .getBody())
                .isEqualTo(expected);
    }

    @ParameterizedHttpServerTest
    public void byteBufferResponseBodyWithRxJava2Observable(HttpServer httpServer)
            throws Exception {
        startServer(httpServer);
        ...
        assertThat(
                        performGet(
                                        "/raw-response/rxjava2-observable",
                                        new HttpHeaders(),
                                        String.class)
                                .getBody())
                .isEqualTo(expected);
    ...
    public void personResponseBodyWithMono(HttpServer httpServer) throws Exception {
        ...
        Person expected = new Person("Robert");
        ResponseEntity<Person> responseEntity =
                performGet("/person-response/mono", JSON, Person.class);
        assertThat(responseEntity.getHeaders().getContentLength()).isEqualTo(17);
        assertThat(responseEntity.getBody()).isEqualTo(expected);
    }
    ...
    public void personResponseBodyWithMonoResponseEntityXml(HttpServer httpServer)
            throws Exception {
        startServer(httpServer);
    ...
    public void personResponseBodyWithList(HttpServer httpServer) throws Exception {
        ...
        ResponseEntity<List<Person>> entity =
                performGet("/person-response/list", JSON, PERSON_LIST);
    ...
    public void personTransformWithPublisher(HttpServer httpServer) throws Exception {
        ...
        assertThat(
                        performPost("/person-transform/publisher", JSON, req, JSON, PERSON_LIST)
                                .getBody())
                .isEqualTo(res);
    }
    ...
    public void personTransformWithObservable(HttpServer httpServer) throws Exception {
        ...
        List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
        assertThat(
                        performPost("/person-transform/observable", JSON, req, JSON, PERSON_LIST)
                                .getBody())
                .isEqualTo(res);
    }
    ...
    public void personTransformWithRxJava2Observable(HttpServer httpServer) throws Exception {
        ...
        assertThat(
                        performPost(
                                        "/person-transform/rxjava2-observable",
                                        JSON,
                                        req,
                                        JSON,
                                        PERSON_LIST)
    ...
    public void personTransformWithFlowable(HttpServer httpServer) throws Exception {
        ...
        List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
        assertThat(
                        performPost("/person-transform/flowable", JSON, req, JSON, PERSON_LIST)
                                .getBody())
                .isEqualTo(res);
    }
    ...
    public void personCreateViaDefaultMethodWithGenerics(HttpServer httpServer) throws Exception {
        ...
        ResponseEntity<String> entity =
                performPost("/23791", JSON, new Person("Robert"), null, String.class);
