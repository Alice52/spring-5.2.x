...
public class WebFluxConfigurationSupportTests {
    ...
    public void requestMappingHandlerMapping() throws Exception {
        ...
        final Field field =
                ReflectionUtils.findField(
                        PathPatternParser.class, "matchOptionalTrailingSeparator");
        ...
        boolean matchOptionalTrailingSlash =
                (boolean) ReflectionUtils.getField(field, patternParser);
    ...
    public void responseEntityResultHandler() throws Exception {
        ...
        ResponseEntityResultHandler handler =
                context.getBean(name, ResponseEntityResultHandler.class);
    ...
    public void viewResolutionResultHandler() throws Exception {
        ...
        ViewResolutionResultHandler handler =
                context.getBean(name, ViewResolutionResultHandler.class);
        assertThat(handler).isNotNull();
