...
public class HandlerResultHandlerTests {
    ...
    void producibleMediaTypesRequestAttribute() {
        ...
        exchange.getAttributes()
                .put(
                        ...
                        Collections.singleton(IMAGE_GIF));
    ...
    void charsetFromAcceptHeader() {
        ...
        MediaType actual =
                this.resultHandler.selectMediaType(
                        exchange, () -> Collections.singletonList(textUtf8));
    ...
    void removeQualityParameter() {
        MockServerWebExchange exchange =
                MockServerWebExchange.from(
                        MockServerHttpRequest.get("/path").header("Accept", "text/plain; q=0.5"));
