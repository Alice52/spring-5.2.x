...
public class RequestContext {
    ...
    /**
     * Return the {@link RequestDataValueProcessor} instance to apply to in form tag libraries and
     * to redirect URLs.
     */
    @Nullable
    ...
    /**
     * Return the query string of the current request. This is useful for building an HTML form
     * action target in combination with the original request path.
     */
