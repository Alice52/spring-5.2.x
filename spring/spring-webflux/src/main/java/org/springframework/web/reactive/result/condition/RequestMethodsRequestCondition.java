...
public final class RequestMethodsRequestCondition
    ...
    private static final Map<HttpMethod, RequestMethodsRequestCondition>
    ...
    public RequestMethodsRequestCondition(RequestMethod... requestMethods) {
        this.methods =
                (ObjectUtils.isEmpty(requestMethods)
     ...
     * match, otherwise try to match to the HTTP method in the "Access-Control-Request-Method"
     * header.
     */
    @Nullable
    ...
    public int compareTo(RequestMethodsRequestCondition other, ServerWebExchange exchange) {
        if (other.methods.size() != this.methods.size()) {
            ...
            if (this.methods.contains(RequestMethod.HEAD)
                    && other.methods.contains(RequestMethod.GET)) {
                return -1;
