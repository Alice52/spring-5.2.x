...
public final class ConsumesRequestCondition
    ...
    /**
     * Creates a new instance with "consumes" and "header" expressions. "Header" expressions where
     * the header name is not 'Content-Type' or have no header value defined are ignored. If 0
     * expressions are provided in total, the condition will match to every request
     *
    ...
    private static List<ConsumeMediaTypeExpression> parseExpressions(
