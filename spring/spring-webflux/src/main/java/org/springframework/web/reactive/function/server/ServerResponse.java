...
public interface ServerResponse {
    ...
    /**
     * Create a builder with an {@linkplain HttpStatus#UNPROCESSABLE_ENTITY 422 Unprocessable
     * Entity} status.
     *
     * @return the created builder
     */
    ...
    interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
        ...
        /**
         * Set the body of the response to the given {@code Object} and return it. This is a
         * shortcut for using a {@link #body(BodyInserter)} with a {@linkplain
         * BodyInserters#fromValue value inserter}.
         *
         ...
         * The model attributes are mapped under a {@linkplain
         * org.springframework.core.Conventions#getVariableName generated name}.
         *
         * <p><em>Note: Empty {@link Collection Collections} are not added to the model when using
         * this method because we cannot correctly determine the true convention name.</em>
         *
