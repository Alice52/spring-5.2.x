...
public abstract class ExchangeFilterFunctions {
     ...
     *
     * @deprecated as of Spring 5.1 in favor of using {@link HttpHeaders#setBasicAuth(String,
     *     String)} while building the request.
     */
    @Deprecated
    ...
    /**
     * Consume up to the specified number of bytes from the response body and cancel if any more
     * data arrives.
     *
            ...
            if (attr instanceof Credentials) {
                ...
                return next.exchange(
                        ClientRequest.from(request)
                                .headers(
                                        headers ->
                                                headers.setBasicAuth(cred.username, cred.password))
                                .build());
            } else {
    ...
    public static final class Credentials {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return (this.username.equals(otherCred.username)
                    && this.password.equals(otherCred.password));
        }
