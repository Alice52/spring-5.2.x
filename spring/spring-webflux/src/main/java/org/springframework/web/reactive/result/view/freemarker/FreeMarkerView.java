...
public class FreeMarkerView extends AbstractUrlBasedView {
    ...
    /**
     * Prepare the model to use for rendering by potentially exposing a {@link RequestContext} for
     * use in Spring FreeMarker macros and then delegating to the inherited implementation of this
     * method.
     *
     * @since 5.2
     * @see #setExposeSpringMacroHelpers(boolean)
    ...
    protected Mono<Map<String, Object>> getModelAttributes(
        ...
        if (this.exposeSpringMacroHelpers) {
            ...
            Map<String, Object> attributes =
                    (model != null ? new HashMap<>(model) : new HashMap<>());
                ...
                .writeWith(
                        Mono.fromCallable(
                                        () -> {
                                            ...
                                            SimpleHash freeMarkerModel =
                                                    getTemplateModel(renderAttributes, exchange);
                                            ...
                                            try {
                                                ...
                                                Writer writer =
                                                        new OutputStreamWriter(
                                                                ...
                                                                charset);
                                                getTemplate(locale)
                                                        .process(freeMarkerModel, writer);
                                                return dataBuffer;
                                            } catch (IOException ex) {
