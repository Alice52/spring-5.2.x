...
public interface WebClient {
    ...
    interface Builder {
         ...
         * </pre>
         *
         * <p>The {@code DefaultUriBuilderFactory} is used to prepare the URL for every request with
         * the given base URL, unless the URL request for a given URL is absolute in which case the
         * base URL is ignored.
         *
         * <p><strong>Note:</strong> this method is mutually exclusive with {@link
         * #uriBuilderFactory(UriBuilderFactory)}. If both are used, the baseUrl value provided here
         * will be ignored.
         *
        ...
        /**
         * Configure default URI variable values that will be used when expanding URI templates
         * using a {@link Map}.
         *
         ...
         */
        /**
         * Configure default URL variable values to use when expanding URI templates with a {@link
         * Map}. Effectively a shortcut for:
         *
         * <p>
         *
         * <pre class="code">
         ...
         *
         * <p><strong>Note:</strong> this method is mutually exclusive with {@link
         * #uriBuilderFactory(UriBuilderFactory)}. If both are used, the defaultUriVariables value
        ...
        /**
         * Provide a pre-configured {@link UriBuilderFactory} instance. This is an alternative to,
         * and effectively overrides the following shortcut properties:
         *
         * <ul>
        ...
        /**
         * Provides access to every {@link #defaultHeader(String, String...)} declared so far with
        ...
        /**
         * Provides access to every {@link #defaultCookie(String, String...)} declared so far with
         * the possibility to add, replace, or remove.
         *
         ...
         *
         * <p>This is an alternative to, and effectively overrides {@link #clientConnector}, and
    ...
    interface RequestHeadersSpec<S extends RequestHeadersSpec<S>> {
        ...
        /**
         * Provides access to every attribute declared so far with the possibility to add, replace,
         * or remove values.
         *
         ...
         * </pre>
         *
         * <p><strong>NOTE:</strong> Unlike {@link #retrieve()}, when using {@code exchange()}, it
         * is the responsibility of the application to consume any response content regardless of
         * the scenario (success, error, unexpected data, etc). Not doing so can cause a memory
         * leak. See {@link ClientResponse} for a list of all the available options for consuming
         * the body. Generally prefer using {@link #retrieve()} unless you have a good reason to use
         * {@code exchange()} which does allow to check the response status and headers before
         * deciding how or if to consume the response.
         *
    ...
    interface RequestBodySpec extends RequestHeadersSpec<RequestBodySpec> {
         ...
         * </pre>
         *
         * <p>For multipart requests consider providing {@link
         * org.springframework.util.MultiValueMap MultiValueMap} prepared with {@link
         * org.springframework.http.client.MultipartBodyBuilder MultipartBodyBuilder}.
         *
         * @param body the value to write to the request body
         * @return this builder
         * @throws IllegalArgumentException if {@code body} is a {@link Publisher} or producer known
         *     to {@link ReactiveAdapterRegistry}
         * @since 5.2
         */
    ...
    interface ResponseSpec {
        ...
        /**
         * Provide a function to map specific error status codes to an error signal to be propagated
         * downstream instead of the response.
         *
         * <p>By default, if there are no matching status handlers, responses with status codes >=
         * 400 are mapped to {@link WebClientResponseException} which is created with {@link
         * ClientResponse#createException()}.
         *
         * <p>To suppress the treatment of a status code as an error and process it as a normal
         * response, return {@code Mono.empty()} from the function. The response will then propagate
         * downstream to be processed.
         *
         * <p>To ignore an error response completely, and propagate neither response nor error, use
         * a {@link ExchangeFilterFunction filter}, or add {@code onErrorResume} downstream, for
         * example:
         *
         * <pre class="code">
         * webClient.get()
        ...
        /**
         * Variant of {@link #onStatus(Predicate, Function)} that works with raw status code values.
         * This is useful for custom status codes.
         *
         ...
         * response has status code 4xx or 5xx, the {@code Mono} will contain a {@link
         * WebClientException}. This can be overridden with {@link #onStatus(Predicate, Function)}.
         *
         ...
         * @since 5.2
         */
        <T> Mono<ResponseEntity<List<T>>> toEntityList(
         ...
         * will contain a {@link WebClientException}. This can be overridden with {@link
         * #onStatus(Predicate, Function)}. Calling this method will {@linkplain
         * ClientResponse#releaseBody() release} the body of the response.
         *
