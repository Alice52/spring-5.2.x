...
public interface ExchangeStrategies {
    ...
    /**
     * Return a builder pre-configured with default configuration to start. This is the same as
     * {@link #withDefaults()} but returns a mutable builder for further customizations.
     */
    ...
    /**
     * Return {@link HttpMessageReader HttpMessageReaders} to read and decode the response body
     * with.
     *
    ...
    /**
     * Return {@link HttpMessageWriter HttpMessageWriters} to write and encode the request body
     * with.
     *
    ...
    /**
     * Return a builder to create a new {@link ExchangeStrategies} instance replicated from the
     * current instance.
     *
     * @since 5.1.12
     */
