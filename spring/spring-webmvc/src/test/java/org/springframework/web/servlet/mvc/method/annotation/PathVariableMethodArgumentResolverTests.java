        ...
        Optional<String> result =
                (Optional<String>)
                        resolver.resolveArgument(
                                paramOptional, mavContainer, webRequest, binderFactory);
    ...
    public void handleMissingValue() throws Exception {
        assertThatExceptionOfType(MissingPathVariableException.class)
                .isThrownBy(
                        () ->
                                resolver.resolveArgument(
                                        paramNamedString, mavContainer, webRequest, null));
    }

    @Test
    public void nullIfNotRequired() throws Exception {
        assertThat(resolver.resolveArgument(paramNotRequired, mavContainer, webRequest, null))
                .isNull();
    }
