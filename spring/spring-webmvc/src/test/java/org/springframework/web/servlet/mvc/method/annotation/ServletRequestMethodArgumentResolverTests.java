...
public class ServletRequestMethodArgumentResolverTests {
    ...
    public void session() throws Exception {
        ...
        assertThat(resolver.supportsParameter(sessionParameter))
                .as("Session not supported")
                .isTrue();
    ...
    public void timeZone() throws Exception {
        ...
        assertThat(resolver.supportsParameter(timeZoneParameter))
                .as("TimeZone not supported")
                .isTrue();
