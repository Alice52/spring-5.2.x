...
public class ViewResolverTests {
    ...
    private void doTestUrlBasedViewResolverWithoutPrefixes(UrlBasedViewResolver vr)
        ...
        this.request.setAttribute(
                DispatcherServlet.THEME_RESOLVER_ATTRIBUTE, new FixedThemeResolver());
                    ...
                    public RequestDispatcher getRequestDispatcher(String path) {
                        return new MockRequestDispatcher(path) {
                            ...
                            public void forward(
                                ...
                                assertThat(forwardRequest.getAttribute("myBean"))
                                        .isSameAs(wac.getBean("myBean"));
                                assertThat(forwardRequest.getAttribute("myBean2"))
                                        .isSameAs(wac.getBean("myBean2"));
                            }
                        };
                    }
                };
