...
public class VersionResourceResolverTests {
    ...
    public void resolveResourceExisting() throws Exception {
        ...
        Resource actual =
                this.resolver.resolveResourceInternal(null, file, this.locations, this.chain);
    ...
    public void resolveResourceNoResourceAfterVersionRemoved() throws Exception {
        ...
        this.resolver.setStrategyMap(Collections.singletonMap("/**", this.versionStrategy));
        Resource actual =
                this.resolver.resolveResourceInternal(
                        null, versionFile, this.locations, this.chain);
        assertThat((Object) actual).isNull();
    ...
    public void resolveResourceSuccess() throws Exception {
        ...
        Resource actual =
                this.resolver.resolveResourceInternal(
                        request, versionFile, this.locations, this.chain);
    ...
    public void resolveUrlPathNoVersionStrategy() throws Exception {
        ...
        String resolved =
                this.resolver.resolveUrlPathInternal("/foo.css", this.locations, this.chain);
