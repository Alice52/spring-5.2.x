...
public class PathResourceResolverTests {
    ...
    public void resolveFromClasspath() throws IOException {
        ...
        Resource actual =
                this.resolver.resolveResource(
                        null, requestPath, Collections.singletonList(location), null);
    ...
    public void checkResourceWithAllowedLocations() {
        ...
        List<Resource> locations = Collections.singletonList(location);
        String actual =
                this.resolver.resolveUrlPath("../testalternatepath/bar.css", locations, null);
    ...
    public void checkRelativeLocation() throws Exception {
        ...
        location =
                location.replace("/test/org/springframework", "/test/org/../org/springframework");

        Resource actual =
                this.resolver.resolveResource(
                        null,
                        "main.css",
                        Collections.singletonList(new UrlResource(location)),
                        null);
    ...
    public void resolvePathRootResource() {
        ...
        String path =
                this.resolver.resolveUrlPathInternal(
                        "", Collections.singletonList(webjarsLocation), null);
    ...
    public void relativePathEncodedForUrlResource() throws Exception {
        ...
        // UTF-8
        this.resolver.setLocationCharsets(
                Collections.singletonMap(location, StandardCharsets.UTF_8));
        this.resolver.resolveResource(new MockHttpServletRequest(), "/Ä ;ä.txt", locations, null);
