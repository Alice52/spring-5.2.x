...
public class HttpEntityMethodProcessorMockTests {
    ...
    public void shouldResolveRequestEntityArgument() throws Exception {
        ...
        Object result =
                processor.resolveArgument(paramRequestEntity, mavContainer, webRequest, null);
                ...
                .isThrownBy(
                        () ->
                                processor.resolveArgument(
                                        paramHttpEntity, mavContainer, webRequest, null));
    }
    ...
    public void shouldHandleReturnValueWithProducibleMediaType() throws Exception {
        ...
        given(stringHttpMessageConverter.canWrite(String.class, MediaType.TEXT_HTML))
                .willReturn(true);
    ...
    public void shouldHandleResponseHeaderAndBody() throws Exception {
        ...
        verify(stringHttpMessageConverter)
                .write(eq("body"), eq(TEXT_PLAIN), outputMessage.capture());
        assertThat(mavContainer.isRequestHandled()).isTrue();
        assertThat(outputMessage.getValue().getHeaders().get("header").get(0))
    ...
    public void shouldHandleLastModifiedWithHttp304() throws Exception {
        ...
        servletRequest.addHeader(
                HttpHeaders.IF_MODIFIED_SINCE, RFC_1123_DATE_TIME.format(dateTime));
        ResponseEntity<String> returnValue =
    ...
    public void handleEtagWithHttp304AndEtagFilterHasNoImpact() throws Exception {
        ...
        FilterChain chain =
                (req, res) -> {
                    servletRequest.addHeader(HttpHeaders.IF_NONE_MATCH, eTagValue);
                    ResponseEntity<String> returnValue =
                            ResponseEntity.ok().eTag(eTagValue).body("body");
                    initStringMessageConversion(TEXT_PLAIN);
                    try {
                        processor.handleReturnValue(
                                returnValue, returnTypeResponseEntity, mavContainer, webRequest);
    ...
    public void shouldHandleIfNoneMatchIfUnmodifiedSince() throws Exception {
        ...
        servletRequest.addHeader(
                HttpHeaders.IF_UNMODIFIED_SINCE, RFC_1123_DATE_TIME.format(dateTime));
        ResponseEntity<String> returnValue = ResponseEntity.ok().eTag(etagValue).body("body");
    ...
    public void disableRangeSupportForStreamingResponses() throws Exception {
        ...
        given(resourceMessageConverter.canWrite(any(), eq(APPLICATION_OCTET_STREAM)))
                .willReturn(true);
    ...
    private void assertConditionalResponse(
        ...
        if (lastModified != -1) {
            assertThat(servletResponse.getHeaderValues(HttpHeaders.LAST_MODIFIED).size())
                    .isEqualTo(1);
