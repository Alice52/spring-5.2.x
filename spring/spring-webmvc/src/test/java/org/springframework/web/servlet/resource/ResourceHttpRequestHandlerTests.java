...
public class ResourceHttpRequestHandlerTests {
    ...
    public void getVersionedResource() throws Exception {
        ...
        this.handler.setResourceResolvers(
                Arrays.asList(versionResolver, new PathResourceResolver()));
        this.handler.afterPropertiesSet();
    ...
    public void getResourceHttp10BehaviorCache() throws Exception {
        ...
        assertThat(this.response.getHeader("Cache-Control"))
                .isEqualTo("max-age=3600, must-revalidate");
        assertThat(
    ...
    public void getResourceFromSubDirectory() throws Exception {
        this.request.setAttribute(
                HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, "js/foo.js");
        this.handler.handleRequest(this.request, this.response);
    ...
    public void getResourceFromSubDirectoryOfAlternatePath() throws Exception {
        this.request.setAttribute(
                HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, "js/baz.js");
        this.handler.handleRequest(this.request, this.response);
    ...
    private void testInvalidPath(String requestPath, ResourceHttpRequestHandler handler)
            throws Exception {
        this.request.setAttribute(
                HandlerMapping.PATH_WITHIN_HANDLER_MAPPING_ATTRIBUTE, requestPath);
        this.response = new MockHttpServletResponse();
        handler.handleRequest(this.request, this.response);
    ...
    public void processPath() {
        ...
        assertThat(this.handler.processPath("\\\\foo\\ \\bar\\\\baz\\\\"))
    ...
    @Test // gh-25976
    public void partialContentByteRangeWithEncodedResource(GzipSupport.GzippedFiles gzippedFiles)
            throws Exception {
        ...
        handler.setResourceResolvers(
                Arrays.asList(new EncodedResourceResolver(), new PathResourceResolver()));
        handler.setLocations(Collections.singletonList(new ClassPathResource("test/", getClass())));
        handler.setServletContext(new MockServletContext());
        handler.afterPropertiesSet();
        ...
        assertThat(this.response.getStatus()).isEqualTo(206);
        assertThat(this.response.getHeaderNames())
