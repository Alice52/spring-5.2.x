...
public class ServletInvocableHandlerMethodTests {
    ...
    public void invokeAndHandle_VoidWithResponseStatus() throws Exception {
        ServletInvocableHandlerMethod handlerMethod =
                getHandlerMethod(new Handler(), "responseStatus");
    ...
    public void invokeAndHandle_VoidWithComposedResponseStatus() throws Exception {
        ...
        assertThat(this.mavContainer.isRequestHandled())
                .as(
                        "Null return value + @ComposedResponseStatus should result in 'request handled'")
                .isTrue();
    }
    ...
    public void invokeAndHandle_VoidWithHttpServletResponseArgument() throws Exception {
        ...
        assertThat(this.mavContainer.isRequestHandled())
                .as(
                        "Null return value + HttpServletResponse arg should result in 'request handled'")
                .isTrue();
    }
    ...
    public void invokeAndHandle_VoidRequestNotModified() throws Exception {
        ...
        ServletInvocableHandlerMethod handlerMethod =
                getHandlerMethod(new Handler(), "notModified");
        handlerMethod.invokeAndHandle(this.webRequest, this.mavContainer);
    ...
    public void wrapConcurrentResult_MethodLevelResponseBody() throws Exception {
        wrapConcurrentResult_ResponseBody(
                new MethodLevelResponseBodyHandler(), "bar", String.class);
    }
    ...
    private void wrapConcurrentResult_ResponseBody(
        ...
        this.returnValueHandlers.addHandler(
                new RequestResponseBodyMethodProcessor(this.converters));
    ...
    public void wrapConcurrentResult_ResponseEntity() throws Exception {
        ...
        handlerMethod =
                handlerMethod.wrapConcurrentResult(new ResponseEntity<>("bar", HttpStatus.OK));
        handlerMethod.invokeAndHandle(this.webRequest, this.mavContainer);
    ...
    public void wrapConcurrentResult_CollectedValuesListWithResponseEntity() throws Exception {
        ...
        this.returnValueHandlers.addHandler(
                new RequestResponseBodyMethodProcessor(converters, manager));
        ServletInvocableHandlerMethod hm =
                getHandlerMethod(new ResponseEntityHandler(), "handleFlux");
        hm = hm.wrapConcurrentResult(result);
        hm.invokeAndHandle(this.webRequest, this.mavContainer);
    ...
    private ServletInvocableHandlerMethod getHandlerMethod(
            Object controller, String methodName, Class<?>... argTypes)
