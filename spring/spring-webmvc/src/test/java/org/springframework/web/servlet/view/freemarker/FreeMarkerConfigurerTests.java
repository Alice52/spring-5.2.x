...
public class FreeMarkerConfigurerTests {
    ...
    public void freeMarkerConfigurerWithResourceLoaderPath() throws Exception {
        ...
        assertThat(multiTemplateLoader.getTemplateLoader(0))
                .isInstanceOf(SpringTemplateLoader.class);
        assertThat(multiTemplateLoader.getTemplateLoader(1))
                .isInstanceOf(ClassTemplateLoader.class);
    }
        ...
        freeMarkerConfigurer.setResourceLoader(
                new ResourceLoader() {
                    ...
                    public Resource getResource(String location) {
                        if (!("file:/mydir".equals(location)
                                || "file:/mydir/test".equals(location))) {
