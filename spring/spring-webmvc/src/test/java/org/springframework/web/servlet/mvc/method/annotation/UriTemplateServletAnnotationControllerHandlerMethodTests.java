...
public class UriTemplateServletAnnotationControllerHandlerMethodTests
                        ...
                        new ApplicationContextInitializer<GenericWebApplicationContext>() {
                            ...
                            public void initialize(GenericWebApplicationContext context) {
                                ...
                                beanDef.getConstructorArgumentValues()
                                        .addGenericArgumentValue(pathVars);
    ...
    public void relative() throws Exception {
        ...
        MockHttpServletRequest request =
                new MockHttpServletRequest("GET", "/hotels/42/bookings/21");
        MockHttpServletResponse response = new MockHttpServletResponse();
        getServlet().service(request, response);
    ...
    public static class MultipleUriTemplateController {
        ...
        public void handle(
            ...
            writer.write(
                    "test-" + hotel + "-q" + qHotel + "-" + booking + "-" + other + "-q" + qOther);
        }
    ...
    public static class BindingUriTemplateController {
        ...
        public void handle(
                @PathVariable("hotel") String hotel, @PathVariable Date date, Writer writer)
                throws IOException {
            assertThat(hotel).as("Invalid path variable value").isEqualTo("42");
            assertThat(date)
    ...
    public static class AmbiguousUriTemplateController {
        ...
        public void handleVars(@PathVariable("hotel") String hotel, Writer writer)
                throws IOException {
            assertThat(hotel).as("Invalid path variable value").isEqualTo("42");
