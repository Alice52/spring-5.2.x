...
public class RequestMappingInfoHandlerMappingTests {
    ...
    public void getHandlerRequestMethodNotAllowed() throws Exception {
        ...
        assertThatExceptionOfType(HttpRequestMethodNotSupportedException.class)
                ...
                .satisfies(
                        ex -> assertThat(ex.getSupportedMethods()).containsExactly("GET", "HEAD"));
    }
    ...
    public void getHandlerMappedInterceptors() throws Exception {
        ...
        MappedInterceptor mappedInterceptor =
                new MappedInterceptor(new String[] {path}, interceptor);
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getSupportedMediaTypes())
                                        .containsExactly(MediaType.APPLICATION_XML));
    }
    ...
    private void testHttpOptions(String requestURI, String allowHeader) throws Exception {
        ...
        Object result =
                new InvocableHandlerMethod(handlerMethod)
                        .invokeForRequest(webRequest, mavContainer);
