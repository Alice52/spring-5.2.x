...
public class SelectTagTests extends AbstractFormTagTests {
    ...
    public void nestedPathWithListAndEditorAndNullValue() throws Exception {
        ...
        BeanPropertyBindingResult bindingResult =
                new BeanPropertyBindingResult(testBean, "testBean");
        bindingResult
                .getPropertyAccessor()
                .registerCustomEditor(
                        Country.class,
    ...
    public void withNestedOptions() throws Exception {
        ...
        assertThat(value.getValue())
                .as("Selected country not exposed in page context")
                .isEqualTo("UK");
    ...
    public void withMultiMapWithItemValueAndItemLabel() throws Exception {
        ...
        try {
            ...
            e =
                    (Element)
                            selectElement.selectSingleNode(
                                    "option[@value = '" + austria.getIsoCode() + "']");
            assertThat(e)
                    .as(
                            "Option node not found with Country ISO code value ["
                                    + austria.getIsoCode()
                                    + "].")
                    .isNotNull();
            assertThat(e.attribute("selected").getValue())
