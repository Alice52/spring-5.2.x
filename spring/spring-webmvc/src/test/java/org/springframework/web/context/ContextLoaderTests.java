...
public class ContextLoaderTests {
    ...
    public void testContextLoaderListenerWithDefaultContext() {
        ...
        assertThat(condition1)
                .as("Correct WebApplicationContext exposed in ServletContext")
                .isTrue();
        assertThat(
    ...
    public void testContextLoaderListenerWithLocalContextInitializers() {
        ...
        sc.addInitParameter(
                ...
                StringUtils.arrayToCommaDelimitedString(
                        new Object[] {
                            TestContextInitializer.class.getName(),
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getCause())
                                        .hasMessageContaining("/WEB-INF/applicationContext.xml"));
    }
    ...
    public void testFrameworkServletWithDefaultLocation() throws Exception {
        ...
        assertThatExceptionOfType(BeanDefinitionStoreException.class)
                .isThrownBy(
                        () ->
                                servlet.init(
                                        new MockServletConfig(new MockServletContext(""), "test")))
                .withCauseInstanceOf(IOException.class)
                .satisfies(
                        ex ->
                                assertThat(ex.getCause())
                                        .hasMessageContaining("/WEB-INF/test-servlet.xml"));
    }
    ...
    private static class TestWebContextInitializer
        ...
        public void initialize(ConfigurableWebApplicationContext applicationContext) {
            ServletContext ctx =
                    applicationContext
                            .getServletContext(); // type-safe access to servlet-specific methods
