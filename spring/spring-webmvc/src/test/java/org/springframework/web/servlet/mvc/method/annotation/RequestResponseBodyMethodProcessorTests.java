...
public class RequestResponseBodyMethodProcessorTests {
    ...
    public void resolveArgumentParameterizedType() throws Exception {
        ...
        List<SimpleBean> result =
                (List<SimpleBean>)
                        processor.resolveArgument(paramGenericList, container, request, factory);
    ...
    public void resolveArgumentClassJson() throws Exception {
        ...
        SimpleBean result =
                (SimpleBean)
                        processor.resolveArgument(paramSimpleBean, container, request, factory);
    ...
    public void resolveArgumentClassString() throws Exception {
        ...
        String result =
                (String) processor.resolveArgument(paramString, container, request, factory);
    ...
    public void resolveArgumentTypeVariableWithNonGenericConverter() throws Exception {
        ...
        HttpMessageConverter<?> proxy =
                ProxyFactory.getProxy(
                        HttpMessageConverter.class, new SingletonTargetSource(target));
    ...
    public void resolveArgumentWithJacksonJsonView() throws Exception {
        ...
        Method method =
                JacksonController.class.getMethod("handleRequestBody", JacksonViewBean.class);
        HandlerMethod handlerMethod = new HandlerMethod(new JacksonController(), method);
    ...
    public void resolveArgumentTypeVariableWithGenericInterfaceAndSubclass() throws Exception {
        ...
        HandlerMethod handlerMethod =
                new HandlerMethod(new SubControllerImplementingInterface(), method);
        MethodParameter methodParameter = handlerMethod.getMethodParameters()[0];
