...
public class PathMatchConfigurer {
     ...
     *     deprecation of path extension config options. As there is no replacement for this method,
     *     for the time being it's necessary to set it to {@code false}. In 5.3 when {@code false}
     ...
     * registered when you {@link WebMvcConfigurer#configureContentNegotiation configure content
     * negotiation}. This is generally recommended to reduce ambiguity and to avoid issues such as
