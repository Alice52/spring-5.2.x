...
public abstract class AbstractMultiCheckedElementTag extends AbstractCheckedElementTag {
    ...
    /**
     * Renders the '{@code input type="radio"}' element with the configured {@link
     * #setItems(Object)} values. Marks the element as checked if the value matches the bound value.
     */
    @Override
    ...
    private void writeObjectEntry(
        ...
        Object renderLabel =
                (labelProperty != null ? wrapper.getPropertyValue(labelProperty) : item);
    ...
    private void writeMapEntry(
        ...
        Object renderValue =
                (valueProperty != null
                        ? mapKeyWrapper.getPropertyValue(valueProperty)
                        : mapKey.toString());
        Object renderLabel =
                (labelProperty != null
