...
public interface RouterFunction<T extends ServerResponse> {
    ...
    /**
     * Return a composed routing function that routes to the given handler function if this route
     * does not match and the given request predicate applies. This method is a convenient
     * combination of {@link #and(RouterFunction)} and {@link
    ...
    /**
     * Return a composed routing function that routes to the given router function if this route
     * does not match and the given request predicate applies. This method is a convenient
     * combination of {@link #and(RouterFunction)} and {@link RouterFunctions#nest(RequestPredicate,
     * RouterFunction)}.
     *
     * @param predicate the predicate to test if this route does not match
     ...
     */
    default RouterFunction<T> andNest(
