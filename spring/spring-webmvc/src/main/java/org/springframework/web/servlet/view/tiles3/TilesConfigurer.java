...
public class TilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
     ...
     * properties on this configurer.</b> The entire initialization procedure is then left to the
     ...
     *
     * <p>Specify a custom DefinitionsFactory, e.g. a UrlDefinitionsFactory subclass, to customize
     * the creation of Tiles Definition objects. Note that such a DefinitionsFactory has to be able
     * to handle {@link java.net.URL} source objects, unless you configure a different
     ...
     * org.apache.tiles.preparer.ViewPreparer} instances based on specified preparer classes,
     * applying Spring's container callbacks as well as applying configured Spring
     * BeanPostProcessors. If Spring's context-wide annotation-config has been activated,
     * annotations in ViewPreparer classes will be automatically detected and applied.
     *
     ...
     * application context in this case, allowing for the use of scoped beans etc. Note that you
     * need to define one Spring bean definition per preparer name (as used in your Tiles
     * definitions).
     *
            ...
            if (definitions != null) {
                ...
                for (String definition : definitions) {
                    Collection<ApplicationResource> resources =
                            applicationContext.getResources(definition);
                    if (resources != null) {
