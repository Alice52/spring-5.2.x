...
public class MvcUriComponentsBuilder {
     ...
     * method argument values. This method delegates to {@link #fromMethod(Class, Method,
     * Object...)}.
     *
     * <p><strong>Note:</strong> This method extracts values from "Forwarded" and "X-Forwarded-*"
     * headers if found. See class-level docs.
     ...
     * URI (via implementations of {@link
     * org.springframework.web.method.support.UriComponentsContributor UriComponentsContributor})
     ...
     * method and the supplied argument values are then used to delegate to {@link
     ...
     *
     * <p>Note that this is a shorthand version of {@link #controller(Class)} intended for inline
     * use (with a static import), for example:
     *
     * <pre class="code">
     ...
     * </pre>
     *
     * <p>Note that it's not necessary to specify all arguments. Only the ones required to prepare
     * the URL, mainly {@code @RequestParam} and {@code @PathVariable}).
     *
     * <p><strong>Note:</strong> This method extracts values from "Forwarded" and "X-Forwarded-*"
     * headers if found. See class-level docs.
     *
    ...
    /**
     * An alternative to {@link #fromMappingName(String)} that accepts a {@code
     * UriComponentsBuilder} representing the base URL. This is useful when using
     * MvcUriComponentsBuilder outside the context of processing a request or to apply a custom
     * baseUrl not matching the current request.
     *
    ...
    private static String getMethodMapping(Method method) {
        ...
        if (requestMapping == null) {
            throw new IllegalArgumentException(
                    "No @RequestMapping on: " + method.toGenericString());
        }
    ...
    private static class ControllerMethodInvocationInterceptor
            ...
            if (controllerType == Object.class) {
                ...
                if (objenesis.isWorthTrying()) {
                    try {
                        ...
                        logger.debug(
                                "Failed to create controller proxy, falling back on default constructor",
                                ex);
                    }
                }
        ...
        public Object intercept(
                @Nullable Object obj, Method method, Object[] args, @Nullable MethodProxy proxy) {
    ...
    public static class MethodArgumentBuilder {
        ...
        public String build() {
            return fromMethodInternal(
                            this.baseUrl, this.controllerType, this.method, this.argumentValues)
                    .build()
                    .encode()
                    .toUriString();
        }
