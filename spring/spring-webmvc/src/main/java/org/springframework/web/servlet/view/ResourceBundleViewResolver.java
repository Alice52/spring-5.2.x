 ...
 *
 * <p>A {@link org.springframework.web.servlet.ViewResolver} implementation that uses bean
...
public class ResourceBundleViewResolver extends AbstractCachingViewResolver
    ...
    /**
     * Set the {@link ClassLoader} to load resource bundles with. Default is the thread context
     * {@code ClassLoader}.
     */
     ...
     *
     * <p>The parent will typically define the view class and common attributes. Concrete views
     * might simply consist of a URL definition then: a la "yyy1.url=/my.jsp", "yyy2.url=/your.jsp".
     *
     ...
     *
     * <p>Allows for pre-initialization of common Locales, eagerly checking the view configuration
     * for those Locales.
     */
