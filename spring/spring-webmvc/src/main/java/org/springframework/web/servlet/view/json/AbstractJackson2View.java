...
public abstract class AbstractJackson2View extends AbstractView {
    ...
    /**
     * Set the {@code JsonEncoding} for this view. By default, {@linkplain JsonEncoding#UTF8 UTF-8}
     * is used.
     */
    ...
    protected void writeContent(OutputStream stream, Object object) throws IOException {
        JsonGenerator generator =
                this.objectMapper.getFactory().createGenerator(stream, this.encoding);
    ...
    /**
     * Set the attribute in the model that should be rendered by this view. When set, all other
