...
public class UrlFilenameViewController extends AbstractUrlViewController {
    ...
    protected String extractOperableUrl(HttpServletRequest request) {
        ...
        if (!StringUtils.hasText(urlPath)) {
            urlPath =
                    getUrlPathHelper().getLookupPathForRequest(request, HandlerMapping.LOOKUP_PATH);
        }
        return urlPath;
    }
    ...
    protected String getViewNameForUrlPath(String uri) {
        return this.viewNameCache.computeIfAbsent(
                uri, u -> postProcessViewName(extractViewNameFromUrlPath(u)));
    }
