...
public interface RequestPredicate {
    ...
    /**
     * Return a composed request predicate that tests against both this predicate OR the {@code
     * other} predicate. When evaluating the composed predicate, if this predicate is {@code true},
     * then the {@code other} predicate is not evaluated.
     *
     ...
     * path-based predicate can return a {@code ServerRequest} with a path remaining after a match.
     *
