...
public class SelectTag extends AbstractHtmlInputElementTag {
    ...
    /**
     * The value of the HTML '{@code size}' attribute rendered on the final '{@code select}'
     * element.
     */
    ...
    /**
     * Set the {@link Collection}, {@link Map} or array of objects used to generate the inner
     * '{@code option}' tags.
     *
    ...
    protected int writeTagContent(TagWriter tagWriter) throws JspException {
        ...
        tagWriter.writeOptionalAttributeValue(
                "size", getDisplayString(evaluate("size", getSize())));
                    ...
                    String valueProperty =
                            (getItemValue() != null
                                    ? ObjectUtils.getDisplayString(
                                            evaluate("itemValue", getItemValue()))
                                    : null);
                    String labelProperty =
                            (getItemLabel() != null
                                    ? ObjectUtils.getDisplayString(
                                            evaluate("itemLabel", getItemLabel()))
                                    : null);
    ...
    /**
     * Clears the {@link TagWriter} that might have been left over when using nested {@link
     * OptionTag options}.
     */
    @Override
