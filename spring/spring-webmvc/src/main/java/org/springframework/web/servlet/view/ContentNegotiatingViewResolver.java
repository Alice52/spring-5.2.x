...
public class ContentNegotiatingViewResolver extends WebApplicationObjectSupport
    ...
    /** ContentNegotiationManager 的工厂，用于创建 contentNegotiationManager 对象 */
    ...
    /** 在找不到 View 对象时，返回 NOT_ACCEPTABLE_VIEW */
     ...
     *
     * <p>If not set, ContentNegotiationManager's default constructor will be used, applying a
    ...
    /**
     * Indicate whether a {@link HttpServletResponse#SC_NOT_ACCEPTABLE 406 Not Acceptable} status
     * code should be returned if no suitable view can be found.
     *
     * <p>Default is {@code false}, meaning that this view resolver returns {@code null} for {@link
     * #resolveViewName(String, Locale)} when an acceptable view cannot be found. This will allow
     * for view resolvers chaining. When this property is set to {@code true}, {@link
    ...
    public View resolveViewName(String viewName, Locale locale) throws Exception {
        ...
        Assert.state(
                attrs instanceof ServletRequestAttributes, "No current ServletRequestAttributes");
        // 获得 MediaType 数组
    ...
    private List<View> getCandidateViews(
        ...
        if (this.viewResolvers != null) {
            Assert.state(
                    this.contentNegotiationManager != null, "No ContentNegotiationManager set");
            // 遍历 viewResolvers 数组
            for (ViewResolver viewResolver : this.viewResolvers) {
                ...
                for (MediaType requestedMediaType : requestedMediaTypes) {
                    ...
                    List<String> extensions =
                            this.contentNegotiationManager.resolveFileExtensions(
                                    requestedMediaType);
                    // 遍历拓展后缀的数组
    ...
    private View getBestView(
        ...
        // 遍历 MediaType 数组（MediaTy数组已经根据pespecificity、quality进行了排序）
