 ...
 *
 * <p>Request mapping information. Encapsulates the following request mapping conditions:
 *
 * <ol>
...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
    ...
    /**
     * Return the URL patterns of this {@link RequestMappingInfo}; or instance with 0 patterns
     * (never {@code null}).
     */
    ...
    /**
     * Return the HTTP request methods of this {@link RequestMappingInfo}; or instance with 0
     * request methods (never {@code null}).
     */
    ...
    /**
     * Return the "consumes" condition of this {@link RequestMappingInfo}; or instance with 0
    ...
    /**
     * Return the "produces" condition of this {@link RequestMappingInfo}; or instance with 0
    ...
    public RequestMappingInfo combine(RequestMappingInfo other) {
        ...
        RequestConditionHolder custom =
                this.customConditionHolder.combine(other.customConditionHolder);
    ...
    /**
     * Compares "this" info (i.e. the current instance) with another info in the context of a
     * request.
     *
     * <p>Note: It is assumed both instances have been obtained via {@link
     * #getMatchingCondition(HttpServletRequest)} to ensure they have conditions with content
    ...
    public String toString() {
        ...
        if (!this.patternsCondition.isEmpty()) {
            ...
            builder.append(" ")
                    .append(patterns.size() == 1 ? patterns.iterator().next() : patterns);
        }
    ...
    private static class DefaultBuilder implements Builder {
            ...
            for (String header : headers) {
                this.hasContentType =
                        this.hasContentType
                                ...
                                || header.contains("content-type");
                this.hasAccept =
                        this.hasAccept || header.contains("Accept") || header.contains("accept");
            }
        ...
        public RequestMappingInfo build() {
            ...
            PatternsRequestCondition patternsCondition =
                    ObjectUtils.isEmpty(this.paths)
                            ? null
    ...
    public static class BuilderConfiguration {
         ...
         * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on
         *     the deprecation of path extension config options.
         */
        @Deprecated
        ...
        /**
         * Set whether suffix pattern matching should be restricted to registered file extensions
         * only. Setting this property also sets {@code suffixPatternMatch=true} and requires that a
         * {@link #setContentNegotiationManager} is also configured in order to obtain the
         * registered file extensions.
         *
         * @deprecated as of 5.2.4. See class-level note in {@link RequestMappingHandlerMapping} on
         *     the deprecation of path extension config options; note also that in 5.3 the default
         *     for this property switches from {@code false} to {@code true}.
         */
        @Deprecated
         ...
         * registeredSuffixPatternMatch=true}, the extensions are obtained from the configured
