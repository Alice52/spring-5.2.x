...
public class SimpleMappingExceptionResolver extends AbstractHandlerExceptionResolver {
     ...
     * meant to define a rule for all checked exceptions. With more unusual exception names such as
     * "BaseBusinessException" there's no need to use a FQN.
     *
     * @param mappings exception patterns (can also be fully qualified class names) as keys, and
     *     error view names as values
     */
    ...
    /**
     * Set one or more exceptions to be excluded from the exception mappings. Excluded exceptions
     * are checked first and if one of them equals the actual exception, the exception will remain
     * unresolved.
     *
     ...
     *
     * <p>Note that this error code will only get applied in case of a top-level request. It will
     * not be set for an include request, since the HTTP status cannot be modified from within an
     * include.
     *
     ...
     * "exception".
     *
     * <p>This can be either set to a different attribute name or to {@code null} for not exposing
     * an exception attribute at all.
     *
     ...
     *
     * <p>May be overridden in subclasses, in order to apply specific exception checks. Note that
     * this template method will be invoked <i>after</i> checking whether this resolved applies
     ...
     *
     * <p>0 means ex matches exactly. Returns -1 if there's no match. Otherwise, returns depth.
     * Lowest depth wins.
     */
