 ...
 *
 * <p>{@link ThemeResolver} implementation that uses a cookie sent back to the user in case of a
 * custom setting, with a fallback to the default theme. This is particularly useful for stateless
