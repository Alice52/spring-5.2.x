                ...
                new MimeMessagePreparator() {
                    ...
                    public void prepare(MimeMessage mimeMessage) throws MessagingException {
                        mimeMessage.setRecipient(
                                Message.RecipientType.TO, new InternetAddress("you@mail.org"));
    ...
    public void javaMailSenderWithMimeMessagePreparators() {
        ...
        MimeMessagePreparator preparator1 =
                new MimeMessagePreparator() {
                    ...
                    public void prepare(MimeMessage mimeMessage) throws MessagingException {
                        mimeMessage.setRecipient(
                                Message.RecipientType.TO, new InternetAddress("he@mail.org"));
                        messages.add(mimeMessage);
                    }
                };
        MimeMessagePreparator preparator2 =
                new MimeMessagePreparator() {
                    ...
                    public void prepare(MimeMessage mimeMessage) throws MessagingException {
                        mimeMessage.setRecipient(
                                Message.RecipientType.TO, new InternetAddress("she@mail.org"));
                        messages.add(mimeMessage);
                    }
                };
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getFailedMessages())
                                        .containsExactly(
                                                entry(simpleMessage1, (Exception) ex.getCause())));
    }
    ...
    private static class MockTransport extends Transport {
        ...
        public void sendMessage(Message message, Address[] addresses) throws MessagingException {
            ...
            if (message.getSubject() != null && message.getSubject().contains("custom")) {
                assertThat(message.getSentDate())
                        .isEqualTo(new GregorianCalendar(2005, 3, 1).getTime());
            }
