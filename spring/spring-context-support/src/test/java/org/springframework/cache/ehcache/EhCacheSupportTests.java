...
public class EhCacheSupportTests {
    ...
    public void testBlankCacheManager() {
        ...
        try {
            ...
            assertThat(cm.getCacheNames().length == 0)
                    .as("Loaded CacheManager with no caches")
                    .isTrue();
    ...
    public void testCacheManagerFromConfigFile() {
        ...
        try {
            CacheManager cm = cacheManagerFb.getObject();
            assertThat(cm.getCacheNames().length == 1)
                    .as("Correct number of caches loaded")
                    .isTrue();
            Cache myCache1 = cm.getCache("myCache1");
    ...
    private void doTestEhCacheFactoryBean(boolean useCacheManagerFb) {
        ...
        try {
            ...
            if (useCacheManagerFb) {
                assertThat(config.getMaxEntriesLocalHeap())
                        .as("myCache1.maxElements")
                        .isEqualTo(300);
            } else {
                assertThat(config.getMaxEntriesLocalHeap())
                        .as("myCache1.maxElements")
            ...
            assertThat(config.getTimeToLiveSeconds() == 120)
                    .as("default timeToLive is correct")
                    .isTrue();
            assertThat(config.getTimeToIdleSeconds() == 120)
                    .as("default timeToIdle is correct")
                    .isTrue();
            ...
            assertThat(config.getMaxEntriesLocalHeap() == 5)
                    ...
                    .isTrue();
            assertThat(config.getTimeToLiveSeconds() == 8)
                    .as("default timeToLive is correct")
                    .isTrue();
            assertThat(config.getTimeToIdleSeconds() == 7)
                    .as("default timeToIdle is correct")
                    .isTrue();
