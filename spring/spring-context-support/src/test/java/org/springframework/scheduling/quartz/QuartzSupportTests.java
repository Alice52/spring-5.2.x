...
public class QuartzSupportTests {
    ...
    public void schedulerWithTaskExecutor() throws Exception {
        ...
        Thread.sleep(500);
        assertThat(DummyJob.count > 0)
                .as("DummyJob should have been executed at least once.")
                .isTrue();
    ...
    public void twoAnonymousMethodInvokingJobDetailFactoryBeans() throws Exception {
        ClassPathXmlApplicationContext ctx =
                context("multipleAnonymousMethodInvokingJobDetailFB.xml");
        Thread.sleep(3000);
        try {
            ...
            assertThat(exportService.getImportCount())
                    .as("doImport called exportService")
                    .isEqualTo(0);
    ...
    public void schedulerAutoStartsOnContextRefreshedEventByDefault() throws Exception {
        ...
        context.registerBeanDefinition(
                "scheduler", new RootBeanDefinition(SchedulerFactoryBean.class));
    ...
    /**
     * SPR-6038: detect HSQL and stop illegal locks being taken. TODO: Against Quartz 2.2, this
     * test's job doesn't actually execute anymore...
     */
    @Test
