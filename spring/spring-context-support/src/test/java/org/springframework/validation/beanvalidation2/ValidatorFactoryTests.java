...
public class ValidatorFactoryTests {
    ...
    public void testSimpleValidation() {
        ...
        for (ConstraintViolation<ValidPerson> cv : result) {
            ...
            assertThat(path)
                    .matches(actual -> "name".equals(actual) || "address.street".equals(actual));
        ...
        assertThat(validator.unwrap(ValidatorFactory.class) instanceof HibernateValidatorFactory)
                .isTrue();
        assertThat(
                        validator.unwrap(HibernateValidatorFactory.class)
                                instanceof HibernateValidatorFactory)
                .isTrue();
    ...
    public void testSimpleValidationWithClassLevel() {
        ...
        assertThat(cv.getConstraintDescriptor().getAnnotation() instanceof NameAddressValid)
                .isTrue();
    }
