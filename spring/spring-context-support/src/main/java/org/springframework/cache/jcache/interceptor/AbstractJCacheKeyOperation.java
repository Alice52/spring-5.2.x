...
abstract class AbstractJCacheKeyOperation<A extends Annotation> extends AbstractJCacheOperation<A> {
    ...
    protected AbstractJCacheKeyOperation(
            CacheMethodDetails<A> methodDetails,
     ...
     * javax.cache.annotation.CacheKey}, only those parameters should be part of the key. If none
     * are annotated, all parameters except the parameter annotated with {@link
     ...
     * @return the {@link CacheInvocationParameter} instances for the parameters to be used to
     *     compute the key
     */
