...
class KeyGeneratorAdapter implements KeyGenerator {
    ...
    /**
     * Create an instance used to wrap the specified {@link
     * javax.cache.annotation.CacheKeyGenerator}.
     */
    public KeyGeneratorAdapter(
            JCacheOperationSource cacheOperationSource, CacheKeyGenerator target) {
        Assert.notNull(cacheOperationSource, "JCacheOperationSource must not be null");
    ...
    private static Object doGenerate(
        ...
        return keyGenerator.generate(
                context.getTarget(), context.getMethod(), parameters.toArray());
    }

    /**
     * Return the target key generator to use in the form of either a {@link KeyGenerator} or a
