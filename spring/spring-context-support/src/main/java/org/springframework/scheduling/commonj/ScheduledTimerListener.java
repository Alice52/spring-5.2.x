...
public class ScheduledTimerListener {
     ...
     *
     * <p>If the "firstTime" property is specified, this property will be ignored. Specify one or
     * the other, not both.
     */
     ...
     *
     * <p>Default is -1, leading to one-time execution. In case of zero or a positive value, the
     * task will be executed repeatedly, with the given interval in-between executions.
     *
     ...
     * is "false", i.e. fixed delay.
     *
     * <p>See TimerManager javadoc for details on those execution modes.
     *
     * @see commonj.timers.TimerManager#schedule(commonj.timers.TimerListener, long, long)
     * @see commonj.timers.TimerManager#scheduleAtFixedRate(commonj.timers.TimerListener, long,
     *     long)
     */
