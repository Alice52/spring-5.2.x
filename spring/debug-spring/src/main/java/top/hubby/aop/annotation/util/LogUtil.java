package top.hubby.aop.annotation.util;
...
public class LogUtil {
    ...
    @Pointcut(
            "execution(public Integer top.hubby.aop.annotation.service.MyCalculator.*(Integer,Integer))")
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            System.out.println(
                    "log---环绕通知start：" + signature.getName() + "方法开始执行，参数为：" + Arrays.asList(args));
