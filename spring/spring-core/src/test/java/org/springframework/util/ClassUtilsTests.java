...
class ClassUtilsTests {
    ...
    void forNameWithPrimitiveArraysInternalName() throws ClassNotFoundException {
        ...
        assertThat(ClassUtils.forName(short[].class.getName(), classLoader))
        ...
        assertThat(ClassUtils.forName(float[].class.getName(), classLoader))
                .isEqualTo(float[].class);
        assertThat(ClassUtils.forName(double[].class.getName(), classLoader))
    ...
    void getShortNameForInnerClass() {
        ...
        assertThat(className)
                ...
                .isEqualTo("ClassUtilsTests.InnerClass");
    }
    ...
    void getPackageName() {
        ...
        assertThat(ClassUtils.getPackageName(getClass()))
    ...
    void argsStaticMethod() throws IllegalAccessException, InvocationTargetException {
        Method method =
                ClassUtils.getStaticMethod(InnerClass.class, "argStaticMethod", String.class);
    ...
    void determineCommonAncestor() {
        ...
        assertThat(ClassUtils.determineCommonAncestor(null, Integer.class))
        ...
        assertThat(ClassUtils.determineCommonAncestor(List.class, List.class))
