...
class MimeTypeTests {
    ...
    void parseCharset() {
        ...
        assertThat(mimeType.getCharset())
                .as("Invalid charset")
    ...
    void withConversionService() {
        ...
        assertThat(conversionService.convert("application/xml", MimeType.class))
                .isEqualTo(mimeType);
    }
    ...
    void isCompatible() {
        MimeType textPlain = MimeTypeUtils.TEXT_PLAIN;
        assertThat(textPlain.isCompatibleWith(textPlain))
                .as("Equal types is not compatible")
                .isTrue();
        MimeType allText = new MimeType("text");

        assertThat(allText.isCompatibleWith(textPlain))
                .as("All subtypes is not compatible")
                .isTrue();
        assertThat(textPlain.isCompatibleWith(allText))
                .as("All subtypes is not compatible")
                .isTrue();
        ...
        assertThat(applicationWildcardXml.isCompatibleWith(MimeTypeUtils.APPLICATION_JSON))
                .isFalse();
    }
