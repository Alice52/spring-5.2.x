                ...
                .isThrownBy(
                        () ->
                                Assert.noNullElements(
                                        new String[] {"foo", null, "bar"}, () -> "enigma"))
                .withMessageContaining("enigma");
    }
    ...
    void noNullElementsWithNullElementsAndNullMessageSupplier() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                Assert.noNullElements(
                                        new String[] {"foo", null, "bar"}, (Supplier<String>) null))
                .withMessage(null);
    }
    ...
    void isAssignableWithTypeMismatchAndCustomMessageWithSpace() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                Assert.isAssignable(
                                        String.class, Integer.class, "Custom message for "))
    ...
    void isAssignableWithTypeMismatchAndNullMessageSupplier() {
        assertThatIllegalArgumentException()
                .isThrownBy(
                        () ->
                                Assert.isAssignable(
                                        String.class, Integer.class, (Supplier<String>) null))
                .withMessageContaining(
                        "class java.lang.Integer is not assignable to class java.lang.String");
    }
