...
class ConcurrentReferenceHashMapTests {
    ...
    void shouldCreateWithInitialCapacityAndLoadFactor() {
        ConcurrentReferenceHashMap<Integer, String> map =
                new ConcurrentReferenceHashMap<>(32, 0.5f);
        assertThat(map.getSegmentsSize()).isEqualTo(16);
        assertThat(map.getSegment(0).getSize()).isEqualTo(2);
    ...
    void shouldCreateFullyCustom() {
        ConcurrentReferenceHashMap<Integer, String> map =
                new ConcurrentReferenceHashMap<>(5, 0.5f, 3);
    ...
    void shouldSupportNullReference() {
        // GC could happen during restructure so we must be able to create a reference for a null
        // entry
    ...
    private <V> StopWatch timeMultiThreaded(
            String id, final Map<Integer, V> map, ValueFactory<V> factory)
            ...
            return new ReferenceManager() {
                ...
                public Reference<K, V> createReference(
                    ...
                    return new MockReference<>(
                            entry, hash, next, TestWeakConcurrentCache.this.queue);
                }
