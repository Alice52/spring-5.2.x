...
class StringUtilsTests {
    ...
    void countOccurrencesOf() {
        ...
        assertThat(StringUtils.countOccurrencesOf(null, "s") == 0)
                .as("null substring = 0")
                .isTrue();
    ...
    void getFilenameExtension() {
        ...
        assertThat(StringUtils.getFilenameExtension("/home/user/.m2/settings/myfile"))
                .isEqualTo(null);
    ...
    void stripFilenameExtension() {
        ...
        assertThat(StringUtils.stripFilenameExtension("mypath/myfile.")).isEqualTo("mypath/myfile");
        assertThat(StringUtils.stripFilenameExtension("mypath/myfile.txt"))
    ...
    void cleanPath() {
        ...
        assertThat(StringUtils.cleanPath("mypath/myfile/../../mypath/myfile"))
                .isEqualTo("mypath/myfile");
        assertThat(StringUtils.cleanPath("../mypath/myfile")).isEqualTo("../mypath/myfile");
        assertThat(StringUtils.cleanPath("../mypath/../mypath/myfile"))
                .isEqualTo("../mypath/myfile");
        assertThat(StringUtils.cleanPath("mypath/../../mypath/myfile"))
                .isEqualTo("../mypath/myfile");
        assertThat(StringUtils.cleanPath("/../mypath/myfile")).isEqualTo("/../mypath/myfile");
        ...
        assertThat(StringUtils.cleanPath("file:./../")).isEqualTo("file:../");
        assertThat(StringUtils.cleanPath("file:.././")).isEqualTo("file:../");
        assertThat(StringUtils.cleanPath("file:/mypath/spring.factories"))
                .isEqualTo("file:/mypath/spring.factories");
    ...
    void pathEquals() {
        ...
        assertThat(
                        StringUtils.pathEquals(
                                "C:\\dummy1\\dummy2\\dummy3", "C:\\dummy1\\dummy2\\dummy3"))
        ...
        assertThat(
                        StringUtils.pathEquals(
                                "/dummy1/bin/../dummy2/bin/../dummy3", "/dummy1/dummy2/dummy3"))
        ...
        assertThat(
                        StringUtils.pathEquals(
                                "/dummy1/bin/tmp/../../dummy2/dummy3", "/dummy1/dummy2/dummy3"))
    ...
    void commaDelimitedListToStringArrayEmptyStrings() {
        ...
        assertThat(sa[0].equals("a") && sa[1].isEmpty() && sa[2].equals("b"))
                .as("components are correct")
                .isTrue();
    ...
    @Test // SPR-3671
    void
            parseLocaleWithMultiValuedVariantUsingUnderscoresAsSeparatorsWithLotsOfLeadingWhitespace() {
        String variant = "proper_northern";
    ...
    void invalidLocaleWithLocaleString() {
        ...
        assertThat(StringUtils.parseLocaleString("invalidvalue"))
                .isEqualTo(new Locale("invalidvalue"));
