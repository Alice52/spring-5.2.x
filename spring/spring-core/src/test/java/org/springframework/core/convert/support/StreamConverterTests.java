...
class StreamConverterTests {
    ...
    void convertFromStreamToList() throws NoSuchFieldException {
        this.conversionService.addConverter(
                Number.class, String.class, new ObjectToStringConverter());
    ...
    void convertFromListToStream() throws NoSuchFieldException {
        ...
        TypeDescriptor streamOfInteger =
                new TypeDescriptor(Types.class.getField("streamOfIntegers"));
    ...
    void convertFromArrayToStream() throws NoSuchFieldException {
        ...
        TypeDescriptor streamOfBoolean =
                new TypeDescriptor(Types.class.getField("streamOfBooleans"));
