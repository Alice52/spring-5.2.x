...
public class StandardEnvironmentTests {
    ...
    void addActiveProfile_whenActiveProfilesPropertyIsAlreadySet() {
        ...
        env.getPropertySources()
                .addFirst(
                        new MockPropertySource().withProperty(ACTIVE_PROFILES_PROPERTY_NAME, "p1"));
        ...
        environment
                ...
                .addFirst(
                        new MockPropertySource()
                                .withProperty(DEFAULT_PROFILES_PROPERTY_NAME, "pd1"));
        assertThat(environment.getDefaultProfiles().length).isEqualTo(1);
    ...
    void acceptsProfiles_withInvalidNotOperator() {
        assertThatIllegalArgumentException()
                .isThrownBy(() -> environment.acceptsProfiles("p1", "!"));
    }
                    ...
                    protected void validateProfile(String profile) {
                        ...
                        if (profile.contains("-")) {
                            throw new IllegalArgumentException(
                                    "Invalid profile ["
                                            + profile
                                            + "]: must not contain dash character");
                        }
                    }
                };
    ...
    void getSystemProperties_withAndWithoutSecurityManager() {
...

        {
            ...
            assertThat(systemProperties.get(ALLOWED_PROPERTY_NAME))
            ...
            // non-string keys and values work fine... until the security manager is introduced
            // below
            assertThat(systemProperties.get(STRING_PROPERTY_NAME))
                    .isEqualTo(NON_STRING_PROPERTY_VALUE);
            assertThat(systemProperties.get(NON_STRING_PROPERTY_NAME))
                    .isEqualTo(STRING_PROPERTY_VALUE);
        }
                ...
                new SecurityManager() {
                    ...
                    public void checkPropertiesAccess() {
                        ...
                        throw new AccessControlException(
                                "Accessing the system properties is disallowed");
                    }
    ...
    void getSystemEnvironment_withAndWithoutSecurityManager() {
        EnvironmentTestUtils.getModifiableSystemEnvironment()
                .put(ALLOWED_PROPERTY_NAME, ALLOWED_PROPERTY_VALUE);
        EnvironmentTestUtils.getModifiableSystemEnvironment()
                .put(DISALLOWED_PROPERTY_NAME, DISALLOWED_PROPERTY_VALUE);
        ...
        try {
            System.setSecurityManager(securityManager);
            {
                ...
                assertThat(systemEnvironment.get(ALLOWED_PROPERTY_NAME))
                        .isEqualTo(ALLOWED_PROPERTY_VALUE);
