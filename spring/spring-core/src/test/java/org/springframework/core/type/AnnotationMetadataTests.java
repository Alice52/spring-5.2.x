 ...
 * ASM-based {@code SimpleAnnotationMetadata} produce <em>almost</em> identical output.
 *
...
class AnnotationMetadataTests {
    ...
    void standardAnnotationMetadataForSubclass() {
        AnnotationMetadata metadata =
                AnnotationMetadata.introspect(AnnotatedComponentSubClass.class);
    ...
    private void doTestSubClassAnnotationInfo(AnnotationMetadata metadata, boolean asm) {
        ...
        if (asm) {
            ...
            assertThat(metadata.getAnnotationTypes())
                    .containsExactly(NamedComposedAnnotation.class.getName());
        }
        ...
        assertThat(metadata.getAnnotationAttributes(MetaAnnotation.class.getName(), false))
                .isNull();
        assertThat(metadata.getAnnotationAttributes(MetaAnnotation.class.getName(), true)).isNull();
        assertThat(metadata.getAnnotatedMethods(DirectAnnotation.class.getName()).size())
                .isEqualTo(0);
    ...
    private void doTestMetadataForInterfaceClass(AnnotationMetadata metadata) {
        ...
        assertThat(metadata.getInterfaceNames()[1])
                .isEqualTo(AnnotatedTypeMetadata.class.getName());
    ...
    void standardAnnotationMetadata_nestedAnnotationsAsMap_false() {
        ...
        AnnotationAttributes specialAttrs =
                (AnnotationAttributes)
                        metadata.getAnnotationAttributes(SpecialAttr.class.getName());
    ...
    void
        ...
        AnnotationMetadata metadata =
                AnnotationMetadata.introspect(NamedComposedAnnotationClass.class);
        assertMultipleAnnotationsWithIdenticalAttributeNames(metadata);
    }
    ...
    void
        ...
        MetadataReader metadataReader =
                metadataReaderFactory.getMetadataReader(
                        NamedComposedAnnotationClass.class.getName());
        AnnotationMetadata metadata = metadataReader.getAnnotationMetadata();
        assertMultipleAnnotationsWithIdenticalAttributeNames(metadata);
    }
    ...
    void
        ...
        MetadataReader metadataReader =
                metadataReaderFactory.getMetadataReader(
                        NamedComposedAnnotationExtended.class.getName());
        AnnotationMetadata metadata = metadataReader.getAnnotationMetadata();
        assertThat(metadata.hasAnnotation(NamedComposedAnnotation.class.getName())).isFalse();
    }
    ...
    private void doTestAnnotationInfo(AnnotationMetadata metadata) {
        ...
        Set<MethodMetadata> methods =
                metadata.getAnnotatedMethods(DirectAnnotation.class.getName());
        ...
        allMeta =
                method.getAllAnnotationAttributes(DirectAnnotation.class.getName())
                        .get("additional");
        ...
        { // perform tests with classValuesAsString = false (the default)
            ...
            AnnotationAttributes[] nestedAnnoArray =
                    specialAttrs.getAnnotationArray("nestedAnnoArray");
            ...
            assertThat((Class<?>[]) optional.get("classArray"))
                    .isEqualTo(new Class<?>[] {Void.class});
            ...
            assertThat(
                            metadata.getAnnotationAttributes(DirectAnnotation.class.getName())
                                    .get("value"))
                    .isEqualTo("direct");
            allMeta =
                    metadata.getAllAnnotationAttributes(DirectAnnotation.class.getName())
                            .get("value");
            assertThat(new HashSet<>(allMeta))
                    .isEqualTo(new HashSet<Object>(Arrays.asList("direct", "meta")));
            allMeta =
    ...
    private void doTestMethodAnnotationInfo(AnnotationMetadata classMetadata) {
        Set<MethodMetadata> methods =
                classMetadata.getAnnotatedMethods(TestAutowired.class.getName());
