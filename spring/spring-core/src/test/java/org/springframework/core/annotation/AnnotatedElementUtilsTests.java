...
class AnnotatedElementUtilsTests {
    ...
    void getMetaAnnotationTypesOnNonAnnotatedClass() {
        assertThat(
                        getMetaAnnotationTypes(
                                        NonAnnotatedClass.class, TransactionalComponent.class)
                                .isEmpty())
                .isTrue();
        assertThat(
                        getMetaAnnotationTypes(
    ...
    void getMetaAnnotationTypesOnClassWithMetaDepth1() {
        Set<String> names =
                getMetaAnnotationTypes(
                        TransactionalComponentClass.class, TransactionalComponent.class);
    ...
    void hasMetaAnnotationTypesOnClassWithMetaDepth1() {
        ...
        assertThat(
                        hasMetaAnnotationTypes(
                                TransactionalComponentClass.class, Component.class.getName()))
                .isTrue();
    }

    @Test
    void hasMetaAnnotationTypesOnClassWithMetaDepth2() {
        assertThat(hasMetaAnnotationTypes(ComposedTransactionalComponentClass.class, TX_NAME))
                .isTrue();
        assertThat(
                        hasMetaAnnotationTypes(
                                ComposedTransactionalComponentClass.class,
    ...
    void isAnnotatedOnClassWithMetaDepth() {
        ...
        assertThat(isAnnotated(ComposedTransactionalComponentClass.class, Transactional.class))
                .isTrue();
        assertThat(isAnnotated(ComposedTransactionalComponentClass.class, Component.class))
                .isTrue();
        assertThat(
                        isAnnotated(
                                ComposedTransactionalComponentClass.class,
    ...
    void isAnnotatedWithNameOnClassWithMetaDepth() {
        ...
        assertThat(
                        isAnnotated(
                                SubTransactionalComponentClass.class,
                                TransactionalComponent.class.getName()))
                .as("isAnnotated() does not search the class hierarchy.")
                .isFalse();
        assertThat(isAnnotated(TransactionalComponentClass.class, TX_NAME)).isTrue();
        assertThat(isAnnotated(TransactionalComponentClass.class, Component.class.getName()))
                .isTrue();
    ...
    void hasAnnotationOnClassWithMetaDepth() {
        ...
        assertThat(
                        hasAnnotation(
                                SubTransactionalComponentClass.class, TransactionalComponent.class))
                .isTrue();
        ...
        assertThat(hasAnnotation(ComposedTransactionalComponentClass.class, Transactional.class))
                .isTrue();
        assertThat(hasAnnotation(ComposedTransactionalComponentClass.class, Component.class))
                .isTrue();
        assertThat(
                        hasAnnotation(
                                ComposedTransactionalComponentClass.class,
    ...
    void getAllAnnotationAttributesOnClassWithLocalAnnotation() {
        MultiValueMap<String, Object> attributes =
                getAllAnnotationAttributes(TxConfig.class, TX_NAME);
    ...
    void
        ...
        assertThat(attributes)
                .as(
                        "Annotation attributes map for @Transactional on SubSubClassWithInheritedAnnotation")
                .isNotNull();
    ...
    void getAllAnnotationAttributesOnLangType() {
        ...
        assertThat(attributes)
                .as("Annotation attributes map for @Nonnull on NonNullApi")
                .isNotNull();
        assertThat(attributes.get("when"))
                .as("value for NonNullApi")
    ...
    void getMergedAnnotationAttributesOnClassWithLocalAnnotation() {
        ...
        assertThat(attributes)
                .as("Annotation attributes for @Transactional on TxConfig")
                .isNotNull();
    ...
    void getMergedAnnotationAttributesOnNonInheritedAnnotationInterface() {
        ...
        AnnotationAttributes attributes = getMergedAnnotationAttributes(element, name);
        assertThat(attributes)
                .as("Should find @Order on NonInheritedAnnotationInterface")
                .isNotNull();
        // Verify contracts between utility methods:
        assertThat(isAnnotated(element, name)).isTrue();
    }
     ...
     *
     * <p>Furthermore, if you choose to execute this test, it can fail for either the first test
     * class or the second one (with different exceptions), depending on the order in which the JVM
     * returns the attribute methods via reflection.
     */
    ...
    void getMergedAnnotationAttributesWithHalfConventionBasedAndHalfAliasedComposedAnnotation() {
        for (Class<?> clazz :
            ...
            getMergedAnnotationAttributesWithHalfConventionBasedAndHalfAliasedComposedAnnotation(
                    clazz);
        }
    }
    ...
    void getMergedAnnotationAttributesWithImplicitAliasesInMetaAnnotationOnComposedAnnotation() {
        ...
        assertThat(attributes)
                ...
                .isNotNull();
        assertThat(attributes.getStringArray("groovyScripts"))
                .as("groovyScripts")
                .isEqualTo(expected);
    ...
    void getMergedAnnotationWithImplicitAliasesWithDefaultsInMetaAnnotationOnComposedAnnotation() {
        ...
        assertThat(annotation)
                .as("Should find @AliasesWithDefaults on " + element.getSimpleName())
                .isNotNull();
    ...
    void findMergedAnnotationAttributesInheritedFromAbstractMethod() throws NoSuchMethodException {
        ...
        AnnotationAttributes attributes =
                findMergedAnnotationAttributes(method, Transactional.class);
        assertThat(attributes)
                .as(
     ...
     */
    @Test
    void findMergedAnnotationAttributesOnMethodWithComposedMetaTransactionalAnnotation()
            throws Exception {
        Method method = getClass().getDeclaredMethod("composedTransactionalMethod");

        AnnotationAttributes attributes =
                findMergedAnnotationAttributes(method, AliasedTransactional.class);
        assertThat(attributes).as("Should find @AliasedTransactional on " + method).isNotNull();
        assertThat(attributes.getString("value"))
                .as("TX qualifier for " + method)
    ...
    void findMergedAnnotationAttributesOnClassWithComposedMetaTransactionalAnnotation()
        ...
        AnnotationAttributes attributes =
                findMergedAnnotationAttributes(clazz, AliasedTransactional.class);
        assertThat(attributes).as("Should find @AliasedTransactional on " + clazz).isNotNull();
        assertThat(attributes.getString("value"))
                .as("TX qualifier for " + clazz)
                .isEqualTo("anotherTransactionManager");
        assertThat(attributes.getString("qualifier"))
                .as("TX qualifier for " + clazz)
                .isEqualTo("anotherTransactionManager");
    ...
    private AnnotationAttributes assertComponentScanAttributes(
            Class<?> element, String... expected) {
        AnnotationAttributes attributes =
                findMergedAnnotationAttributes(element, ComponentScan.class);
    ...
    void findMergedAnnotationForMultipleMetaAnnotationsWithClashingAttributeNames() {
        ...
        TestPropSource testPropSource =
                AnnotationUtils.findAnnotation(element, TestPropSource.class);
    ...
    void getAllMergedAnnotationsOnClassWithInterface() throws Exception {
        ...
        Set<Transactional> allMergedAnnotations =
                getAllMergedAnnotations(method, Transactional.class);
    ...
    void findAllMergedAnnotationsOnClassWithInterface() throws Exception {
        Method method = TransactionalServiceImpl.class.getMethod("doIt");
        Set<Transactional> allMergedAnnotations =
                findAllMergedAnnotations(method, Transactional.class);
    ...
    void forAnnotationsCreatesCopyOfArrayOnEachCall() {
        AnnotatedElement element =
                AnnotatedElementUtils.forAnnotations(
                        ForAnnotationsClass.class.getDeclaredAnnotations());
