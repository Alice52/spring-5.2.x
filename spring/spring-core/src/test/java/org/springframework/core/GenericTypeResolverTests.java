...
class GenericTypeResolverTests {
    ...
    void methodReturnTypes() {
        assertThat(
                        resolveReturnTypeArgument(
                                findMethod(MyTypeWithMethods.class, "integer"),
                                MyInterfaceType.class))
                .isEqualTo(Integer.class);
        assertThat(
                        resolveReturnTypeArgument(
                                findMethod(MyTypeWithMethods.class, "string"),
                                MyInterfaceType.class))
                .isEqualTo(String.class);
        assertThat(
                        resolveReturnTypeArgument(
        ...
        assertThat(
                        resolveReturnTypeArgument(
                                findMethod(MyTypeWithMethods.class, "object"),
                                MyInterfaceType.class))
                .isEqualTo(null);
    }
    ...
    void testResolveType() {
        Method intMessageMethod =
                findMethod(
                        MyTypeWithMethods.class, "readIntegerInputMessage", MyInterfaceType.class);
        ...
        Method genericArrMessageMethod =
                findMethod(
                        MySimpleTypeWithMethods.class,
                        "readGenericArrayInputMessage",
                        Object[].class);
        MethodParameter genericArrMessageMethodParam =
                new MethodParameter(genericArrMessageMethod, 0);
    ...
    void getGenericsOnArrayFromParamCannotBeResolved() throws Exception {
        ...
        Class<?> resolved =
                GenericTypeResolver.resolveParameterType(methodParameter, WithArray.class);
    ...
    void resolveIncompleteTypeVariables() {
        Class<?>[] resolved =
                GenericTypeResolver.resolveTypeArguments(
                        IdFixingRepository.class, Repository.class);
    ...
    public static class MyTypeWithMethods<T> {
        ...
        /**
         * Similar to {@link #createProxy(Object)} but adds an additional argument before the
         * argument of type {@code T}. Note that they may potentially be of the same time when
         * invoked!
         */
        ...
        /**
         * Similar to {@link #createNamedMock(String, Class)} but adds an additional parameterized
         * type.
         */
