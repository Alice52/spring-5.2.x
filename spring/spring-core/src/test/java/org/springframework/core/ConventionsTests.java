...
class ConventionsTests {
                ...
                .orElseThrow(
                        () ->
                                new IllegalArgumentException(
                                        "Unique return type not found: " + returnType));
    }
    ...
    void reactiveReturnTypes() {
        ...
        assertThat(
                        Conventions.getVariableNameForReturnType(
                                getMethodForReturnType(Observable.class)))
                .isEqualTo("testObjectObservable");
    }
    ...
    void attributeNameToPropertyName() {
        ...
        assertThat(Conventions.attributeNameToPropertyName("pointcut-ref"))
                .isEqualTo("pointcutRef");
