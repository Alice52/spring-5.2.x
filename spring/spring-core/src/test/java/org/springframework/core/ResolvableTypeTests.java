...
class ResolvableTypeTests {
    ...
    void forInstanceProvider() throws Exception {
        ResolvableType type =
                ResolvableType.forInstance(new MyGenericInterfaceType<>(String.class));
    ...
    void asFromSuperType() throws Exception {
        ...
        assertThat(type.getType().toString())
                .isEqualTo("java.util.ArrayList<java.lang.CharSequence>");
    }
    ...
    void resolveGenericMultiArrayType() throws Exception {
        ResolvableType type =
                ResolvableType.forField(Fields.class.getField("genericMultiArrayType"));
        assertThat(type.resolve()).isEqualTo(List[][][].class);
        assertThat(type.getComponentType().resolve()).isEqualTo(List[][].class);
    }
    ...
    void doesResolveFromOuterOwner() throws Exception {
        ResolvableType type =
                ResolvableType.forField(Fields.class.getField("listOfListOfUnknown"))
                        .as(Collection.class);
    ...
    void resolveBoundedTypeVariableResult() throws Exception {
        ResolvableType type =
                ResolvableType.forMethodReturnType(
                        Methods.class.getMethod("boundedTypeVariableResult"));
    ...
    void resolveBoundedTypeVariableWildcardResult() throws Exception {
        ResolvableType type =
                ResolvableType.forMethodReturnType(
                        Methods.class.getMethod("boundedTypeVariableWildcardResult"));
        assertThat(type.getGeneric(1).asCollection().resolveGeneric())
    ...
    void resolveTypeVariableFromSimpleCollectionSuperclassType() {
        ResolvableType type =
                ResolvableType.forClass(MyCollectionSuperclassType.class)
                        .as(MySuperclassType.class);
        assertThat(type.resolveGeneric()).isEqualTo(Collection.class);
        assertThat(type.resolveGeneric(0, 0)).isEqualTo(String.class);
    }
    ...
    void resolveTypeVariableFromTypeWithVariableResolver() throws Exception {
        ...
        ResolvableType type =
                ResolvableType.forType(
                        sourceType,
                        ResolvableType.forClass(TypedMethods.class)
                                .as(Methods.class)
                                .asVariableResolver());
        assertThat(type.resolve()).isEqualTo(String.class);
        assertThat(type.getType().toString()).isEqualTo("T");
    ...
    void resolveTypeWithCustomVariableResolver() throws Exception {
        ...
        ResolvableType variable =
                ResolvableType.forType(
                        Fields.class.getField("typeVariableType").getGenericType(),
                        variableResolver);
        ResolvableType parameterized =
                ResolvableType.forType(
                        Fields.class.getField("parameterizedType").getGenericType(),
                        variableResolver);
    ...
    void resolveTypeVariableFromReflectiveParameterizedTypeReference() throws Exception {
        Type sourceType = Methods.class.getMethod("typedReturn").getGenericReturnType();
        ResolvableType type =
                ResolvableType.forType(ParameterizedTypeReference.forType(sourceType));
        assertThat(type.resolve()).isNull();
        assertThat(type.getType().toString()).isEqualTo("T");
    }
    ...
    void toStrings() throws Exception {
        ...
        assertThat(forField("charSequenceList"))
                .hasToString("java.util.List<java.lang.CharSequence>");
        ...
        assertThat(forField("stringIntegerMultiValueMap"))
                .hasToString(
                        "org.springframework.util.MultiValueMap<java.lang.String, java.lang.Integer>");
        assertThat(forField("stringIntegerMultiValueMapSwitched"))
                .hasToString(
                        VariableNameSwitch.class.getName()
        ...
        assertThat(forTypedField("parameterizedType"))
                .hasToString("java.util.List<java.lang.String>");
                ...
                .isThrownBy(
                        () ->
                                ResolvableType.forClass(Object.class)
                                        .isAssignableFrom((ResolvableType) null))
    ...
    void isAssignableFromForDifferentClassesWithGenerics() throws Exception {
        ResolvableType extendsCharSequenceCollection =
                ResolvableType.forField(
                        AssignmentBase.class.getField("collectionxc"), Assignment.class);
        ResolvableType charSequenceCollection =
                ResolvableType.forField(
                        AssignmentBase.class.getField("collectionc"), Assignment.class);
        ResolvableType charSequenceList =
                ResolvableType.forField(AssignmentBase.class.getField("listc"), Assignment.class);
        ResolvableType extendsCharSequenceList =
                ResolvableType.forField(AssignmentBase.class.getField("listxc"), Assignment.class);
        ...
        assertThatResolvableType(extendsStringList)
                .isNotAssignableFrom(
                        charSequenceCollection, charSequenceList, extendsCharSequenceList);
    }
    ...
    void hashCodeAndEquals() throws Exception {
        ...
        ResolvableType forFieldViaType =
                ResolvableType.forType(
                        Fields.class.getDeclaredField("stringList").getGenericType(),
                        (VariableResolver) null);
        ResolvableType forFieldWithImplementation =
                ResolvableType.forField(
                        Fields.class.getDeclaredField("stringList"), TypedFields.class);
    ...
    void classWithGenericsAs() throws Exception {
        ResolvableType type =
                ResolvableType.forClassWithGenerics(
                        MultiValueMap.class, Integer.class, String.class);
    ...
    void serialize() throws Exception {
        ...
        testSerialization(
                ResolvableType.forConstructorParameter(
                        Constructors.class.getConstructor(List.class), 0));
        testSerialization(
    ...
    void spr11219() throws Exception {
        ...
        assertThat(
                        type.getNested(2)
                                .isAssignableFrom(
                                        ResolvableType.forClass(BaseImplementation.class)))
                .isTrue();
        assertThat(type.toString())
                .isEqualTo(
                        "java.util.Collection<org.springframework.core.ResolvableTypeTests$IBase<?>>");
    }
