...
class ReactiveAdapterRegistryTests {
    ...
    void publisherToReactivexObservable() {
        ...
        assertThat(condition).isTrue();
        assertThat(((io.reactivex.Observable<?>) target).toList().blockingGet())
                .isEqualTo(sequence);
    }
    ...
    void publisherToReactivexSingle() {
        ...
        assertThat(condition).isTrue();
        assertThat(((io.reactivex.Single<Integer>) target).blockingGet())
                .isEqualTo(Integer.valueOf(1));
    }
    ...
    void rxObservableToPublisher() {
        ...
        assertThat(condition)
                .as("Expected Flux Publisher: " + target.getClass().getName())
                .isTrue();
        assertThat(((Flux<Integer>) target).collectList().block(Duration.ofMillis(1000)))
                .isEqualTo(sequence);
    }
    ...
    void rxSingleToPublisher() {
        ...
        boolean condition = target instanceof Mono;
        assertThat(condition)
                .as("Expected Mono Publisher: " + target.getClass().getName())
                .isTrue();
        assertThat(((Mono<Integer>) target).block(Duration.ofMillis(1000)))
                .isEqualTo(Integer.valueOf(1));
    }
    ...
    @Test
    void deferred() {
        assertThat(getAdapter(CompletableFuture.class).getDescriptor().isDeferred())
                .isEqualTo(false);
        ...
        assertThat(getAdapter(io.reactivex.Completable.class).getDescriptor().isDeferred())
                .isEqualTo(true);
        assertThat(getAdapter(io.reactivex.Single.class).getDescriptor().isDeferred())
                .isEqualTo(true);
        assertThat(getAdapter(io.reactivex.Flowable.class).getDescriptor().isDeferred())
                .isEqualTo(true);
        assertThat(getAdapter(io.reactivex.Observable.class).getDescriptor().isDeferred())
                .isEqualTo(true);

        assertThat(getAdapter(Deferred.class).getDescriptor().isDeferred()).isEqualTo(true);
        assertThat(getAdapter(kotlinx.coroutines.flow.Flow.class).getDescriptor().isDeferred())
                .isEqualTo(true);
    }
