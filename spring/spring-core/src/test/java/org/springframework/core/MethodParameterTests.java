...
class MethodParameterTests {
    ...
    void testFactoryMethods() {
        ...
        assertThat(MethodParameter.forParameter(method.getParameters()[0]))
                .isEqualTo(stringParameter);
        assertThat(MethodParameter.forParameter(method.getParameters()[1]))
    ...
    void genericConstructorParameterInInnerClass() throws Exception {
        ...
        assertThat(methodParameter.getGenericParameterType())
                .isEqualTo(
                        ResolvableType.forClassWithGenerics(Callable.class, Integer.class)
                                .getType());
    }
