...
/**
 * Unit tests demonstrating that the reflection-based {@link StandardAnnotationMetadata} supports
 * {@link Inherited @Inherited} annotations; whereas, the ASM-based {@code SimpleAnnotationMetadata}
 * does not.
 *
 * @author Sam Brannen
 * @since 5.2.3
...
class InheritedAnnotationsAnnotationMetadataTests {
    ...
    private final AnnotationMetadata standardMetadata =
            AnnotationMetadata.introspect(AnnotatedSubclass.class);
    ...
    InheritedAnnotationsAnnotationMetadataTests() throws Exception {
        ...
        MetadataReader metadataReader =
                metadataReaderFactory.getMetadataReader(AnnotatedSubclass.class.getName());
        this.asmMetadata = metadataReader.getAnnotationMetadata();
    }

    @Test
    void getAnnotationTypes() {
        assertThat(standardMetadata.getAnnotationTypes())
                .containsExactlyInAnyOrder(
                        NamedAnnotation3.class.getName(),
                        InheritedComposedAnnotation.class.getName());

        assertThat(asmMetadata.getAnnotationTypes())
                .containsExactly(NamedAnnotation3.class.getName());
    }

    @Test
    void hasAnnotation() {
        assertThat(standardMetadata.hasAnnotation(InheritedComposedAnnotation.class.getName()))
                .isTrue();
        ...
        assertThat(asmMetadata.hasAnnotation(InheritedComposedAnnotation.class.getName()))
                .isFalse();
    }
    ...
    void getMetaAnnotationTypes() {
        ...
        metaAnnotationTypes =
                standardMetadata.getMetaAnnotationTypes(
                        InheritedComposedAnnotation.class.getName());
        assertThat(metaAnnotationTypes)
                .containsExactlyInAnyOrder(
        ...
        metaAnnotationTypes =
                asmMetadata.getMetaAnnotationTypes(InheritedComposedAnnotation.class.getName());
    ...
    @Test
    void isAnnotated() {
        assertThat(standardMetadata.isAnnotated(InheritedComposedAnnotation.class.getName()))
                .isTrue();
    ...
    void getAnnotationAttributes() {
        ...
        annotationAttributes =
                standardMetadata.getAnnotationAttributes(NamedAnnotation1.class.getName());
        assertThat(annotationAttributes.get("name")).isEqualTo("name 1");

        annotationAttributes =
                asmMetadata.getAnnotationAttributes(NamedAnnotation1.class.getName());
    ...
    void getAllAnnotationAttributes() {
        ...
        annotationAttributes =
                standardMetadata.getAllAnnotationAttributes(NamedAnnotation3.class.getName());
        ...
        annotationAttributes =
                asmMetadata.getAllAnnotationAttributes(NamedAnnotation1.class.getName());
        assertThat(annotationAttributes).isNull();
    }
