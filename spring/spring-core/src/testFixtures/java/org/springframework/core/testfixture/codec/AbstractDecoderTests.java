...
public abstract class AbstractDecoderTests<D extends Decoder<?>> extends AbstractLeakCheckingTests {
     ...
     * test method will feed the first element of the {@code input} stream to the decoder, followed
     * by an {@link InputException}. The result is expected to contain one "normal" element,
    ...
    /**
     * Test a {@link Decoder#decodeToMono decode} scenario where the input stream is empty. The
