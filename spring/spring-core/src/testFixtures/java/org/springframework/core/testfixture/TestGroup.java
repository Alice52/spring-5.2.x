...
public enum TestGroup {
    ...
    /**
     * Tests that take a considerable amount of time to run. Any test lasting longer than 500ms
     * should be considered a candidate in order to avoid making the overall test suite too slow to
     * run during the normal development cycle.
     */
    LONG_RUNNING,
     ...
     * considered a candidate as their successful execution is likely to be based on events
     * occurring within a given time window.
     */
    PERFORMANCE;
    ...
    /**
     * Load test groups dynamically instead of during static initialization in order to avoid a
     * {@link NoClassDefFoundError} being thrown while attempting to load collaborator classes.
     */
