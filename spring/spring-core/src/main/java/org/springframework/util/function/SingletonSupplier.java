...
public class SingletonSupplier<T> implements Supplier<T> {
    ...
    /**
     * Build a {@code SingletonSupplier} with the given singleton instance and a default supplier
     * for the case when the instance is {@code null}.
     *
    ...
    public SingletonSupplier(
            @Nullable Supplier<? extends T> instanceSupplier,
