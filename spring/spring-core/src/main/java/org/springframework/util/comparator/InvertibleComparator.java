...
public class InvertibleComparator<T> implements Comparator<T>, Serializable {
    ...
    /**
     * Create an InvertibleComparator that sorts ascending by default. For the actual comparison,
     * the specified Comparator will be used.
     *
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (this.comparator.equals(otherComp.comparator)
                && this.ascending == otherComp.ascending);
    }
