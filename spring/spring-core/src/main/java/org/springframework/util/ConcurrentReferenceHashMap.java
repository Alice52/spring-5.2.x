...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V>
     ...
     *
     * @param initialCapacity the initial capacity of the map
     * @param loadFactor the load factor. When the average number of references per table exceeds
     *     this value resize will be attempted
     */
     ...
     *
     * @param initialCapacity the initial capacity of the map
     * @param concurrencyLevel the expected number of threads that will concurrently write to the
     *     map
     */
    ...
    /**
     * Return a {@link Reference} to the {@link Entry} for the specified {@code key}, or {@code
     * null} if not found.
     *
    ...
    public boolean replace(
            @Nullable K key, final @Nullable V oldValue, final @Nullable V newValue) {
        Boolean result =
                doTask(
                        key,
    ...
    /**
     * Remove any entries that have been garbage collected and are no longer referenced. Under
     * normal circumstances garbage collected entries are automatically purged as items are added or
     * removed from the Map. This method can be used to force a purge, and is useful when the Map is
     * read frequently but updated less often.
     */
    ...
    protected final class Segment extends ReentrantLock {
        ...
        /**
         * Array of references indexed using the low order bits from the hash. This property should
         * only be set along with {@code resizeThreshold}.
         */
        private volatile Reference<K, V>[] references;

        /**
         * The threshold when resizing of the references should occur. When {@code count} exceeds
         * this value references will be resized.
         */
        ...
        public Reference<K, V> getReference(
                @Nullable Object key, int hash, Restructure restructure) {
                ...
                Entries<V> entries =
                        value -> {
                            ...
                            Reference<K, V> newReference =
                                    Segment.this.referenceManager.createReference(
                                            newEntry, hash, head);
        ...
        /**
         * Restructure the underlying data structure when it becomes necessary. This method can
         * increase the size of the references table as well as purge any references that have been
         * garbage collected.
         *
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(@Nullable Object o) {
            if (o instanceof Map.Entry<?, ?>) {
                ...
                Reference<K, V> ref =
                        ConcurrentReferenceHashMap.this.getReference(
    ...
    protected class ReferenceManager {
         ...
         * underlying structure or {@code null} if no references need purging. This method must be
         * thread safe and ideally should not block when returning {@code null}. References should
