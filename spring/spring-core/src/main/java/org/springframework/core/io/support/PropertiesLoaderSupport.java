...
public abstract class PropertiesLoaderSupport {
    ...
    /**
     * Set local properties, e.g. via the "props" tag in XML bean definitions. These can be
     * considered defaults, to be overridden by properties loaded from files.
     */
     ...
     *
     * <p>Default is "false": Properties from files override local defaults. Can be switched to
     * "true" to let local properties override defaults from files.
     */
     ...
     *
     * <p>Return a merged Properties instance containing both the loaded properties and properties
