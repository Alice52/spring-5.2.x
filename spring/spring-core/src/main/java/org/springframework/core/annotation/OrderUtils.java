...
public abstract class OrderUtils {
     ...
     */
    @Nullable
    static Integer getOrderFromAnnotations(
            AnnotatedElement element, MergedAnnotations annotations) {
    ...
    /**
     * Return the value of the {@code javax.annotation.Priority} annotation declared on the
