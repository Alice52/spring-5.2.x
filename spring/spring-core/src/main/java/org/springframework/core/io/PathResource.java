 ...
 * java.nio.file.Files} API. This {@code PathResource} is effectively a pure {@code
 * java.nio.path.Path} based alternative with different {@code createRelative} behavior.
 *
