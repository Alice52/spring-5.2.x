 ...
 *
 * <p>Encapsulates a Java {@link java.lang.reflect.Type}, providing access to {@link #getSuperType()
...
public class ResolvableType implements Serializable {
     ...
     *
     * <p>{@code ResolvableType} returned when no value is available. {@code NONE} is used in
    ...
    /** 被管理的底层类型 The underlying Java type being managed. */
    private final Type type;

    /** 类型的可选提供提供者 Optional provider for the type. */
    @Nullable private final TypeProvider typeProvider;

    /**
     * 要使用的{@code VariableResolve}或如果没有可用的解析器则为{@code null} The {@code VariableResolver} to use or
     * {@code null} if no resolver is available.
     */
    @Nullable private final VariableResolver variableResolver;

    /**
     * 数组的元素类型；如果应该推到类型，则为{@code null} The component type for an array or {@code null} if the type
     * should be deduced.
     */
     ...
     *
     * <p>Private constructor used to create a new {@link ResolvableType} for cache key purposes,
     ...
     *
     * <p>Private constructor used to create a new {@link ResolvableType} for cache value purposes,
     ...
     *
     * <p>Private constructor used to create a new {@link ResolvableType} for uncached purposes,
    ...
    /**
     * 私有构造函数，用于在{@link Class}的基础上创建新的{@link ResolvableType}。避免为了创建直接的{@link Class}包装类而进行所有{@code
     * instanceof}检查
     *
     * <p>Private constructor used to create a new {@link ResolvableType} on a {@link Class} basis.
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Class}, using the full generic
     * type information for assignability checks. For example: {@code
    ...
    /**
     * 为指定的{@link Class}返回一个{@link ResolvableType}，仅针对原始类型进行可分配性检查(类似于{@link
     * Class#isAssignableFrom},它用作包装器
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Class}, doing assignability
     * checks against the raw class only (analogous to {@link Class#isAssignableFrom}, which this
     * serves as a wrapper for. For example: {@code ResolvableType.forRawClass(List.class)}.
     *
     * @param clazz the class to introspect ({@code null} is semantically equivalent to {@code
     *     Object.class} for typical use cases here)
     * @return a {@link ResolvableType} for the specified class
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified base type (interface or base class) with
     * a given implementation class. For example: {@code ResolvableType.forClass(List.class,
     * MyArrayList.class)}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Class} with pre-declared
     * generics.
     *
    ...
    public static ResolvableType forClassWithGenerics(Class<?> clazz, ResolvableType... generics) {
        ...
        Assert.isTrue(
                variables.length == generics.length, "Mismatched number of generics specified");
        ...
        for (int i = 0; i < generics.length; i++) {
            ...
            // 如果arguments不为null 且
            // argument不是TypeVariable的子类或本身,则第i个argument元素就为argument，否则就为第i个variables元素
            arguments[i] =
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified instance. The instance does not convey
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Field}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Field} with a given
     * implementation.
     *
     * <p>Use this variant when the class that declares the field includes generic parameter
    ...
    public static ResolvableType forField(
            Field field, @Nullable ResolvableType implementationType) {
        Assert.notNull(field, "Field must not be null");
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Field} with the given nesting
     * level.
     *
     * @param field the source field
     * @param nestingLevel the nesting level (1 for the outer level; 2 for a nested generic type;
     *     etc)
     * @see #forField(Field)
     */
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Constructor} parameter.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Constructor} parameter with a
     * given implementation. Use this variant when the class that declares the constructor includes
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Method} return type.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Method} return type. Use this
     * variant when the class that declares the method includes generic parameter variables that are
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Method} parameter.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Method} parameter with a given
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link MethodParameter}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link MethodParameter} with a given
     * implementation type. Use this variant when the class that declares the method includes
     * generic parameter variables that are satisfied by the implementation type.
     *
     * @param methodParameter the source method parameter (must not be {@code null})
     * @param implementationType the implementation type
     * @return a {@link ResolvableType} for the specified method parameter
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link MethodParameter}, overriding the
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link MethodParameter} at a specific
     * nesting level, overriding the target type to resolve with a specific given type.
     *
     * @param methodParameter the source method parameter (must not be {@code null})
     * @param targetType the type to resolve (a part of the method parameter's type)
     ...
     *
     * <p>Return a {@link ResolvableType} as a array of the specified {@code componentType}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Type}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Type} backed by the given owner
     * type.
     *
     * <p>Note: The resulting {@link ResolvableType} instance may not be {@link Serializable}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link ParameterizedTypeReference}.
     *
     * <p>Note: The resulting {@link ResolvableType} instance may not be {@link Serializable}.
     *
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified {@link Type} backed by a given {@link
     * VariableResolver}.
     *
     * @param type the source type or {@code null}
    ...
    static ResolvableType forType(
            @Nullable Type type, @Nullable VariableResolver variableResolver) {
     ...
     *
     * <p>Clear the internal {@code ResolvableType}/{@code SerializableTypeWrapper} cache.
     *
     * @since 4.2
     */
     ...
     *
     * <p>Return the underling Java {@link Type} being managed.
     */
    public Type getType() {
     ...
     *
     * <p>Return the underlying Java {@link Class} being managed, if available; otherwise {@code
     * null}.
     */
    @Nullable
    ...
    /**
     * 返回可解析类型的基础源。将返回{@link Field},{@link MethodParameter}或者{@link Type}具体取决于{@link
     * ResolvableType}的构造方式。 除了{@link #NONE}常量外，这个方法将永远不会返回{@code
     * null}.此方法主要用于提供对其他类型信息或替代JVM语言可能提供的元数据的访问
     *
     * <p>Return the underlying source of the resolvable type. Will return a {@link Field}, {@link
     ...
     *
     * <p>Return this type as a resolved {@code Class}, falling back to {@link java.lang.Object} if
     * no specific class can be resolved.
     *
     ...
     *
     * <p>Determine whether the given object is an instance of this {@code ResolvableType}.
     *
     ...
     *
     * <p>Determine whether this {@code ResolvableType} is assignable from the specified other type.
     *
     ...
     * <p>Determine whether this {@code ResolvableType} is assignable from the specified other type.
     *
     * <p>Attempts to follow the same rules as the Java compiler, considering whether both the
    ...
    private boolean isAssignableFrom(
            ResolvableType other, @Nullable Map<Type, Type> matchedBefore) {
    ...
    /**
     * 如果此类型解析为表示数组的Class,则返回{@code true} Return {@code true} if this type resolves to a Class that
     * represents an array.
     *
     ...
     *
     * <p>Return the ResolvableType representing the component type of the array or {@link #NONE} if
     * this type does not represent an array.
     *
     * @see #isArray()
     */
     ...
     *
     * <p>Convenience method to return this type as a resolvable {@link Collection} type. Returns
     * {@link #NONE} if this type does not implement or extend {@link Collection}.
     *
     * @see #as(Class)
     * @see #asMap()
     */
     ...
     *
     * <p>Convenience method to return this type as a resolvable {@link Map} type. Returns {@link
     * #NONE} if this type does not implement or extend {@link Map}.
     *
     * @see #as(Class)
     * @see #asCollection()
     */
     ...
     *
     * <p>Return this type as a {@link ResolvableType} of the specified class. Searches {@link
     * #getSuperType() supertype} and {@link #getInterfaces() interface} hierarchies to find a
     ...
     *
     * <p>Return a {@link ResolvableType} representing the direct supertype of this type. If no
     * supertype is available this method returns {@link #NONE}.
     *
     * <p>Note: The resulting {@link ResolvableType} instance may not be {@link Serializable}.
     *
     * @see #getInterfaces()
     ...
     *
     * <p>Return a {@link ResolvableType} array representing the direct interfaces implemented by
     * this type. If this type does not implement any interfaces an empty array is returned.
     *
     ...
     *
     * <p>Return {@code true} if this type contains generic parameters.
     *
     * @see #getGeneric(int...)
     * @see #getGenerics()
     */
     ...
     *
     * <p>Return {@code true} if this type contains unresolvable generics only, that is, no
     ...
     *
     * <p>Determine whether the underlying type has any unresolvable generics: either through an
     * unresolvable type variable on the type itself or through implementing a generic interface in
     * a raw fashion, i.e. without substituting that interface's type variables. The result will be
     ...
     *
     * <p>Determine whether the underlying type is a type variable that cannot be resolved through
     * the associated variable resolver.
     */
     ...
     *
     * <p>Determine whether the underlying type represents a wildcard without specific bounds (i.e.,
     ...
     *
     * <p>Return a {@link ResolvableType} for the specified nesting level. See {@link
     ...
     * 返回指定嵌套等级的{@link ResolvableType}对象
     *
     * <p>Return a {@link ResolvableType} for the specified nesting level.
     *
     * <p>The nesting level refers to the specific generic parameter that should be returned. A
     * nesting level of 1 indicates this type; 2 indicates the first nested generic; 3 the second;
     ...
     *
     * <p>Nesting levels may also apply to array types; for example given {@code String[]}, a
     ...
     *
     * @param nestingLevel the required nesting level, indexed from 1 for the current type, 2 for
     *     the first nested generic, 3 for the second and so on
     * @param typeIndexesPerLevel a map containing the generic index for a given nesting level (may
     *     be {@code null})
     ...
     * 则返回一个空的数组。如果需要访问特定的泛型，请考虑使用{@link #getGeneric(int...)} 方法， 因为它允许访问嵌套的泛型并防止{@code
     * IndexOutBoundsExceptions}
     *
     * <p>Return an array of {@link ResolvableType ResolvableTypes} representing the generic
     * parameters of this type. If no generics are available an empty array is returned. If you need
     * to access a specific generic consider using the {@link #getGeneric(int...)} method as it
     * allows access to nested generics and protects against {@code IndexOutOfBoundsExceptions}.
     *
     ...
     *
     * <p>Convenience method that will {@link #getGenerics() get} and {@link #resolve() resolve}
     * generic parameters.
     *
     ...
     *
     * <p>Convenience method that will {@link #getGenerics() get} and {@link #resolve() resolve}
     * generic parameters, using the specified {@code fallback} if any type cannot be resolved.
     *
     ...
     *
     * <p>Convenience method that will {@link #getGeneric(int...) get} and {@link #resolve()
    ...
    /**
     * 将此类型解析为{@link java.lang.Class},如果无法解析，则返回{@code null}.如果直接解析失败， 则此方法将考虑{@link TypeVariable
     * TypeVariables}和{@link WildcardType WildcardTypes}的范围； 但是，{@code Object.class}的边界将被忽略
     *
     * <p>Resolve this type to a {@link java.lang.Class}, returning {@code null} if the type cannot
     * be resolved. This method will consider bounds of {@link TypeVariable TypeVariables} and
     * {@link WildcardType WildcardTypes} if direct resolution fails; however, bounds of {@code
    ...
    /**
     * 将此类型解析为{@link java.lang.Class}，如果无法解析该类型，则返回指定的{@code fallback} 如果直接解析失败，则此方法考虑{@Code
     * TypeVariable TypeVariables}和{@link WildcardType WildcardTypes}的bounds， 但是{@code
     * Object.class}的bounds将被忽略
     *
     * <p>Resolve this type to a {@link java.lang.Class}, returning the specified {@code fallback}
     * if the type cannot be resolved. This method will consider bounds of {@link TypeVariable
     * TypeVariables} and {@link WildcardType WildcardTypes} if direct resolution fails; however,
     ...
     *
     * <p>Resolve this type by a single level, returning the resolved value or {@link #NONE}.
     *
    ...
    private int calculateHashCode() {
        ...
        if (this.variableResolver != null) {
            // 叠加计算哈希值
            hashCode =
                    31 * hashCode + ObjectUtils.nullSafeHashCode(this.variableResolver.getSource());
        }
        // 数组的元素类型不为null
        if (this.componentType != null) {
            // 叠加计算哈希值
     ...
     *
     * <p>Adapts this {@link ResolvableType} to a {@link VariableResolver}.
     */
    @Nullable
     ...
     *
     * <p>Custom serialization support for {@link #NONE}.
     */
     ...
     *
     * <p>Return a String representation of this type in its fully resolved form (including any
     * generic parameters).
     */
    @Override
     ...
     *
     * <p>Strategy interface used to resolve {@link TypeVariable TypeVariables}.
     */
    interface VariableResolver extends Serializable {
         ...
         *
         * <p>Return the source of the resolver (used for hashCode and equals).
         */
        Object getSource();
         ...
         * 解析指定的变量
         *
         * <p>Resolve the specified variable.
         *
    ...
    private static class TypeVariablesVariableResolver implements VariableResolver {
        ...
        public TypeVariablesVariableResolver(
                TypeVariable<?>[] variables, ResolvableType[] generics) {
        ...
        public ResolvableType resolveVariable(TypeVariable<?> variable) {
            ...
            for (int i = 0; i < this.variables.length; i++) {
                ...
                TypeVariable<?> resolvedVariable =
                        SerializableTypeWrapper.unwrap(this.variables[i]);
     ...
     *
     * <p>Internal helper to handle bounds from {@link WildcardType WildcardTypes}.
     */
    private static class WildcardBounds {
         ...
         *
         * <p>Internal constructor to create a new {@link WildcardBounds} instance.
         *
         ...
         *
         * <p>Get a {@link WildcardBounds} instance for the specified type, returning {@code null}
         * if the specified type cannot be resolved to a {@link WildcardType}.
         *
         ...
         *
         * <p>Return {@code true} if this bounds is the same kind as the specified bounds.
         */
         ...
         *
         * <p>Return {@code true} if this bounds is assignable to all the specified types.
         *
         ...
         * 返回底层的界限
         *
         * <p>Return the underlying bounds.
         */
        public ResolvableType[] getBounds() {
            return this.bounds;
        }

        /** 各种界限 The various kinds of bounds. */
        enum Kind {
            UPPER,
            LOWER
        }
     ...
     *
     * <p>Internal {@link Type} used to represent an empty value.
     */
    @SuppressWarnings("serial")
