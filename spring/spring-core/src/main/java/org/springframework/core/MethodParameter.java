 ...
 *
 * <p>Helper class that encapsulates the specification of a method parameter, i.e. a {@link Method}
...
public class MethodParameter {
    ...
    /** 从整数嵌套等级到整数类型索引的映射 Map from Integer level to Integer type index. */
    ...
    /**
     * 包含的类。也可以通过覆盖{@link #getContainingClass()}来提供 The containing class. Could also be supplied by
     * overriding {@link #getContainingClass()}
     */
    ...
    /**
     * 使用嵌套级别1为给定方法创建一个新的{@code MethodParameter} Create a new {@code MethodParameter} for the given
     * method, with nesting level 1.
     *
     ...
     *
     * <p>Create a new MethodParameter for the given constructor, with nesting level 1.
     *
     ...
     *
     * <p>Internal constructor used to create a {@link MethodParameter} with a containing class
     * already set.
     *
     ...
     *
     * <p>Copy constructor, resulting in an independent MethodParameter object based on the same
     * metadata and cache state that the original object was in.
     *
    ...
    /**
     * 为给定的method或者constructor创建一个新的MethodParameter对象 Create a new MethodParameter for the given
     ...
     *
     * <p>Create a new MethodParameter for the given method or constructor.
     *
     * <p>This is a convenience factory method for scenarios where a Method or Constructor reference
     * is treated in a generic fashion.
     *
     ...
     *
     * <p>Create a new MethodParameter for the given parameter descriptor.
     *
     ...
     * 返回包装的方法，如果有
     *
     * <p>Return the wrapped Method, if any.
     *
     ...
     * 返回包装的构造函数，如果有
     *
     * <p>Return the wrapped Constructor, if any.
     *
     * <p>Note: Either Method or Constructor is available.
     *
    ...
    /** 返回声明底层方法或者构造函数的类 Return the class that declares the underlying Method or Constructor. */
     ...
     * 返回包装的注解元素
     *
     * <p>Return the wrapped annotated element.
     *
     * <p>Note: This method exposes the annotations declared on the method/constructor itself (i.e.
     * at the method/constructor level, not at the parameter level).
     *
     ...
     * 回包装的可执行程序
     *
     * <p>Return the wrapped executable.
     *
     ...
     *
     * <p>Return the {@link Parameter} descriptor for method/constructor parameter.
     *
     * @since 5.0
     */
    ...
    /**
     * 返回方法/构造函数参数的索引 Return the index of the method/constructor parameter.
     *
     ...
     * 增加参数的嵌套等级
     *
     * <p>Increase this parameter's nesting level.
     *
     * @see #getNestingLevel()
     ...
     * 降低此参数的嵌套等级
     *
     * <p>Decrease this parameter's nesting level.
     *
     * @see #getNestingLevel()
     ...
     *
     * <p>Return the nesting level of the target type (typically 1; e.g. in case of a List of Lists,
     ...
     *
     * <p>Return a variant of this {@code MethodParameter} with the type for the current level set
     ...
     * 返回当前嵌套等级的类型索引
     *
     * <p>Return the type index for the current nesting level.
     *
     * @return the corresponding type index, or {@code null} if none specified (indicating the
     *     default type index)
     * @see #getNestingLevel()
     */
    @Nullable
     ...
     * 设置当前嵌套等级的类型索引
     *
     * <p>Set the type index for the current nesting level.
     *
     ...
     * 返回指定嵌套等级的类型索引
     *
     * <p>Return the type index for the specified nesting level.
     *
     ...
     *
     * <p>Obtain the (lazily constructed) type-indexes-per-level Map.
     */
     ...
     *
     * <p>Return a variant of this {@code MethodParameter} which points to the same parameter but
    ...
    /**
     * 返回此方法是否表明不需要参数：以Java8的{@link java.util.Optional}形式， 参数级{@code
     * Nullable}注解的任何变体(例如来自JSR-305或FindBugs注释集), 或者Kotlin中的语言集可为null的类型声明。
     *
     * <p>Return whether this method indicates a parameter which is not required: either in the form
     * of Java 8's {@link java.util.Optional}, any variant of a parameter-level {@code Nullable}
     ...
     *
     * <p>Check whether this method parameter is annotated with any variant of a {@code Nullable}
     ...
     *
     * <p>Return a variant of this {@code MethodParameter} which points to the same parameter but
     * one nesting level deeper in case of a {@link java.util.Optional} declaration.
     *
     * @since 4.3
     * @see #isOptional()
     * @see #nested()
     ...
     *
     * <p>Return a variant of this {@code MethodParameter} which refers to the given containing
     * class.
     *
     ...
     * 返回方法参数的包含类
     *
     * <p>Return the containing class for this method parameter.
     *
     ...
     * 设置一个包含类来解析参数类型
     *
     * <p>Set a containing class to resolve the parameter type against.
     */
    @Deprecated
     ...
     *
     * <p>Return the type of the method/constructor parameter.
     *
     ...
     * 设置解析的（通用）参数类型
     *
     * <p>Set a resolved (generic) parameter type.
     */
    @Deprecated
     ...
     *
     * <p>Return the generic type of the method/constructor parameter.
     *
     * @return the parameter type (never {@code null})
     * @since 3.0
     */
            ...
            if (this.parameterIndex < 0) {
                ...
                if (this.executable instanceof Constructor
                        ...
                        && genericParameterTypes.length
                                == this.executable.getParameterCount() - 1) {
    ...
    /** 计算参数类型，如果当前参数索引小于0，返回method的返回类型；否则返回executable的参数类型 数组中当前参数索引的参数类型 */
    ...
    /**
     * 返回method/constructor参数嵌套类型 Return the nested type of the method/constructor parameter.
     *
     * @return the parameter type (never {@code null})
     * @since 3.1
     * @see #getNestingLevel()
     ...
     *
     * <p>Return the nested generic type of the method/constructor parameter.
     *
     * @return the parameter type (never {@code null})
     * @since 4.2
     * @see #getNestingLevel()
    ...
    /**
     * 返回与目标method或constructor本身关联的经过后处理的注解 Return the annotations associated with the target
     * method/constructor itself.
     */
     ...
     *
     * <p>Return the method/constructor annotation of the given type, if available.
     *
    ...
    /**
     * 返回method/constructor是否使用给定类型进行注释 Return whether the method/constructor is annotated with the
     * given type.
     *
     * @param annotationType the annotation type to look for
     * @since 4.3
     ...
     *
     * <p>Return the annotations associated with the specific method/constructor parameter.
     */
     ...
     *
     * <p>Return {@code true} if the parameter has at least one annotation, {@code false} if it has
     * none.
     *
     ...
     * 返回给定类型的参数注解,如果可用
     *
     * <p>Return the parameter annotation of the given type, if available.
     *
     * @param annotationType the annotation type to look for
     * @return the annotation object, or {@code null} if not found
     */
     ...
     * 返回参数是否具有给定的注解类型声明
     *
     * <p>Return whether the parameter is declared with the given annotation type.
     *
     * @param annotationType the annotation type to look for
     ...
     * 初始化此方法参数的参数名称发现器
     *
     * <p>Initialize parameter name discovery for this method parameter.
     *
     ...
     *
     * <p>Return the name of the method/constructor parameter.
     *
     ...
     *
     * <p>A template method to post-process a given annotation instance before returning it to the
     * caller.
     *
     ...
     *
     * <p>A template method to post-process a given annotation array before returning it to the
     * caller.
     *
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (getContainingClass() == otherParam.getContainingClass()
                && ObjectUtils.nullSafeEquals(
                        this.typeIndexesPerLevel, otherParam.typeIndexesPerLevel)
     ...
     *
     * <p>Inner class to avoid a hard dependency on Kotlin at runtime.
     */
    private static class KotlinDelegate {
         ...
         *
         * <p>Check whether the specified {@link MethodParameter} represents a nullable Kotlin type,
         * an optional parameter (with a default value in the Kotlin declaration) or a {@code
         * Continuation} parameter used in suspending functions.
         */
         ...
         *
         * <p>Return the generic return type of the method, with support of suspending functions via
         * Kotlin reflection.
         */
         ...
         * 返回method的返回类型,通过Kotlin反射支持暂停功能
         *
         * <p>Return the return type of the method, with support of suspending functions via Kotlin
         * reflection.
         */
