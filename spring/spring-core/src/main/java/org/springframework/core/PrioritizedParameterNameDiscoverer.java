...
/**
 * 陆续尝试一些发现器委托类的{@link ParameterNameDiscoverer}实现。 在{@code
 * addDiscoverer}方法中最先添加的那些有效级最高。如果一个返回{@code null},尝试下一个
 *
 * <p>{@link ParameterNameDiscoverer} implementation that tries several discoverer delegates in
...
public class PrioritizedParameterNameDiscoverer implements ParameterNameDiscoverer {
     ...
     *
     * <p>Add a further {@link ParameterNameDiscoverer} delegate to the list of discoverers that
     * this {@code PrioritizedParameterNameDiscoverer} checks.
     */
