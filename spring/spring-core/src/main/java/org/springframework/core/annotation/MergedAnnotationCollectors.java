...
public abstract class MergedAnnotationCollectors {
    ...
    /**
     * Create a new {@link Collector} that accumulates merged annotations to an {@link
     * MultiValueMap} with items {@linkplain MultiValueMap#add(Object, Object) added} from each
     * merged annotation {@link MergedAnnotation#asMap(Adapt...) as a map}.
     *
     * @param <A> the annotation type
