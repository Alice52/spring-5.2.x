...
public final class ReactiveTypeDescriptor {
    ...
    /**
     * The same as {@link #singleOptionalValue(Class, Supplier)} but for a non-deferred, async type
     ...
     * @since 5.2.7
     */
    public static ReactiveTypeDescriptor nonDeferredAsyncValue(
            Class<?> type, Supplier<?> emptySupplier) {
     ...
     * reactive type can produce 1 value at most and is therefore a good fit to adapt to {@code
     * Mono}.
     */
    ...
    /**
     * Whether the underlying operation is deferred and needs to be started explicitly, e.g. via
     * subscribing (or similar), or whether it is triggered without the consumer having any control.
     *
     * @since 5.2.7
     */
