...
public final class Conventions {
    ...
    /**
     * Determine the conventional variable name for the supplied {@code Object} based on its
     * concrete type. The convention used is to return the un-capitalized short name of the {@code
     * Class}, according to JavaBeans property naming rules.
     *
     * <p>For example:<br>
     ...
     * Collection}s an attempt is made to 'peek ahead' to determine the component type and return
    ...
    public static String getVariableNameForParameter(MethodParameter parameter) {
        ...
        if (parameter.getParameterType().isArray()) {
            ...
            ReactiveAdapter adapter =
                    ReactiveAdapterRegistry.getSharedInstance().getAdapter(valueClass);
    ...
    /**
     * Determine the conventional variable name for the return type of the given method, taking the
     * generic collection type, if any, into account, falling back on the given actual return value
     * if the method declaration is not specific enough, e.g. {@code Object} return type or untyped
     * collection.
     *
     * @param method the method to generate a variable name for
     ...
     * into property name format (camel-case). For example {@code transaction-manager} becomes
     ...
     * attribute name '{@code foo}' qualified by {@link Class} '{@code com.myapp.SomeClass}' would
     * be '{@code com.myapp.SomeClass.foo}'
     */
    ...
    /**
     * Retrieve the {@code Class} of an element in the {@code Collection}. The exact element for
     * which the {@code Class} is retrieved will depend on the concrete {@code Collection}
     * implementation.
     */
