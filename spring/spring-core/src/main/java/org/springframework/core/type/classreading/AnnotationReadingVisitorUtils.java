...
abstract class AnnotationReadingVisitorUtils {
    ...
    public static AnnotationAttributes convertClassValues(
        ...
        AnnotationUtils.postProcessAnnotationAttributes(
                annotatedElement, result, classValuesAsString);
                ...
                if (value instanceof AnnotationAttributes) {
                    ...
                    value =
                            (classValuesAsString
                                    ...
                                    : ClassUtils.forName(
                                            ((Type) value).getClassName(), classLoader));
                } else if (value instanceof Type[]) {
     ...
     * @return the merged annotation attributes, or {@code null} if no matching annotation is
     *     present in the {@code attributesMap}
     * @since 4.0.3
     */
    @Nullable
    public static AnnotationAttributes getMergedAnnotationAttributes(
        ...
        for (String currentAnnotationType : annotationTypes) {
            List<AnnotationAttributes> currentAttributesList =
                    attributesMap.get(currentAnnotationType);
