...
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    public TypedValue read(EvaluationContext context, @Nullable Object target, String name)
        ...
        throw new AccessException(
                "Neither getter method nor field found for property '" + name + "'");
    }
    ...
    public void write(
        ...
        throw new AccessException(
                "Neither setter method nor field found for property '" + name + "'");
    }
    ...
    protected Method findGetterForProperty(
        ...
        Method method =
                findMethodForProperty(
                        getPropertyMethodSuffixes(propertyName),
                        "get",
                        clazz,
                        mustBeStatic,
                        0,
    ...
    /**
     * Determine whether the given {@code Method} is a candidate for property access on an instance
    ...
    /**
     * Return the method suffixes for a given property name. The default implementation uses
     * JavaBean conventions with additional support for properties of the form 'xY' where the method
     * 'getXY()' is used in preference to the JavaBean convention of 'getxY()'.
     */
     ...
     * read() is called. This method will just return the ReflectivePropertyAccessor instance if it
     * is unable to build a more optimal accessor.
     *
    ...
    /**
     * Captures the member (method/field) to call reflectively to access a property value and the
     * type descriptor for the value returned by the reflective call.
     */
    ...
    /**
     * An optimized form of a PropertyAccessor that will use reflection but only knows how to access
     * a particular property on a particular class. This is unlike the general
     * ReflectivePropertyResolver which manages a cache of methods/fields that may be invoked to
     * access different properties on different classes. This optimal accessor exists because
     * looking up the appropriate reflective object by class/name on each read is not cheap.
     */
    public static class OptimalPropertyAccessor implements CompilablePropertyAccessor {
        ...
        public void generateCode(String propertyName, MethodVisitor mv, CodeFlow cf) {
            ...
            if (this.member instanceof Method) {
                ...
                int opcode =
                        (isStatic ? INVOKESTATIC : isInterface ? INVOKEINTERFACE : INVOKEVIRTUAL);
                mv.visitMethodInsn(
                        opcode,
                        classDesc,
                        method.getName(),
