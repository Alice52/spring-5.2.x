...
/**
 * Represents a bean reference to a type, for example {@code @foo} or {@code @'foo.bar'}. For a
 * FactoryBean the syntax {@code &foo} can be used to access the factory itself.
 *
 * @author Andy Clement
 */
    ...
    public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
        ...
        try {
            return new TypedValue(
                    beanResolver.resolve(state.getEvaluationContext(), this.beanName));
