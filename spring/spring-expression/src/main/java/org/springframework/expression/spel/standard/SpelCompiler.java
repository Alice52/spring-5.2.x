...
public final class SpelCompiler implements Opcodes {
    ...
    /**
     * Factory method for compiler instances. The returned SpelCompiler will attach a class loader
     * as the child of the given class loader and this child will be used to load compiled
     * expressions.
     *
    ...
    /**
     * Request to revert to the interpreter for expression evaluation. Any compiled form is
     * discarded but can be recreated by later recompiling again.
     *
    ...
    /**
     * Generate the class that encapsulates the compiled expression and define it. The generated
     * class will be a subtype of CompiledExpression.
     *
    ...
    /**
     * Load a compiled expression class. Makes sure the classloaders aren't used too much because
     * they anchor compiled classes in memory and prevent GC. If you have expressions continually
     * recompiling over time then by replacing the classloader periodically at least some of the
     * older variants can be garbage collected.
     *
