...
public class Indexer extends SpelNodeImpl {
    ...
    protected ValueRef getValueRef(ExpressionState state) throws EvaluationException {
        ...
        // This first part of the if clause prevents a 'double dereference' of the property
        // (SPR-5847)
        ...
        if (target.getClass().isArray()
            ...
            if (target.getClass().isArray()) {
                ...
                return new ArrayIndexingValueRef(
                        state.getTypeConverter(), target, idx, targetDescriptor);
        ...
        if (this.indexedType == IndexedType.ARRAY) {
            ...
            return (this.cachedReadAccessor != null
                    && this.cachedReadAccessor
                            instanceof ReflectivePropertyAccessor.OptimalPropertyAccessor
    ...
    private <T> T convertValue(
            TypeConverter converter, @Nullable Object value, Class<T> targetType) {
        T result =
                (T)
    ...
    private class ArrayIndexingValueRef implements ValueRef {
        ...
        public TypedValue getValue() {
            ...
            return new TypedValue(
                    arrayElement, this.typeDescriptor.elementTypeDescriptor(arrayElement));
        }
        ...
        public void setValue(@Nullable Object newValue) {
            ...
            setArrayElement(
                    this.typeConverter, this.array, this.index, newValue, elementType.getType());
        }
            ...
            try {
                ...
                for (PropertyAccessor accessor : accessorsToTry) {
                    if (accessor.canWrite(this.evaluationContext, this.targetObject, this.name)) {
                        ...
                        accessor.write(
                                this.evaluationContext, this.targetObject, this.name, newValue);
                        return;
                    }
                }
            } catch (AccessException ex) {
    ...
    private class CollectionIndexingValueRef implements ValueRef {
        ...
        public TypedValue getValue() {
            ...
            for (Object o : this.collection) {
                if (pos == this.index) {
                    return new TypedValue(
                            o, this.collectionEntryDescriptor.elementTypeDescriptor(o));
                }
                pos++;
            }
        ...
        private void growCollectionIfNecessary() {
            if (this.index >= this.collection.size()) {
                ...
                try {
                    Constructor<?> ctor =
                            ReflectionUtils.accessibleConstructor(elementType.getType());
