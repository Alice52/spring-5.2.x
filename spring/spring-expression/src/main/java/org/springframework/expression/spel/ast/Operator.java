...
public abstract class Operator extends SpelNodeImpl {
     ...
     *
     * <p>This method is not just used for reflective comparisons in subclasses but also from
     * compiled expression code, which is why it needs to be declared as {@code public static} here.
     *
    ...
    public static boolean equalityCheck(
        ...
        if (left instanceof Comparable && right instanceof Comparable) {
            Class<?> ancestor =
                    ClassUtils.determineCommonAncestor(left.getClass(), right.getClass());
    ...
    protected static final class DescriptorComparison {
         ...
         *
         * <p>For generic types with unbound type variables, the declared descriptor discovered may
         * be 'Object' but from the actual descriptor it is possible to observe that the objects are
         * really numeric values (e.g. ints).
         *
        ...
        public static DescriptorComparison checkNumericCompatibility(
            ...
            // If the declared descriptors aren't providing the information, try the actual
            // descriptors
