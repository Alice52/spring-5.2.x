        ...
        try {
            ...
            for (Constructor<?> ctor : ctors) {
                ...
                if (ctor.isVarArgs() && argumentTypes.size() >= paramCount - 1) {
                    // *sigh* complicated
                    // Basically.. we have to have all parameters match up until the varargs one,
                    // then the rest of what is
                    // being provided should be
                    // the same type whilst the final argument to the method must be an array of
                    // that (oh, how easy...not) -
