...
public abstract class SpelNodeImpl implements SpelNode, Opcodes {
    ...
    /**
     * Indicates the type descriptor for the result of this expression node. This is set as soon as
     * it is known. For a literal node it is known immediately. For a property access or method
    ...
    protected static void generateCodeForArgument(
        ...
        if (primitiveOnStack && paramDesc.charAt(0) == 'L') {
            ...
            // This would be unnecessary in the case of subtyping (e.g. method takes Number but
            // Integer passed in)
     ...
     * expression being compiled is available in the codeflow object, e.g. including information
     * about the type of the object currently on the stack.
     *
