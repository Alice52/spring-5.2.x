...
public class StandardEvaluationContext implements EvaluationContext {
    ...
    /**
     * Register a {@code MethodFilter} which will be called during method resolution for the
     * specified type.
     *
     * <p>The {@code MethodFilter} may remove methods and/or sort the methods which will then be
     * used by SpEL as the candidates to look through for a match.
     *
