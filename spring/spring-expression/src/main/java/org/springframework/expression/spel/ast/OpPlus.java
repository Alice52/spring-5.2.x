...
public class OpPlus extends Operator {
        ...
        if (typeConverter.canConvert(value.getTypeDescriptor(), typeDescriptor)) {
            return String.valueOf(
                    typeConverter.convertValue(
                            value.getValue(), value.getTypeDescriptor(), typeDescriptor));
        }
    ...
    /**
     * Walk through a possible tree of nodes that combine strings and append them all to the same
     * (on stack) StringBuilder.
     */
                ...
                switch (targetDesc) {
                    ...
                    default:
                        throw new IllegalStateException(
                                "Unrecognized exit type descriptor: '"
