...
public class SpelExpression implements Expression {
    ...
    @Nullable private volatile CompiledExpression compiledAst;
            ...
            try {
                ...
                if (this.configuration.getCompilerMode() == SpelCompilerMode.MIXED) {
                    ...
                    throw new SpelEvaluationException(
                            ex, SpelMessage.EXCEPTION_RUNNING_COMPILED_EXPRESSION);
                }
            }
        }
    ...
    public <T> T getValue(
            ...
            @Nullable Class<T> expectedResultType)
            throws EvaluationException {
    ...
    public Class<?> getValueType(EvaluationContext context) throws EvaluationException {
        ...
        TypeDescriptor typeDescriptor =
                this.ast.getValueInternal(expressionState).getTypeDescriptor();
    ...
    /**
     * Perform expression compilation. This will only succeed once exit descriptors for all nodes
     * have been determined. If the compilation fails and has failed more than 100 times the
     * expression is no longer considered suitable for compilation.
     *
     ...
     * ideally look like the input expression, but properly formatted since any unnecessary
     * whitespace will have been discarded during the parse of the expression.
     *
