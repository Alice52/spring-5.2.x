...
public class SetValueTests extends AbstractExpressionTests {
    ...
    public void testIsWritableForInvalidExpressions_SPR10610() {
        ...
        //			org.springframework.expression.spel.SpelEvaluationException: EL1008E:(pos 15): Property
        // or field 'wibble' cannot be found on object of type
    ...
    public void testSetGenericMapElementRequiresCoercion() throws Exception {
        ...
        Collection<?> vs =
                parse("mapOfStringToBoolean.values()").getValue(eContext, Collection.class);
        for (Object o : vs) {
    ...
    protected void setValue(String expression, Object value) {
        try {
            ...
            StandardEvaluationContext lContext = TestScenarioCreator.getTestEvaluationContext();
            assertThat(e.isWritable(lContext))
                    .as("Expression is not writeable but should be")
                    .isTrue();
    ...
    /**
     * For use when coercion is happening during a setValue(). The expectedValue should be the
     * coerced form of the value.
     */
