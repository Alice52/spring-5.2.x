...
public class MethodInvocationTests extends AbstractExpressionTests {
    ...
    /**
     * Check on first usage (when the cachedExecutor in MethodReference is null) that the exception
     * is not wrapped.
     */
    @Test
    ...
    public void testInvocationOnNullContextObject() {
        evaluateAndCheckError(
                "null.toString()", SpelMessage.METHOD_CALL_ON_NULL_OBJECT_NOT_ALLOWED);
    }
    ...
    public void invokeMethodWithoutConversion() throws Exception {
        ...
        context.setBeanResolver(
                (context1, beanName) -> ("service".equals(beanName) ? service : null));
