...
public abstract class AbstractExpressionTests {
    ...
    /**
     * Evaluate an expression and check that the actual result matches the expectedValue and the
     * class of the result matches the expectedClassOfResult.
     *
    ...
    /**
     * Evaluate an expression and check that the actual result matches the expectedValue and the
     * class of the result matches the expectedClassOfResult. This method can also check if the
     * expression is writable (for example, it is a variable or property reference).
     *
     * @param expression the expression to evaluate
     * @param expectedValue the expected result for evaluating the expression
                        ...
                        ex -> {
                            ...
                            if (!ObjectUtils.isEmpty(otherProperties)) {
                                ...
                                if (otherProperties.length > 1) {
                                    ...
                                    assertThat(inserts)
                                            .as("inserts")
                                            .containsExactly(expectedInserts);
                                }
                            }
                        });
    }
    ...
    /**
     * Parse the specified expression and ensure the expected message comes out. The message may
     * have inserts and they will be checked if otherProperties is specified. The first entry in
     * otherProperties should always be the position.
     *
     * @param expression the expression to evaluate
