...
public class SpelCompilationCoverageTests extends AbstractExpressionTests {
    ...
    public void inlineList() throws Exception {
        ...
        expression =
                parser.parseExpression("{'abcde','ijklm'}[0].substring({1,3,4}[0],{1,3,4}[1])");
        o = expression.getValue();
    ...
    public void nestedInlineLists() throws Exception {
        ...
        expression =
                parser.parseExpression("{'abcde',{'ijklm','nopqr'}}[1][0].substring({1,3,4}[0])");
        o = expression.getValue();
    ...
    public void intLiteral() throws Exception {
        ...
        // Code gen is different for -1 .. 6 because there are bytecode instructions specifically
        // for those values
    ...
    public void ternary() throws Exception {
        ...
        expression =
                parser.parseExpression(
                        "(#root and true)?T(Integer).valueOf(1):T(Long).valueOf(3L)");
    ...
    public void nullsafeMethodChaining_SPR16489() throws Exception {
        ...
        SpelExpression expression =
                (SpelExpression) parser.parseExpression("getFoo()?.getObject()");
        assertThat(expression.getValue(context)).isEqualTo("hello");
        foh.foo = null;
        assertThat(expression.getValue(context)).isNull();
        assertCanCompile(expression);
    ...
    public void compiledExpressionShouldWorkWhenUsingCustomFunctionWithVarargs() throws Exception {
        ...
        context.registerFunction(
                "doFormat",
                DelegatingStringFormat.class.getDeclaredMethod(
    ...
    public void functionReferenceNonCompilableArguments_SPR12359() throws Exception {
        ...
        assertThat(((SpelNodeImpl) ((SpelExpression) expression).getAST()).isCompilable())
                .isFalse();
    }
    ...
    public void functionReferenceVarargs_SPR12359() throws Exception {
        ...
        context.registerFunction(
                "append4",
                SomeCompareMethod2.class.getDeclaredMethod(
                        "append4", String.class, String[].class));
        context.registerFunction(
                "appendChar",
                SomeCompareMethod2.class.getDeclaredMethod("appendChar", char[].class));
        context.registerFunction(
                "sum", SomeCompareMethod2.class.getDeclaredMethod("sum", int[].class));
        context.registerFunction(
                "sumDouble",
        ...
        expression = parser.parseExpression("append(#stringArray)");
        assertThat(expression.getValue(context, new SomeCompareMethod2()).toString())
                .isEqualTo("xyz");
        assertThat(((SpelNodeImpl) ((SpelExpression) expression).getAST()).isCompilable()).isTrue();
        assertCanCompile(expression);
        assertThat(expression.getValue(context, new SomeCompareMethod2()).toString())
    ...
    public void opNe_SPR14863() throws Exception {
        SpelParserConfiguration configuration =
                new SpelParserConfiguration(
                        SpelCompilerMode.MIXED, ClassLoader.getSystemClassLoader());
    ...
    public void compilationOfBasicNullSafeMethodReference() {
        SpelExpressionParser parser =
                new SpelExpressionParser(
                        new SpelParserConfiguration(
                                SpelCompilerMode.OFF, getClass().getClassLoader()));
    ...
    public void constructorReference_SPR13781() {
        ...
        expression =
                parser.parseExpression(
                        "#userId.toString().toLowerCase(T(java.util.Locale).ENGLISH)");
        StandardEvaluationContext context = new StandardEvaluationContext();
        ...
        // These tests below verify that the chain of static accesses (either method/property or
        // field)
        ...
        expression =
                parser.parseExpression(
                        "T(String).valueOf(T(" + shclass + ").fielda.fielda.fieldb)");
    ...
    public void methodReference() throws Exception {
        ...
        tc.reset();
        assertCanCompile(
                expression); // The generated code should include boxing of the int to a Number
        expression.getValue(tc);
        assertThat(tc.s).isEqualTo("123");
    ...
    public void compoundExpression() throws Exception {
        ...
        assertThat(expression.getValue(payload).getClass().getName())
                .isEqualTo(
                        "org.springframework.expression.spel.SpelCompilationCoverageTests$Three");
        assertCanCompile(expression);
        assertThat(expression.getValue(payload).getClass().getName())
                .isEqualTo(
                        "org.springframework.expression.spel.SpelCompilationCoverageTests$Three");
        ...
        assertThat(ast.getExitDescriptor())
                .isEqualTo(
                        "Lorg/springframework/expression/spel/SpelCompilationCoverageTests$Three");
    ...
    public void compilerWithGenerics_12040() {
        ...
        assertCanCompile(expression);
        assertThat(expression.getValue(new GenericMessageTestHelper<>(6L), Boolean.class))
                .isFalse();
        ...
        expression = parser.parseExpression("payload==6L");
        assertThat(expression.getValue(new GenericMessageTestHelper<>(4L), Boolean.class))
                .isFalse();
        assertCanCompile(expression);
    ...
    public void indexerMapAccessor_12045() throws Exception {
        ...
        // What about a map key that is an expression - ensure the getKey() is evaluated in the
        // right scope
    ...
    /**
     * Exception thrown from {@code read} in order to reset a cached PropertyAccessor, allowing
     * other accessors to have a try.
     */
    @SuppressWarnings("serial")
