...
public class ExpressionLanguageScenarioTests extends AbstractExpressionTests {
    ...
    public void testScenario_RegisteringJavaMethodsAsFunctionsAndCallingThem()
        ...
        try {
            ...
            ctx.registerFunction(
                    "repeat",
                    ExpressionLanguageScenarioTests.class.getDeclaredMethod(
                            "repeat", String.class));
     ...
     * what colour a fruit is ! It only supports property reading, not writing. To support writing
     * it would need to override canWrite() and write()
     */
