...
public class NotificationListenerTests extends AbstractMBeanServerTests {
    ...
    public void testRegisterNotificationListenerWithFilter() throws Exception {
        ...
        assertThat(listener.getCount(nameAttribute))
                .as("Listener not notified for Name")
                .isEqualTo(1);
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    @Test
    public void testRegisterNotificationListenerWithBeanNameAndBeanNameInBeansMap()
            throws Exception {
    ...
    @Test
    public void
            testRegisterNotificationListenerWithBeanNameBeforeObjectNameMappedToSameBeanInstance()
                    throws Exception {
        String beanName = "testBean";
        ObjectName objectName = ObjectName.getInstance("spring:name=Test");
    ...
    @Test
    public void
            testRegisterNotificationListenerWithObjectNameBeforeBeanNameMappedToSameBeanInstance()
                    throws Exception {
        String beanName = "testBean";
        ObjectName objectName = ObjectName.getInstance("spring:name=Test");
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    private static class CountingAttributeChangeNotificationListener
