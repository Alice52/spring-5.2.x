...
public abstract class AbstractMetadataAssemblerTests extends AbstractJmxAssemblerTests {
    ...
    public void testManagedResourceDescriptor() throws Exception {
        ...
        assertThat(desc.getFieldValue("logFile"))
                .as("Log file should be build/jmx.log")
                .isEqualTo("build/jmx.log");
    ...
    public void testAttributeDescriptor() throws Exception {
        ...
        assertThat(desc.getFieldValue("default"))
                .as("Default value should be foo")
                .isEqualTo("foo");
        assertThat(desc.getFieldValue("currencyTimeLimit"))
    ...
    public void testOperationParameterMetadata() throws Exception {
        ...
        assertThat(params[0].getType())
                .as("Incorrect type for x param")
                .isEqualTo(int.class.getName());

        assertThat(params[1].getName()).as("Incorrect name for y param").isEqualTo("y");
        assertThat(params[1].getType())
                .as("Incorrect type for y param")
                .isEqualTo(int.class.getName());
    }
    ...
    public void testMetricDescription() throws Exception {
        ...
        assertThat(operation.getDescription())
                .as(
                        "The description for the getter operation of the queue size metric is incorrect")
                .isEqualTo("The QueueSize metric");
    }
