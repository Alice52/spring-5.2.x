...
public class ApplicationContextEventTests extends AbstractApplicationEventListenerTests {
    ...
    public void multicastSmartGenericWrongTypeGenericListener() {
        multicastEvent(
                false, StringEventListener.class, new SmartGenericTestEvent<>(this, 123L), null);
    }
    ...
    public void listenersInApplicationContext() {
        ...
        context.registerBeanDefinition(
                "listener1", new RootBeanDefinition(MyOrderedListener1.class));
        ...
        context.refresh();
        assertThat(context.getDefaultListableBeanFactory().containsSingleton("listener2"))
                .isFalse();
    ...
    public void listenerAndBroadcasterWithCircularReference() {
        StaticApplicationContext context = new StaticApplicationContext();
        context.registerBeanDefinition(
                "broadcaster", new RootBeanDefinition(BeanThatBroadcasts.class));
    ...
    public void innerBeanAsListener() {
        ...
        listenerDef
                .getPropertyValues()
                .add("friends", new RootBeanDefinition(BeanThatListens.class));
        context.registerBeanDefinition("listener", listenerDef);
        context.refresh();
    ...
    public void initMethodPublishesEvent() {
        ...
        context.registerBeanDefinition(
                "messageSource", new RootBeanDefinition(StaticMessageSource.class));
        context.registerBeanDefinition(
                "initMethod", new RootBeanDefinition(EventPublishingInitMethod.class));
        context.refresh();
    ...
    public void initMethodPublishesAsyncEvent() {
        ...
        context.registerBeanDefinition(
                "messageSource", new RootBeanDefinition(StaticMessageSource.class));
        context.registerBeanDefinition(
                "initMethod", new RootBeanDefinition(AsyncEventPublishingInitMethod.class));
        context.refresh();
    ...
    public static class MyOrderedListener1
    ...
    public static class EventPublishingInitMethod
    ...
    public static class AsyncEventPublishingInitMethod
            implements ApplicationEventPublisherAware, InitializingBean {
