...
public class ResourceBundleMessageSourceTests {
    ...
    protected void doTestMessageAccess(
        ...
        Object expected =
                fallbackToSystemLocale && expectGermanFallback ? "nachricht2" : "message2";
        ...
        assertThat(ac.getMessage("code2", null, new Locale("DE", "at", "oo")))
        ...
        assertThat(ac.getMessage(null, null, "{0}, default", Locale.ENGLISH))
                .isEqualTo("{0}, default");
