...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
    ...
    /**
     * We really are testing the AbstractMessageSource class here. The underlying implementation
     * uses a hashMap to cache messageFormats once a message has been asked for. This test is an
     * attempt to make sure the cache is being used properly.
     *
    ...
    public void getMessageWithMessageAlreadyLookedFor() {
        ...
        Object[] newArguments = {
            8, new Date(System.currentTimeMillis()), "a disturbance in the Force"
        };
        ...
        */
        ...
        assertThat(
                        sac.getMessage("message.format.example1", arguments, Locale.UK)
                                .contains(
                                        "there was \"a disturbance in the Force\" on station number 7."))
                .as(
    ...
    protected ConfigurableApplicationContext createContext() throws Exception {
        ...
        parent.registerPrototype(
                "rod",
                org.springframework.beans.testfixture.beans.TestBean.class,
        ...
        sac.registerSingleton(
                "beanThatListens", BeanThatListens.class, new MutablePropertyValues());
