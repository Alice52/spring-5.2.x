...
public class BeanFactoryPostProcessorTests {
    ...
    public void testBeanFactoryPostProcessorNotExecutedByBeanFactory() {
        ...
        bf.registerBeanDefinition(
                "bfpp", new RootBeanDefinition(TestBeanFactoryPostProcessor.class));
    ...
    public void testBeanDefinitionRegistryPostProcessor() {
        ...
        TestBeanDefinitionRegistryPostProcessor bdrpp =
                new TestBeanDefinitionRegistryPostProcessor();
