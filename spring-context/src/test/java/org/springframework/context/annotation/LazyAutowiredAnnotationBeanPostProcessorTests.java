...
public class LazyAutowiredAnnotationBeanPostProcessorTests {
    ...
    private void doTestLazyResourceInjection(Class<? extends TestBeanHolder> annotatedBeanClass) {
        ...
        assertThat(
                        ObjectUtils.containsElement(
                                bf.getDependenciesForBean("annotatedBean"), "testBean"))
                .isTrue();
        assertThat(ObjectUtils.containsElement(bf.getDependentBeans("testBean"), "annotatedBean"))
                .isTrue();
    }
    ...
    public void testLazyResourceInjectionWithField() {
        ...
        FieldResourceInjectionBean bean =
                ac.getBean("annotatedBean", FieldResourceInjectionBean.class);
    ...
    public static class FieldResourceInjectionBeanWithCompositeAnnotation
    ...
    public static class MethodResourceInjectionBeanWithCompositeAnnotation
            implements TestBeanHolder {
