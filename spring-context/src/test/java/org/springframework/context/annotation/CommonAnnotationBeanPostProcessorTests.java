...
public class CommonAnnotationBeanPostProcessorTests {
    ...
    public void testPostConstructAndPreDestroyWithApplicationContextAndPostProcessor() {
        ...
        ctx.registerBeanDefinition(
                "bpp1", new RootBeanDefinition(InitDestroyBeanPostProcessor.class));
        ctx.registerBeanDefinition(
    ...
    public void testResourceInjection() {
        ...
        bf.addBeanPostProcessor(bpp);
        bf.registerBeanDefinition(
                "annotatedBean", new RootBeanDefinition(ResourceInjectionBean.class));
    ...
    public void testExtendedResourceInjection() {
        ...
        NamedResourceInjectionBean bean2 =
                (NamedResourceInjectionBean) bf.getBean("annotatedBean2");
    ...
    public void testExtendedResourceInjectionWithOverriding() {
        ...
        RootBeanDefinition annotatedBd =
                new RootBeanDefinition(ExtendedResourceInjectionBean.class);
        ...
        try {
            ...
            NoSuchBeanDefinitionException innerEx =
                    (NoSuchBeanDefinitionException) ex.getRootCause();
