...
class InstantFormatterTests {
    ...
    void should_parse_an_ISO_formatted_string_representation_of_an_Instant(String input)
    ...
    void should_parse_an_RFC1123_formatted_string_representation_of_an_Instant(String input)
            throws ParseException {
