...
public class AdvisorAutoProxyCreatorTests {
    ...
    private static final String COMMON_INTERCEPTORS_CONTEXT =
            CLASSNAME + "-common-interceptors.xml";
    private static final String CUSTOM_TARGETSOURCE_CONTEXT =
            CLASSNAME + "-custom-targetsource.xml";
    ...
    public void testCommonInterceptorAndAdvisor() throws Exception {
        ...
        NopInterceptor nop2 =
                (NopInterceptor) bf.getBean("pointcutAdvisor", Advisor.class).getAdvice();
    ...
    /**
     * We have custom TargetSourceCreators but there's no match, and hence no proxying, for this
     * bean
     */
    @Test
