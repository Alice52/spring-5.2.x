...
public class AutoProxyCreatorTests {
    ...
    public void testCustomAutoProxyCreator() {
        ...
        sac.registerSingleton(
                "containerCallbackInterfacesOnly", ContainerCallbackInterfacesOnly.class);
    ...
    public void testAutoProxyCreatorWithPackageVisibleMethod() {
        ...
        PackageVisibleMethod tb =
                (PackageVisibleMethod) sac.getBean("packageVisibleMethodToBeProxied");
    ...
    public void testAutoProxyCreatorWithFactoryBeanAndPrototype() {
        ...
        FactoryBean<?> prototypeFactory =
                (FactoryBean<?>) sac.getBean("&prototypeFactoryToBeProxied");
    ...
    public static class TestAutoProxyCreator extends AbstractAutoProxyCreator {
        ...
        protected Object[] getAdvicesAndAdvisorsForBean(
            ...
            if (StaticMessageSource.class.equals(beanClass)) {
                ...
                if ((this.proxyFactoryBean && isFactoryBean)
                        || (this.proxyObject && !isFactoryBean)) {
    ...
    public static class IntroductionTestAutoProxyCreator extends TestAutoProxyCreator {
        ...
        protected Object[] getAdvicesAndAdvisors() {
            DefaultIntroductionAdvisor advisor =
                    new DefaultIntroductionAdvisor(this.testInterceptor);
