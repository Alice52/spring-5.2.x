...
public class ProxyFactoryBeanTests {
    ...
    public void setUp() throws Exception {
        ...
        parent.registerBeanDefinition(
                "target2", new RootBeanDefinition(TestApplicationListener.class));
    ...
    public void testTargetSourceNotAtEndOfInterceptorNamesIsRejected() {
        ...
        assertThatExceptionOfType(BeanCreationException.class)
                ...
                .withCauseInstanceOf(AopConfigException.class)
                .satisfies(
                        ex -> assertThat(ex.getCause().getMessage()).contains("interceptorNames"));
    }
    ...
    public void testSingletonInstancesAreEqual() {
        ...
        pc1.addAdvice(1, di);
        assertThat(pc2.getAdvisors()).isEqualTo(pc1.getAdvisors());
        assertThat(pc2.getAdvisors().length)
                .as("Now have one more advisor")
                .isEqualTo((oldLength + 1));
    ...
    */
    ...
    public void testGlobalsCanAddAspectInterfaces() {
        ...
        assertThat(pfb.getAdvisors().length)
                .as("Have 2 globals and 2 explicit advisors")
                .isEqualTo(3);
    ...
    public void testSerializableSingletonProxyFactoryBean() throws Exception {
        ...
        ProxyFactoryBean pfb2 =
                (ProxyFactoryBean) SerializationTestUtils.serializeAndDeserialize(pfb);
    ...
    /**
     * Use as a global interceptor. Checks that global interceptors can add aspect interfaces. NB:
     * Add only via global interceptors in XML file.
     */
