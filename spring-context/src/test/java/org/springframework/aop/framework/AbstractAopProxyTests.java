...
public abstract class AbstractAopProxyTests {
    ...
    public void testReentrance() {
        ...
        assertThat(advised1.getSpouse().getAge())
                .as("Advised spouse has correct age")
                .isEqualTo(age1);
    ...
    /**
     * An interceptor throws a checked exception not on the method signature. For efficiency, we
     * don't bother unifying java.lang.reflect and org.springframework.cglib
    ...
    public void testUndeclaredCheckedException() throws Throwable {
        ...
        assertThatExceptionOfType(UndeclaredThrowableException.class)
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getUndeclaredThrowable())
     ...
     * invocation, it doesn't happen if we've asked to see the proxy, so as to guarantee a
        ...
        TrapTargetInterceptor tii =
                new TrapTargetInterceptor() {
                    ...
                    public Object invoke(MethodInvocation invocation) throws Throwable {
                        ...
                        assertThat(invocation.getThis())
                                .as("Target is correct")
    ...
    private void assertNoInvocationContext() {
        assertThatIllegalStateException()
                .isThrownBy(ExposeInvocationInterceptor::currentInvocation);
    }
    ...
    @Test
    public void testCannotAddDynamicIntroductionAdviceExceptInIntroductionAdvice()
            throws Throwable {
    ...
    public void testRejectsBogusDynamicIntroductionAdviceWithNoAdapter() throws Throwable {
        ...
        pc.addAdvisor(
                new DefaultIntroductionAdvisor(
                        new DummyIntroductionAdviceImpl(), Comparable.class));
        assertThatExceptionOfType(Exception.class)
                .isThrownBy(
                        () -> {
                ...
                .isThrownBy(
                        () ->
                                pc.addAdvisor(
                                        0,
                                        new DefaultIntroductionAdvisor(
                                                new TimestampIntroductionInterceptor(),
                                                ITestBean.class)));
        // Check it still works: proxy factory state shouldn't have been corrupted
        ITestBean proxied = (ITestBean) createProxy(pc);
        assertThat(proxied.getAge()).isEqualTo(target.getAge());
    ...
    public void testCanPreventCastToAdvisedUsingOpaque() {
        ...
        Advisor advisor =
                new DefaultPointcutAdvisor(
                        new NameMatchMethodPointcut().addMethodName("setAge"), mba);
        pc.addAdvisor(advisor);
    ...
    public void testDynamicMethodPointcutThatAlwaysAppliesStatically() throws Throwable {
        ...
        ProxyFactory pc = new ProxyFactory();
        pc.addInterface(ITestBean.class);
        TestDynamicPointcutAdvice dp =
                new TestDynamicPointcutAdvice(new NopInterceptor(), "getAge");
        pc.addAdvisor(dp);
        pc.setTarget(tb);
        ...
        MethodInterceptor twoBirthdayInterceptor =
                new MethodInterceptor() {
                    ...
                    public Object invoke(MethodInvocation mi) throws Throwable {
                        ...
                        MethodInvocation clone1 =
                                ((ReflectiveMethodInvocation) mi).invocableClone();
                        MethodInvocation clone2 =
                                ((ReflectiveMethodInvocation) mi).invocableClone();
                        clone1.proceed();
                        clone2.proceed();
                        return mi.proceed();
    ...
    public void testUserAttributes() throws Throwable {
        class MapAwareMethodInterceptor implements MethodInterceptor {
            ...
            public Object invoke(MethodInvocation invocation) throws Throwable {
                ...
                for (Iterator<String> it = rmi.getUserAttributes().keySet().iterator();
                        it.hasNext(); ) {
                    Object key = it.next();
    ...
    public void testMultiAdvice() throws Throwable {
        ...
        assertThatExceptionOfType(SpecializedUncheckedException.class)
                ...
                .isThrownBy(
                        () ->
                                proxied.exceptional(
                                        new SpecializedUncheckedException(
                                                "foo", (SQLException) null)));
    ...
    private static class CheckMethodInvocationIsSameInAndOutInterceptor
        ...
        public Object invoke(MethodInvocation mi) throws Throwable {
            ...
            assertThat(mi.getMethod())
                    .as("Method invocation has same method on way back")
                    .isEqualTo(m);
            return retval;
        }
    }
            ...
            setPointcut(
                    new DynamicMethodMatcherPointcut() {
                        ...
                        public boolean matches(
                                Method m, @Nullable Class<?> targetClass, Object... args) {
                            return args[0] == null;
                        }
     ...
     * invocations may be reused and hence cleared at the end of each invocation. So we trap only
     * the target.
     */
    ...
    public static class CountingMultiAdvice extends MethodCounter
        ...
        @Override
        public void afterReturning(
                @Nullable Object o, Method m, Object[] args, @Nullable Object target)
                throws Throwable {
            count(m);
        }
