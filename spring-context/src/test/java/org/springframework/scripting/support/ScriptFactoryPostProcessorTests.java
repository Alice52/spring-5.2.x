...
public class ScriptFactoryPostProcessorTests {
    ...
    private static StaticScriptSource getScriptSource(GenericApplicationContext ctx)
        ...
        BeanDefinition bd =
                processor.scriptBeanFactory.getBeanDefinition("scriptedObject.messenger");
    ...
    public void testDoesNothingWhenPostProcessingNonScriptFactoryTypeBeforeInstantiation()
        ...
        assertThat(
                        new ScriptFactoryPostProcessor()
                                .postProcessBeforeInstantiation(getClass(), "a.bean"))
                .isNull();
    }
    ...
    public void testScriptHavingAReferenceToAnotherBean() throws Exception {
        // just tests that the (singleton) script-backed bean is able to be instantiated with
    ...
    public void testPrototypeScriptedBean() throws Exception {
        ...
        ctx.registerBeanDefinition(
                BEAN_WITH_DEPENDENCY_NAME, scriptedBeanBuilder.getBeanDefinition());
