...
public class AnnotationCacheOperationSourceTests {
    ...
    public void singleComposedAnnotation() {
        ...
        assertThat(cacheOperation).isInstanceOf(CacheableOperation.class);
        assertThat(cacheOperation.getCacheNames())
                .isEqualTo(Collections.singleton("composedCache"));
    ...
    public void customKeyGeneratorInherited() {
        Collection<CacheOperation> ops =
                getOps(AnnotatedClass.class, "customKeyGeneratorInherited", 1);
        CacheOperation cacheOperation = ops.iterator().next();
        assertThat(cacheOperation.getKeyGenerator())
                .as("Custom key generator not set")
                .isEqualTo("custom");
    ...
    public void customCacheManagerInherited() {
        Collection<CacheOperation> ops =
                getOps(AnnotatedClass.class, "customCacheManagerInherited", 1);
        CacheOperation cacheOperation = ops.iterator().next();
        assertThat(cacheOperation.getCacheManager())
                .as("Custom cache manager not set")
                .isEqualTo("custom");
    ...
    public void validateNoCacheIsValid() {
        ...
        CacheOperation cacheOperation = ops.iterator().next();
        assertThat(cacheOperation.getCacheNames())
                .as("cache names set must not be null")
                .isNotNull();
        assertThat(cacheOperation.getCacheNames().size())
                .as("no cache names specified")
                .isEqualTo(0);
    }
