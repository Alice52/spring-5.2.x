...
public class CachePutEvaluationTests {
    ...
    public void getAndPut() {
        ...
        // operations
        // are only processed in case of a cache miss. This is why combining @Cacheable with
        // @CachePut
        // is a very bad idea. We could refine the condition now that we can figure out if we are
        // going
