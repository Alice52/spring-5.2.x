...
abstract class ParserStrategyUtils {
    ...
    /**
     * Instantiate a class using an appropriate constructor and return the new instance as the
     * specified assignable type. The returned instance will have {@link BeanClassLoaderAware},
     * {@link BeanFactoryAware}, {@link EnvironmentAware}, and {@link ResourceLoaderAware} contracts
    ...
    static <T> T instantiateClass(
        ...
        ParserStrategyUtils.invokeAwareMethods(
                instance, environment, resourceLoader, registry, classLoader);
        return instance;
    }
