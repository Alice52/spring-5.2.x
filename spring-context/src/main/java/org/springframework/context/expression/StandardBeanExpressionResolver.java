 ...
 *
 * <p>All beans in the containing {@code BeanFactory} are made available as predefined variables
 * with their common bean name, including standard context beans such as "environment",
...
public class StandardBeanExpressionResolver implements BeanExpressionResolver {
    ...
    /**
     * Create a new {@code StandardBeanExpressionResolver} with the given bean class loader, using
     * it as the basis for expression compilation.
     *
        ...
        try {
            ...
            if (expr == null) {
                expr =
                        this.expressionParser.parseExpression(
                                value, this.beanExpressionParserContext);
            ...
            if (sec == null) {
                ...
                ConversionService conversionService =
                        evalContext.getBeanFactory().getConversionService();
