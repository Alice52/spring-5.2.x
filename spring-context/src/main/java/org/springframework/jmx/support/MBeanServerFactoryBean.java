...
/**
 * {@link FactoryBean} that obtains a {@link javax.management.MBeanServer} reference through the
 * standard JMX 1.2 {@link javax.management.MBeanServerFactory} API.
 *
...
public class MBeanServerFactoryBean
    ...
    /**
     * Set whether or not the {@code MBeanServerFactoryBean} should attempt to locate a running
     * {@code MBeanServer} before creating one.
     *
     ...
     *
     * <p>Default is none. If specified, this will result in an automatic attempt being made to
     * locate the attendant MBeanServer, and (importantly) if said MBeanServer cannot be located no
     * attempt will be made to create a new MBeanServer (and an MBeanServerNotFoundException will be
     * thrown at resolution time).
     *
    ...
    /**
     * Set whether to register the {@code MBeanServer} with the {@code MBeanServerFactory}, making
     * it available through {@code MBeanServerFactory.findMBeanServer()}.
     *
     ...
     *
     * <p>The default implementation attempts to find an {@code MBeanServer} using a standard
     * lookup. Subclasses may override to add additional location logic.
     *
     * @param agentId the agent identifier of the MBeanServer to retrieve. If this parameter is
     *     {@code null}, all registered MBeanServers are considered.
     * @return the {@code MBeanServer} if found
     * @throws org.springframework.jmx.MBeanServerNotFoundException if no {@code MBeanServer} could
     *     be found
     * @see #setLocateExistingServerIfPossible
    ...
    /**
     * Create a new {@code MBeanServer} instance and register it with the {@code
