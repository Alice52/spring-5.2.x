...
public class MBeanRegistrationSupport {
    ...
    /**
     * Specify the {@code MBeanServer} instance with which all beans should be registered. The
     * {@code MBeanExporter} will attempt to locate an existing {@code MBeanServer} if none is
     * supplied.
     */
                ...
                if (this.registrationPolicy == RegistrationPolicy.IGNORE_EXISTING) {
                    ...
                    try {
                        ...
                        if (logger.isInfoEnabled()) {
                            logger.info(
                                    "Unable to replace existing MBean at [" + objectName + "]",
                                    ex2);
                        }
                        throw ex;
                    }
