...
public class DefaultMessageCodesResolver implements MessageCodesResolver, Serializable {
     ...
     *
     * <p>See the {@link DefaultMessageCodesResolver class level javadoc} for details on the
     * generated codes.
     *
    ...
    /**
     * Add both keyed and non-keyed entries for the supplied {@code field} to the supplied field
     * list.
     */
    protected void buildFieldList(String field, List<String> fieldList) {
        ...
        while (keyIndex != -1) {
            ...
            if (endKeyIndex != -1) {
                plainField =
                        plainField.substring(0, keyIndex) + plainField.substring(endKeyIndex + 1);
    ...
    public enum Format implements MessageCodeFormatter {
        ...
        /**
         * Prefix the error code at the beginning of the generated message code. e.g.: {@code
