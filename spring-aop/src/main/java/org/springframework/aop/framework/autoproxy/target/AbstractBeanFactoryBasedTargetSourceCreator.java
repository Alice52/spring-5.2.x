...
public abstract class AbstractBeanFactoryBasedTargetSourceCreator
    ...
    protected DefaultListableBeanFactory getInternalBeanFactoryForBean(String beanName) {
        synchronized (this.internalBeanFactories) {
            DefaultListableBeanFactory internalBeanFactory =
                    this.internalBeanFactories.get(beanName);
     ...
     * interested it in, in which case no special target source will be created. Subclasses should
     * not call {@code setTargetBeanName} or {@code setBeanFactory} on the
