...
/**
 * Factory that can create Spring AOP Advisors given AspectJ classes from classes honoring AspectJ's
 * annotation syntax, using reflection to invoke the corresponding advice methods.
 *
 * @author Rod Johnson
