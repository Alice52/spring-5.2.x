...
public class TypePatternClassFilter implements ClassFilter {
     ...
     * typePattern} property, else a no doubt fatal {@link IllegalStateException} will be thrown
     ...
     * (though &amp;&amp; will work). We also allow {@code and} between two sub-expressions.
     *
    ...
    public boolean equals(Object other) {
        return (this == other
                || (other instanceof TypePatternClassFilter
                        && ObjectUtils.nullSafeEquals(
                                this.typePattern, ((TypePatternClassFilter) other).typePattern)));
    }
