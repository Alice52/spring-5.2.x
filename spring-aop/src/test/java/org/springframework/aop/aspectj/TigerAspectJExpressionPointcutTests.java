...
public class TigerAspectJExpressionPointcutTests {
    ...
    public void testMatchGenericArgument() {
        String expression =
                "execution(* set*(java.util.List<org.springframework.beans.testfixture.beans.TestBean>) )";
        ...
        assertThat(ajexp.matches(methodsOnHasGeneric.get("setPartners"), HasGeneric.class))
                .isFalse();
    ...
    public void testMatchVarargs() throws Exception {
        ...
        assertThat(
                        jdbcVarArgs.matches(
                                MyTemplate.class.getMethod(
                                        "queryForInt", String.class, Object[].class),
                                MyTemplate.class))
                .isTrue();
        ...
        assertThat(
                        jdbcVarArgs.matches(
                                methodsOnHasGeneric.get("setPhoneNumbers"), HasGeneric.class))
                .isFalse();
    ...
    private AspectJExpressionPointcut testMatchAnnotationOnClass(String expression)
        ...
        assertThat(
                        ajexp.matches(
                                ...
                                HasTransactionalAnnotation.class))
                .isTrue();
        assertThat(ajexp.matches(BeanB.class.getMethod("setName", String.class), BeanB.class))
                .isTrue();
    ...
    public void testAnnotationOnMethodArgumentsWithFQN() throws Exception {
        ...
        assertThat(
                        takesSpringAnnotatedArgument2.matches(
                                BeanA.class.getMethod("getAge"), BeanA.class))
                .isFalse();
        assertThat(
                        takesSpringAnnotatedArgument2.matches(
                                BeanA.class.getMethod("setName", String.class), BeanA.class))
