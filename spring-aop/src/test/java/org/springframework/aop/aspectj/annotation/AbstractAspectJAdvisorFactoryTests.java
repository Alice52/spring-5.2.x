...
abstract class AbstractAspectJAdvisorFactoryTests {
    ...
    void perTypeWithinAspect() throws SecurityException, NoSuchMethodException {
        ...
        TestBean itb =
                (TestBean) createProxy(target, getFixture().getAdvisors(aif), TestBean.class);
        ...
        assertThat(itb2.getAge())
                .as("Around advice be independent for second instance")
                .isEqualTo(0);
                ...
                (ITestBean)
                        createProxy(
                                ...
                                getFixture()
                                        .getAdvisors(
                                                new SingletonMetadataAwareAspectInstanceFactory(
                                                        new NamedPointcutAspectFromLibraryWithBinding(),
                                                        "someBean")),
                                ITestBean.class);
        itb.setAge(10);
                ...
                (ITestBean)
                        createProxy(
                                ...
                                getFixture()
                                        .getAdvisors(
                                                new SingletonMetadataAwareAspectInstanceFactory(
                                                        new BindingAspectWithSingleArg(),
                                                        "someBean")),
                                ITestBean.class);
        itb.setAge(10);
        assertThat(itb.getAge()).as("Around advice must apply").isEqualTo(20);
    ...
    // TODO: Why does this test fail? It hasn't been run before, so it maybe never actually
    // passed...
    @Test
    @Disabled
    ...
    void aspectMethodThrowsExceptionLegalOnSignature() {
        ...
        List<Advisor> advisors =
                getFixture()
                        .getAdvisors(
                                new SingletonMetadataAwareAspectInstanceFactory(
                                        new ExceptionThrowingAspect(expectedException),
                                        "someBean"));
    ...
    void failureWithoutExplicitDeclarePrecedence() {
        ...
        ITestBean itb =
                (ITestBean)
                        createProxy(
                                target,
                                getFixture().getAdvisors(aspectInstanceFactory),
                                ITestBean.class);
        itb.getAge();
    }
...
class MakeITestBeanModifiable extends AbstractMakeModifiable {
    ...
    @DeclareParents(
            value = "org.springframework.beans.testfixture.beans.ITestBean+",
