...
public class AspectJAdviceParameterNameDiscovererTests {
    ...
    public void testJoinPointOnly() {
        assertParameterNames(
                getMethod("tjp"), "execution(* *(..))", new String[] {"thisJoinPoint"});
    }
    ...
    protected void assertParameterNames(
        ...
        assertThat(parameterNames.length)
                .as(
                        "bad test specification, must have same number of parameter names as method arguments")
