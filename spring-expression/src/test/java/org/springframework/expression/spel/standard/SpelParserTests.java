...
public class SpelParserTests {
    ...
    public void generalExpressions() {
        assertThatExceptionOfType(SpelParseException.class)
                ...
                .satisfies(
                        ex -> parseExceptionRequirements(SpelMessage.MISSING_CONSTRUCTOR_ARGS, 10));
        ...
        assertThatExceptionOfType(SpelParseException.class)
                ...
                .satisfies(
                        ex ->
                                parseExceptionRequirements(
                                        SpelMessage.NON_TERMINATING_DOUBLE_QUOTED_STRING, 0));
        ...
        assertThatExceptionOfType(SpelParseException.class)
                ...
                .satisfies(
                        ex ->
                                parseExceptionRequirements(
                                        SpelMessage.NON_TERMINATING_QUOTED_STRING, 0));
    }
                ...
                .satisfies(
                        ex -> {
                            ...
                            assertThat(ex.getMessageCode())
                                    .isEqualTo(SpelMessage.UNEXPECTED_ESCAPE_CHAR);
                        });
    }
