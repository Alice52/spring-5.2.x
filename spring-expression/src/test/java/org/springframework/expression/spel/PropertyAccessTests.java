...
public class PropertyAccessTests extends AbstractExpressionTests {
    ...
    public void testAddingSpecificPropertyAccessor() {
        ...
        // message will be: EL1063E:(pos 20): A problem occurred whilst attempting to set the
        // property
    ...
    public void propertyAccessWithoutMethodResolver() {
        ...
        assertThatExceptionOfType(SpelEvaluationException.class)
                .isThrownBy(
                        () ->
                                parser.parseExpression("name.substring(1)")
                                        .getValue(context, target));
    }
    ...
    void propertyAccessWithArrayIndexOutOfBounds() {
        ...
        assertThatExceptionOfType(SpelEvaluationException.class)
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getMessageCode())
                                        .isEqualTo(SpelMessage.ARRAY_INDEX_OUT_OF_BOUNDS));
    }
