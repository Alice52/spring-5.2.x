...
public class SpelDocumentationTests extends AbstractExpressionTests {
    ...
    public void testLiterals() throws Exception {
        ...
        int maxValue =
                (Integer) parser.parseExpression("0x7FFFFFFF").getValue(); // evals to 2147483647
    ...
    public void testPropertyAccess() throws Exception {
        ...
        int year =
                (Integer) parser.parseExpression("Birthdate.Year + 1900").getValue(context); // 1856
    ...
    public void testPropertyNavigation() throws Exception {
        ...
        invention =
                parser.parseExpression("Members[0].Inventions[6]")
    ...
    public void testDictionaryAccess() throws Exception {
        ...
        Inventor pupin =
                parser.parseExpression("officers['president']")
        ...
        // setting values
        Inventor i =
                parser.parseExpression("officers['advisors'][0]")
                        .getValue(societyContext, Inventor.class);
        ...
        Inventor i2 =
                parser.parseExpression("reverse[0]['advisors'][0]")
                        .getValue(societyContext, Inventor.class);
    ...
    public void testMethodInvocation2() throws Exception {
        ...
        // evaluates to true
        boolean isMember =
                parser.parseExpression("isMember('Mihajlo Pupin')")
    ...
    public void testOtherOperators() throws Exception {
        // evaluates to false
        boolean falseValue =
                parser.parseExpression("'xyz' instanceof T(int)").getValue(Boolean.class);
    ...
    public void testLogicalOperators() throws Exception {
        ...
        boolean trueValue =
                parser.parseExpression(expression).getValue(societyContext, Boolean.class);
    ...
    public void testNumericalOperators() throws Exception {
        ...
        String testString =
                parser.parseExpression("'test' + ' ' + 'string'")
    ...
    public void testAssignment() throws Exception {
        ...
        String aleks =
                parser.parseExpression("foo = 'Alexandar Seovic'")
    ...
    public void testFunctions() throws Exception {
        ...
        String helloWorldReversed =
                parser.parseExpression("#reverseString('hello world')")
    ...
    public void testSelection() throws Exception {
        ...
        List<Inventor> list =
                (List<Inventor>)
                        parser.parseExpression("Members2.?[nationality == 'Serbian']")
                                .getValue(societyContext);
