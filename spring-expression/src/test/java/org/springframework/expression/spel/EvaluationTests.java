...
public class EvaluationTests extends AbstractExpressionTests {
    ...
    public void testCreateListsOnAttemptToIndexNull01() throws EvaluationException, ParseException {
        ...
        assertThatExceptionOfType(EvaluationException.class)
                .isThrownBy(
                        () ->
                                parser.parseExpression("list2[3]")
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getMessageCode())
                                        .isEqualTo(SpelMessage.FLAWED_PATTERN));
    }
    ...
    public void testPropertiesNested03() throws ParseException {
        assertThatExceptionOfType(SpelParseException.class)
                ...
                .satisfies(
                        ex -> {
                            assertThat(ex.getMessageCode())
                                    .isEqualTo(SpelMessage.UNEXPECTED_DATA_AFTER_DOT);
    ...
    public void testComparison() {
        ...
        boolean trueValue =
                parser.parseExpression("T(java.util.Date) == Birthdate.Class")
    ...
    public void testResolvingList() {
        ...
        assertThatExceptionOfType(EvaluationException.class)
                .isThrownBy(
                        () ->
                                parser.parseExpression("T(List)!=null")
                                        .getValue(context, Boolean.class));
        ((StandardTypeLocator) context.getTypeLocator()).registerImport("java.util");
        assertThat(parser.parseExpression("T(List)!=null").getValue(context, Boolean.class))
                .isTrue();
    }
    ...
    /**
     * SPR-6984: attempting to index a collection on write using an index that doesn't currently
     * exist in the collection (address.crossStreets[0] below)
     */
    @Test
    ...
    public void increment03() {
        ...
        assertThatExceptionOfType(SpelEvaluationException.class)
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getMessageCode())
                                        .isEqualTo(SpelMessage.OPERAND_NOT_INCREMENTABLE));
    ...
    public void decrement03() {
        ...
        assertThatExceptionOfType(SpelEvaluationException.class)
                ...
                .satisfies(
                        ex ->
                                assertThat(ex.getMessageCode())
                                        .isEqualTo(SpelMessage.OPERAND_NOT_DECREMENTABLE));
    ...
    public void incrementAllNodeTypes() throws SecurityException, NoSuchMethodException {
        ...
        expectFailNotAssignable(parser, ctx, "--('abc' matches '^a..')");
        expectFailSetValueNotSupported(
                parser, ctx, "('abc' matches '^a..')=('abc' matches '^a..')");
        ...
        expectFailNotAssignable(
                parser, ctx, "({1,2,3}.?[#isEven(#this)])=({1,2,3}.?[#isEven(#this)])");
        ...
        expectFailNotIncrementable(
                parser,
                ctx,
                "({1,2,3}.![#isEven(#this)])++"); // projection would be {false,true,false}
