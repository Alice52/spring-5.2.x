    ...
    public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
        ...
        if (value instanceof Number) {
            ...
            if (op1 instanceof BigDecimal) {
                newValue =
                        new TypedValue(
                                ((BigDecimal) op1).add(BigDecimal.ONE),
                ...
                newValue =
                        new TypedValue(
                                ((BigInteger) op1).add(BigInteger.ONE),
                                typedValue.getTypeDescriptor());
                ...
                newValue =
                        new TypedValue(
                                op1.shortValue() + (short) 1, typedValue.getTypeDescriptor());
            } else if (op1 instanceof Byte) {
                newValue =
                        new TypedValue(op1.byteValue() + (byte) 1, typedValue.getTypeDescriptor());
            } else {
