...
public class MethodReference extends SpelNodeImpl {
    ...
    /**
     * Decode the AccessException, throwing a lightweight evaluation exception or, if the cause was
     * a RuntimeException, throw the RuntimeException directly.
     */
    ...
    public void generateCode(MethodVisitor mv, CodeFlow cf) {
        ...
        if (executorToCheck == null
            ...
            throw new IllegalStateException(
                    "No applicable cached executor found: " + executorToCheck);
        }
        ...
        mv.visitMethodInsn(
                (isStaticMethod
                        ? INVOKESTATIC
                        : (method.isDefault() ? INVOKEINTERFACE : INVOKEVIRTUAL)),
                classDesc,
                method.getName(),
        ...
        if (this.originalPrimitiveExitTypeDescriptor != null) {
            // The output of the accessor will be a primitive but from the block above it might be
            // null,
