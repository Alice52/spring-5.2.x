...
public final class SimpleEvaluationContext implements EvaluationContext {
     ...
     * delegates: typically a custom {@code PropertyAccessor} specific to a use case (e.g. attribute
     * resolution in a custom data structure), potentially combined with a {@link
    ...
    /**
     * Create a {@code SimpleEvaluationContext} for read-write access to public properties via
    ...
    public static class Builder {
        ...
        /**
         * Register the specified {@link MethodResolver} delegates for a combination of property
         * access and method resolution.
         *
