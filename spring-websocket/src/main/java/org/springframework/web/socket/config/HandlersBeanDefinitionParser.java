...
class HandlersBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext context) {
        ...
        context.registerComponent(
                new BeanComponentDefinition(handlerMappingDef, handlerMappingName));
    ...
    private interface HandlerMappingStrategy {
        ...
        void addMapping(
                Element mappingElement, ManagedMap<String, Object> map, ParserContext context);
    }
    ...
    private static class WebSocketHandlerMappingStrategy implements HandlerMappingStrategy {
        ...
        public void addMapping(
            ...
            requestHandlerDef
                    .getPropertyValues()
                    .add("handshakeInterceptors", this.interceptorsList);
