...
public class StandardWebSocketClient extends AbstractWebSocketClient {
     ...
     * use {@code ContainerProvider.getWebSocketContainer()} to obtain the {@code
     * WebSocketContainer} instance.
     */
     ...
     * ClientEndpointConfig#getUserProperties() userProperties}. Use this property to configure one
     * or more properties to be passed on every handshake.
     */
    ...
    /**
     * Set an {@link AsyncListenableTaskExecutor} to use when opening connections. If this property
     * is set to {@code null}, calls to any of the {@code doHandshake} methods will block until the
