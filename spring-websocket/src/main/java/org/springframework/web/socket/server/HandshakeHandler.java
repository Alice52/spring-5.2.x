...
public interface HandshakeHandler {
     ...
     * @throws HandshakeFailureException thrown when handshake processing failed to complete due to
     *     an internal, unrecoverable error, i.e. a server error as opposed to a failure to
     *     successfully negotiate the handshake.
     */
    boolean doHandshake(
