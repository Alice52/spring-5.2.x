...
public class WebSocketStompClientTests {
    ...
    public void setUp() throws Exception {
        ...
        given(
                        webSocketClient.doHandshake(
                                this.webSocketHandlerCaptor.capture(), any(), any(URI.class)))
    ...
    public void handleWebSocketMessageBinary() throws Exception {
        ...
        connect()
                .handleMessage(
                        ...
                        new BinaryMessage(text.getBytes(StandardCharsets.UTF_8)));
    ...
    public void sendWebSocketMessage() throws Exception {
        ...
        getTcpConnection()
                .send(MessageBuilder.createMessage(payload, accessor.getMessageHeaders()));
