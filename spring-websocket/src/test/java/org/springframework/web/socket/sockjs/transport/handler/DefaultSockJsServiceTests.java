...
public class DefaultSockJsServiceTests extends AbstractHttpRequestTests {
    ...
    public void setup() {
        ...
        this.session =
                new TestSockJsSession(
                        sessionId, new StubSockJsServiceConfig(), this.wsHandler, attributes);
    ...
    public void defaultTransportHandlersWithOverride() {
        ...
        DefaultSockJsService service =
                new DefaultSockJsService(mock(TaskScheduler.class), xhrHandler);
        Map<TransportType, TransportHandler> handlers = service.getTransportHandlers();
