...
public class SimpleBrokerMessageHandlerTests {
    ...
    public void subscribeDisconnectPublish() {
        ...
        assertThat(SimpMessageHeaderAccessor.getUser(captured.getHeaders()).getName())
                .isEqualTo("joe");
    ...
    public void connect() {
        ...
        SimpMessageHeaderAccessor connectAckHeaders =
                SimpMessageHeaderAccessor.wrap(connectAckMessage);
    ...
    private Message<String> createConnectMessage(
            String sessionId, Principal user, long[] heartbeat) {
