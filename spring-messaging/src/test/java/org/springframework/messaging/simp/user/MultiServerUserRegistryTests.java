...
class MultiServerUserRegistryTests {
    ...
    private final MultiServerUserRegistry registry =
    ...
    void findSubscriptionsFromRemoteRegistry() {
        ...
        given(userRegistry.getUsers())
                .willReturn(new HashSet<>(Arrays.asList(user1, user2, user3)));
    ...
    void getSessionsWhenUserIsConnectedToMultipleServers() {
        ...
        Object remoteRegistryDto =
                new MultiServerUserRegistry(remoteRegistry).getLocalRegistryDto();
