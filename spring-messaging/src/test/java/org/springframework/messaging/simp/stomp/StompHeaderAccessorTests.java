...
public class StompHeaderAccessorTests {
    ...
    public void createWithSubscribeNativeHeaders() {
        ...
        StompHeaderAccessor headers =
                StompHeaderAccessor.create(StompCommand.SUBSCRIBE, extHeaders);
    ...
    public void createWithUnubscribeNativeHeaders() {
        ...
        StompHeaderAccessor headers =
                StompHeaderAccessor.create(StompCommand.UNSUBSCRIBE, extHeaders);
    ...
    public void createWithConnectNativeHeaders() {
        ...
        StompHeaderAccessor headerAccessor =
                StompHeaderAccessor.create(StompCommand.STOMP, extHeaders);
        ...
        assertThat(output.get(StompHeaderAccessor.STOMP_PASSCODE_HEADER).get(0))
                .isEqualTo("PROTECTED");
    }
    ...
    public void toNativeHeadersMessageFrame() {
        ...
        assertThat(actual.get(StompHeaderAccessor.STOMP_SUBSCRIPTION_HEADER).get(0))
                .isEqualTo("s1");
        assertThat(actual.get(StompHeaderAccessor.STOMP_DESTINATION_HEADER).get(0)).isEqualTo("/d");
    ...
    public void encodeConnectWithLoginAndPasscode() throws UnsupportedEncodingException {
        ...
        assertThat(new String(bytes, "UTF-8"))
                .isEqualTo("CONNECT\nlogin:joe\npasscode:joe123\n\n\0");
    }
    ...
    public void getShortLogMessage() {
        ...
        assertThat(actual)
                .isEqualTo(
                        ("SEND /foo session=123 application/json payload="
                                + sb
                                + "...(truncated)"));
    }
}
