...
public class DefaultRSocketRequesterBuilderTests {
    ...
    private final TestRSocketConnectorConfigurer connectorConfigurer =
            new TestRSocketConnectorConfigurer();
    ...
    public void rsocketConnectorConfigurer() {
        ClientRSocketFactoryConfigurer factoryConfigurer =
                mock(ClientRSocketFactoryConfigurer.class);
        Consumer<RSocketStrategies.Builder> strategiesConfigurer = mock(Consumer.class);
        RSocketRequester.builder()
                .rsocketConnector(this.connectorConfigurer)
        ...
        verify(factoryConfigurer)
                .configure(any(io.rsocket.RSocketFactory.ClientRSocketFactory.class));
    ...
    public void dataMimeTypeExplicitlySet() {
        ...
        ConnectionSetupPayload setupPayload =
                Mono.from(this.connection.sentFrames())
    ...
    public void setupWithAsyncValues() {
        ...
        DefaultMetadataExtractor extractor =
                new DefaultMetadataExtractor(StringDecoder.allMimeTypes());
