...
public class PayloadMethodArgumentResolverTests {
                ...
                .consumeErrorWith(
                        ex -> {
                            assertThat(ex.getClass())
                                    .isEqualTo(MethodArgumentResolutionException.class);
    ...
    public void stringMono() {
        ...
        Mono<Object> mono =
                resolveValue(
                        param,
                        Mono.delay(Duration.ofMillis(10)).map(aLong -> toDataBuffer(body)),
                        null);
    ...
    private PayloadMethodArgumentResolver createResolver(
        ...
        return new PayloadMethodArgumentResolver(
                decoders, validator, null, useDefaultResolution) {};
    }
