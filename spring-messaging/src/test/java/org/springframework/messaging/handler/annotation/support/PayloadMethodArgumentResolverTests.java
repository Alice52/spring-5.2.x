    ...
    public void resolveNotRequired() throws Exception {
        ...
        assertThat(
                        this.resolver.resolveArgument(
                                this.paramAnnotatedNotRequired, emptyByteArrayMessage))
                .isNull();

        Message<?> emptyStringMessage = MessageBuilder.withPayload("").build();
        assertThat(
                        this.resolver.resolveArgument(
                                this.paramAnnotatedNotRequired, emptyStringMessage))
                .isNull();
    ...
    public void resolveNonConvertibleParam() throws Exception {
        ...
        assertThatExceptionOfType(MessageConversionException.class)
                .isThrownBy(
                        () ->
                                this.resolver.resolveArgument(
                                        this.paramAnnotatedRequired, notEmptyMessage))
    ...
    public void resolveNonAnnotatedParameter() throws Exception {
        ...
        assertThatExceptionOfType(MethodArgumentNotValidException.class)
                .isThrownBy(
                        () ->
                                this.resolver.resolveArgument(
                                        this.paramValidated, emptyStringMessage));
    }
        ...
        assertThatExceptionOfType(MethodArgumentNotValidException.class)
                .isThrownBy(
                        () ->
                                assertThat(
                                                this.resolver.resolveArgument(
                                                        this.paramValidatedNotAnnotated, message))
