...
public abstract class AbstractMessageConverter implements SmartMessageConverter {
     ...
     *
     * <p>When this flag is set to {@code true}, {@link #supportsMimeType(MessageHeaders)} will
     * return {@code false} if the {@link #setContentTypeResolver contentTypeResolver} is not
     * defined or if no content-type header is present.
     */
    ...
    /**
     * Configure the preferred serialization class to use (byte[] or String) when converting an
     * Object payload to a {@link Message}.
     *
    ...
    /**
     * Return the default content type for the payload. Called when {@link #toMessage(Object,
     ...
     * @param conversionHint an extra object passed to the {@link MessageConverter}, e.g. the
     *     associated {@code MethodParameter} (may be {@code null}}
     * @return the resulting payload for the message, or {@code null} if the converter cannot
