...
final class DefaultRSocketRequester implements RSocketRequester {
    ...
    private static boolean isVoid(ResolvableType elementType) {
        return (Void.class.equals(elementType.resolve())
                || void.class.equals(elementType.resolve()));
    }
    ...
    private class DefaultRequestSpec implements RequestSpec {
        ...
        private final MetadataEncoder metadataEncoder =
                new MetadataEncoder(metadataMimeType(), strategies);

        @Nullable private Mono<Payload> payloadMono;

        @Nullable private Flux<Payload> payloadFlux;
        ...
        private void createPayload(Object input, ResolvableType elementType) {
            ...
            if (input instanceof Publisher) {
                ...
                this.payloadMono =
                        firstPayload(Mono.fromCallable(() -> encodeData(input, type, null)));
            ...
            Encoder<?> encoder =
                    elementType != ResolvableType.NONE
                                    && !Object.class.equals(elementType.resolve())
        ...
        private Mono<Payload> getPayloadMono() {
            Assert.state(
                    this.payloadFlux == null,
                    "No RSocket interaction with Flux request and Mono response.");
