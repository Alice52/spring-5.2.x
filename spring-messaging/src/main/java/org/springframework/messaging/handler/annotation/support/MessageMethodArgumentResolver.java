...
public class MessageMethodArgumentResolver implements HandlerMethodArgumentResolver {
     ...
     * that can be overridden to select a more specific target type after also taking into account
     * the "Content-Type", e.g. return {@code String} if target type is {@code Object} and {@code
     * "Content-Type:text/**"}.
     *
