...
public class SimpMessageHeaderAccessor extends NativeMessageHeaderAccessor {
    ...
    /**
     * A header that indicates to the broker that the sender will ignore errors. The header is
     * simply checked for presence or absence.
     */
    ...
    public void setUserChangeCallback(Consumer<Principal> callback) {
        ...
        this.userCallback =
                this.userCallback != null ? this.userCallback.andThen(callback) : callback;
    }
