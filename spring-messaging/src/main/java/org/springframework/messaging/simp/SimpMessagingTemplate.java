...
public class SimpMessagingTemplate extends AbstractMessageSendingTemplate<String>
     ...
     * SimpMessageHeaderAccessor#DESTINATION_HEADER} then the message is sent without further
     * changes.
     *
     * <p>If a destination header is not already present ,the message is sent to the configured
     * {@link #setDefaultDestination(Object) defaultDestination} or an exception an {@code
    ...
    protected void doSend(String destination, Message<?> message) {
        ...
        message =
                MessageBuilder.createMessage(
                        message.getPayload(), simpAccessor.getMessageHeaders());
        sendInternal(message);
    }
     ...
     * SimpMessageHeaderAccessor#getMessageHeaders()} then the same headers instance is also
