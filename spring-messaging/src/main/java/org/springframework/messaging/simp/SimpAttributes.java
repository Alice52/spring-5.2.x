...
public class SimpAttributes {
    ...
    public static final String SESSION_COMPLETED_NAME =
            SimpAttributes.class.getName() + ".COMPLETED";
     ...
     * However it <i>does not</i> execute the callback. It is assumed the removed object will
     * continue to be used and destroyed independently at the appropriate time.
     *
     * @param name the name of the attribute
     */
        ...
        synchronized (getSessionMutex()) {
            if (isSessionCompleted()) {
                throw new IllegalStateException(
                        "Session id=" + getSessionId() + " already completed");
            }
