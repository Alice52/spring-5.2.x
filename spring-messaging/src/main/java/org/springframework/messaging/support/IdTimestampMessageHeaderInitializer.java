...
public class IdTimestampMessageHeaderInitializer implements MessageHeaderInitializer {
    ...
    /**
     * Configure the IdGenerator strategy to initialize {@code MessageHeaderAccessor} instances
     * with.
     *
     ...
     * org.springframework.messaging.MessageHeaders#TIMESTAMP} header on {@code
