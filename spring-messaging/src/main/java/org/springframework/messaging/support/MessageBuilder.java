...
public final class MessageBuilder<T> {
    ...
    @Nullable private final Message<T> providedMessage;
     ...
     * copied from the provided message. The payload of the provided Message will also be used as
     * the payload for the new message.
     *
     * <p>If the provided message is an {@link ErrorMessage}, the {@link
     * ErrorMessage#getOriginalMessage() originalMessage} it contains, will be passed on to new
     * instance.
     *
     ...
     * MessageHeaders}.
     *
     * <p><strong>Note:</strong> the given {@code MessageHeaders} instance is used directly in the
     * new message, i.e. it is not copied.
     *
    ...
    /**
     * Set the value for the given header name. If the provided value is {@code null}, the header
     * will be removed.
     */
     ...
     * may contain simple matching patterns for header names. Supported pattern styles are: "xxx*",
     * "*xxx", "*xxx*" and "xxx*yyy".
     */
     ...
     * values. Use { {@link #copyHeadersIfAbsent(Map)} to avoid overwriting values. Note that the
     * 'id' and 'timestamp' header values will never be overwritten.
     */
    ...
    /**
     * Copy the name-value pairs from the provided Map. This operation will <em>not</em> overwrite
     * any existing values.
     */
    ...
    public Message<T> build() {
        ...
        if (this.payload instanceof Throwable) {
            if (this.providedMessage != null && this.providedMessage instanceof ErrorMessage) {
                ...
                if (message != null) {
                    return (Message<T>)
                            new ErrorMessage((Throwable) this.payload, headersToUse, message);
                }
            }
