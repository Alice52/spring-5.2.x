...
class SortedProperties extends Properties {
    ...
    /**
     * Construct a new {@code SortedProperties} instance that honors the supplied {@code
     * omitComments} flag.
     *
     ...
     *
     * <p>The keys will be converted to strings if necessary using {@link String#valueOf(Object)}
     ...
     *
     * <p>The entries will be sorted based on their keys, and the keys will be converted to strings
     * if necessary using {@link String#valueOf(Object)} and compared alphanumerically according to
